...
从手杀/如真似幻大厅的“皮肤”按钮、武将资料或局内人物介绍中的“换肤”入口进入。局内主副将分别提供入口，隐将遵循本体显示规则。支持搜索、预览、使用和恢复经典形象；预览不保存，使用后通过核心皮肤服务持久化。关闭换肤保留选择，重新开启恢复。

旧武将衣橱页面与设置入口已删除。迁移范围、后续动态皮肤与语音计划见 `qianhuan-skin-migration.md`。
