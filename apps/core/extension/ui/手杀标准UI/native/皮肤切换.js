...
window.shoushaNativeFactories["皮肤切换"] = function(lib, game, ui, get, ai, _status, bridge) {
const localStorage=bridge.storage, sessionStorage=bridge.session;

    //藏珍阁，启动！
    lib.config.extension_皮肤切换_czgEnable = true;
    return {
        name: "皮肤切换",
        content: function (config, pack) {
            (function () {
                ...
                const MIN_VERSION = 114514//128;Helasisy修：暂时不需要你
            ...
            adjustBoxStyle.href = lib.assetURL + 'extension/手杀标准UI/original/皮肤切换/style/adjustBox.css'
        ...
        precontent: function () {
            // 加载settings.js配置文件
            lib.init.js(lib.assetURL + 'extension/手杀标准UI/original/皮肤切换/settings.js', null, function () {
            ...
            window.skinSwitch = {
                ...
                qhly_hasExtension: function(name){return bridge.hasModule(name);},
                ...
                //判断文件、文件夹是否存在
                qhly_checkFileExist: function(path,callback){return bridge.checkFileExist(path,callback);},
                    ...
                    chukuangStart: function (data) {
                        ...
                        skinSwitch.rendererOnMessage.addListener(player, 'hideAllNodeEnd', function () {
                            ...
                            if (data.action === 'GongJi') {
                                ...
                                // 开始播放音效, 音效名等同
                                // 优先播放十周年同名文件夹下同名的音效文件
                                let path = 'extension/手杀标准UI/original/十周年UI/assets/dynamic/' + playName + '_1.mp3'
                                skinSwitch.qhly_checkFileExist(path, exists => {
                                    if (exists) {
                                        game.playAudio("..", path)
                                    } else {
                            ...
                            if (data.action === 'TeShu') {
                                ...
                                // 开始播放音效, 音效名等同
                                // 优先播放十周年同名文件夹下同名的音效文件
                                let path = 'extension/手杀标准UI/original/十周年UI/assets/dynamic/' + playName + '_2.mp3'
                                skinSwitch.qhly_checkFileExist(path, exists => {
                                    if (exists) {
                                        game.playAudio("..", path)
                                    } else {
                ...
                chukuangWorker2: null,  // 管理出框的worker2 (z-index: 4)
            ...
            function editBoxInit() {
                ...
                let initPosParams = () => {
                    ...
                    getDynamicPos(currentMode, (data) => {
                        ...
                        if (data && data.scale) adjustScale = data.scale;
                        adjustAngle = (data && data.angle) || 0;
