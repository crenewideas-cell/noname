...
window.shoushaNativeFactories["千幻聆音"] = function(lib, game, ui, get, ai, _status, bridge) {
const localStorage=bridge.storage, sessionStorage=bridge.session;
  ...
  window.qhly_extension_package = {
    ...
    name: "千幻聆音", content: function (config, pack) {
      ...
      var qhly_oldinit = bridge.playerInit;
 ...
 return result;
      ...
      bridge.installSkinEvents();
      // Card skin audio is adapted through playCardAudio, not engine content.
