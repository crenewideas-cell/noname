...
window.shoushaNativeFactories["选将美化"] = function(lib,game,ui,get,ai,_status, bridge){
...
//感谢某个萌新辛劳的付出
	...
	if(lib.skill.dcwangyuan) { lib.skill.dcwangyuan.intro = {
	    name:'妄(妄缘/铃音)',
	    markcount:'expansion',
	...
	if(lib.skill.dcfozong) { lib.skill.dcfozong.intro = {
	    markcount:'expansion',
	    mark: function(dialog, expansion, player) {
            chakangpaiming('佛宗', player.getExpansions('dcfozong'),true);	
        },
	}; }
	if(lib.skill.xinzhoufu2) { lib.skill.xinzhoufu2.intro = {
	    markcount:'expansion',
	    mark: function(dialog, expansion, player) {
            chakangpaiming('咒缚', player.getExpansions('xinzhoufu2'),true);	
        },
	}; }
	if(lib.skill.jutu) { lib.skill.jutu.intro = {
	    markcount:'expansion',
	    mark: function(dialog, expansion, player) {
            chakangpaiming('据土', player.getExpansions('jutu'),true);	
        },
	}; }
	if(lib.skill.duwang) { lib.skill.duwang.intro = {
	    name:'刺',
		name2:'刺',
	    markcount:'expansion',
	    mark: function(dialog, expansion, player) {
	...
	if(lib.skill.bizhuan) { lib.skill.bizhuan.intro = {
	    name:'辟撰(书)',
		name2:'书',
	    markcount:'expansion',
	    mark: function(dialog, expansion, player) {
	...
	if(lib.skill.rebizhuan) { lib.skill.rebizhuan.intro = {
	    name:'辟撰(书)',
		name2:'书',
	    markcount:'expansion',
	    mark: function(dialog, expansion, player) {
	...
	if(lib.skill.kuangbi) { lib.skill.kuangbi.intro = {
	    markcount:'expansion',
	    mark: function(dialog, expansion, player) {
            chakangpaiming('匡弼', player.getExpansions('kuangbi'),true);	
        },
	}; }
	if(lib.skill.rekuangbi) { lib.skill.rekuangbi.intro = {
	    markcount:'expansion',
	    mark: function(dialog, expansion, player) {
            chakangpaiming('匡弼', player.getExpansions('rekuangbi_effect'),true);	
        },
	}; }
	if(lib.skill.jieyue2) { lib.skill.jieyue2.intro = {
	    markcount:'expansion',
	    mark: function(dialog, expansion, player) {
            chakangpaiming('节', player.getExpansions('jieyue2'),true);	
        },
	}; }
	if(lib.skill.chunlao) { lib.skill.chunlao.intro = {
	    markcount:'expansion',
	    mark: function(dialog, expansion, player) {
	...
	if(lib.skill.sidi) { lib.skill.sidi.intro = {
	    markcount:'expansion',
	    mark: function(dialog, expansion, player) {
            chakangpaiming('司敌', player.getExpansions('sidi'),true);	
        },
	}; }
	if(lib.skill.residi) { lib.skill.residi.intro = {
	    markcount:'expansion',
	    mark: function(dialog, expansion, player) {
            chakangpaiming('司敌', player.getExpansions('residi'),true);	
        },
	}; }
	if(lib.skill.xinpojun2) { lib.skill.xinpojun2.intro = {
	    markcount:'expansion',
	    mark: function(dialog, expansion, player) {
	...
	if(lib.skill.decadepojun2) { lib.skill.decadepojun2.intro = {
	    markcount:'expansion',
	    mark: function(dialog, expansion, player) {
	...
	if(lib.skill.repojun2) { lib.skill.repojun2.intro = {
	    markcount:'expansion',
	    mark: function(dialog, expansion, player) {
	...
	if(lib.skill.reqianxun2) { lib.skill.reqianxun2.intro = {
	    markcount:'expansion',
	    mark: function(dialog, expansion, player) {
	...
	if(lib.skill.kongsheng) { lib.skill.kongsheng.intro = {
	    markcount:'expansion',
	    mark: function(dialog, expansion, player) {
	...
	if(lib.skill.olkongsheng) { lib.skill.olkongsheng.intro = {
	    markcount:'expansion',
	    mark: function(dialog, expansion, player) {
	...
	if(lib.skill.xiansi) { lib.skill.xiansi.intro = {
	    markcount:'expansion',
	    mark: function(dialog, expansion, player) {
            chakangpaiming('陷嗣', player.getExpansions('xiansi'),true);	
        },
	}; }
	if(lib.skill.remoshi) { lib.skill.remoshi.intro = {
	    name:'没矢',
		name2:'矢',
	    markcount:'expansion',
	    mark: function(dialog, expansion, player) {
	...
	if(lib.skill.olchenglie) { lib.skill.olchenglie.intro = {
	    markcount:'expansion',
		mark:function(dialog,content,player){
	...
	if(lib.skill.muniu_skill) { lib.skill.muniu_skill.intro = {
        markcount: function(storage, player) {
