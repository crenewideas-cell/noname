...
if(localStorage.getItem('rz_KFZ_reload')=='reload') {
		...
		game.reload3(true);
            ...
            if (!Login) {
                window.location.href = lib.assetURL + 'extension/手杀标准UI/original/如真似幻/html/rzsh.html';
            };
        ...
        if(!localStorage.getItem('liuli_tenUIfix')||localStorage.getItem('liuli_tenUIfix')!='fix') {
            ...
            pixiscript.src = lib.assetURL + 'extension/手杀标准UI/original/如真似幻/js/pixi6.min.js';
            document.head.appendChild(pixiscript);
        }else {
            pixiscript = this;
        }
            let script2 = document.createElement('script');
            script2.src = lib.assetURL + 'extension/手杀标准UI/original/如真似幻/js/gsap.min.js';
       ...
       /*      let czgscript = document.createElement('script');
            czgscript.src = lib.assetURL + 'extension/手杀标准UI/original/皮肤切换/czg_setting.js';
            ...
            pixiscript.onload = function() {
              /*  let script2 = document.createElement('script');
                script2.src = lib.assetURL + 'extension/手杀标准UI/original/如真似幻/js/spine.3.8.js';
                document.head.appendChild(script2);*/
                if (!lib.config.tianti_versus_two || (!lib.config['tianti_versus_two'].xxingnum&&!lib.config['tianti_versus_two'].count)) {
                    game.saveConfig('tianti_versus_two', {
                        count: 0,
                ...
                if (sessionStorage.getItem('Network') == 'offline') {
                    ...
                    link.rel = 'stylesheet';
                    link.href = lib.assetURL + 'extension/手杀标准UI/original/如真似幻/css/offline.css'; // CSS文件的路径
                    ...
                    lib.init.onload = function() {
                        ...
                        if (!lib.imported.mode || !lib.imported.mode[lib.config.mode]) {
                            ...
                            var clickNodek = function() {
                                ...
                                splash.setBackgroundImage('extension/手杀标准UI/original/如真似幻/images/mode/' + this.link + '.jpg');
                            ...
                            bigEnter.src = lib.assetURL + 'extension/手杀标准UI/original/如真似幻/images/offline/kaizhan.png'
                            bigEnter.width = 100;
    ...
    if (distance > 110) {
      return;
                            ...
                            offlineTextBlank.src = lib.assetURL + 'extension/手杀标准UI/original/如真似幻/images/offline/blank.png'
                            ...
                            offlineText.src = lib.assetURL + 'extension/手杀标准UI/original/如真似幻/images/offline/offlinetext.png'
                            offlineText.id = 'offlinetext'; // 设置元素的 ID
                            splash.appendChild(offlineText);
                            var logOut = document.createElement('img');
                            logOut.src = lib.assetURL + 'extension/手杀标准UI/original/如真似幻/images/offline/button.png'
                            logOut.id = 'logout'; // 设置元素的 ID
                            splash.appendChild(logOut);
                            splash.setBackgroundImage('extension/手杀标准UI/original/如真似幻/images/mode/identity.jpg');
                            // 缓存logOut按钮
                            // 添加click事件监听器
                            ...
                            for (var i = 0; i < lib.config.all.mode.length; i++) {
                                ...
                                //avatarnode.setBackgroundImage('extension/手杀标准UI/original/如真似幻/images/lbtn.png');
                                var avatarnode2 = ui.create.div(node/*, '.avatar'*/);//ui.create.div(avatarnode);
                                avatarnode2.setBackgroundImage('extension/手杀标准UI/original/如真似幻/images/lbtn.png');
                                //avatarnode2.style.backgroundImage='url("'+lib.assetURL+'extension/手杀标准UI/original/如真似幻/images/lbtn.png'+'")';
                    ...
                    //    lib.init.js(lib.assetURL + 'extension/手杀标准UI/original/如真似幻/js', 'dynamicSkin');
                        game.documentZoom = game.deviceZoom;
                        if (game.documentZoom != 1) {
                            ui.updatez();
                        }
                        ...
                        //检测不到主题文件夹就恢复主题
                            if(lib.config.uiStyles && game.getFileList) game.getFileList('extension/手杀标准UI/original/如真似幻/images/uiStyles',function(folders,files){
                                                ...
                                                if(typeof game.rollCard=='function') {
                                                    setTimeout(function(){
                                                        ...
                                                        for(var g=0; g<emodeList.length; g++) {
                                                            cardsList.push({
                                                                name: emodeList[g],
                                                                front:'extension/手杀标准UI/original/如真似幻/images/emode/cards/'+emodeList[g]+'.png',
                                                                back:'extension/手杀标准UI/original/如真似幻/images/emode/cards/cardback.png'
                                                            });
                                                        }
                                                        /*for(var g=0; g<emodeList.length; g++) {
                                                            cardsList.push({
...
'我堂堂吕布，为何就成了三姓家奴。',
    ...
    for(var i=0;i<modes.length;i++) {
        ...
        game.rz_remen_cha=game.rz_remen_cha.concat(list);
                             ...
                             //       if (window.dyapp) window.dyapp.destroy(true);
                                    lib.init.js(lib.assetURL + 'mode', lib.config.mode, proceed);
                              //      lib.init.js(lib.assetURL + 'extension/手杀标准UI/original/如真似幻/mode', 'rzsh', proceed);
                                     });
                                }
            ...
            n.open('GET', lib.assetURL + 'extension/手杀标准UI/original/如真似幻/js/pixi6.min_chg.js', false);
            n.send();
