...
window.nmimport(function(lib, game, ui, get, ai, _status){
	...
	ui.create.menu = function (connectMenu) {
        ...
        /*var openMenu = function(node, e, onclose) {
			...
			popupContainer.classList.remove('hidden');
			//game.playAudio('../extension/手杀标准UI/original/手杀ui/audio/Menu.mp3');
			//这里也是第一次点击选项的声音
			popupContainer.onclose = onclose;
		};*/
		var clickToggle = function() {
    		...
    		game.playAudio('../extension/手杀标准UI/original/手杀ui/audio/MidButton.mp3');
    		/*关闭选项的声音*/
		...
		var clickSwitcher = function() {
			...
			game.playAudio('../extension/手杀标准UI/original/手杀ui/audio/WinButton.mp3');
			/*内部选项第一下点击的声音*/
			if (this._link.menu) {
		...
		var clickMenuItem = function() {
			...
			game.playAudio('../extension/手杀标准UI/original/手杀ui/audio/TinyButton.mp3');
			/*内部选项，比如斗地主选模式等*/
			if (config.onclick) {
