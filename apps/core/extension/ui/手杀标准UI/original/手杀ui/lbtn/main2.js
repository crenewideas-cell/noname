...
lib.arenaReady.push(function(){  
   ...
   // var head = ui.create.node('img');
			// head.src= lib.assetURL + "extension/手杀标准UI/original/手杀ui/lbtn/images/uibutton/chubing.png"
		...
		var head = ui.create.node('img');    
		    head.src= lib.assetURL + "extension/手杀标准UI/original/手杀ui/lbtn/images/uibutton/shoupai.png"
			head.style.cssText="display: block; --w: 50px;--h: 38px;width: var(--w);height: var(--h);position: absolute;top: 0px;left:120px;background-color: transparent;z-index:-1"
		    document.body.appendChild(head); 
      }}
    ...
    if(lib.config.mode=='identity'||lib.config.mode=='doudizhu'||lib.config.mode=='guozhan'||lib.config.mode=='versus'||lib.config.mode=='single'||lib.config.mode=='martial'){
           ...
           var wenhao = ui.create.node('img');
			wenhao.src= lib.assetURL + "extension/手杀标准UI/original/手杀ui/lbtn/images/CD/wenhao.png"
    ...
    var head = ui.create.node('img');
			head.src= lib.assetURL + "extension/手杀标准UI/original/手杀ui/lbtn/images/uibutton/yinying.png"
			head.style.cssText="display: block;width: 100%;height: 30%;position: absolute;bottom: 0px;background-color: transparent;z-index:-4"
		    document.body.appendChild(head); 
  
    var head = ui.create.node('img');
			head.src= lib.assetURL + "extension/手杀标准UI/original/手杀ui/lbtn/images/CD/button3.png"
   ...
   var head = ui.create.node('div');
			head.style.cssText="display: block;--w: 56px;--h: calc(var(--w) * 74/71);width: var(--w);height: var(--h);position: absolute;bottom: calc(100% - 69px);left: calc(100% - 112.5px);background-color: transparent;z-index:1"
		head.onclick = function() {
			game.playAudio('../extension/手杀标准UI/original/手杀ui/lbtn/images/CD/click.mp3');
			var popuperContainer = ui.create.div('.popup-container', {background: "rgb(0,0,0,0)"}, ui.window);
                            popuperContainer.addEventListener('click', event => {
        game.playAudio('../extension/手杀标准UI/original/手杀ui/lbtn/images/CD/back.mp3');
          ...
          event.stopPropagation();
				...
				game.playAudio('../extension/手杀标准UI/original/手杀ui/lbtn/images/CD/button.mp3');
       ...
       game.playAudio('../extension/手杀标准UI/original/手杀ui/lbtn/images/CD/button.mp3');
         ...
         var Backgrounds =["人间安乐","兵临城下","兵荒马乱","三国开黑节","华灯初上","天书乱斗","朝堂之上","校园行","桃园风格","汉室当兴","游卡桌游","十周年"];
             ...
             ui.background.setBackgroundImage("extension/手杀标准UI/original/手杀ui/lbtn/images/background/"+Backgrounds.randomGet()+".jpg");           
	...
	var head = ui.create.node('img');
			head.src= lib.assetURL + "extension/手杀标准UI/original/手杀ui/lbtn/images/uibutton/zhengli.png"
  ...
  ui.create.confirm = function(str, func) {
    ...
    create: {
      control: function() {
        ...
        //-------原版---------//
       if(lib.config.extension_手杀ui_XPJ == "on") {
    ...
    click: {
      ...
      huanfu:function() {
      game.playAudio('../extension/手杀标准UI/original/手杀ui/lbtn/images/CD/huanfu.mp3');
