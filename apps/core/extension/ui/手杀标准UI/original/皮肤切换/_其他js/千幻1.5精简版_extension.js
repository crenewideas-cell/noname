game.import("extension",function(lib,game,ui,get,ai,_status){return {name:"千幻聆音",content:function(config,pack){
    ...
    var DEFAULT_PACKAGE = {
        ...
        skin:{
            standard:'extension/手杀标准UI/original/千幻聆音/sanguoskin/',//皮肤图片在千幻聆音扩展内的位置。
        },
        audioOrigin:'',
    ...
    game.qhly_open=function(name){
        ...
        var refreshView = function(name,viewAbstract){
            ...
            if(skills){
                ...
                for(var skill of skills){
                    ...
                    if(window.qhly_TrySkillAudio){
                        infoString += "<a style='color:#ffffff' href=\"javascript:window.qhly_TrySkillAudio('"+skill+"',{name:'"+name+"'},null,window.qhly_audio_which[\'"+skill+"\'],\'"+viewAbstract.skin+"\');window.qhly_audio_which[\'"+skill+"\']++;\"><img style=height:22px src="+lib.assetURL+"extension/手杀标准UI/original/千幻聆音/qhly_pic_playaudiobutton.png></a><br>";
                    }
                    infoString += "<br><br>";
                    str += infoString;
                }
            ...
            str += "【阵亡】";
            str += "<a style='color:#ffffff' href=\"javascript:window.qhly_playDieAudio(\'"+name+"\');\"><img style=height:22px src="+lib.assetURL+"extension/手杀标准UI/original/千幻聆音/qhly_pic_playaudiobutton.png></a><br>";
            if(info.info){
                str += info.info;
            }
    ...
    intro:"对局内实时换肤换音扩展！<br>感谢以下群友参与了BUG反馈，并给出了可行的建议：꧁彥꧂ 不是狗的牧羊犬 笔芯笔芯<br><br><b><font color=\"#FF3030\">推广：无名杀扩展大作《玄武江湖》，是一个原创武侠故事扩展。独特的内力值系统，所有武将均有配音演员配音，精彩的人物故事更增添代入感，欢迎各位朋友下载。</font></b><br><br>BUG反馈，故事讨论，人物客串，意见建议，欢迎做客玄武江湖工作室群 522136249。<br><img style=width:238px src="+lib.assetURL+"extension/手杀标准UI/original/千幻聆音/xwjh_pic_erweima.jpg>",
    author:"玄武江湖工作室",
    diskURL:"",
    forumURL:"",
    version:"1.5",
