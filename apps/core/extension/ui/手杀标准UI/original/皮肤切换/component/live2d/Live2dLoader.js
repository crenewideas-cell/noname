...
var CustomLive2dLoader = class Live2dLoader {
    ...
    initMotionSelectDiv(config) {
        ...
        img.src = lib.assetURL + 'extension/手杀标准UI/original/皮肤切换/images/other/l2d-tool.png'
        ...
        img2.src = lib.assetURL + 'extension/手杀标准UI/original/皮肤切换/images/other/change-model.png'
...
<!--                <div class="cur-model" id="l2d-cur-model">当前model: xxxx</div>-->
                <div class="l2d-button1" id="l2d-button1" style="background-image: url(&quot;extension/手杀标准UI/original/皮肤切换/images/other/newui_button_selected_wz.png&quot;);">显示
                </div>
                <div class="l2d-button2" id="l2d-button2" style="background-image: url(&quot;extension/手杀标准UI/original/皮肤切换/images/other/newui_button_wz.png&quot;);">动作
                </div>
                <div class="l2d-button3" id="l2d-button3" style="background-image: url(&quot;extension/手杀标准UI/original/皮肤切换/images/other/newui_button_wz.png&quot;);">表情
                </div>
                <div class="l2d-button4" id="l2d-button4" style="background-image: url(&quot;extension/手杀标准UI/original/皮肤切换/images/other/newui_button_wz.png&quot;);">切换
                </div>
        ...
        images[0].src = lib.assetURL + 'extension/手杀标准UI/original/皮肤切换/images/other/change-scale.png'
        images[1].src = lib.assetURL + 'extension/手杀标准UI/original/皮肤切换/images/other/change-angle.png'
