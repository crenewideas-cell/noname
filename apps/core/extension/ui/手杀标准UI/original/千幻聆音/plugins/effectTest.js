    ...
    lib.qhlyPlugins.push({
        ...
        content:function(name){
            ...
            for(var skill of skills){
                ...
                str += "</p>";
                str += "<img id='qh_eff_add_pic_"+skill+"' style='width:30px;height:30px;' src='"+lib.assetURL+"extension/手杀标准UI/original/千幻聆音/image/add.png'/>";
                str += "<img id='qh_eff_clear_pic_"+skill+"' style='width:30px;height:30px;' src='"+lib.assetURL+"extension/手杀标准UI/original/千幻聆音/image/clear.png'/>";
                str += "<h4>骨骼特效：</h4>";
                str += "<p>";
                ...
                str += "</p>";
                str += "<img id='qh_eff_add_spin_"+skill+"' style='width:30px;height:30px;' src='"+lib.assetURL+"extension/手杀标准UI/original/千幻聆音/image/add.png'/>";
                str += "<img id='qh_eff_clear_spin_"+skill+"' style='width:30px;height:30px;' src='"+lib.assetURL+"extension/手杀标准UI/original/千幻聆音/image/clear.png'/>";
            }
