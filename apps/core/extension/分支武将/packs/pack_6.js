// Extracted from character/extra.js; legacy startup and engine/UI patches are not executed.
export default function(lib, game, ui, get, ai, _status) {
return {
"character": {
			dc_shen_huangzhong: ['male', 'shen', 4, ['dclieqiong', 'dczhanjue'], ['shu']],
			dc_shen_huatuo: ['male', 'shen', 3, ['dcjingyu', 'dclvxin', 'dchuandao'], ['qun']],
			shen_huatuo: ['male', 'shen', 3, ['mbwuling', 'mbyouyi'], ['qun']],
			shen_xuchu: ['male', 'shen', 5, ['shenzhengqing', 'shenzhuangpo'], ['wei']],
			shen_lusu: ['male', 'shen', 3, ['shentamo', 'shendingzhou', 'shenzhimou'], ['wu']],
		},
"characterSort": {
			extra: {
				extra_feng: [],
				...
				extra_yin: [],
				extra_lei: [],
				extra_decade: [ 'shen_xuchu', 'dc_shen_huatuo', 'dc_shen_huangzhong'],
				extra_dif: [],
				extra_ol: [],
				extra_mobilezhi: [],
				extra_mobilexin: [],
...
"characterReplace": {
			...
			shen_caocao: ['shen_caocao', 'mb_shen_caocao'],
...
"dynamicTranslate": {
			...
			shentamo: function (player) {
				if (get.mode() == 'doudizhu') return '游戏开始时，你可以交换一号位和二号位的座次。';
				return '游戏开始时，你可以重新分配所有非主公角色的座次。';
			}
		},
"translate": {
			"shen_luxun": "神陆逊",
			...
			hina_xingzhi: '幸凪',
			hina_xingzhi_info: '每回合限一次，你可以通过“助战”触发一张牌的全部应变效果，且响应助战的角色摸两张牌。',
			...
			dcqijing: '奇径',
			dcqijing_info: '觉醒技，一名角色的回合结束后，若你的三个副区域标签均被激活，则你减1点体力上限，获得〖摧心〗，将座位移动至一名其他角色的上家之后，并进行一个额外回合。',
			dccuixin: '摧心',
			dccuixin_info: '当你不因此技能使用的基本牌或普通锦囊牌结算结束后，若此牌的目标包含你的上家或下家，则你可以视为对下家或上家再使用一张牌名和元素相同的牌。',
			shen_huatuo: '神华佗',
			mbwuling: '五灵',
			mbwuling_info: '出牌阶段限两次，你可以令一名没有“五灵”标记的角色获得你选择效果顺序的“五灵”标记，其于准备阶段切换为下一种效果。',
			wuqinxi_hu: '虎灵',
			wuqinxi_hu_info: '当你使用的牌指定唯一目标后，此牌对目标角色造成的伤害+1。',
			wuqinxi_he: '鹤灵',
			wuqinxi_he_info: '获得此标记时，你摸三张牌。',
			wuqinxi_xiong: '熊灵',
			wuqinxi_xiong_info: '每名角色的回合限一次，你受到的伤害-1。',
			wuqinxi_yuan: '猿灵',
			wuqinxi_yuan_info: '获得此标记时，你获得一名其他角色装备区内的一张牌。',
			wuqinxi_lu: '鹿灵',
			wuqinxi_lu_info: '你获得此标记时，回复1点体力，弃置判定区所有牌。你不能成为延时锦囊牌的目标。',
			mbyouyi: '游医',
			mbyouyi_info: '弃牌阶段结束时，你可以将此阶段弃置的牌置入“仁”区。出牌阶段限一次，你可以弃置所有“仁”区的牌，令所有角色回复1点体力。',
			shen_xuchu: '神许褚',
			shenzhengqing: '争擎',
			shenzhengqing_info: '锁定技，每轮结束时，移去所有“擎”标记，然后本轮单回合内造成伤害最多的角色获得X枚“擎”标记并与你各摸一张牌（X为其该回合造成的伤害数）。若是你获得“擎”且是获得数量最多的一次，你改为摸X张牌（至多摸五张）。',
			shenzhuangpo: '壮魄',
			shenzhuangpo_info: '你可以将一张牌面信息中有“杀”的牌当【决斗】使用。若你有“擎”，此【决斗】指定目标后，你可以移去任意枚“擎”，然后令其弃置等量的牌；若此【决斗】指定有“擎”的角色为目标，此牌伤害+1。',
			shen_lusu: '神鲁肃',
			shentamo: '榻谟',
			shentamo_info: '游戏开始时，你可以重新分配所有非主公角色的座次。',
			shendingzhou: '定州',
			shendingzhou_info: '出牌阶段限一次，你可以交给一名场上有牌的其他角色X+1张牌（X为其场上的牌数），然后你获得其场上的牌。',
			shenzhimou: '智盟',
			shenzhimou_info: '回合结束后，你可以与一名其他角色随机平均分配双方手牌，若牌数和为奇数，则你分配较多张数。',
			dc_shen_huatuo: '神华佗',
			dcjingyu: '静域',
			dcjingyu_info: '锁定技，每个技能每轮限一次，当一名角色发动除此技能外的技能时，你摸一张牌。',
			dclvxin: '滤心',
			dclvxin_info: '出牌阶段限一次，你可以交给一名其他角色一张手牌，令其摸X张牌/随机弃置X张手牌（X为游戏轮数且至多为5）。若其摸到/弃置了与你交给其的牌相同牌名的牌，其下次发动技能时回复/失去1点体力。',
			dchuandao: '寰道',
			dchuandao_info: '限定技，出牌阶段，你可以令一名角色复原武将牌，其可以获得一个同名武将的技能，然后其选择并失去一个其他技能。',
...
"skill": {
			jxlianpo: {
				...
				filter: function (event, player) {
					var zhuzhong = game.countPlayer(function (current) {
					...
					if (player.getStorage('lianposhow') == 'zhuzhong') {
						zhuzhong++;
					} else if (player.getStorage('lianposhow') == 'fan') {
						fan++;
					} else if (player.getStorage('lianposhow') == 'nei') {
						nei++;
					}
					var maxzhenying = Math.max(zhuzhong, fan, nei);
					var list = [];
					if (zhuzhong - maxzhenying == 0) list.push('zhuzhong');
					if (fan - maxzhenying == 0) list.push('fan');
					if (nei - maxzhenying == 0) list.push('nei');
					if (list.length <= 1) return false;
					return event.source && event.source.isIn();
				},
				forced: true,
				logTarget: 'source',
				group: ['jxlianpo_show', 'jxlianpo_jilu'],
				content: function () {
				...
				intro: {
					content: function (storage, player) {
						var list = [];
						if (player.getStorage('maxzylist').includes('zhuzhong')) list.push('主忠');
						if (player.getStorage('maxzylist').includes('fan')) list.push('反贼');
						if (player.getStorage('maxzylist').includes('nei')) list.push('内奸');
						return "场上最大阵营为：" + list;
					},
				},
				subSkill: {
					jilu: {
						...
						content: function () {
							...
							for (var current of game.filterPlayer()) {
								current.storage.maxzylist = [];
								if (zhuzhong - maxzhenying == 0) current.storage.maxzylist.push('zhuzhong');
								if (fan - maxzhenying == 0) current.storage.maxzylist.push('fan');
								if (nei - maxzhenying == 0) current.storage.maxzylist.push('nei');
							};
						},
					},
					show: {
						...
						filter: function (event, player) {
							player.storage.lianposhow = '';
							var list = ['zhu', 'zhong', 'zhong', 'zhong', 'fan', 'fan', 'fan', 'fan', 'nei', 'nei'];
							for (var current of game.filterPlayer()) {
						...
						content: function () {
							...
							var listx = [];
							if (list.includes('zhong')) listx.push('忠臣');
							if (list.includes('fan')) listx.push('反贼');
							if (list.includes('nei')) listx.push('内奸');
							player.chooseControl(listx).set('prompt', "炼魄：请选择一个身份，你选择的身份对应的阵营角色数于本轮内视为+1");
							'step 1'
							if (result.control) {
								var color = '';
								var name = '';
								if (result.control == '忠臣') {
									var color = '#y';
									player.storage.lianposhow = 'zhuzhong';
								} else if (result.control == '反贼') {
									var color = '#g';
									player.storage.lianposhow = 'fan';
								} else if (result.control == '内奸') {
									var color = '#b';
									player.storage.lianposhow = 'nei';
								};
								game.log(player, '展示了', `${color}${result.control}`, '的身份牌');
							}
							'step 2'
							var zhuzhong = game.countPlayer(function (current) {
								return current.identity == 'zhu' || current.identity == 'zhong';
					...
					global: {
						mod: {
							maxHandcard: function (player, num) {
								if (!player.getStorage('maxzylist').includes('fan')) return;
							...
							cardSavable: function (card, player, target) {
								if (card.name == 'tao' && !player.hasSkill('jxlianpo')) {
									if (!player.getStorage('maxzylist').includes('zhuzhong')) return;
			...
			jxzhaoluan: {
				...
				content: function () {
					...
					if (!player.storage.jxzhaoluan_effect) player.storage.jxzhaoluan_effect = [];
					player.storage.jxzhaoluan_effect.push(target);
					...
					effect: {
						...
						filter: function (event, player) {
							return game.filterPlayer(function (current) {
								return player.getStorage('jxzhaoluan_effect').includes(current);
							}).length;
						},
						...
						content: function () {
							'step 0'
							target.addTempSkill('jxzhaoluan_hit', 'phaseUseEnd');
							var bodies = game.filterPlayer(function (current) {
								return player.getStorage('jxzhaoluan_effect').includes(current);
							});
							if (bodies.length > 1) event.goto(2);
							'step 1'
							var bodies = game.findPlayer(function (current) {
								return player.getStorage('jxzhaoluan_effect').includes(current);
							});
							player.line(bodies);
							bodies.loseMaxHp();
							event.goto(4);
							'step 2'
							player.chooseTarget('兆乱：请选择被减上限的傀儡', true, function (card, player, target) {
								return player.getStorage('jxzhaoluan_effect').includes(target);
							}).set('ai', function (target) {
								return 8 - get.attitude(_status.event.player, target);
							});
							'step 3'
							if (result.bool) {
								var bodies = result.targets[0];
								player.line(bodies);
								bodies.loseMaxHp();
							} else {
								event.finish();
						...
						ai: {
							...
							result: {
								player: function (player) {
									...
									if (get.attitude(player, bodies) > 4 && !bodies.isDamaged() && bodies.hp <= 2) return -10;
									return 0;
								},
			...
			dclieqiong: {
				...
				content: function (event, trigger, player) {
					...
					event.position.lowerLimb = `地机：令${get.translation(target)}一次受到的伤害+1直到其回合结束。`;
					...
					if (result.bool) {
						...
						target.markAuto('dclieqiong_hit', [result.links[0]]);
						game.log(target, '的', '#g' + position[result.links[0]].slice(0, 2), '被击伤了');
						switch (result.links[0]) {
							case 'head':
								if (target.hp > 0) {
									target.loseHp(target.hp);
									player.addTempSkill('dclieqiong_add');
								}
								break;
							case 'upperLimb':
				...
				subSkill: {
					...
					lowerLimb: {
						...
						content: function () {
							trigger.num++;
							player.removeSkill('dclieqiong_lowerLimb');
						},
						mark: true,
						marktext: '地机',
						intro: {
					...
					thorax: {
						...
						content: function () {
							...
							player.removeSkill('dclieqiong_thorax');
						}
					},
					belly: {
						charlotte: true,
					...
					add: {
						charlotte: true,
						trigger: {
							global: ['dieAfter', 'useCardAfter'],
						},
						silent: true,
						forced: true,
						content: function () {
							if (trigger.name == 'die') player.gainMaxHp();
							player.removeSkill('dclieqiong_add');
						},
					}
				},
			},
			dczhanjue: {
				...
				content: function () {
					'step 0'
					player.chooseControl(['摸损失体力值张牌', '摸体力值张牌', 'cancel2']).set('ai', () => {
			...
			xinrenjie: {
				...
				init: function (player) {
					player.storage.xinrenjie_round = 0;
					player.storage.xinrenjie_use == true;
				},
				filter: function (event, player) {
					if (event.type == 'phase') return false;
					return player.storage.xinrenjie_use == false && player.storage.xinrenjie_round < 4;
				},
				...
				forced: true,
				content: function () {
					event.trigger('trigger_renjie');
					player.addMark('xinrenjie', 1);
					player.storage.xinrenjie_round++;
					player.storage.xinrenjie_use = true;
				},
				marktext: "忍",
				intro: {
				...
				group: ['xinrenjie_round', 'xinrenjie_choose'],
				subSkill: {
					round: {
						trigger: {
							global: 'roundStart'
					...
					choose: {
						...
						silent: true,
						content: function () {
							player.addTempSkill('xinrenjie_use', 'trigger_renjie');
							player.storage.xinrenjie_use = false;
						},
						sub: true,
					},
					use: {
			...
			xinlianpo: {
				...
				init: function (player) {
					if (!player.storage.xinjilve) player.storage.xinjilve = ["fangzhu", "rejizhi", "rezhiheng", "rewansha"];
				},
				content: function () {
					'step 0'
					var list = [[0, '于此回合结束后获得一个额外回合'], [1, '获得' + get.translation(player.getStorage("xinjilve")) + '中的一个技能']];
					player.chooseButton(['连破：请选择一项效果执行', [list, 'textbutton']], true).set('filterButton',
						function (button) {
							if (button.link == 1) {
								return player.hasSkill('xinjilve') && player.getStorage("xinjilve").length;
							}
							return true;
						});
					'step 1'
					if (result.bool) {
						switch (result.links[0]) {
							case 0:
								...
								break;
							case 1:
								player.chooseControl(player.getStorage("xinjilve")).set('prompt', "你发动了连破，选择获得1个〖极略〗技能");
								break;
						}
					};
					'step 2'
					if (result.control) {
						...
						player.storage.xinjilve.remove(result.control);
						player.syncStorage("xinjilve");
						player.addSkill(result.control);
						game.log(player, "获得了技能", "#y【" + get.translation(result.control) + "】");
					}
				}
			},
			xinjilve: {
				init: function (player) {
					player.storage.xinjilve_use = ['use'];
					if (!player.storage.xinjilve) player.storage.xinjilve = ["fangzhu", "rejizhi", "rezhiheng", "rewansha"];
					player.addSkill("reguicai");
					game.log(player, "获得了技能", "#y【鬼才】");
					if (player.group == 'wei') {
						player.storage.xinjilve.remove("fangzhu");
						player.syncStorage("xinjilve");
						player.addSkill("fangzhu");
						game.log(player, "获得了技能", "#y【放逐】");
					} else if (player.group == 'shu') {
						player.storage.xinjilve.remove("rejizhi");
						player.syncStorage("xinjilve");
						player.addSkill("rejizhi");
						game.log(player, "获得了技能", "#y【集智】");
					} else if (player.group == 'wu') {
						player.storage.xinjilve.remove("rezhiheng");
						player.syncStorage("xinjilve");
						player.addSkill("rezhiheng");
						game.log(player, "获得了技能", "#y【制衡】");
					} else if (player.group == 'qun') {
						player.storage.xinjilve.remove("rewansha");
						player.syncStorage("xinjilve");
						player.addSkill("rewansha");
						game.log(player, "获得了技能", "#y【完杀】");
					}
				},
				mark: true,
				marktext: "极略",
				intro: {
					...
					content: function (storage) {
						return ((storage || []).length ? ("未获得的〖极略〗技能：" + get.translation(storage)) : "已获得全部〖极略〗技能")
					},
				},
				audio: 2,
				trigger: {
				...
				content: function () {
					'step 0'
					var list = [[0, '弃置' + player.getStorage("xinjilve_use").length + '枚“忍”标记并获得' + get.translation(player.getStorage("xinjilve")) + '中的一个技能'], [1, '弃置至多3枚“忍”标记并摸等量张牌']];
					trigger.player.chooseButton(['极略：请选择一项效果执行', [list, 'textbutton']], true).set('filterButton',
						function (button) {
							if (button.link == 0) {
								return player.countMark("xinrenjie") >= player.getStorage("xinjilve_use").length && player.getStorage("xinjilve").length
							}
							return player.hasMark('xinrenjie');
						});
					'step 1'
					if (result.bool) {
						switch (result.links[0]) {
							case 0:
								player.storage.xinjilve_use.push('use');
								player.removeMark('xinrenjie', player.getStorage("xinjilve_use").length);
								player.chooseControl(player.getStorage("xinjilve")).set('prompt', "你发动了极略，选择获得1个技能");
								break;
							case 1:
								event.goto(3);
								break;
					...
					'step 3'
					var list = [];
					for (var i = 1; i <= Math.min(player.countMark("xinrenjie"), 3); i++) {
						list.push(i);
					};
					player.chooseControl(list).set('prompt', '你发动了极略，弃置至多3枚“忍”标记并摸等量张牌');
					'step 4'
					if (result.control) {
						player.removeMark('xinrenjie', result.control);
			...
			dcjingyu: {
				forced: true,
				init: function (player) {
					player.storage.dcjingyu = [];
				},
				audio: 2,
				trigger: { global: ['useSkillAfter', 'logSkill'] },
				filter: function (event, player) {
					if (!lib.skill[event.skill] || lib.skill[event.skill].equipSkill) return false;
					if (event.skill.startsWith('_')) return false;
					var str = event.skill.split('_')[0];
					if (player.storage.dcjingyu.includes(str)) return false;
					if (event.sourceSkill && event.skill && player.storage.dcjingyu.includes(event.Skill)) return false;
					return event.skill != undefined && event.skill != 'dcjingyu' && player.storage.dcjingyu && !player.storage.dcjingyu.includes(event.skill);
				},
				content: function () {
					player.draw();
					if (trigger.sourceSkill) player.storage.dcjingyu.add(trigger.sourceSkill);
					else player.storage.dcjingyu.add(trigger.skill);
				},
				group: 'dcjingyu_c',
				subSkill: {
					c: {
						...
						content: function () { player.storage.dcjingyu = [] },
					}
				}
			},
			dclvxin: {
				...
				content: function () {
					...
					player.chooseControl(['摸牌', '弃牌']).set('ai', () => {
						if (get.attitude(_status.event.player, _status.event.target) > 0) return '摸牌';
						return '弃牌';
					}).set('prompt', '选择一项');
					'step 1'
					var num = Math.min(5, game.roundNumber);
					event.dclvxinCardName = get.name(cards[0]);
					if (result.control == '摸牌') {
						target.draw(num);
					}
					else {
						var hs = target.getCards('h');
						target.discard(hs.randomGets(Math.min(num, target.countCards('h'))));
					}
				},
				group: 'dclvxin_3',
				subSkill: {
					...
					3: {
						...
						direct: true,
						filter: function (event, player) {
							if (event.player == player || !event.cards || event.cards.length == 0 || !event.getParent(1) || !event.getParent(2) || event.getParent(2).name != 'dclvxin' || !event.getParent(2).dclvxinCardName) return false
							if (event.name == 'gain') return event.getParent(1).name == 'draw';
							return event.getParent(1).name == 'discard';
						},
						content: function () {
							var list = [];
							...
							if (list.contains(trigger.getParent(2).dclvxinCardName)) {
								if (trigger.name == 'gain') trigger.player.addSkill('dclvxin_1');
								else trigger.player.addSkill('dclvxin_2');
							}
						}
					},
				}
			...
			dchuandao: {
				...
				content: function () {
					'step 0'
					if (target.isLinked()) player.link();
					'step 1'
					if (target.isTurnedOver()) player.turnOver();
					'step 2'
					player.awakenSkill('dchuandao');
					var list = [];
					var whiteList = ['武安国'];
					let regex = /^(谋|界|SP|神|起|承|转|合|手杀|星|乐|族|武|极|梦)+/;
					var name2 = get.translation(target);
					if (_status.characterlist) {
						for (var i = 0; i < _status.characterlist.length; i++) {
							var name = _status.characterlist[i];
							var match = name2.match(regex);
							if (match && !whiteList.includes(name2)) {
								name2 = name2.slice(match[0].length);
							}
							if (get.translation(name).includes(name2) && lib.character[name] && lib.character[name][3].length) {
								for (var j = 0; j < lib.character[name][3].length; j++) {
									if (!target.hasSkill(lib.character[name][3][j])) list.add(lib.character[name][3][j]);
								}
							}
						}
					}
					if (list.length) {
						var skillL = list.randomGet();
						event.skillL = skillL;
						target.chooseBool('是否获得【' + get.translation(skillL) + '】并失去一个其他技能').set('ai', () => {
							if (get.skillProperty(_status.event.skillL) != 'negative') return true;
							return false;
						})
					}
					else event.finish();
					'step 3'
					if (result.bool) {
						var sn = target.getSkills(null, false, false).filter(function (i) {
							var info = get.info(i);
							return info && !info.charlotte;
						});
						if (sn.length) target.chooseControl(sn).set('prompt', '选择失去一个技能');
					}
					else event.finish();
					'step 4'
					if (result.control) {
						target.addSkill(event.skillL);
				...
				ai: {
					...
					result: {
						player: function (player, target) {
							if (get.attitude(player, target) > 0 && (target.isLinked() || target.isTurnedOver())) return 0.5;
							else if (get.attitude(player, target) < 0) return -4;
							return 0;
						},
						target: function (player, target) {
							if (get.attitude(player, target) > 0 && (target.isLinked() || target.isTurnedOver())) return 2;
							return 1;
						}
					}
				}
			...
			shentamo: {
				...
				firstDo: true,
				filter: function (event, player) {
					return (event.name != 'phase' || game.phaseNumber == 0) && !player.storage.shentamo_doudizhu;
				},
				content: function () {
					'step 0'
					player.chooseTarget('选择两名角色交换座位', 2, function (card, player, target) {
						if (get.mode() == 'identity') return target != game.zhu;
						if (get.mode() == 'doudizhu') return target.getSeatNum() != 3;
						else return true;
					}).set('ai', function (target) {
						var player = _status.event.player;
						if (target.getSeatNum() <= player.getSeatNum()) return 6;
						else return 0;
					});
					'step 1'
					if (result.bool) {
					...
					'step 2'
					player.storage.shentamo_doudizhu = true;
					var pre = _status.roundStart;
					var tempPlayer = game.players.slice();
					for (var i of game.players) {
						tempPlayer[i.getSeatNum() - 1] = i;
						if (i.getSeatNum() == 1) {
							_status.roundStart = i;
						}
					}
					if (pre != _status.roundStart) {
						var c = pre.next;
						while (true) {
							if (c != _status.roundStart) {
								c.addSkill('shentamo_1');
								c = c.next;
							}
							else {
								c.addSkill('shentamo_2');
								break;
							}
						}
						trigger.cancel();
			...
			shenzhimou: {
				...
				content: function () {
					...
					if (result.bool) {
						...
						player.logSkill('shenzhimou', target);
						event.target = target;
			...
			shenzhengqing: {
				...
				forced: true,
				init: function (player) {
					player.storage.shenzhengqing1 = new Map();
					player.storage.shenzhengqing2 = 0;
				},
				...
				content: function () {
					...
					game.players.forEach(function (c) {
						if (c.hasMark('shenzhengqing')) c.removeMark('shenzhengqing', c.countMark('shenzhengqing'));
					});
					'step 1'
					var t = lib.skill.shenzhengqing.getMaxKey(player.storage.shenzhengqing1);
					if (t == player && player.storage.shenzhengqing1.get(player) > player.storage.shenzhengqing2) {
						player.draw(Math.min(player.storage.shenzhengqing1.get(player) + 1, 5));
						player.addMark('shenzhengqing', player.storage.shenzhengqing1.get(player));
					}
					else {
						var n = player.storage.shenzhengqing1.get(t);
						t.addMark('shenzhengqing', n);
						t.draw();
						player.draw();
					}
					'step 2'
					if (player.storage.shenzhengqing1.get(player) > player.storage.shenzhengqing2) {
						player.storage.shenzhengqing2 = player.storage.shenzhengqing1.get(player);
					}
				},
				group: ['shenzhengqing_sub1', 'shenzhengqing_sub2'],
				subSkill: {
					sub1: {
						unique: true,
						trigger: {
						...
						content: function () {
							game.players.forEach(function (c) {
								player.storage.shenzhengqing1.set(c, 0);
							})
						}
					},
					sub2: {
						...
						content: function () {
							...
							player.storage.shenzhengqing1.set(trigger.player, dam);
						}
					},
				}
			},
			shenzhuangpo: {
				...
				group: ['shenzhuangpo_1', 'shenzhuangpo_2'],
				subSkill: {
					1: {
						trigger: {
						...
						filter: function (event, player) {
							return event.skill == 'shenzhuangpo' && event.name == 'juedou' && player.countMark('shenzhengqing') > 0 && event.target.countCards('he') > 0;
						},
						direct: true,
						content: function () {
							'step 0'
							var list = [];
							for (var i = 1; i <= player.countMark('shenzhengqing'); i++) {
								if (i <= trigger.target.countCards('he')) list.push(i);
							}
							if (list.length > 0) {
							...
							if (result.control == 0) {
								...
								player.removeMark('shenzhengqing', result.control);
								trigger.target.chooseToDiscard(result.control, 'he', true);
							}
						}
					},
					2: {
						...
						direct: true,
						filter: function (event, player) {
							return event.getParent().skill == 'shenzhuangpo' && event.getParent().name == 'juedou' && event.getParent().target != player && event.getParent().target.hasMark('shenzhengqing');
						},
						content: function () {
							trigger.num++;
						}
			...
			mbwuling: {
				...
				wuqin: function (player) {
					if (player.storage.mbwuling[0] == '鹿灵') {
						player.recover();
						if (player.countCards('j') > 0) player.discardPlayerCard(player, 'j', player.countCards('j'), true);
					}
					if (player.storage.mbwuling[0] == '鹤灵') player.draw(3);
				},
				content: function () {
					'step 0'
					var list = [['', '', 'wuqinxi_hu'], ['', '', 'wuqinxi_he'], ['', '', 'wuqinxi_xiong'], ['', '', 'wuqinxi_yuan'], ['', '', 'wuqinxi_lu']];
					var next = player.chooseToMove();
					next.set('prompt', '表演五禽戏');
					next.set('list', [
						['选择传授顺序', [list, 'vcard']],
					]);
					next.processAI = function (list) {
						var card = list[0].slice(), player = _status.event.getParent().target;
						var title = card.shift();
						var list2 = [];
						if (player.maxHp - player.hp >= 3 && !player.hasSkill('pinghe') && !player.hasSkill('xinjuejing')) list2.add(['', '', 'wuqinxi_xiong']);
						else if (player.maxHp - player.hp >= 2 && !player.hasSkill('pinghe')) list2.add(['', '', 'wuqinxi_lu']);
						else if (player.countCards('h') < player.hp) list2.add(['', '', 'wuqinxi_he']);
						if (player.countCards('j')) list2.add(['', '', 'wuqinxi_lu']);
						if (game.hasPlayer(function (c) {
							return c.countCards('e') && get.attitude(c, player) <= 0;
						})) list2.add(['', '', 'wuqinxi_yuan']);
						for (var i of card[0][0]) {
							if (!list2.some(item => item[2] === i[2])) {
								list2.push(i);
							}
						}
						return [list2];
					...
					'step 1'
					if (result.bool) {
						var list = result.moved[0].map(function (i) {
							return get.translation(i[2]);
						})
						target.storage.mbwuling = list;
						player.playAnim(list);
						...
						if (target.storage.mbwuling[0] == '鹤灵') target.draw(3);
						if (target.storage.mbwuling[0] == '猿灵') {
							var next = game.createEvent('mbwuqin_yuan');
							next.player = target;
							next.setContent(lib.skill.mbwuqinxi_yuan.content);
						}
					}
				},
				ai: {
			...
			mbwuqinxi: {
				...
				marktext: '五灵',
				intro: {
					name: function (storage, player) { return '' },
					...
					content: function (storage, player) {
						...
						switch (str) {
							...
							case '鹿灵': str = '你获得此标记时，回复1点体力，弃置判定区所有牌。你不能成为延时锦囊牌的目标。'; break;
							case '猿灵': str = '获得此标记时，你获得一名其他角色装备区内的一张牌。'; break;
							case '熊灵': str = '每名角色的回合限一次，你受到的伤害-1'; break;
							case '鹤灵': str = '获得此标记时，你摸三张牌。'; break;
						}
						var str2;
						// if(player.storage.mbwuling.length>1) str2='<br>下一个动作为：'+player.storage.mbwuling[1];
						// else str='';
						return str;
					},
				},
				...
				onremove: function (player) {
					delete player.storage.mbwuling;
				},
				content: function () {
					'step 0'
					...
					if (event.trick == '鹤灵') player.draw(3);
					if (event.trick == '猿灵') {
						var next = game.createEvent('mbwuqin_yuan');
						next.player = player;
						next.setContent(lib.skill.mbwuqinxi_yuan.content);
					}
					if (player.storage.mbwuling.length == 0) player.removeSkill('mbwuqinxi');
				},
				group: ['mbwuqinxi_hu', 'mbwuqinxi_xiong', 'mbwuqinxi_lu'],
				subSkill: {
					hu: {
						direct: true,
						charlotte: true,
					...
					yuan: {
						...
						content: function () {
							'step 0'
							player.chooseTarget('五灵：选择一名其他角色，随机获得其装备区里的一张牌', lib.filter.notMe).set('ai', function (target) {
								var player = _status.event.player;
					...
					xiong: {
						...
						filter: function (event, player) {
							return player.storage.mbwuling && player.storage.mbwuling[0] == '熊灵' && player.getHistory('useSkill', function (e) { return e.skill == 'mbwuling' }).length == 0;
						},
						content: function () {
							trigger.num--;
						}
			...
			shiki_omusubi: {
				...
				content: function () {
					...
					if (result.bool) {
						...
						game.broadcastAll(function (list, name1) {
							lib.character[name1][3].addArray(list);
