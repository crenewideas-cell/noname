// Extracted from character/old.js; legacy startup and engine/UI patches are not executed.
export default function(lib, game, ui, get, ai, _status) {
return {
"character": {
			old_chendeng: ['male', 'qun', 4, ['olfengji'], ['character:ol_chendeng']],
...
"characterSort": {
			old: {
				...
				old_yijiang4: [],
				old_yijiang5: [],
				old_yijiang67: [ "ol_liuyu"],
				old_sp: [ 'old_chendeng'],
				old_yingbian: [],
				old_mobile: [ 'old_majun'],
			},
		},
"translate": {
