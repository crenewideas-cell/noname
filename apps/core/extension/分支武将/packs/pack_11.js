// Extracted from character/mobile.js; legacy startup and engine/UI patches are not executed.
export default function(lib, game, ui, get, ai, _status) {
return {
"character": {
			mb_zhangbu: ['male', 'wu', 4, ['mbchengxiong', 'mbwangzhuan']],
			mb_huojun: ['male', 'shu', 4, ['mbsidai', 'mbjieyu'], ['character:tw_huojun']],
			mb_chengui: ['male', 'wei', 3, ['mbguimou', 'mbzhouxian']],
			mb_muludawang: ['male', 'qun', '3/3/1', ['mbshoufa', 'mbzhoulin', 'mbyuxiang']],
			mb_xianglang: ['male', 'shu', 4, ['mbnaxue', 'mbyijie']],
			mb_liwei: ['male', 'shu', 4, ['mbjiaohua']],
			mb_laimin: ['male', 'shu', 3, ['mblaishou', 'mbluanqun']],
			mb_zhangyi: ['male', 'shu', 4, ['mbwurong', 'shizhi'], []],
			...
			majun: ["male", "wei", 3, ["xinfu_jingxiex", "qiaosi"]],
			scs_gaowang: ['male', 'qun', '', ['scsanruo'], ['unseen']],
		},
"characterSort": {
			mobile: {
				mobile_default: [ "mb_simafu", "yanpu", "sp_jianggan", 'mb_laimin', 'mb_liwei', 'mb_xianglang',
					'mb_muludawang', 'mb_chengui', 'mb_huojun', 'mb_zhangbu'],
				mobile_qiankun: [ "majun"],
				mobile_yijiang: [],
				mobile_standard: [],
				mobile_shenhua: [],
				mobile_yijiang1: [ "re_lingtong"],
				mobile_yijiang2: [],
				mobile_yijiang3: [],
				mobile_yijiang4: [ "xin_caozhen"],
				mobile_yijiang5: [ 'mb_zhangyi'],
				mobile_yijiang67: [],
				mobile_changshi: [ 'scs_gaowang'],
				mobile_sp: [],
			},
		},
"characterFilter": {
...
"characterIntro": {
			mb_zhangfen: '张昭之侄，他二十岁时，制造了用作攻城的大攻车，因而被步骘推荐。张昭不情愿的问张奋:“你年纪还小，为什么要把自己委派到军旅中呢？”张奋回答：“当年童汪遇难而死，子奇十六岁治理阿县。我张奋确实没有才能啊，但从年纪来说不算小了。”于是领兵为将，连续立有功绩，官至半州都督，封乐乡亭侯。',
...
"translate": {
			...
			"yizan_count_info": "",
			"xinfu_jingxiex": "精械",
			"xinfu_jingxiex_info": "出牌阶段，你可以展示一张未强化过的【诸葛连弩】或标准包/军争包/SP包中的防具牌，然后对其进行强化。当你处于濒死状态时，你可以重铸一张防具牌，然后将体力回复至1点。",
			"xinfu_jingxie2": "精械",
			"xinfu_jingxie2_info": "",
			"xinfu_qiaosi": "巧思",
			...
			qiaosi_map: '水转百戏图',
			qiaosi_map_info: '<br><li>主帅：锦囊牌*2<br><li>商人：装备牌/【杀】/【酒】*1<br><li>工匠：【杀】/【酒】*1<br><li>农户：【闪】/【桃】*1<br><li>学士：锦囊牌/【闪】/【桃】*1<br><li>大将：装备牌*2<li>Illustration:うら;Twitter:@ura530',
			...
			xin_caozhen: '界曹真',
			discretesidi: '司敌',
			discretesidi_info: '①当你使用除延时锦囊牌外的牌结算结束后，你可以选择一名未指定“司敌”目标的其他角色，为其标记一名“司敌”目标（仅你可见）；②当有“司敌”目标的角色使用第一张除延时锦囊牌外的牌仅指定“司敌”目标为唯一目标时（否则消除其的“司敌”目标标记），若目标角色为你，你摸一张牌，否则你选择一项：1.取消之，然后若此时场上没有角色处于濒死状态，你对其造成1点伤害；2.你摸两张牌。若如此做，消除其的“司敌”目标标记。',
			fuqian: '傅佥',
			jueyong: '绝勇',
			...
			mb_zhangyi: '界张嶷',
			mbwurong: '怃戎',
			mbwurong_info: '出牌阶段限一次，你可以与一名其他角色进行谋弈：<br><li>若你选择“镇压”且其选择“反抗”，你对其造成1点伤害，然后你摸一张牌。<br><li>若你选择“安抚”且其选择“归顺”，其须交给你两张牌（若其手牌数不足两张，则改为令其跳过其下个摸牌阶段）。<br><li>若你选择“镇压”且其选择“归顺”，你获得其一张牌，然后你交给其两张牌。<br><li>若你选择“安抚”且其选择“反抗”，你受到1点伤害，然后你摸两张牌。',
			mb_guozhao: '郭女王',
			yichong: '易宠',
			yichong_info: '准备阶段，你可以选择一名其他角色并声明一种花色，获得其所有此花色的牌，然后令其获得[雀]（场上已有时改为移动之）直到你的下回合开始。有[雀]的角色获得你声明花色的牌时，你获得之（至多获得五张）。',
			wufei: '诬诽',
			wufei_info: '当你使用伤害类牌指定目标后，此牌伤害来源改为有[雀]的角色。当你受到伤害后，若有[雀]的角色体力值大于你且至少为1，你可以令该角色受到1点伤害。',
			mbyj_zhoubuyi: '☆周不疑',
			mbhuiyao: '慧夭',
			...
			mb_laimin: '来敏',
			mblaishou: '来寿',
			mblaishou_info: '锁定技，当你受到伤害时，若此伤害会令你进入濒死且你的体力值上限小于9，则防止此伤害，并增加等量体力值上限。准备阶段，若你的体力值上限不小于9，你死亡。',
			mbluanqun: '乱群',
			mbluanqun_info: '出牌阶段限一次，若你有手牌，你可以令所有角色同时展示一张手牌，然后你可以获得其中一张与你展示牌颜色相同的牌：所有与你展示牌颜色不同的角色的下回合中出牌阶段的第一张【杀】只能对你使用，且这些角色的下回合对你使用【杀】，你不可响应。',
			mb_liwei: '李遗',
			mbjiaohua: '教化',
			mbjiaohua_info: '出牌阶段限两次，你可以令一名角色从牌堆中随机获得一张你指定类型且未被“教化”记录过的牌，然后你记录此牌的类型。当“教化”已记录基本牌、锦囊牌、装备牌三种类型时，清除“教化”记录的类型。',
			mb_xianglang: '手杀向朗',
			mb_xianglang_ab: '向朗',
			mbnaxue: '纳学',
			mbnaxue_info: '你可以跳过出牌阶段，然后你弃置任意张牌并摸等量的牌，然后你交给至多两名其他角色各一张牌。',
			mbyijie: '遗诫',
			mbyijie_info: '锁定技，当你死亡时，所有其他角色的体力值调整为X（X为所有其他角色的体力值之和与所有其他角色数的平均数向下取整，且X至少为1）。',
			mb_muludawang: '木鹿大王',
			mbshoufa: '兽法',
			mbshoufa_info: '当你受到伤害后/于一回合首次造成伤害后，你可以选择一名与你距离大于/不大于2的角色，令其随机执行以下一项：豹，令其受到1点无来源伤害；鹰，你随机获得其一张牌；熊，你随机弃置其装备区的一张牌；兔，令其摸一张牌。',
			mbyuxiang: '御象',
			mbyuxiang_info: '锁定技，若你有护甲值，则：①你计算与其他角色的距离-1，其他角色计算与你的距离+1；②当你受到火焰伤害时，此伤害+1。',
			mbzhoulin: '咒鳞',
			mbzhoulin_info: '限定技，出牌阶段，你可以获得2点护甲值，然后选择一个“兽法”效果，你发动〖兽法〗的执行效果改为你选择的效果直到你的下个回合结束。',
			mb_huban: '胡班',
			mbyilie: '义烈',
			...
			mb_chengui: '陈珪',
			mbguimou: '诡谋',
			mbguimou_info: '锁定技。游戏开始时你随机选择一项，或回合结束后你选择一项：直到下个准备阶段，1.记录使用牌最少的角色；2.记录弃置牌最少的角色；3.记录获得牌最少的角色。准备阶段，你选择被记录的一名其他角色，然后查看并选择其的一张牌，然后你将此牌弃置或交给另一名你选择的其他角色。',
			mbzhouxian: '州贤',
			mbzhouxian_info: '锁定技。当你成为其他角色使用的伤害类卡牌的目标后，你亮出牌堆顶的3张牌，然后其须选择一项：①弃置一张与亮出牌之一类别相同的牌；②令此牌对你无效。',
			mb_huojun: '霍峻',
			mbsidai: '伺怠',
			mbsidai_info: '限定技，出牌阶段，你可以将手牌区内的所有基本牌当做【杀】使用。若此牌对应的实体牌中：包含【闪】，则目标角色成为此牌的目标后，需弃置一张基本牌，否则不可响应此牌；包含【桃】，则当目标角色受到此牌的伤害后，其减1点体力上限。',
			mbjieyu: '竭御',
			mbjieyu_info: '结束阶段，你可从弃牌堆中随机获得【杀】【闪】【桃】【酒】其中X个牌名的牌各一张（X为3-你上次发动竭御后至本阶段，你成为其他角色使用伤害类卡牌目标的次数，且X至少为1）。',
			mb_yangfeng: '杨奉',
			mbxuetu: '血途',
			mbxuetu_info: "一级：转换技。出牌阶段限一次，阳：你可令一名角色回复1点体力；阴：你可令一名角色摸两张牌。<br>二级：出牌阶段各限一次，你可以执行一项：1.令一名角色回复1点体力；2.令一名角色摸两张牌。<br>三级：转换技。出牌阶段限一次，阳：你可回复1点体力并令一名角色弃置两张牌；阴：你可摸一张牌并对一名角色造成一点伤害。",
			mbxuetu1: '血途1级',
			mbxuetu1_info: "转换技。出牌阶段限一次，阳：你可令一名角色回复1点体力；阴：你可令一名角色摸两张牌。",
			mbxuetu2: '血途2级',
			mbxuetu2_info: '出牌阶段各限一次，你可以执行一项：1.令一名角色回复1点体力；2.令一名角色摸两张牌。',
			mbxuetu3: '血途3级',
			mbxuetu3_info: "转换技。出牌阶段限一次，阳：你可回复1点体力并令一名角色弃置两张牌；阴：你可摸一张牌并对一名角色造成一点伤害。",
			mbweiming: '威命',
			mbweiming_info: "使命技，锁定技：出牌阶段开始时，你选择一名未被记录过的其他角色，记录之。<br>成功：若你杀死一名未被记录过的角色，则修改血途（修改后：出牌阶段各限一次，你可以执行一项：1.令一名角色回复1点体力；2.令一名角色摸两张牌。）<br>失败：若一名被记录过的角色死亡，则修改血途（修改后：转换技。出牌阶段限一次，你可阳：回复1点体力，然后令一名角色弃置两张牌；阴：摸一张牌，然后对一名角色造成一点伤害。）",
			mb_zhangbu: '张布',
			mbchengxiong: '惩凶',
			mbchengxiong_info: '你使用锦囊牌指定其他角色为目标后，你可选择一名牌数不小于x的角色(x为你此阶段使用的牌数)，可以弃置其一张牌。若此牌颜色与你使用的锦囊牌颜色相同，你对其造成1点伤害。',
			mbwangzhuan: '妄专',
			mbwangzhuan_info: '当一名角色受到非游戏牌造成的伤害后，若你是伤害来源或受伤角色，你可以摸两张牌，然后当前回合角色非锁定技失效直到回合结束。',
			mb_zhangfen: '张奋',
			mbquchong: '渠冲',
			mbquchong_info: "出牌阶段，你可重铸装备牌。每个回合结束时，你将弃牌堆的装备移出游戏并获得等量的铸造值。出牌阶段开始时，若场上没有【大攻车】(“大攻车·进击※”、“大攻车·守御※”)，则你可以依次消耗0、5、10、10点铸造值选择一种大攻车效果并将之交给任一角色并令其使用此牌；否则你可以将场上的【大攻车】交给另一名角色并令其使用。",
			mbxunjie: '逊节',
			mbxunjie_info: '锁定技。当你受到伤害时，若场上没有你制造的【大攻车】且伤害来源的体力值大于你，则你进一次判定：若不为黑桃，则此伤害-1。',
			dagongche_attack: '大攻车',
			dagongche_attack_skill: '大攻车进击',
			dagongche_attack_info: '大攻车·进击：武器牌，攻击范围9，1耐久度。此牌进入装备区时，弃置你装备区的其他牌。若此牌在你的装备区，当其他装备牌进入装备区时，改为置入弃牌堆。当你对一名角色造成伤害时，你可-1耐久度令此伤害+x(x为当前轮数，至多为3)。当此牌非因渠冲而移出装备区时，防止之，然后-1耐久度。当耐久度减至0时，销毁此牌。',
			dagongche_defense: '大攻车',
			dagongche_defense_skill: '大攻车守御',
			dagongche_defense_info: '大攻车·守御：武器牌，攻击范围9，3耐久度。此牌进入装备区时，弃置你装备区的其他牌。若此牌在你的装备区，当其他装备牌进入装备区时，改为置入弃牌堆。你受到伤害时，扣除等量的耐久度(不足则全扣)，然后减少等于扣除耐久度的伤害值。当此牌非因渠冲而移出装备区时，防止之，然后-1耐久度。当耐久度减至0时，销毁此牌。',
			mb_sp_zhenji: 'SP甄姬',
			mbbojian: '博鉴',
			mbbojian_info: '锁定技。出牌阶段结束时，若你本阶段使用的牌数量与花色数与上个出牌阶段皆不一致，则你摸两张牌；否则你选择本阶段使用过的且在弃牌堆中的一张牌，将之交给一名角色。',
			mbjiwei: '济危',
			mbjiwei_info: '锁定技。每个其他角色的回合结束时，此回合每满足一项，你便摸一张牌：1.有不小于一名角色失去过牌；2.有不小于一名角色受到过伤害。准备阶段，若你的手牌数不小于场上存活人数且不小于你的体力值，则你须将手牌中数量较多颜色的牌全部分配给其他角色(若数量相同则选择一种颜色)。',
			mb_sp_ganfuren: '甘夫人',
			mbzhijie: '智诫',
			mbzhijie_info: '每轮限一次，一名角色的出牌阶段开始时，你可以展示其一张手牌。本阶段其使用与此牌类别相同的牌后，其摸一张牌并弃置X张牌（X为本回合其使用此类型牌的次数-1）；此阶段结束时，若其此阶段因此法获得的牌数大于弃置的牌数，则你与其各摸一张牌。',
			mbshushen: '淑慎',
			mbshushen_info: '每回合各限一次，当你回复体力时，你可以令一名其他角色摸两张牌；当你获得两张或更多牌时，你可以令一名其他角色回复1点体力。',

			mobile_standard: '手杀异构·标准包',
			mobile_shenhua: '手杀异构·神话再临',
			mobile_yijiang1: '手杀·将1',
			mobile_yijiang2: '手杀·将2',
			mobile_yijiang3: '手杀·将3',
			mobile_yijiang4: '手杀·将4',
			mobile_yijiang5: '手杀·将5',
			mobile_yijiang67: '手杀异构·原创设计',
			mobile_sp: '手杀异构·SP',
			mobile_changshi: '十常侍单体',
			mobile_qiankun: '手杀·袖里乾坤',
		},
"skill": {
			mbzhijie: {
				audio: 2,
				...
				prompt: function (event, player) {
					return '你是否发动智诫，展示' + get.translation(event.player) + '的一张手牌，其本回合使用同类别牌将摸牌并弃牌';
				},
				content: function () {
					'step 0'
					...
					'step 1'
					if (result.bool) {
						player.logSkill('mbzhijie');
						trigger.player.storage.mbzhijie = player;
						trigger.player.storage.mbzhijiex = get.type(result.links[0]);
						trigger.player.addTempSkill('mbzhijie_effect', 'phaseUseAfter');
						trigger.player.showCards(result.links, false, 1);
					}
				},
				subSkill: {
					effect: {
						...
						charlotte: true,
						filter: function (event, player) {
							if (event.name == 'useCard') return get.type2(event.card.viewAs || event.card, player) == player.storage.mbzhijiex;
							else return player.countMark('mbzhijie_effect') > 0 && player.countMark('mbzhijie_effect') <= 2;
						},
						content: function () {
							if (trigger.name == 'useCard') {
								player.draw(1);
								if (player.countMark('mbzhijie_effect') > 0) player.chooseToDiscard(player.countMark('mbzhijie_effect'), true)
									.set('prompt', '请选择弃置的' + player.countMark('mbzhijie_effect') + '张牌')
									.set('ai', card => {
										return 7.5 - get.value(card);
									});
								player.addMark('mbzhijie_effect', 1);
							} else {
								player.getStorage('mbzhijie')
									.logSkill('mbzhijie');
								player.getStorage('mbzhijie')
									.draw(1, 'nodelay');
								player.draw();
			...
			mbshushen: {
				...
				direct: true,
				filter: function (event, player) {
					return event.name == 'recover' ? !player.hasSkill('mbshushen_recover') : (event.player == player && event.getg(event.player)
						.length >= 2 && game.hasPlayer(function (current) {
							return current.isDamaged() && current != player;
						}) && !player.hasSkill('mbshushen_gain'));
				},
				content: function () {
					'step 0'
					player.chooseTarget((card, player, target) => {
						return trigger.name == 'recover' ? target != player : (target != player && target.isDamaged());
					})
						.set('prompt', '你是否发动淑慎，令一名其他角色' + (trigger.name == 'recover' ? '摸2张牌' : '回复1点体力'))
						.set('ai', target => {
							return get.attitude(_status.event.player, target);
						});
					'step 1'
					if (result.bool) {
						player.logSkill('mbshushen', result.targets[0]);
						trigger.name == 'recover' ? result.targets[0].draw(2) : result.targets[0].recover();
						player.addTempSkill(trigger.name == 'recover' ? 'mbshushen_recover' : 'mbshushen_draw', 'phaseAfter');
					}
				},
				subSkill: {
					recover: {
			...
			mbbojian: {
				...
				init: function (player) {
					if (!player.storage.mbbojian_last) player.storage.mbbojian_last = [0, 0];
				},
				filter: function (event, player) {
					var cards = [];
					player.getHistory('useCard', function (evt) {
						for (var card of evt.cards) if (get.position(card, true) == 'd' && evt.isPhaseUsing()) cards.push(card);
					});
					if (player.getStorage('mbbojian_last')[0] != player.getStorage('mbbojian_present')[0] && player.getStorage('mbbojian_last')[1] != player.getStorage('mbbojian_present')[1].length) return true;
					else return cards.length;
				},
				content: function () {
					'step 0'
					if (player.getStorage('mbbojian_last')[0] != player.getStorage('mbbojian_present')[0] && player.getStorage('mbbojian_last')[1] != player.getStorage('mbbojian_present')[1].length) {
						...
						player.chooseButton(['博鉴：在弃牌堆选择本阶段使用过的1张牌', cards], true)
							.set('ai', function (button) {
								...
								if (player.hp > 1 && player.hasFriend() && get.type(button.link) === 'basic' && name === 'tao') return val + 4;
								return val;
							});
					}
					'step 1'
					if (result.bool) {
						...
						if (event.cards.length > 1) player.chooseCardButton('博鉴：请选择要分配的牌', true, event.cards, [1, event.cards.length]).set('ai', function (button) {
					...
					if (result.targets.length) {
						...
						game.log(result.targets[0], '获得了' + get.cnNumber(event.togive.length) + '张', '#g“博鉴牌”');
						if (!map[id]) map[id] = [];
						map[id].addArray(event.togive);
					}
					if (cards.length > 0) event.goto(1);
				},
				group: 'mbbojian_start',
				subSkill: {
					start: {
						trigger: {
						...
						locked: true,
						content: function () {
							player.storage.mbbojian_present = [0, []];
							player.addTempSkill('mbbojian_use', 'phaseUseAfter');
							if (player == game.me) player.markSkill('mbbojian_use');
						},
					},
					use: {
						trigger: {
						...
						filter: function (event, player) {
							...
							return _status.currentPhase == player && evt && evt.player == player && event.card;
						},
						content: function () {
							player.storage.mbbojian_present[0]++;
							if (get.suit(trigger.card) && !player.getStorage('mbbojian_present')[1].contains(get.suit(trigger.card))) player.storage.mbbojian_present[1].add(get.suit(trigger.card));
							if (player == game.me) player.markSkill('mbbojian_use');
						},
						intro: {
							content: function (storage, player) {
								return '上个出牌阶段使用牌情况：①牌数：' + player.getStorage('mbbojian_last')[0] + '；②花色数：' + player.getStorage('mbbojian_last')[1];
							},
						},
						onremove: function (player) {
							player.storage.mbbojian_last[0] = player.storage.mbbojian_present[0];
							player.storage.mbbojian_last[1] = player.storage.mbbojian_present[1].length;
							delete player.storage.mbbojian_present;
						},
					},
				},
			},
			mbjiwei: {
				...
				filter: function (event, player) {
					var players = [],
						bool = false;
					players.addArray(game.players);
					players.addArray(game.dead);
					for (var current of players) if (current.getHistory('damage')
						.length > 0) bool = true;
					return _status.currentPhase != player && (game.getGlobalHistory('cardMove', function (evt) {
						var evtx = evt.getParent();
						if (evtx && evtx.name == 'useCard' && evtx.card && get.type(evtx.card) == 'equip') return false;
						return evt.name == 'lose' || evt.type == 'discard';
					})
						.length > 0 || bool);
				},
				content: function () {
				...
				subSkill: {
					give: {
						...
						filter: function (event, player) {
							...
							return cards.length >= game.players.length && cards.length >= player.hp;
						},
						content: function () {
							'step 0'
							event.red = player.getCards('h', {
								color: 'red'
							});
							event.black = player.getCards('h', {
								color: 'black'
							});
							if (event.red.length == event.black.length) {
								var list = [];
								list.push('红色');
								list.push('黑色');
								player.chooseControl(list)
									.set('prompt', '你须选择一种颜色的牌，然后进行分配')
									.set('ai', function () {
										//②
										if (player.hp < 2) return "黑色";
										return list.randomGet();
									});
							}
							'step 1'
							if (result.control) result.control == '红色' ? event.cards = event.red : event.cards = event.black;
							else event.red.length > event.black.length ? event.cards = event.red : event.cards = event.black;
							event.given_map = {};
							"step 2"
							if (event.cards.length > 1) player.chooseCardButton('济危：请选择要分配的牌', true, event.cards, [1, event.cards.length]).set('ai', function (button) {
								if (ui.selected.buttons.length == 0) return 1;
								return 0;
							});
							else if (event.cards.length == 1) event._result = { links: event.cards.slice(0), bool: true };
							...
							if (result.bool) {
								event.cards.removeArray(result.links);
								event.togive = result.links.slice(0);
								player.chooseTarget('选择一名角色获得' + get.translation(result.links), true, lib.filter.notMe).set('ai', function (target) {
									var att = get.attitude(_status.event.player, target);
									if (_status.event.enemy) {
										return -att;
									}
							...
							if (result.targets.length) {
								var id = result.targets[0].playerid, map = event.given_map;
								game.log(result.targets[0], '获得了' + get.cnNumber(event.togive.length) + '张', '#g“济危牌”');
								if (!map[id]) map[id] = [];
								map[id].addArray(event.togive);
							}
			...
			mbquchong: {
				...
				marktext: '铸造值',
				intro: {},
				group: ['mbquchong_remove', 'mbquchong_create', 'mbquchong_move'],
				subSkill: {
					attack: {
						audio: 1
					},
					...
					remove: {
						...
						filter: function (event, player) {
							var filter = card => get.type(card) == 'equip';
					...
					create: {
						...
						delay: false,
						filter: function (event, player) {
							var num = player.countMark('mbquchongx') == 0 ? 0 : (player.countMark('mbquchongx') == 3 ? 10 : 5);
							return game.countPlayer(current => current.countCards('ej', function (card) {
								return card.name.indexOf('dagongche_') == 0;
							}) > 0) == 0 && player.countMark('mbquchong') >= num && player.countMark('mbquchongx') < 4;
						},
						prompt: function (event, player) {
							var num = player.countMark('mbquchongx') == 0 ? 0 : (player.countMark('mbquchongx') == 3 ? 10 : 5);
							return '你可消耗' + num + '点铸造值建造一种大攻车';
						},
						content: function () {
							'step 0'
							event.num = player.countMark('mbquchongx') == 0 ? 0 : (player.countMark('mbquchongx') == 3 ? 10 : 5);
							var list = [];
							list.push('进击');
							list.push('守御');
							player.chooseControl(list)
								.set('prompt', '你可消耗' + event.num + '点铸造值建造一种大攻车')
								.set('ai', function () {

								});
							'step 1'
							event.control = result.control;
							var prompt = event.control == '进击' ? '大攻车·进击' : '大攻车·守御';
							player.chooseTarget()
								.set('prompt', '选择一个目标令其使用大攻车' + prompt)
							...
							if (result.bool) {
								...
								player.logSkill('mbquchong_create', event.target);
								if (event.num > 0) player.removeMark('mbquchong', event.num);
								player.addMark('mbquchongx', 1);
								event.card = event.control == '进击' ? game.createCard('dagongche_attack', 'heart', 1) : game.createCard('dagongche_defense', 'diamond', 1);
								event.card.setAttribute('id', player.playerid);
								event.card.setAttribute('durability', event.control == '进击' ? 2 : 4);
								event.target == game.me ? event.target.gain(event.card, 'draw') : event.target.gain(event.card, 'gain2');
							} else event.goto(0);
							'step 3'
							if (event.target.getCards('h')
								.contains(event.card)) event.target.chooseUseTarget(event.card, 'nopopup', true);
						},
					},
					move: {
						trigger: {
						...
						filter: function (event, player) {
							return game.countPlayer(current => current.countCards('ej', function (card) {
								return card.name.indexOf('dagongche_') == 0;
							}) > 0) > 0 && game.countPlayer(current => current.countCards('ej', function (card) {
								return card.name.indexOf('dagongche_') == 0;
							}) == 0) > 0;
						},
						content: function () {
							...
							player.chooseTarget((card, player, target) => {
								...
								.set('prompt', '你可选择一个角色，将大攻车移给他')
								.set('ai', target => {
									return get.attitude(_status.event.player, target);
								});
							'step 1'
							if (result.bool) {
								var target = game.filterPlayer(current => current.countCards('e', function (card) {
									return card.name.indexOf('dagongche_') == 0;
								}) > 0)[0];
								event.card = target.getCards('e', function (card) {
									return card.name.indexOf('dagongche_') == 0;
								})[0];
								player.logSkill(event.card.name == 'dagongche_attack' ? 'mbquchong_attack' : 'mbquchong_defense');
								result.targets[0] == game.me ? result.targets[0].gain(event.card, target) : result.targets[0].gain(event.card, target, 'gain2');
								event.target = result.targets[0];
							} else event.finish();
							'step 2'
							game.delayx();
			...
			dagongche_attack_skill: {
				...
				delay: false,
				prompt: function () {
					return '你可-1耐久度，使此伤害+' + Math.min(3, game.roundNumber);
				},
				content: function () {
					var card = trigger.source.getCards('e', function (card) {
						return card.name.indexOf('dagongche_') == 0;
					})[0];
					if (card) card.setAttribute('durability', card.getAttribute('durability') - 1);
					trigger.num += Math.min(3, game.roundNumber);
				},
			},
			dagongche_defense_skill: {
				equipSkill: true,
				trigger: {
					player: 'damageBegin4'
				},
				...
				content: function () {
					...
					var numx = Math.min(trigger.num, card.getAttribute('durability'));
					card.setAttribute('durability', card.getAttribute('durability') - numx);
					trigger.num -= numx;
				},
			},
			dagongche_ban: {
				trigger: {
					player: ['useCard', 'equipBegin']
				},
				direct: true,
				filter: function (event, player) {
					return event.name == 'useCard' ? get.type(event.card) == 'equip' : true;
				},
				content: function () {
					trigger.name == 'useCard' ? trigger.all_excluded = true : trigger.cancelled = true;
				},
			},
			dagongche_lose: {
				trigger: {
				...
				filter: function (event, player) {
					...
					return event.cards.contains(card) && event.getParent(2)
						.name != 'mbquchong' && event.getParent(2)
							.name != 'mbquchong_move' && event.getParent(2)
								.name != 'disableEquip' && event.getParent()
									.name != 'useCard' && event.getParent()
										.name != 'respond';
				},
				content: function () {
					var card = player.getCards('e', function (card) {
					...
					card.setAttribute('durability', card.getAttribute('durability') - 1);
					trigger.cards.remove(card);
				},
			},
			dagongche_strong: {
				trigger: {
					player: ['useCardEnd', 'equipEnd']
				},
				direct: true,
				filter: function (event, player) {
					return event.card.name.indexOf('dagongche_') == 0 && player.countCards('e', function (card) {
						return card.name.indexOf('dagongche_') != 0;
					}) > 0;
				},
				content: function () {
					...
					if (cards) player.discard(cards, 'passive');
				},
			},
			dagongche_destroy: {
				trigger: {
					player: ['dagongche_attack_skillAfter', 'dagongche_defense_skillAfter', 'dagongche_loseAfter']
				},
				direct: true,
				filter: function (event, player) {
					var card = player.getCards('e', function (card) {
					...
					return card && card.getAttribute('durability') <= 0;
				},
				content: function () {
					var card = player.getCards('e', function (card) {
						return card.name.indexOf('dagongche_') == 0;
			...
			mbxunjie: {
				...
				filter: function (event, player) {
					return game.countPlayer(current => current.countCards('ej', function (card) {
						return card.name.indexOf('dagongche_') == 0 && card.getAttribute('id') == player.playerid;
					}) > 0) == 0 && event.source && event.source.isIn() && event.source.hp > player.hp;
				},
				forced: true,
				content: function () {
					'step 0'
			...
			mbchengxiong: {
				...
				content: function (event, trigger, player) {
					...
					player.chooseTarget(get.prompt2("mbchengxiong"), function (card, player, target) {
						...
						const color = _status.event.color;
					...
					if (result.bool) {
						...
						event.target = result.targets[0];
						player.discardPlayerCard("he", target, true).set("ai", function (button) {
							let val = get.buttonValue(button);
							if (get.attitude(_status.event.player, get.owner(button.link)) > 0) val *= -1;
							if (get.position(button.link) == "e" && get.color(button.link) == _status.event.color) return val *= 2;
							return val;
						}).set("color", get.color(trigger.card));
					}
					"step 2"
					if (result.bool && get.color(result.links[0]) == get.color(trigger.card)) target.damage();
				},
				mod: {
			...
			mbxuetu: {
				audio: 4,
				init: function (player) {
					player.removeSkill('mbxuetu');
					player.addSkill('mbxuetu1');
				},
			},
			mbxuetu1: {
				audio: 2,
				...
				intro: {
					content: function (storage, player, skill) {
						if (player.storage.mbxuetu1) return '转换技。出牌阶段限一次，你可令一名角色摸两张牌。';
						return '转换技。出牌阶段限一次，你可令一名角色回复1点体力。';
					},
				},
				prompt: function () {
					if (_status.event.player.storage.mbxuetu1) return '你可令一名角色摸两张牌';
					return '你可令一名角色回复1点体力';
				},
				content: function () {
					'step 0'
					if (player.storage.mbxuetu1 == true) {
						target.draw(2);
					} else {
						target.recover();
					}
					player.changeZhuanhuanji('mbxuetu1');
				},
				ai: {
					order: function () {
						return get.order({ name: 'sha' }) + 6;
					},
					threaten: 3,
					result: {
						target: 1,
			...
			mbxuetu2: {
				...
				direct: true,
				filter: function (event, player) {
					return !player.hasSkill('mbxuetu2_recovercheck') || !player.hasSkill('mbxuetu2_drawcheck');
				},
				content: function () {
					'step 0'
					if (player.hasSkill('mbxuetu2_recovercheck')) {
						player.chooseControl('令人摸牌', '取消').set('prompt', '你可选择令人回复体力，或令人摸牌');
					} else if (player.hasSkill('mbxuetu2_drawcheck')) {
						player.chooseControl('令人回血', '取消').set('prompt', '你可选择令人回复体力，或令人摸牌');
					} else {
						player.chooseControl('令人回血', '令人摸牌', '取消').set('prompt', '你可选择令人回复体力，或令人摸牌');
					};
					'step 1'
					if (result.control) {
						if (result.control == '取消') {
							event.finish();
							player.getStat('skill').mbxuetu2--;
						} else if (result.control == '令人回血') {
							event.goto(2);
						} else if (result.control == '令人摸牌') {
							event.goto(4);
						} else {
							event.finish();
						}
					...
					'step 2'
					player.chooseTarget('你可令1名角色回复1点体力', '').set('ai', function (target) {
					...
					'step 3'
					if (result.bool) {
						player.addTempSkill('mbxuetu2_recovercheck', 'phaseUseEnd');
						player.logSkill('mbxuetu2', result.targets[0]);
					...
					'step 4'
					player.chooseTarget('你可令1名角色摸2张牌', '').set('ai', function (target) {
						var player = _status.event.player;
						if (get.attitude(player, target) > 0) {
							return get.recoverEffect(target, player, player) + 1;
						}
					...
					'step 5'
					if (result.bool) {
						player.addTempSkill('mbxuetu2_drawcheck', 'phaseUseEnd');
						player.logSkill('mbxuetu2', result.targets[0]);
				...
				subSkill: {
					recovercheck: { charlotte: true, },
					drawcheck: { charlotte: true, },
				},
				ai: {
					order: function () {
						return get.order({ name: 'sha' }) + 8;
					},
					threaten: 4,
					result: {
						target: 1,
			...
			mbxuetu3: {
				...
				intro: {
					content: function (storage, player, skill) {
						if (player.storage.mbxuetu3 == true) return '转换技。出牌阶段限一次，你可摸一张牌并对一名角色造成一点伤害。';
						return '转换技。出牌阶段限一次，你可回复1点体力并令一名角色弃置两张牌。';
					},
				},
				prompt: function () {
					if (_status.event.player.storage.mbxuetu3) return '你可摸1张牌，然后对1名角色造成1点伤害';
					return '你可回复1点体力，然后令1名角色弃2张牌';
				},
				content: function () {
					'step 0'
					if (player.storage.mbxuetu3 == true) {
						player.draw();
					...
					player.changeZhuanhuanji('mbxuetu3');
				},
				ai: {
					order: function () {
			...
			mbweiming: {
				...
				content: function () {
					for (var target of game.filterPlayer()) {
						if (target.hasMark('mbweiming')) {
							target.removeMark("mbweiming", target.countMark("mbweiming"));
						};
					};
				},
				group: ['mbweiming_add', 'mbweiming_achieve', 'mbweiming_fail'],
				subSkill: {
					add: {
						audio: "mbweiming1",
						trigger: {
						...
						filter: function (event, player) {
							var num = game.countPlayer(function (current) {
								return current.hasMark('mbweiming');
							});
							return num < game.countPlayer() - 1;
						},
						content: function () {
							'step 0'
							player.logSkill('mbweiming1');
							player.chooseTarget('选择1名未被选择过的角色，如其在你杀死其他未被选择过的角色死亡前死亡，则威命失败', true, (card, player, target) => {
								return player != target && !target.hasMark('mbweiming');
							})
								.set('animate', false)
								.set('ai', function (target) {
									if (target === player) return 1;
									return 1 + Math.sqrt(Math.abs(get.attitude(player, target))) * Math.abs(get.threaten(target)) / Math.sqrt(target.hp + 1) / Math.sqrt(target.countCards('hes') + 1);
								});
							'step 1'
							player.line(result.targets[0], 'green');
							result.targets[0].addMark('mbweiming', 1, false);
							game.log(player, '发动', '#g【威命】', '记录了', result.targets[0]);
						}
					},
					achieve: {
						audio: "mbweiming2",
						...
						filter: function (event, player) {
							return !event.player.hasMark('mbweiming');
						},
						content: function () {
							'step 0'
							game.log(player, '使命成功');
							player.awakenSkill('mbweiming');
							player.removeSkill('mbxuetu1');
							player.addSkill('mbxuetu2');
							game.log(player, '升级技能', '#g【血途】', '至2级');
						},
					},
					fail: {
						audio: "mbweiming3",
						...
						content: function () {
							...
							player.awakenSkill('mbweiming');
							player.failSkill('mbweiming');
							player.removeSkill('mbxuetu1');
							player.addSkill('mbxuetu3');
							game.log(player, '升级技能', '#g【血途】', '至3级');
						},
					},
				},
			},
			mbsidai: {
				...
				filter: function (event, player) {
					...
					return event.filterCard(get.autoViewAs({ name: 'sha', storage: { mbsidai: true } }, cards), player, event);
				},
				viewAs: { name: 'sha', storage: { mbsidai: true } },
				filterCard: { type: 'basic' },
				selectCard: -1,
				check: () => 1,
				onuse: function (result, player) {
					player.awakenSkill('mbsidai');
					player.addTempSkill('mbsidai_effect');
				},
				ai: {
					order: 2.9,
					result: {
				...
				mod: {
					cardUsable: function (card) {
						if (card.storage && card.storage.mbsidai) return Infinity;
					},
					targetInRange: function (card) {
						if (card.storage && card.storage.mbsidai) return true;
					},
				},
				subSkill: {
					effect: {
						charlotte: true,
						group: ['mbsidai_tao', 'mbsidai_shan'],
					},
					tao: {
						trigger: { source: 'damageSource' },
						filter: function (event, player) {
							if (!event.card || !event.card.storage || !event.card.storage.mbsidai || !event.player.isIn()) return false;
					...
					shan: {
						...
						filter: function (event, player) {
							if (!event.card || !event.card.storage || !event.card.storage.mbsidai || !event.target.isIn()) return false;
							for (var i of event.cards) {
			...
			mbjieyu: {
				...
				intro: {
					markcount: function (storage) {
						return Math.max(1, 3 - storage);
					},
					content: function (storage) {
						return '下次发动〖竭御〗可获得' + Math.max(1, 3 - storage) + '张基本牌'
					}
				},
				content: function () {
					'step 0'
					event.cardList = ['sha', 'shan', 'tao', 'jiu'];
					event.getTime = Math.max(1, 3 - player.storage.mbjieyu);
					event.cardGetList = [];
					'step 1'
					if (event.getTime <= 0 || event.cardList.length <= 0) event.goto(3);
					var current = event.cardList.shift();
					var card = get.discardPile(function (card) {
						return card.name == current;
					});
					if (card) {
						event.cardGetList.add(card);
						event.getTime--;
					}
					'step 2'
					event.goto(1);
					'step 3'
					if (event.cardGetList.length) player.gain(event.cardGetList, 'gain2');
			...
			mbguimou: {
				...
				content: function () {
					...
					player.removeAdditionalSkill('mbguimou');
					player.addAdditionalSkill('mbguimou', 'mbguimou_' + num);
				},
				group: ['mbguimou_e', 'mbguimou_z', 'mbguimou_d'],
				subSkill: {
					e: {
						audio: 'mbguimou',
						...
						content: function () {
							...
							'step 1'
							player.addAdditionalSkill('mbguimou', 'mbguimou_' + (result.index + 1));
						}
					},
					1: {
						init: function (player) {
							player.storage.guimou2 = new Map();
							for (var i of game.players) {
								if (i != player) player.storage.guimou2.set(i, 0);
							}
						},
						onremove: function (player) {
							delete player.storage.guimou2;
						},
						...
						content: function () {
							if (!player.storage.guimou2) player.storage.guimou2 = new Map();
							player.storage.guimou2.set(trigger.player, player.storage.guimou2.get(trigger.player) + 1);
						}
					},
					2: {
						init: function (player) {
						...
						content: function () {
							...
							player.storage.guimou2.set(trigger.player, player.storage.guimou2.get(trigger.player) + evt.cards2.length);
						}
					},
					3: {
						init: function (player) {
						...
						content: function () {
							if (!player.storage.guimou2) player.storage.guimou2 = new Map();
							player.storage.guimou2.set(trigger.player, player.storage.guimou2.get(trigger.player) + trigger.getg(player).length);
						}
					},
					z: {
						audio: 'mbguimou',
						...
						filter: function (event, player) {
							return player.storage.guimou2 && player.storage.guimou2.size > 0 && game.hasPlayer((c) => {
								return c != player && lib.skill.mbguimou.getMinKeys(player.storage.guimou2).includes(c) && c.countCards('he');
							});
						},
						forced: true,
						locked: false,
						content: function () {
							'step 0'
							player.storage.guimou2.delete(player);
							player.chooseTarget('请选择一名被记录的其他角色', true, (card, player, target) => {
								return target != player && lib.skill.mbguimou.getMinKeys(player.storage.guimou2).includes(target) && target.countCards('he');
							}).set('ai', target => {
								return -get.attitude(_status.event.player, target);
							});
							'step 1'
							if (result.bool) {
								...
								event.targetGuimou = target;
								var next = player.choosePlayerCard(target, 'he', 1, '选择' + get.translation(target) + '一张牌', true).set('ai', function (button) {
							...
							'step 2'
							if (result.bool) {
								event.cardGuimou = result.cards[0];
								var list = [];
								game.players.forEach((c) => {
									if (c != player && c != event.targetGuimou) list.add(c);
								})
								var list2 = ['弃置此牌'];
								if (list.length) list2.add('将此牌交给一名其他角色');
								player.chooseControl(list2).set('ai', () => {
									var player = _status.event.player;
									if (game.hasPlayer(c => {
										return get.attitude(player, c) > 0
									})) return '将此牌交给一名其他角色';
									return '弃置此牌';
								}).set('prompt', '选择一项');
							}
							'step 3'
							player.removeAdditionalSkill('mbguimou');
							if (result.control == '弃置此牌') {
								event.targetGuimou.discard(event.cardGuimou);
								event.finish();
							}
							else {
								player.chooseTarget('选择一名其他角色并交给其' + get.translation(event.cardGuimou), (card, player, target) => {
									return target != player && target != event.targetGuimou;
								}, true).set('ai', (target) => {
									return get.attitude(_status.event.player, target);
								})
							}
							'step 4'
							if (result.bool) {
								player.give(event.cardGuimou, result.targets[0])
							}
						}
					},
					d: {
						...
						direct: true,
						filter: function (event, player) {
							return player.storage.guimou2.size > 0
						},
						content: function () {
							player.storage.guimou2.delete(trigger.player);
						}
					}
				},
				ai: {
			...
			mbshoufa: {
				...
				content: function (event, trigger, player) {
					...
					player.chooseTarget(get.prompt('mbshoufa'), '选择一名距离' + (event.triggername == 'damageEnd' ? '' : '不') + '大于2的角色，' + str, (card, player, target) => {
					...
					if (result.bool) {
						const target = result.targets[0];
						player.logSkill('mbshoufa', target);
						const mbshoufa = zhoufa ? zhoufa : ['豹', '鹰', '熊', '兔'].randomGet();
						game.log(target, '执行', '#g' + mbshoufa, '效果');
						switch (mbshoufa) {
							case '豹':
			...
			mbyuxiang: {
				...
				filter: function (event, player) {
					return player.hujia > 0 && event.nature == 'fire';
				},
				forced: true,
				content: function (event, trigger, player) {
					trigger.num++;
			...
			mbzhoulin: {
				...
				content: function (event, trigger, player) {
					'step 0'
					player.awakenSkill('mbzhoulin');
					player.changeHujia(2, null, true);
					player.chooseControl('豹', '鹰', '熊', '兔').set('ai', () => '豹').set('prompt', '选择一个固定效果');
					'step 1'
					...
					if (control) {
						...
						player.addTempSkill('mbzhoulin_zhoufa');
						/*const zhoufa=control;*/
						player.storage.mbzhoulin_zhoufa = control;
						player.markSkill('mbzhoulin_zhoufa');
						/*player.addTempSkill('mbzhoulin_zhoufa');*/
						/*game.broadcastAll(function(player,zhoufa){
							if(player.marks.mbzhoulin_zhoufa) player.marks.mbzhoulin_zhoufa.firstChild.innerHTML=zhoufa;
						},player,control);*/
					}
					if (control == '豹') {
					...
					if (control == '鹰') {
						player.gain(player.getGainableCards(player, 'he').randomGet(), player, 'giveAuto');
					}
					if (control == '熊') {
						target.discard(player.getGainableCards(player, 'e').randomGet()).discarder = player;
					}
					if (control == '兔') {
						player.draw();
					}
			...
			mbnaxue: {
				...
				content: function () {
					'step 0'
					player.chooseBool('纳学：是否跳过出牌阶段？').set('ai', function () {
						var player = _status.event.player;
					...
					'step 1'
					if (result.bool) {
						player.logSkill('mbnaxue');
						player.chooseToDiscard([1, player.countCards('h')], 'h', '纳学：是否弃置任意张牌并摸等量的牌');
					}
					else event.finish();
					'step 2'
					if (result.bool) {
			...
			mbyijie: {
				...
				content: function () {
					...
					hp = Math.max(1, Math.floor(hp / game.countPlayer()));
					game.log(player, '发动了', '#g【遗诫】', '，令', game.players, '将体力调整为', hp);
					game.players.forEach(function (current) {
						current.changeHp(hp - current.hp)._triggered = null;
					})
				}
			},
			mbjiaohua: {
				...
				intro: {
					content: function (storage, player) {
						if (storage.length == 0) return '暂无记录';
						return '当前已记录：' + storage;
					}
				},
				content: function () {
					'step 0'
					list = [];
					if (!player.storage.mbjiaohua.contains('基本牌')) list.add('基本牌');
					if (!player.storage.mbjiaohua.contains('锦囊牌')) list.add('锦囊牌');
					if (!player.storage.mbjiaohua.contains('装备牌')) list.add('装备牌');
					player.chooseControl(list, true).set('prompt', '教化：令' + get.translation(target) + '从牌堆中获得一张该类型的牌').set('ai', function () {
						if (!player.storage.mbjiaohua.contains('锦囊牌')) return '锦囊牌';
						if (!player.storage.mbjiaohua.contains('装备牌')) return '装备牌';
						if (!player.storage.mbjiaohua.contains('基本牌')) return '基本牌';
						return list.randomGet();
					});
					'step 1'
					var map = {
					...
					var typejh = map[result.control];
					var card = get.cardPile2(function (card) {
						return get.type2(card) == typejh;
					});
					if (card) {
						target.gain(card, 'gain2');
						player.storage.mbjiaohua.add(result.control);
						if (player.storage.mbjiaohua.length == 3) {
							player.storage.mbjiaohua.length = 0;
							player.markSkill('mbjiaohua');
						}
					}
				},
				ai: {
			...
			mblaishou: {
				...
				filter: function (event, player) {
					var num = 9;
					if (event.name == 'damage') return event.num >= player.hp && player.maxHp < num;
				...
				content: function () {
					...
					if (targets.length) {
						...
						targets.forEach(target => {
							target.addTempSkill('mbluanqun_effect', { player: 'phaseUseAfter' });
							target.markAuto('mbluanqun_effect', [player]);
						});
					}
				},
				ai: {
					...
					effect: {
						...
						mod: {
							playerEnabled: function (card, player, target) {
								...
								if (card.name == 'sha' && !player.getStorage('mbluanqun_effect').contains(target)) return false;
							},
						},
						...
						forced: true,
						content: function () {
							trigger.directHit.addArray(player.getStorage('mbluanqun_effect'));
							player.removeSkill('mbluanqun_effect');
						},
					},
				},
			},
			mbhuiyao: {
				...
				content: function () {
					player.damage('nosource');
					target.damage(player).setContent(lib.skill.guanzong.viewAsDamageContent);
				},
			},
			mbquesong: {
				audio: 2,
				...
				content: function () {
					...
					if (result.bool) {
						...
						var list = [['draw', '摸等同于其装备区中空栏的数量的牌并复原武将牌']];
						if (target.countCards('h') >= target.hp) list.push(['discard', '弃置等同于其体力值的手牌并回复1点体力']);
						if (list.length > 1) {
							target.chooseButton([get.prompt('mbquesong'),
							[list, 'textbutton']]).set('selectButton', 1);
						}
					}
					else event.finish();
					'step 2'
					if (result.bool) {
						if (result.links == 'draw') event.goto(3);
						if (result.links == 'discard') event.goto(6);
					}
					else event.goto(3);
					'step 3'
					event.target.draw(5 - event.target.countDisabled() - event.target.countCards('e'));
					'step 4'
					...
					event.finish();
					'step 6'
					event.target.chooseToDiscard('h', false, event.target.hp, '弃置' + event.target.hp + '张牌并回复1点体力');
					'step 7'
					if (result.bool) {
				...
				subSkill: {
					...
					give: {
						...
						content: function () {
							...
							}, true).set('ai', target => 1 - get.attitude(_status.event.player, target));
							'step 2'
							if (result.bool) {
			...
			yijin: {
				...
				filter: function (event, player) {
					...
					return lib.skill.yijin.getKane(player) && lib.skill.yijin.getKane(player).length;
				},
				...
				getValue: function (player, mark, target) {
					...
					switch (mark.slice(6)) {
						...
						case 'tongshen':
							...
							if (eff >= 0 && target.hp > 2) return 0;
							if (att >= 4) {
								if (target.hp == 1) return att * 5 / Math.max(0.1, 5 - dis);
								if (target.hp == 2 && target.countCards('h') <= 2) return att * 3 / Math.max(0.1, 5 - dis);
							}
							if (att > 0) {
								if (target.hp <= 2 && target.countCards('h') <= 2) return 3 + dis;
								return 1 + dis;
							}
							return -eff / 2 * dis;
						case 'yongbi':
					...
					mark: {
						...
						intro: {
							...
							markcount: function (storage, player) {
								if (lib.skill.yijin.getKane(player)) return lib.skill.yijin.getKane(player).length;
								return '';
							},
							content: function (storage, player) {
			...
			reqianxin: {
				...
				content: function () {
					...
					event.target = target;
					'step 2'
					event.target.storage.reqianxin2.push([cards[event.count], player]);
					event.map.push([event.target, cards[event.count]]);
					'step 3'
					event.count++;
					'step 4'
			...
			xinfu_jingxiex: {
				...
				filterCard: function (card) {
					var player = _status.event.player;
					if (player.isDying()) return get.subtype(card) == 'equip2';
					else if (player.isPhaseUsing()) return ["bagua", "baiyin", "lanyinjia", "renwang", "tengjia", "zhuge"].contains(card.name);
				},
				discard: false,
				//lose:false,
				get lose() {
				...
				content: function () {
					'step 0'
					if (player.isDying()) event.goto(4);
					else if (player.isPhaseUsing()) event.goto(1);
					else event.finish();
					'step 1'
					player.showCards(cards);
					'step 2'
					...
					event.finish();
					'step 4'
					// player.lose(cards[0],ui.discardPile);
					// game.delay(1.2);
					player.$throw(cards[0], 1000);
					game.log(player, '将', cards[0], '置入了弃牌堆');
					'step 5'
					player.draw();
					'step 6'
					var num = 1 - player.hp;
...
"card": {
			...
			'dagongche_attack': {
				...
				skills: ['dagongche_attack_skill', 'dagongche_ban', 'dagongche_destroy', 'dagongche_lose', 'dagongche_strong'],
				ai: {
					basic: {
						equipValue: 2
					}
			...
			'dagongche_defense': {
				...
				skills: ['dagongche_defense_skill', 'dagongche_ban', 'dagongche_destroy', 'dagongche_lose', 'dagongche_strong'],
				ai: {
					basic: {
						equipValue: 2
					}
