// Extracted from character/shenhua.js; legacy startup and engine/UI patches are not executed.
...
"characterReplace": {
			...
			sunce: ['sunce', 're_sunben', 're_sunce', 'sp_sunce'],
			...
			yl_luzhi: ['yl_luzhi', 'sb_luzhi', 'tw_yl_luzhi'],
		},
"characterPrefix": {
			caoren: '界',
		},
"dynamicTranslate": {
			...
			nzry_shenshi: function (player) {
				if (player.storage.nzry_shenshi == true) return '转换技，阳：出牌阶段限一次，你可以将一张牌交给一名手牌数最多的角色，然后对其造成一点伤害，若该角色因此死亡，则你可以令一名角色将手牌摸至四张。<span class="bluetext">阴：其他角色对你造成伤害后，你可以观看该角色的手牌，然后交给其一张牌，当前角色回合结束时，若此牌仍在该角色的区域内，你将手牌摸至四张。</span>';
				return '转换技，<span class="bluetext">阳：出牌阶段限一次，你可以将一张牌交给一名手牌数最多的角色，然后对其造成一点伤害，若该角色因此死亡，则你可以令一名角色将手牌摸至四张。</span>阴：其他角色对你造成伤害后，你可以观看该角色的手牌，然后交给其一张牌，当前角色回合结束时，若此牌仍在该角色的区域内，你将手牌摸至四张。';
			},
		},
"perfectPair": {
			jiaxu: ['liqueguosi'],
...
"translate": {
			...
			"nzry_shenshi1": "审时",
			"nzry_shenshi": "审时",
			"nzry_shenshi_info": "转换技，阳：出牌阶段限一次，你可以将一张牌交给一名除你外手牌数最多的角色，然后对其造成一点伤害，若该角色因此死亡，则你可以令一名角色将手牌摸至四张。阴：其他角色对你造成伤害后，你可以观看该角色的手牌，然后交给其一张牌，当前角色回合结束时，若此牌仍在该角色的区域内，你将手牌摸至四张。",
			"nzry_mingren": "明任",
...
"skill": {
			...
			"drlt_zhenggu": {
				...
				content: function () {
					...
					"step 2"
					event.target.storage.drlt_zhenggu_mark.push(player);
					event.target.markSkill("drlt_zhenggu_mark");
					lib.skill.drlt_zhenggu.sync(player, event.target);
				},
