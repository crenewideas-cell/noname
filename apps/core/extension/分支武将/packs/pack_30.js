// Extracted from character/yijiang.js; legacy startup and engine/UI patches are not executed.
export default function(lib, game, ui, get, ai, _status) {
return {
"character": {
			dc_peixiu: ['male', 'qun', 3, ['dczhitu', 'dcfujue']],
			dc_xuangongzhu: ['female', 'wei', 3, ['dcqimei', 'dczhuiji']],
			dc_simafu: ['male', 'wei', 4, ['dcbeiyu', 'dcduchi']],
			dc_linghuyu: ['male', 'wei', 4, ['dcxuzhi']],
			dc_xukun: ['male', 'wu', 4, ['dcfazhu']],
			dc_xiahoumao: ['male', 'wei', 4, ['dctongwei', 'dccuguo']],
			dc_chenshi: ['male', 'shu', 4, ['dcqingbei'], []],
			dc_sunli: ['male', 'wei', 4, ['dckangli']],
			dc_feiyao: ['male', 'wei', 4, ['dczhenfeng'], []],
		},
"characterSort": {
			yijiang: {
				yijiang_2011: [],
				...
				yijiang_2017: [],
				yijiang_2022: [],
				yijiang_2023: ['dc_xiahoumao', 'dc_chenshi', 'dc_sunli', 'dc_feiyao', 'dc_xukun', 'dc_linghuyu', 'dc_simafu', 'dc_xuangongzhu', 'dc_peixiu'],
			},
		},
"characterIntro": {
...
"characterReplace": {
			caozhi: ['ol_re_caozhi', 're_caozhi', 'dc_caozhi', 'caozhi', 'ps_caozhi'],
			...
			chengpu: ['reol_chengpu', 're_chengpu', 'tw_chengpu', 'ns_chengpu', 'chengpu', 'xin_chengpu'],
			...
			yufan: ['reol_yufan', 'xin_yufan', 're_yufan', 'yufan'],
			...
			caorui: ['caorui', 'redc_caorui', 'old_caorui'],
...
"translate": {
			...
			jishe: '极奢',
			jishe2: '极奢',
			jishe_info: '①若你的手牌上限大于0，你可以摸一张牌，然后你本回合的手牌上限-1。②结束阶段开始时，若你没有手牌，则你可以横置至多X名角色的武将牌（X为你的体力值）',
			lianhuo: '链祸',
			...
			yj_sufei: '苏飞',
			shuojian: '数谏',
			shuojian_info: '出牌阶段限三次。你可以交给一名其他角色一张牌，其选择一项：1.令你摸X张牌并弃置X-1张牌；2.视为使用X张【过河拆桥】，然后此技能本回合失效（X为此技能本阶段剩余发动次数）。',
			yj_qiaozhou: '谯周',
			shiming: '识命',
			...
			hanlong: '韩龙',
			duwang: '独往',
			duwang_info: '锁定技，游戏开始时，你从牌堆顶将五张不为【杀】的牌置于武将牌上，称为“刺”。若你有“刺”，则你与其他角色互相计算距离时均+1。',
			cibei: '刺北',
			...
			wuanguo: '武安国',
			diezhang: '叠嶂',
			diezhang_info: '转换技，①出牌阶段，你使用杀的次数上限+1。②阳：当你使用牌被其他角色抵消后，你可以弃置一张牌，视为对其使用X张【杀】；阴：当其他角色使用牌被你抵消后，你可以摸X张牌，视为对其使用一张【杀】（X为1）。',
			duanwan: '断腕',
			...
			dc_sunli: '孙礼',
			dckangli: '伉厉',
			dckangli_info: '当你造成或受到伤害后，你摸两张牌。然后你下次造成伤害时弃置这些牌。',
			dc_xiahoumao: '夏侯楙',
			dctongwei: '统围',
			dctongwei_info: '出牌阶段限一次。你可以重铸两张牌并指定一名其他角色，当其使用的下一张牌结算结束后，若此牌点数在你上次以此法重铸的牌的点数之间，你视为对其使用一张【杀】或【过河拆桥】。',
			dccuguo: '蹙国',
			dccuguo_info: '锁定技，当你于一回合使用牌首次被抵消后，你弃置一张牌，视为对此牌的目标角色使用一张该被抵消的牌。此牌结算结束后，若此牌被抵消，你失去1点体力。',
			dc_chenshi: '陈式',
			dcqingbei: '擎北',
			dcqingbei_info: '一轮游戏开始时，你可以选择任意种花色，你不能于本轮内使用这些花色的牌。然后当你于本轮使用牌结算结束后，你摸等同于你上一次〖擎北〗选择过的花色数的牌。',
			dc_feiyao: '费曜',
			dczhenfeng: '镇锋',
			dczhenfeng_info: '每回合限一次。当其他角色于其回合内使用牌时，若其手牌数不大于其体力值，你可以猜测其手牌中与此牌类别相同的牌数。若你猜对，你摸X张牌并视为对其使用一张【杀】（X为你连续猜对的次数且至多为5）；若你猜错且差值大于1，其视为对你使用一张【杀】。',
			dc_xukun: '徐琨',
			dcfazhu: '筏铸',
			dcfazhu_info: '准备阶段，你可以重铸你区域内的任意张非伤害牌，将以此法获得的牌交给至多等量名角色各一张（获得牌的角色可以依次使用一张【杀】，这些【杀】无距离限制）。',
			dc_linghuyu: '令狐愚',
			dcxuzhi: '蓄志',
			dcxuzhi_info: '出牌阶段限一次，你可以令两名有手牌的角色选择任意张手牌，然后交换选择的牌。若交换前选择的牌数不同，则选择牌数较多的角色视为使用一张无距离与次数限制的【杀】，否则你摸两张牌且本阶段发动此技能的次数上限+1（不能选择本阶段选择过的角色）。',
			dc_simafu: '司马孚',
			dcbeiyu: '备预',
			dcbeiyu_info: '出牌阶段限一次，你可将手牌摸至体力上限，然后你将一种花色的所有手牌置于牌堆底。',
			dcduchi: '督持',
			dcduchi_info: '每回合限一次，当你成为其他角色使用牌的目标后，你可从牌堆底摸一张牌并展示所有手牌，若颜色均相同，则此牌对你无效。',
			dc_peixiu: '裴秀',
			dczhitu: '制图',
			dczhitu_info: '当你使用基本牌或单目标普通锦囊牌时，你可以选择任意名角色为目标（你距离这些角色的距离须相等）。',
			dcfujue: '复爵',
			dcfujue_info: '出牌阶段限一次，你可以：依次执行以下所有项：1.你可以移动场上的一张牌；2.将你的牌数调整至五。若你在此过程中失去且获得过牌，你本回合计算与其他角色的距离-1。',
			dc_xuangongzhu: '宣公主',
			dcqimei: '齐眉',
			dcqimei_info: '出牌阶段限一次，你可选择一名其他角色，你与其各摸两张牌并展示两张手牌，根据展示牌的花色数，你可执行以下效果：1.你依次使用之；2.你与其复原武将牌；3.你与其重铸这些牌；4.你与其各摸一张牌。',
			dczhuiji: '追姬',
			dczhuiji_info: '当你死亡后，你可令一名角色随机使用装备牌直至其装备区满，当其失去以此法使用的装备牌后，废除对应的装备栏。',
...
"skill": {
			...
			dcqimei: {
				...
				content: function () {
					...
					target.draw(2);
					player.chooseCardOL([player, target], 'he', true, 2, '齐眉：请展示两张牌');
					'step 1'
					player.showCards(result[0].cards);
					target.showCards(result[1].cards);
					event.cards = result.reduce((list, evt) => {
						list.addArray(evt.cards);
						return list;
					}, []);
					event.usingCards = event.cards.slice();
					event.cards0 = result[0].cards;
					event.cards1 = result[1].cards;
					'step 2'
					var suits = event.cards.reduce((list, card) => {
					...
					switch (event.suits) {
						case 1:
							if (event.usingCards.length != 0) {
								var card = event.usingCards.shift();
						...
						case 2:
							...
							break;
						case 3:
							player.chongzhu(event.cards0);
							target.chongzhu(event.cards1);
							break;
						case 4:
							player.draw();
							target.draw();
			...
			dczhuiji: {
				...
				filter: function (event, player) {
					return game.hasPlayer(target => target != player && lib.skill.dczhuiji.filterTarget(null, player, target));
				},
				// 防止报错，从羊祜【戎备】那里复制一份技能
				...
				content: function () {
					'step 0'
					player.chooseTarget(get.prompt2('dczhuiji'), (card, player, target) => {
						return target != player && lib.skill.dczhuiji.filterTarget(null, player, target);
					}).set('forceDie', true).set('ai', target => {
						var slot = 0;
						for (var i = 1; i < 6; i++) {
							if (target.isEmpty(i)) slot++;
						}
						return get.attitude(_status.event.player, target) * (slot + 1);
					});
					'step 1'
					if (result.bool) {
						event.num = 0, event.cards = [];
					...
					if (event.cards.length) {
						event.target.addSkill('dczhuiji_effect');
						event.target.markAuto('dczhuiji_effect', event.cards);
					}
				},
				ai: {
					result: {
				...
				subSkill: {
					effect: {
						...
						filter: function (event, player) {
							...
							return evt && evt.es && evt.es.some(i => player.getStorage('dczhuiji_effect').includes(i));
						},
						content: function () {
							var evt = trigger.getl(player);
							var cards = evt.es.filter(i => player.getStorage('dczhuiji_effect').includes(i));
							player.unmarkAuto('dczhuiji_effect', cards);
							for (var card of cards) player.disableEquip(get.subtype(card));
						},
						intro: {
			...
			dczhitu: {
				...
				filter: function (event, player) {
					...
					if (info.type != 'basic' && (!info || info.type != 'trick' || info.notarget || (info.selectTarget && info.selectTarget != 1))) return false;
					if (event.targets && !info.multitarget) {
						if (game.hasPlayer(function (current) {
							return !event.targets.contains(current) && lib.filter.targetEnabled2(card, player, current) && get.distance(player, current) == get.distance(player, event.targets[0]);
						})) {
							return true;
						}
					}
				...
				content: function () {
					'step 0'
					player.chooseTarget(get.prompt('dczhitu'), [1, Infinity], (card, player, target) => {
						var player = _status.event.player, targets = _status.event.targets;
						return !targets.includes(target) && lib.filter.targetEnabled2(_status.event.card, player, target) && get.distance(player, target) == get.distance(target, player);
					}).set('prompt2', `为${get.translation(trigger.card)}增加任意个你与其距离相等的目标`).set('ai', target => {
					...
					'step 2'
					if (event.targets) {
						player.logSkill('dczhitu', event.targets);
			...
			dcfujue: {
				...
				content: function () {
					...
					'step 1'
					var num = player.countCards('he') - 5;
					if (num == 0) event.finish();
					else if (num < 0) player.draw(-num);
					else player.chooseToDiscard('he', num, true);
					'step 2'
					var lose = player.getHistory('lose', evt => evt.getParent(3) == 'dcfujue');
					var gain1 = player.getHistory('gain', evt => evt.getParent(2) == 'dcfujue');
					var gain2 = game.getGlobalHistory('cardMove', evt => evt.parent.name == 'equip' && evt.player == player && evt.getParent(2) == 'dcfujue');
					if (lose && gain1 || lose && gain2) {
						player.addTempSkill('dcfujue_effect');
						player.addMark('dcfujue_effect', 1, false);
					}
				},
				subSkill: {
					effect: {
			...
			dcbeiyu: {
				...
				content: function () {
					...
					else player.chooseControl(list).set('prompt', '将一种花色的牌置于牌堆底');
					'step 2'
					...
					player.popup(get.cnNumber(bottom.length) + '张牌置于牌堆底');
			...
			dcduchi: {
				...
				content: function () {
					...
					if (player.countCards("h")) {
						player.showHandcards(get.translation(player) + "发动了【督持】");
			...
			dcxuzhi: {
				...
				usable: 1,
				filter: function (event, player) {
					return game.countPlayer(target => lib.skill.dcxuzhi.filterTarget(null, player, target)) > 1;
				},
				filterTarget: function (card, player, target) {
					return target.countCards('h') > 0 && !target.hasSkill('dcxuzhi_phase');
				},
				selectTarget: 2,
				multiline: true,
				multitarget: true,
				content: function () {
					...
					event.targets.forEach(current => {
						current.addTempSkill('dcxuzhi_phase');
					});
					if (event.targets.some(i => !i.countCards('h'))) return;
					player.chooseCardOL(event.targets, 'h', true, [1, Infinity], '蓄志：选择任意张手牌并与对方交换')
						.set('ai', card => {
							var player = _status.event.player, target = _status.event.getParent(2).targets.find(i => i != player);
							var eff1 = eff2 = 0;
							if (player.hasUseTarget({ name: 'sha' }, false)) {
								eff1 = Math.max(...game.filterPlayer(current => player.canUse({ name: 'sha' }, current, false)).map(current => {
									return get.effect(current, { name: 'sha' }, player, player);
								}));
							}
							if (target.hasUseTarget({ name: 'sha' }, false)) {
								eff2 = Math.max(...game.filterPlayer(current => target.canUse({ name: 'sha' }, current, false)).map(current => {
									return get.effect(current, { name: 'sha' }, player, player);
								}));
							}
							return 5 + 2 * get.sgn(eff1 - eff2) - get.value(card);
						});
					'step 1'
					event.cards = [result[0].cards, result[1].cards];
					event.targets[0].swapHandcards(event.targets[1], event.cards[0], event.cards[1]);
					'step 2'
					if (event.cards[0].length == event.cards[1].length) {
						player.draw(2);
						player.getStat('skill').dcxuzhi--;
					} else {
						var aim = event.targets[event.cards[0].length > event.cards[1].length ? 0 : 1];
						if (aim.hasUseTarget({ name: 'sha' }, false)) {
							aim.chooseUseTarget({ name: 'sha' }, true, false, 'nodistance');
						}
					}
				},
				subSkill: {
			...
			dcfazhu: {
				...
				content: function () {
					'step 0'
					player.chooseButton([1, Infinity], ['选择重铸区域内任意非伤害牌', player.getCards('hej', function (card) {
						return !get.tag(card, 'damage');
					})], false);
					'step 1'
					if (result.bool) {
						player.logSkill('dcfazhu');
						player.chongzhu(result.links);
					}
					else event.finish();
					'step 2'
					event.cards = player.getHistory('gain', e => {
						return e.getParent().name == 'chongzhu' && e.getParent(2).name == 'dcfazhu'
					})[0].getParent().gain;
					event.selected = [];
					'step 3'
					if (event.cards && player.countCards('h', (c) => {
						return event.cards.contains(c)
					})) {
						player.chooseCardTarget({
							prompt: '请选择【筏铸】的牌和目标',
							prompt2: '将一张牌交给一名其他角色，然后其可以使用一张【杀】',
							filterCard: function (card) {
								return _status.event.getParent().cards.contains(card);
							},
							forced: false,
							filterTarget: function (card, player, target) {
								return !_status.event.getParent().selected.contains(target);
							},
							ai1: function (card) {
					...
					if (result.bool) {
						...
						event.selected.push(target);
						target.chooseToUse('是否使用一张【杀】？', function (card, player, event) {
			...
			dczhenfeng: {
				...
				filter: function (event, player) {
					return _status.currentPhase == event.player && event.player != player && event.player.countCards('h') <= event.player.hp;
				},
				content: function () {
					'step 0'
					var list = [];
					for (var i = 0; i < trigger.player.countCards('h') + 1; i++) {
						list.push([i, '有' + i + '张牌']);
					}
					player.chooseButton([get.prompt('dczhenfeng'),
					'猜测当前回合角色手牌中' + get.translation(get.type2(trigger.card)) + '牌的数量',
					[list, 'textbutton']]).set('ai', function (button) {
						var player = _status.event.player;
						var target = _status.currentPhase;
						var card = _status.event.getTrigger().card;
						var check;
						if (Math.random() > 0.8) check = -1;
						else check = 1;
						if (button.link == target.getCards('h', { type: get.type2(card) }).length) return player.storage.dczhenfeng * check;
						return 0.2;
					}).set('selectButton', 1);
					'step 1'
					if (result.bool) {
						var chang = trigger.player.getCards('h', { type: get.type(trigger.card) });
						if (chang.length == result.links) {
							player.addMark('dczhenfeng');
							event.goto(2);
						}
						else {
							player.removeMark('dczhenfeng', player.countMark('dczhenfeng'));
							if (Math.abs(result.links - chang.length) > 1) {
								event.goto(4);
							}
							else event.finish();
						}
					...
					'step 2'
					player.draw(Math.min(player.countMark('dczhenfeng'), 5));
			...
			dcqingbei: {
				...
				mod: {
					cardEnabled: function (card, player) {
						if (player.storage.dcqingbei.contains(get.suit(card))) return false;
					}
				},
				mark: true,
				marktext: '擎北',
				...
				filter: function (event, player) {
					return player.storage.dcqingbei.length > 0;
				},
				content: function () {
					player.draw(player.storage.dcqingbei.length);
				},
				group: 'dcqingbei_collect',
				subSkill: {
					collect: {
						audio: 'dcqingbei',
						direct: true,
						init: function (player) {
							if (!player.storage.dcqingbei) player.storage.dcqingbei = [];
						},
						trigger: { global: 'roundStart' },
						content: function () {
							'step 0'
							player.storage.dcqingbei = [];
							'step 1'
							player.chooseButton([get.prompt('dcqingbei'), [[
								['heart', '♥'],
								['club', '♣'],
								['diamond', '♦'],
								['spade', '♠'],
								...
								if (tao.length > 0 && player.maxHp - player.hp > 1 && (button.link == 'heart' || button.link == 'diamond')) return -0.8;
								if (player.hp > 2 && (button.link == 'club' || button.link == 'spade')) return -0.3;
								if (player.hp <= 2 && (button.link == 'heart' || button.link == 'diamond')) return -1;
								return 2;
							}).set('selectButton', [1, 4]);
							'step 2'
							if (result.bool) {
								player.logSkill('dcqingbei');
								player.storage.dcqingbei = result.links;
								game.log(player, '本轮不能使用', result.links, '花色的牌');
							}
						},
					},
				},
			...
			dckangli: {
				...
				locked: false,
				content: function () {
					player.draw(2).gaintag = ['dckangli'];
				},
				ai: {
					maixie: true,
				},
				group: 'dckangli_clear',
				subSkill: {
					clear: {
						...
						content: function () {
							var cards = player.getCards('h', function (card) {
								return card.hasGaintag('dckangli');
							});
			...
			dctongwei: {
				...
				popname: true,
				init: function (player) {
					player.storage.dctongwei = [];
					player.storage.dctongwei2 = '';
				},
				check: function (card) {
					var num = 6.5;
				...
				content: function () {
					...
					var list = [];
					for (var i = 0; i < cards.length; i++) {
						list.push(get.number(cards[i]));
					}
					list.sort(function (a, b) {
						return a - b;
					})
					player.storage.dctongwei = list;
					'step 1'
					player.loseToDiscardpile(cards);
					player.draw(cards.length);
					'step 2'
					player.addSkill('dctongwei_attack');
					player.storage.dctongwei2 = target;
				},
				subSkill: {
					attack: {
						trigger: {
						...
						filter: function (event, player) {
							return event.player == player.storage.dctongwei2;
						},
						...
						content: function () {
							'step 0'
							if (get.number(trigger.card) < player.storage.dctongwei[0] || get.number(trigger.card) > player.storage.dctongwei[1]) event.goto(3);
							else event.goto(1);
							'step 1'
							var target = player.storage.dctongwei2;
							var list = [];
							if (player.canUse('sha', target)) list.push('sha');
							if (player.canUse('guohe', target)) list.push('guohe');
							if (list.length == 1) event._result = { control: list[0] };
							else player.chooseControl(list).set('prompt', '视为对' + get.translation(target) + '使用').set('ai', function () {
								var player = _status.event.player, target = _status.event.getParent()._trigger.player;
								var eff1 = get.effect(target, { name: 'sha' }, player, player), eff2 = get.effect(target, { name: 'guohe' }, player, player);
								return eff1 > eff2 ? 0 : 1;
							});
							'step 2'
							player.useCard({ name: result.control, isCard: false }, player.storage.dctongwei2, false);
							'step 3'
							player.removeSkill('dctongwei_attack');
						},
					},
				},
				ai: {
			...
			dccuguo: {
				...
				init: function (player) {
					player.storage.dccuguo = true;
					player.storage.dccuguo2 = {};
				},
				filter: function (event, player) {
					return event.card && player.storage.dccuguo == true;
				},
				forced: true,
				content: function () {
					'step 0'
					...
					player.storage.dccuguo = false;
					'step 1'
					if (player.canUse(player.storage.dccuguo2.name, trigger.target)) {
						player.useCard({ name: player.storage.dccuguo2.name, isCard: false }, trigger.target, false);
					}
				},
				group: ['dccuguo_after', 'dccuguo_attack'],
				subSkill: {
					attack: {
						trigger: { player: ['shaMiss', 'eventNeutralized'] },
						forced: true,
						...
						popup: false,
						filter: function (event, player) {
							return event.getParent(2).name == 'dccuguo';
						},
						content: function () {
							player.loseHp();
						}
			...
			shuojian: {
				...
				content: function () {
					...
					'step 1'
					var num = 4 - get.skillCount('shuojian');
					event.num = num;
					event.num2 = num;
			...
			duwang: {
				...
				mod: {
					globalFrom: function (from, to, distance) {
						if (from.getExpansions('duwang').length > 0)
							return distance + 1;
					},
					globalTo: function (from, to, distance) {
						if (to.getExpansions('duwang').length > 0)
							return distance + 1;
					}
				},
			},
			...
			lkbushi: {
				...
				content: function () {
					...
					next.set('processAI', function () {
						...
						list.randomSort();
						list2.addArray(list);
						console.log([list2.map((i) => ['', '', 'lukai_' + i])])
			...
			xinbenxi: {
				...
				ai: {
					...
					skillTagFilter: function (player, tag, arg) {
						...
						if (arg.card && arg.card.name != 'sha' && arg.card.name != 'chuqibuyi') return false;
			...
			xinyaoming: {
				...
				content: function () {
					...
					player.chooseTarget(get.prompt2('xinyaoming'), function (card, player, target) {
						...
						if (s.contains('弃牌') && s.contains('制衡') && s.contains('摸牌')) return false;
						if (s.contains('制衡')) return target != player;
						return true;
					}).ai = function (target) {
						var player = _status.event.player;
					...
					if (result.bool) {
						...
						event.list = [];
						if (!player.storage.xinyaoming.contains('制衡')) {
							event.list.push('令其弃置至多两张牌并摸等量牌');
						}
						if (!player.storage.xinyaoming.contains('弃牌') && target != player) {
							event.list.push('弃置其一张手牌');
						}
						if (!player.storage.xinyaoming.contains('摸牌') && target != player) {
							event.list.push('令其摸一张牌');
						}
						player.chooseControl().set('choiceList', event.list).set('ai', function () {
							if (get.attitude(player, event.target) < 0) return '弃置一名其他角色的一张手牌';
							else if (get.attitude(player, event.target) > 0 && event.target.countCards('he') > 2) return '令一名角色弃置至多两张牌并摸等量牌';
							else return '令一名其他角色摸一张牌';
						});
					} else event.finish();
					'step 2'
					if (event.list[result.index] == "令其摸一张牌") {
						player.storage.xinyaoming.push('摸牌');
						target.draw();
						event.finish();
					} else if (event.list[result.index] == "令其弃置至多两张牌并摸等量牌") {
						player.storage.xinyaoming.push('制衡');
						target.chooseToDiscard('he', '弃置一到两张牌，然后摸等量的牌', true, [1, 2]).ai = lib.skill.zhiheng.check;
					} else if (event.list[result.index] == "弃置其一张手牌") {
						player.storage.xinyaoming.push('弃牌');
			...
			yanyu2: {
				...
				filter: function (event, player) {
					return player.getHistory('lose', function (evt) {
						return evt.cards[0].name == 'sha' && evt.getParent(2).name == 'chongzhu' && evt.getParent(3).name == 'yanyu' && evt.getParent(6).name == 'phaseUse';
					}).length >= 2;
				},
				content: function () {
					'step 0'
			...
			qianxi: {
				...
				ai: {
					...
					skillTagFilter: function (player, tag, arg) {
						...
						if (arg.card && arg.card.name == 'sha') return arg.target.storage.qianxi2 == 'red' && (!arg.target.getEquip('bagua') || player.hasSkillTag('unequip', false, {
							name: arg.card ? arg.card.name : null,
							target: arg.target,
							card: arg.card
						}) || player.hasSkillTag('unequip_ai', false, {
			...
			bingyi: {
				...
				content: function () {
					...
					if (lib.skill.bingyi.filterx(trigger, player)) {
						player.chooseTarget(get.prompt('bingyi'), '展示所有手牌，并令至多' + get.cnNumber(player.countCards('h')) + '名角色各摸一张牌', [1, player.countCards('h')], function (card, player, target) {
							return true;
						}).set('ai', function (target) {
							return get.attitude(_status.event.player, target);
						});
