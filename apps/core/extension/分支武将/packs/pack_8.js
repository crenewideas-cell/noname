// Extracted from character/huicui.js; legacy startup and engine/UI patches are not executed.
export default function(lib, game, ui, get, ai, _status) {
return {
"character": {
			dc_sp_zhurong: ["female", "qun", 4, ["dcmanhou"]],
			yue_miheng: ['male', 'qun', 3, ['dcyuejigu', 'dcyuesirui']],
			yue_zoushi: ['female', 'qun', 3, ['dcyueyunzheng', 'dcyuehuoxin']],
			dc_kongrong: ['male', 'qun', 3, ['dcmingshi', 'lirang']],
			dc_jiangwanfeiyi: ['male', 'shu', 3, ['shengxi', 'dcshoucheng']],
			yue_daqiao: ['female', 'wu', 3, ['dcyueqiqin', 'dcyuezixi']],
			yue_xiaoqiao: ['female', 'wu', 3, ['dcyueqiqin', 'dcyueweiwan']],
			mengyou: ['male', 'qun', 5, ['hmmanyi', 'dcmanzhi'], []],
		},
"characterSort": {
			huicui: {
				sp_baigei: [],
				sp_caizijiaren: [ 'dc_kongrong'],
				sp_zhilan: [],
				sp_guixin: [],
				sp_daihan: [],
				sp_jianghu: [],
				...
				sp_jishi: [],
				sp_raoting: [],
				sp_yijun: [ 'mengyou', 'dc_sp_zhurong'],
				sp_zhengyin: [ 'yue_xiaoqiao', 'yue_daqiao', 'yue_zoushi', 'yue_miheng'],
			}
		},
"characterFilter": {
		},
"characterTitle": {
			dc_zhangmancheng: 'DC·群英荟萃',
			dc_lingcao: 'DC·群英荟萃',
			dc_lifeng: 'DC·群英荟萃',
		},
"characterIntro": {
			wupu: '吴普，三国时期医药学家，名医华佗弟子。<br>吴普以华佗所创五禽戏进行养生锻炼，因获长寿，“年九十余，耳目聪明，齿牙完坚”。吴普的主要成就在本草学上，所撰《吴普本草》六卷，又名《吴氏本草》，为《神农本草经》古辑注本之一，流行于世达数百年，后代有不少子书引述其内容',
			dc_jiangwanfeiyi: '蒋琬，字公琰，费祎，字文伟。诸葛亮、董允、蒋琬、费祎合称“蜀汉四相”。<br>蒋琬在刘备平定蜀地之后被任命为广都县的县令。但有一次刘备出巡时却发现蒋琬不理政务、醉酒不醒。刘备大怒，要处死蒋琬，被慧眼识才的诸葛亮劝下。<br>诸葛亮对蒋琬非常器重，诸葛亮北伐时，蒋琬与长史张裔统丞相府一切事务，诸葛亮给刘禅的密表中也称如果臣出了意外，军国大事可全部托给蒋琬。<br>诸葛亮死后，费祎起初与董允一起被立为太子舍人，太子舍人从汉代开始担任者多为德行高尚之人，以其品行影响太子，可见费祎为人。<br>诸葛亮对费祎非常器重，诸葛亮征南回来之时，特别邀请费祎和他同坐一车并让他出使东吴重申盟好。费祎到了东吴后，酒宴上孙权和诸葛恪为首的东吴群臣，多次发难，费祎对答如流，无有失误，使孙权对费祎也甚表器重。<br>费祎辅政期间功勋卓著，曾击退曹爽。与诸葛亮、姜维不同，费祎主张敬守社稷、休养生息。延熙十六年，蜀汉岁首大会时被魏国降将郭循所刺杀。',
			liuli: '刘理，字奉孝，涿郡涿县人，三国时期蜀汉昭烈帝刘备之子，蜀汉后主刘禅、甘陵王刘永异母弟。章武元年，刘备称帝，派司徒许靖封刘理为梁王，后娶马超之女为妻。建兴八年，改封为安平王。刘理生性坦荡直率，有侠义之风，尚武且心系百姓，主张以武立国、以仁治国。',
			dc_yuezhoufei: '周妃，周瑜与小乔之女，生卒年不祥，一名为周彻，貌美贤淑，精通音律，善弹箜篌。<br>黄武四年，孙权为时年十七岁的王太子孙登聘娶她为太子妃，两人举行了极为隆重的婚礼。太常程秉负责主持婚礼，亲自以《关雎》教导孙登夫妇之道，在吴郡迎接周妃，一起乘大船顺江而上到武昌。孙权为表重视，也亲临程秉的船上，对周妃极为优待礼遇。周妃婚后与孙登装瑟调和，与孙权二女孙鲁班、孙鲁育交好，她的两位兄弟周循和周辙也受到优待，先后娶了公主孙鲁班和宗室女为妻。',
...
"translate": {
			...
			dc_caiyang: '蔡阳',
			dcxunji: '寻嫉',
			dcxunji_info: '出牌阶段限一次，你可以选择一名其他角色。该角色的下个结束阶段开始时，若其于该回合内使用过黑色牌，则你视为对其使用一张【决斗】，且当此【决斗】对其造成伤害后，你失去等量的体力。',
			dcjiaofeng: '交锋',
			...
			dcshuhe: '数合',
			dcshuhe_info: '出牌阶段限一次，你可以展示一张手牌。若场上有与此牌点数相同的牌，则你获得这些牌，然后“列候”的额外摸牌数+1（不能超过5）；否则你将此牌交给一名其他角色并获得一枚“爵”。',
			dcliehou: '列侯',
			...
			dc_yuejiu: '乐就',
			dccuijin: '催进',
			dccuijin_info: '当你或你攻击范围内的角色使用【杀】或【决斗】时，你可以弃置一张牌，令此【杀】的伤害基数+1。然后当此杀被目标角色抵消或无效或防止伤害后，你摸两张牌，并对使用者造成1点伤害。',
			panghui: '庞会',
			dcyiyong: '异勇',
			dcyiyong_info: '当你对其他角色造成伤害时，若你有牌，你可以与其同时弃置至少一张牌。若你以此法弃置的牌的点数之和：不大于其，你摸X+1张牌；不小于其，此伤害+1（X为其以此法弃置的牌数）。',
			dcsuchou: "夙仇",
			dcsuchou_hp: "失去1点体力",
			dcsuchou_maxHp: "减1点体力上限",
			...
			dcsaowei: '扫围',
			dcsaowei_info: '当一名其他角色使用【杀】结算结束后，若此牌的目标角色不包含你且均在你的攻击范围内，你可以将一张“隘”当做【杀】对所有目标角色使用。若此【杀】造成伤害，你获得此牌。',
			...
			zhangchu: '张楚',
			dcjizhong: '集众',
			dcjizhong_info: '出牌阶段限一次。你可以令一名其他角色摸两张牌，然后其选择一项：1.若其没有“信众”标记，其获得“信众”标记；2.你获得其三张手牌。',
			dcrihui: '日彗',
			dcrihui_info: '每回合限一次。当你使用普通锦囊牌或黑色基本牌结算结束后，若此牌的目标数为1且目标不为你，且其：没有“信众”，则所有有“信众”的角色依次视为对其使用一张与此牌牌名和属性相同的牌；有“信众”，则你可以获得其区域里的一张牌。',
			dcguangshi: '光噬',
			dcguangshi_info: '锁定技，准备阶段，若所有其他角色均有“信众”标记，你摸X张牌(X为全场“信众”数)，然后你失去1点体力。',
			dongwan: "董绾",
			dcshengdu: "生妒",
			...
			yuanyin: '袁胤',
			dcmoshou: '墨守',
			dcmoshou_info: '当你成为黑色牌的目标后，你可以摸体力上限张牌，然后你下次发动此技能时，摸牌数-1，若你以此法摸牌数为1，则你将摸牌数改为你的体力上限。',
			dcyunjiu: '运柩',
			dcyunjiu_info: '一名角色死亡后，你可以将其此次弃置的其中一张牌交给一名其他角色。然后你加1点体力上限并回复1点体力。',
			gaoxiang: '高翔',
			dcchiying: '驰应',
			...
			dczuowei: '作威',
			dczuowei_info: '当你于回合内使用牌时，你可以根据你的手牌数执行对应效果：大于X，令此牌不可被响应；等于X，对一名其他角色造成1点伤害；小于X，摸两张牌并令此选项于本回合失效（X为你装备区里牌的数量且至少为1）。',
			liuchongluojun: '刘宠骆俊',
			dcminze: "悯泽",
			...
			dclingkong: '灵箜',
			dclingkongx: '灵箜',
			dclingkong_info: '锁定技，游戏开始时，你的初始手牌增加“箜篌”标记且不计入手牌上限。当你于一回合内首次于摸牌阶段外得到牌后，你将这些牌标记为“箜篌”牌。',
			dcxianshu: '贤淑',
			dcxianshu_info: '出牌阶段，你可以展示一张“箜篌”牌并交给一名其他角色，然后，你摸X张牌（X为你与该角色体力值之差且至多为5）。若此牌为红色，且该角色体力值小于等于你，该角色回复1点体力；若此牌为黑色，且该角色体力值大于等于你，该角色失去1点体力。',
			dc_kuaiqi: '蒯祺',
			dcliangxiu: '良秀',
			dcliangxiu_info: '出牌阶段，你可以弃置两张不同类型的牌，然后从牌堆中将两张与你弃置牌类型均不同的牌交给任意角色（每种类型的牌限一次）。',
			dcxunjie: '殉节',
			dcxunjie_info: '每个回合结束时，若你本回合于非摸牌阶段获得过手牌，你可以令一名角色将手牌调整至等于其体力值或将体力值调整至等于其手牌数（每项每轮限一次）。',
			dc_jiachong: '贾充',
			dcbeini: '悖逆',
			dcbeini_info: '出牌阶段限一次，你可以将手牌调整至体力上限张，然后令一名角色视为对另一名角色使用一张【杀】，这两名角色的非锁定技于本回合失效。',
			dcshizong: '恃纵',
			dcshizong2: '恃纵',
			dcshizong_info: '当你需要使用一张基本牌时，你可交给一名其他角色X张牌（X为此技能本回合发动次数），然后其可将一张牌置于牌堆底，视为你使用之。若其不为当前回合角色，此技能失效直到本回合结束。',
			dc_lingcao: '凌操',
			dcdufeng: '独锋',
			dcdufeng_info: '锁定技，出牌阶段开始时，你需选择至少1项：①失去一点体力；②废除一个装备栏，然后你摸X张牌，你的攻击范围与出牌阶段使用【杀】的次数均改为X。（ X为你废除的装备栏数与损失的体力值之和且最多为你的体力上限）。',
			yue_xiaoqiao: '乐小乔',
			dcyueqiqin: '绮琴',
			dcyueqiqin_info: '锁定技，游戏开始时，你的初始手牌标记为“琴”且不计入手牌上限。准备阶段，你获得弃牌堆中所有“琴”。',
			dcyueweiwan: '媦婉',
			dcyueweiwan_info: '出牌阶段限一次，你可以弃置一张“琴”并选择一名其他角色，随机获得其区域内与此牌花色不同的牌各一张，若你获得牌数为：一，其失去1点体力；二，你本回合对其使用牌无距离及次数限制；三，你本回合无法对其使用牌。',
			yue_daqiao: '乐大乔',
			dcyuezixi: '姊希',
			dcyuezixi_info: '出牌阶段开始时和结束时，你可以声明一个延时锦囊牌名，并将一张“琴”置于一名角色的判定区，此“琴”离开其判定区前，其不能成为对应延时锦囊牌的目标。当你使用基本牌或普通锦囊牌指定唯一目标后，可以根据其判定区内牌数获得对应效果：一张：此牌额外结算一次；两张：你摸两张牌；三张：弃置其判定区所有牌并对其造成3点伤害。 ',
			dcyuezixi_card: '姊希',
			dcyuezixi_card_info: '',
			dc_liuli: '刘理',
			dcfuli: "抚黎",
			dcfuli_info: "出牌阶段限一次，你可以展示所有手牌，选择其中有的一种类别全部弃置（每种类别每回合限一次）然后摸x张牌（x为所有弃置的牌的牌名称字数之和且不能超过全场手牌数最多角色的手牌数），然后你可以令一名角色攻击范围-1直到你的下个回合开始时。若你因此弃置了伤害牌，则你可以令一名角色攻击范围减至零直到你的下个回合开始时。",
			dcdehua: "德化",
			dcdehua_info: "锁定技，每轮游戏开始时，你选择一张你仍可以使用的伤害牌牌名，你视为使用此牌，然后本局游戏你不能再使用手牌中相同牌名的牌：你的手牌上限增加你依此法选择的伤害牌牌名数量。所有伤害牌均被选择后，你失去“德化”。然后本局游戏你的伤害牌不计手牌上限。",
			dc_jiangwanfeiyi: '蒋琬费祎',
			dcshoucheng: '守成',
			dcshoucheng_info: '每回合限一次，当一名角色于其回合外失去最后的手牌时，你可以令其摸两张牌。',
			dc_kongrong: '孔融',
			dcmingshi: '名士',
			dcmingshi_info: '锁定技，当你受到伤害时，若伤害来源的手牌数大于你，其选择一项：1.弃置一张手牌；2.令此伤害-1。',
			dc_caofang: '曹芳',
			dczhimin: '置民',
			dczhimin_info: '锁定技，每轮开始时，选择至多X名其他角色，然后你获得这些角色点数最小的一张手牌（X为当前体力）。你回合外获得的手牌增加“民”标记，你失去“民”牌后将手牌补至体力上限。',
			dcjujian: '拒谏',
			dcjujian_info: '主公技，出牌阶段限一次，你可令一名其他魏势力角色摸一张牌，若如此做，则本轮内其使用普通锦囊牌对你无效。',
			dc_gongsunxiu: '公孙修',
			dcgangu: '干蛊',
			dcgangu_info: '锁定技，每名角色的回合限一次，当其他角色失去体力后，你摸三张牌并失去1点体力。',
			dckuizhen: '溃阵',
			dckuizhen_info: '出牌阶段限一次，你可以令一名手牌数或体力值大于等于你的角色视为对你使用一张【决斗】。若你因此受到伤害，你观看其手牌并获得其中所有【杀】，且这些【杀】无次数限制；若你未因此受到伤害，其失去1点体力。 ',
			dc_lifeng: '李丰',
			dctunchu: '囤储',
			dctunchu_info: '锁定技，分发手牌时，共发你游戏人数四倍的牌。你的手牌不能弃置和被弃置。准备阶段，若你的手牌数大于体力值，你本回合至多使用三张牌。',
			dcshuliang: '输粮',
			dcshuliang_info: '每个回合结束时，你可以交给任意名没有手牌的其他角色各一张牌。若此牌可指定该角色自己为目标，则其可使用之。',
			dc_wupu: '吴普',
			dcduanti: '锻体',
			dcduanti_info: '锁定技，当你每使用或打出五张牌后，你回复1点体力，加1点体力上限（至多加5点）。',
			dcshicao: '识草',
			dcshicao_info: '出牌阶段，你可以声明一种类别，从牌堆顶或牌堆底摸一张牌。若此牌与你声明的类别不同，你观看另一端两张牌，然后此技能本回合失效。',
			dc_pangshanmin: '庞山民',
			dccaisi: '才思',
			dccaisi_info: '当你在回合内/回合外使用基本牌后，你可以从牌堆/弃牌堆获得1张随机的非基本牌。每次发动该技能后，若发动次数：小于等于体力上限：本回合下次获得牌张数翻倍；大于体力上限：本回合此技能失效。',
			dczhuoli: '擢吏',
			dczhuoli_info: '锁定技，每个回合结束时，若你本回合使用牌或获得牌的张数大于体力值，你增加一点体力上限并回复一点体力（体力上限不能超过游戏开始时人数）。',
			yue_zoushi: '乐邹氏',
			dcyueyunzheng: '韵筝',
			dcyueyunzheng_info: '锁定技，游戏开始时，你的初始手牌增加"筝"标记且不计入手牌上限，手牌有“筝"的角色非锁定技失效。',
			dcyuehuoxin: '惑心',
			dcyuehuoxin_info: '锁定技，当你使用非装备牌时，你可以展示一名其他角色的一张手牌并标记为“筝”。若此牌与你使用牌花色相同或已被标记过，你获得之。',
			yue_miheng: '乐祢衡',
			dcyuejigu: '激鼓',
			dcyuejigu_info: '锁定技，游戏开始时，你将初始手牌标记为“激鼓”且不计入手牌上限。每轮限X次（X为已开始过回合的角色数），当你造成或受到伤害后，若你的“激鼓”数等于你装备区内的牌数，你摸等同于你空置的装备栏数的牌。',
			dcyuesirui: '思锐',
			dcyuesirui_info: '出牌阶段限一次，你可以将一张牌当与此牌名字数相等的基本牌或普通锦囊牌使用（无距离与次数限制）。',
			dc_hansong: "韩嵩",
			dcyinbi: "隐避",
			...
			dc_mateng: '马腾',
			dcxiongyi: '雄异',
			dcxiongyi_info: '限定技，出牌阶段，你可以与一名其他角色各摸三张牌。若你的体力值全场唯一最小，你回复1点体力。然后当你脱离濒死状态后，你复原此技能且删去回复体力的效果。',
			dcxiongyi2: '雄异',
			dcxiongyi2_info: '限定技，出牌阶段，你可以与一名其他角色各摸三张牌。然后当你脱离濒死状态后，你复原此技能。',
			dc_huangwudie: "黄舞蝶",
			dcshuangrui: "双锐",
			dcshuangrui_info: "准备阶段，你可以选择一名其他角色，视为对其使用一张【杀】。若其：不在你攻击范围内，此杀不可响应，你获得〖狩星〗直到回合结束；在你攻击范围内，此杀伤害+1，你获得〖铩雪〗直到回合结束。",
			dcfuxie: "伏械",
			dcfuxie_info: "出牌阶段，你可以弃置一张武器牌或移除一个技能，令一名其他角色弃置两张手牌。",
			dcshouxing: "狩星",
			dcshouxing_info: "你可以将X张牌当一张不计次数的【杀】对一名攻击范围外的角色使用（X为你计算与该角色的距离）。",
			dcshaxue: "铩雪",
			dcshaxue_info: "当你对其他角色造成伤害后，你可以摸两张牌然后弃X张牌（X为你计算与该角色的距离）。",
			yue_diaochan: "乐貂蝉",
			dctanban_tag: "已选择",
			dctanban: "檀板",
			dctanban_info: "锁定技，游戏开始时，你的初始手牌增加“檀板”标记且不计入手牌上限。摸牌阶段结束时，你可以交换手中“檀板”与非“檀板”的标记。",
			dcdiou: "低讴",
			dcdiou_info: "你使用“檀板”结算后，可以展示1张手中的非“檀板＂，然后视为使用之。若此牌为本回合首次展示或与你使用的牌的牌名相同，你摸2张牌。",
			yue_zhouyu: '乐周瑜',
			dcguyin: '顾音',
			dcguyin_info: '锁定技，你没有初始手牌，其他角色的初始手牌+1。其他角色的初始手牌被使用或弃置进入弃牌堆后，你摸一张牌。',
			dcpinglu: '平虏',
			dcpinglu_info: '出牌阶段，你可以获得攻击范围内每名其他角色各一张随机手牌。你此阶段不能再发动该技能直到这些牌离开你的手牌。',
			dc_dongzhao: '董昭',
			dcyijia: '移驾',
			dcyijia_info: '当一名距离1以内的角色受到伤害后，你可以将场上的一张装备牌移至其装备区（可替换原装备）。若其因此脱离了一名角色的攻击范围，你摸一张牌。',
			dcdingji: '定基',
			dcdingji_info: '准备阶段，你可以令一名角色将手牌摸至或弃置至五张，然后其展示所有手牌，若牌名均不同，该角色可以视为使用其中的一张基本牌或普通锦囊牌。',
			dc_sp_menghuo: 'SP孟获',
			dcmanwang: '蛮王',
			...
			dc_panghong: "庞宏",
	        dcpingzhi: "评骘",
	        dcpingzhi_info: "转换技，出牌阶段限一次，你可以观看一名角色手牌并选择其中一张牌，阳：你弃置此牌，其视为对你使用【火攻】，若未造成伤害此技能视为未使用；阴：其使用此牌，若造成伤害则此技能视为未使用。",
	        dcgangjian: "刚简",
...
"skill": {
			...
			dcpingzhi: {
				...
				intro: {
					content(storage) {
						if (!storage) return "转换技，出牌阶段限一次，你可以观看一名角色手牌并选择其中一张牌，你弃置此牌，其视为对你使用【火攻】，若未造成伤害此技能视为未使用";
						return "转换技，出牌阶段限一次，你可以观看一名角色手牌并选择其中一张牌，其使用此牌，若造成伤害则此技能视为未使用。";
					},
				},
				content: function () {
					'step 0'
					player.changeZhuanhuanji("dcpingzhi");
					player.choosePlayerCard(target, 'h', 'visible', true, '选择其中一张牌');
					'step 1'
					if (result.bool) {
					...
					if (player.storage.dcpingzhi) {
						target.discard(event.card).set("discarder", player);
						var cardx = {
							name: "huogong",
							isCard: true
						};
						target.useCard(cardx, player, false, 'dcpingzhi');
					} else {
						if (target.hasUseTarget(event.card, true))
							target.chooseUseTarget(event.card, true);
					}
					'step 3'
					if (!player.storage.dcpingzhi && target.hasHistory('sourceDamage', function (evt) {
			...
			dcgangjian: {
				...
				filter(event, player) {
					...
					return player.hasMark("dcgangjian");
				},
				content(event, trigger, player) {
					player.draw(Math.min(player.countMark('dcgangjian'), 5));
				},
				group: ['dcgangjian_record', 'dcgangjian_clear'],
				subSkill: {
					record: {
						trigger: {
							global: 'showCardsEnd'
				...
				ai: {
					...
					result: {
						player: function (player, target) {
							...
							if (player.getStat('skill').dcmanwang && player.hasSkill('dcpanqin')) return 0;
							return 1;
						},
					},
				},
			...
			dcyijia: {
				...
				filter: function (event, player) {
					...
					return game.filterPlayer(target => target != event.player && lib.skill.dcyijia.filterEquip(event, player, target));
				},
				filterEquip: function (event, player, target) {
					return target.getCards('e').filter(cardx => !event.player.isDisabled(parseInt(get.info(cardx).subtype.replace(/equip/g, ''))) && lib.filter.canBeDiscarded(cardx, player, event.player));
				},
				prompt2: function (event, player) {
				...
				content: function () {
					'step 0'
					var target = this.trigger.player;
					event.inRangeList = game.filterPlayer(current => current.inRange(target));
					player.chooseTarget(get.prompt('dcyijia'), (card, player, targetx) => {
						return targetx != target && lib.skill.dcyijia.filterEquip(_status.event, player, targetx);
					}).set('ai', () => {
						var player = _status.event.player;
						return get.attitude(player, target) < 0 ? get.attitude(player, target) : 0;
					});
					'step 1'
					if (result.bool) {
						var targetx = result.targets[0];
						player.choosePlayerCard('e', true, function (button) {
							return get.value(button.link) * get.effect(targetx, button.link, player, player);
						}, targetx);
					}
					'step 2'
					if (result.bool) {
						trigger.player.equip(result.links[0]);
						var leave = event.inRangeList.some(current => !current.inRange(trigger.player));
						if (leave) player.draw();
					}
				},
				ai: {
					maixie: true,
			...
			dcdingji: {
				...
				content: function () {
					'step 0'
					player.chooseTarget(get.prompt2('dcdingji')).set('ai', target => {
					...
					if (result.bool) {
						...
						const delta = 5 - target.countCards('h');
						if (delta != 0) {
							target[delta > 0 ? 'draw' : 'chooseToDiscard'](Math.abs(delta), true);
						}
						...
						if (hasSame) return event.finish();
							...
							var list = hs.filter(i => ['trick', 'basic'].includes(get.type(i)));
							if (!list.length) event.finish();
							player.chooseButton(['是否视为使用其中一张牌？', list])
			...
			dcguyin: {
				...
				group: ['dcguyin_start', 'dcguyin_draw'],
				subSkill: {
					start: {
						audio: 'dcguyin',
						trigger: {
						...
						content: function () {
							...
							player._start_cards = [];
							if (!player._start_cards_dcguyin) player._start_cards_dcguyin = [];
							for (var target of game.filterPlayer(current => current != player)) {
								var cards = target.getCards('h');
								player._start_cards_dcguyin.push(...cards);
							};
						},
					},
					draw: {
						...
						filter: function (event, player) {
							...
							} else if (event.type != 'discard' || event.getlx === false) return false;
							return event.getd()
								.some(card => {
									return player._start_cards_dcguyin.includes(card);
								});
						},
						forced: true,
						content: function () {
			...
			dcpinglu: {
				...
				enable: 'phaseUse',
				filter: function (event, player) {
					if (player.countCards('h', card => card.hasGaintag('dcpinglu')) > 0) return false;
					return game.hasPlayer(target => {
						return lib.skill.dcpinglu.filterTarget(null, player, target);
					});
				},
				...
				content: function () {
					...
					for (var target of targets) {
						var cardx = target.getCards('h', card => {
					...
					'step 1'
					player.addGaintag(event.cards, 'dcpinglu');
					player.addTempSkill('dcpinglu_clear');
				},
				ai: {
					order: 10,
					result: {
				...
				subSkill: {
					clear: {
						...
						charlotte: true,
						content: function () {
							player.removeGaintag('dcpinglu');
							player.removeSkill('dcpinglu_clear');
						},
					},
				},
			},
			...
			dctanban: {
				...
				subSkill: {
					restore: {
						...
						filter: function (event, player) {
							var cards = player.getCards("h", card => card.hasGaintag("dctanban"));
							var cards1 = player.getCards("h", card => !card.hasGaintag("dctanban"));
							return cards.length > 0 && cards1.length > 0;
						},
						prompt2(event, player) {
							return "交换手中“檀板”与非“檀板”的标记";
						},
						content: function () {
							var cards = player.getCards("h", card => card.hasGaintag("dctanban"));
							var cards1 = player.getCards("h", card => !card.hasGaintag("dctanban"));
							if (cards.length) {
								player.removeGaintag('dctanban', cards);
							}
							if (cards1.length) {
								player.addGaintag(cards1, 'dctanban');
							}
						},
					},
				},
			...
			dcdiou: {
				...
				content: function () {
					"step 0"
					player.chooseCard(get.prompt2("dcdiou"), "你可以选择一张非“檀板＂牌，然后视为使用之", (card, player) => {
						return !card.hasGaintag("dctanban");
					}).set("ai", card => {
						var player = _status.event.player;
						return player.getUseValue(card) + (get.effect(player, { name: "draw" }, player, player));
					});
					"step 1"
					if (result.bool) {
						player.showCards(result.cards, get.translation(player) + "发动了【低讴】");
						var card = { name: get.name(result.cards[0]), isCard: true };
						if (get.type(result.cards[0]) !== "equip" && get.type(result.cards[0]) !== "delay" && player.hasUseTarget(result.cards[0])) player.chooseUseTarget(card, false);
						if (!result.cards[0].hasGaintag("dctanban_tag") || result.cards[0].name == trigger.card.name) {
							player.draw(2);
							player.addGaintag(result.cards[0], 'dctanban_tag');
						}
					}
				},
				subSkill: {
					...
					1: {
						...
						popup: false,
						content: function () {
							var cards = player.getCards("h", card => card.hasGaintag("dctanban_tag"));
							if (cards.length) {
								player.removeGaintag('dctanban_tag', cards);
							}
						},
					},
				},
			...
			dcshuangrui: {
				...
				direct: true,
				prompt2: function (event, player) {
					return "你可以选择一名其他角色，视为对其使用一张【杀】。若其：不在你攻击范围内，此【杀】不可响应，你获得“狩星”直到回合结束；在你攻击范围内，此【杀】伤害+1，你获得“铩雪”直到回合结束。";
				},
				content: function () {
					"step 0"
					player.chooseTarget(get.prompt("dcshuangrui"), "你可以视为对一名其他角色使用一张【杀】", function (card, player, target) {
					...
					"step 1"
					if (result.bool) {
						player.useCard({ name: 'sha', isCard: true }, result.targets[0], false, 'dcshuangrui');
						if (player.inRange(result.targets[0])) {
							player.addTempSkill("dcshuangrui_1");
							player.addTempSkill("dcshaxue");
						}
						if (!player.inRange(result.targets[0])) {
							player.addTempSkill("dcshuangrui_2");
							player.addTempSkill("dcshouxing");
						}
					}
				},
				group: ["dcshuangrui_3"],
				...
				subSkill: {
					1: {
						...
						content: function () {
							trigger.num++;
							player.removeSkill("dcshuangrui_1");
						},
					},
					2: {
						trigger: {
						...
						content: function () {
							...
							player.removeSkill("dcshuangrui_2");
						},
					},
					3: {
						trigger: {
			...
			dcfuxie: {
				...
				prompt2: function (event, player) {
					if (player.countCards('e')) return "你可以弃置一张武器牌或移除一个技能，令一名其他角色弃置两张手牌。";
					return "你可以移除一个技能，令一名其他角色弃置两张手牌。";
				},
				selectCard: [0, 1],
				filterTarget: function (card, player, target) {
					if (player == target) return false;
				...
				content: function () {
					...
					if (cards.length == 0) {
						...
						if (skills.length == 1) event._result = { control: skills[0] };
						...
						})).set('displayIndex', false).set('prompt', '伏械：选择失去一个技能').set('ai', () => {
							...
							if (choices.contains('dcshaxue')) return 'dcshaxue';
							if (choices.contains('dcshouxing')) return 'dcshouxing';
					...
					"step 2"
					target.chooseToDiscard(get.prompt('dcfuxie'), '请弃置2张牌', 'h', 2, true);
			...
			dcshouxing: {
				...
				audio: 2,
				filter: function (event, player) {
					return game.hasPlayer(play => player.countCards('he') > get.distance(player, play) && !player.inRange(play));
				},
				filterTarget: function (card, player, target) {
					if (player == target && !ui.selected.cards || ui.selected.cards.length == 0) return false;
					return get.distance(player, target) == ui.selected.cards.length && !player.inRange(target);
				},
				filterCard: true,
				selectCard: [1, Infinity],
				check: function (card) {
				...
				ai: {
					...
					skillTagFilter: function (player, tag, arg) {
						if (arg && arg.name == 'sha' && arg.card && arg.card.storage && arg.card.storage.dcshouxing) return true;
						return false;
					}
				},
				group: ["dcshouxing_sha"],
				subSkill: {
					sha: {
						trigger: {
							player: "useCardBegin",
						...
						filter: function (event, player) {
							return get.name(event.card) == 'sha' && event.skill == 'dcshouxing';
						},
						direct: true,
						silent: true,
						charlotte: true,
			...
			dcshaxue: {
				...
				prompt2: function (event, player) {
					var num = get.distance(player, event.player);
					if (get.distance(player, event.player) > 0) return "你可以摸2张牌，然后弃置" + num + "张牌"; return "你可以摸2张牌";
				},
				content: function () {
					"step 0"
					player.draw(2);
					"step 1"
					if (player.countCards('he') && get.distance(player, trigger.player) > 0) {
						var num = get.distance(player, trigger.player);
						player.chooseToDiscard(get.prompt('dcshaxue'), '请弃置' + get.cnNumber(num) + '张牌', 'he', num, true);
					}
				},
			},
			//马腾
			dcxiongyi: {
				...
				init: function (player, skill) {
					...
					player.addSkill('dcxiongyi_risutoa');
				},
				subSkill: {
					risutoa: {
						charlotte: true,
						...
						content: function () {
							if (player.awakenedSkills.contains('dcxiongyi')) {
								player.addSkill('dcxiongyi2');
								player.addSkill('dcxiongyi2_risutoa');
								player.removeSkill('dcxiongyi');
			...
			dcxiongyi2: {
				...
				subSkill: {
					risutoa: {
						...
						trigger: { player: 'dyingAfter' },
						content: function () {
							if (player.awakenedSkills.contains('dcxiongyi2')) {
								player.restoreSkill('dcxiongyi2');
								game.log(player, '重置了', '#g【雄异】');
							}
						}
					},
			...
			dcmanhou: {
				...
				content: function () {
					...
					list.push('cancel2');
					event.map = map;
					player.chooseControl(list).set('prompt', get.prompt2('dcmanhou'));
					'step 1'
					if (result.control != 'cancel2') {
						player.logSkill('dcmanhou');
						var num = event.map[result.control] || 1;
						event.num = num;
						player.draw(num);
					}
					'step 2'
					if (num >= 1) player.removeSkill('dctanluan');
					if (num >= 2 && player.countCards("h")) player.chooseToDiscard("h", true);
			...
			dctanluan: {
				...
				content: function () {
					...
					const num1 = game.filterPlayer(current => !trigger.targets.includes(current)).length;
					if (num >= num1 && trigger.targets.some(current => current.countDiscardableCards(player, "ej"))) {
						player.chooseTarget(get.prompt("dctanluan"), (card, player, target) => {
						...
						player.addTempSkill("dctanluan_effect");
						player.addMark('dctanluan_effect', 1, false);
					}
					'step 1'
					if (result.bool) {
				...
				subSkill: {
					effect: {
						...
						content: function () {
							'step 0'
							var num = player.countMark('dctanluan_effect');
							player.removeSkill('dctanluan_effect');
							...
							if (!filter(trigger, player)) event.finish();
								...
								trigger.player.chooseTarget(get.prompt('dctanluan_effect'), prompt, [1, num], function (card, player, target) {
									var player = _status.event.player;
							...
							'step 2'
							player.logSkill('dctanluan_effect', result.targets);
				...
				mod: {
					...
					maxHandcard: function (player, num) {
						...
						game.players.forEach(p => {
							if (p != player && p.getHandcardLimit() > n) n = p.getHandcardLimit();
						})
						return n;
					},
				},
			...
			dcshuaiyan: {
				...
				content: function () {
					...
					player.chooseControl().set('choiceList', [
						'弃置' + get.translation(trigger.player) + '的一张牌',
						'摸一张牌'
					]).set('ai', function () {
						if (get.attitude(_status.event.player, trigger.player) > 0) return '选项二';
						return '选项一';
					});
					"step 1"
					if (result.index === 0) {
			...
			dcyuejigu: {
				...
				content: function () {
					var cards = player.getCards('h');
					player.addGaintag(cards, 'dcyuejigu');
				},
				mod: {
					ignoredHandcard: function (card, player) {
						if (card.hasGaintag('dcyuejigu')) {
							return true;
						}
					},
					cardDiscardable: function (card, player, name) {
						if (name == 'phaseDiscard' && card.hasGaintag('dcyuejigu')) {
							return false;
						}
					},
				...
				group: ['dcyuejigu_1', 'dcyuejigu_2', 'dcyuejigu_3'],
				subSkill: {
					air: { charlotte: true, },
					1: {
						audio: 2,
						...
						forced: true,
						filter: function (event, player) {
							if (player.countMark('dcyuejigu') >= player.countMark('dcyuesirui')) return false;
							var num = 0;
							for (var i of player.getCards('h')) {
								if (i.hasGaintag('dcyuejigu')) num++;
							}
							return num == player.countCards('e');
						},
						content: function () {
							player.draw(5 - player.countDisabled() - player.countCards('e'));
							player.addMark('dcyuejigu', 1);
						}
					},
					2: {
						...
						charlotte: true,
						content: function () {
							player.removeMark('dcyuejigu', player.countMark('dcyuejigu'), false);
						}
					},
					3: {
						...
						charlotte: true,
						filter: function (event, player) {
							return !event.player.hasSkill('dcyuejigu_air');
						},
						content: function () {
							trigger.player.addSkill('dcyuejigu_air');
							player.addMark('dcyuesirui', 1);
						}
					}
				}
			},
			dcyuesirui: {
				...
				usable: 1,
				filter: function (event, player) {
					return event.type != 'respondShan' && player.countCards('he') > 0;
				},
				hiddenCard: function (player, name) {
					return lib.inpile.contains(name) && get.has.handcardStrNum(player.getCards('he')).contains(get.translation(name).length);
				},
				chooseButton: {
					dialog: function (event, player) {
						var list = [];
						var list2 = get.has.handcardStrNum(player.getCards('he'));
						for (var i = 0; i < lib.inpile.length; i++) {
							var name = lib.inpile[i];
							if (!list2.includes(get.translation(name).length)) continue;
							if (name == 'sha') {
								list.push(['基本', '', 'sha']);
						...
						if (list.length == 0) {
							return ui.create.dialog('思锐已无可用牌');
						}
					...
					backup: function (links, player) {
						return {
							audio: 'dcyuesirui',
							filterCard: function (card) {
								return get.translation(get.name(card)).length == get.translation(lib.skill.dcyuesirui_backup.viewAs.name).length;
							},
							selectCard: 1,
							popname: true,
							check: function (card) {
				...
				mod: {
					targetInRange: function (card, player, target) {
						if (card.dcyuesirui) return true;
					},
				},
				ai: {
			...
			dcyueyunzheng: {
				...
				content: function () {
					var cards = player.getCards('h');
					player.addGaintag(cards, 'dcyueyunzheng');
				},
				mod: {
					ignoredHandcard: function (card, player) {
						if (card.hasGaintag('dcyueyunzheng')) {
							return true;
						}
					},
					cardDiscardable: function (card, player, name) {
						if (name == 'phaseDiscard' && card.hasGaintag('dcyueyunzheng')) {
							return false;
						}
					},
				},
				global: 'dcyueyunzheng_g',
				subSkill: {
					g: {
						trigger: {
							player: "loseAfter",
						...
						content: function () {
							var check = false;
							for (var i of player.getCards('h')) {
								if (i.hasGaintag('dcyueyunzheng')) check = true;
							}
							if (check) player.addSkill('dcyueyunzheng_f');
							else player.removeSkill('dcyueyunzheng_f');
						}
					},
					f: {
						init: function (player, skill) {
						...
						skillBlocker: function (skill, player) {
							return !lib.skill[skill].charlotte && !get.is.locked(skill, player) && !lib.skill[skill].forever;
						},
						mark: true,
						intro: {
			...
			dcyuehuoxin: {
				...
				content: function () {
					'step 0'
					player.chooseTarget(get.prompt2('dcyuehuoxin'), (card, player, target) => {
					...
					if (result.bool) {
						var target = result.targets[0];
						event.target = target;
						player.choosePlayerCard(target, '选择' + get.translation(target) + '一张牌', 1, 'h', true);
					}
					'step 2'
					if (result.bool) {
						player.logSkill('dcyuehuoxin', target);
					...
					'step 3'
					if (event.card.hasGaintag('dcyueyunzheng') || get.suit(trigger.card) == get.suit(event.card)) {
						player.gain(event.card, 'giveAuto', 'bySelf').set("gaintag", ["dcyueyunzheng"]);
					}
					else event.card.addGaintag('dcyueyunzheng')
					'step 4'
					var check = false;
					for (var i of target.getCards('h')) {
						if (i.hasGaintag('dcyueyunzheng')) check = true;
					}
					if (check) target.addSkill('dcyueyunzheng_f');
					else target.removeSkill('dcyueyunzheng_f');
				}
			},
			dccaisi: {
				audio: 2,
				init: function (player) {
					player.storage.dccaisi = 1;
				},
				mark: true,
				intro: {
					content: '本回合下次摸牌数为#',
				...
				trigger: { player: 'useCardAfter' },
				filter: function (event, player) {
					return event.card && get.type(event.card) == 'basic' && !player.hasSkill('dccaisi_f');
				},
				content: function () {
					'step 0'
					var list = [];
					if (_status.currentPhase == player) {
						while (list.length < player.storage.dccaisi) {
							var card = get.cardPile2(function (i) {
								return get.type(i) != 'basic' && !list.contains(i);
							});
							if (!card) break;
							else list.push(card);
						}
					...
					var a = player.getHistory('useSkill', s => {
						return s.skill == 'dccaisi';
					}).length;
					if (a <= player.maxHp) player.storage.dccaisi = player.storage.dccaisi * 2;
					else player.addTempSkill('dccaisi_f', 'phaseEnd')
				},
				group: 'dccaisi_1',
				subSkill: {
					f: { charlotte: true },
			...
			dczhuoli: {
				...
				priority: 1,
				init: function (player) {
					player.storage.dczhuoli = game.players.length;
				},
				filter: function (event, player) {
					var u = 0, g = 0;
					player.getHistory('gain', (ga) => {
						if (ga.cards) g += ga.cards.length;
					})
					player.getHistory('useCard', (us) => {
						if (us.cards) u += us.cards.length;
					})
					return (u > player.hp || g > player.hp) && player.maxHp <= player.storage.dczhuoli;
				},
				content: function () {
					player.gainMaxHp();
					player.recover();
			...
			dcduanti: {
				...
				init: function (player) {
					player.storage.dcduanti = 0;
					player.storage.dcduanti2 = 0;
				},
				filter: function (event, player) {
					return event.cards && event.cards.length && player.storage.dcduanti2 < 5;
				},
				intro: {
				...
				content: function () {
					'step 0'
					player.storage.dcduanti += trigger.cards.length
					player.markSkill('dcduanti');
					'step 1'
					if (player.storage.dcduanti >= 5) {
						player.storage.dcduanti -= 5;
						player.storage.dcduanti2++;
						player.gainMaxHp();
						player.recover();
						event.goto(1);
					}
					if (player.storage.dcduanti2 >= 5) player.unmarkSkill('dcduanti');
				}
			},
			dcshicao: {
				audio: 2,
				enable: 'phaseUse',
				filter: function (event, player) {
					return !player.hasSkill('dcshicao_f');
				},
				content: function () {
					'step 0'
					player.chooseControl('基本牌', '锦囊牌', '装备牌').set('prompt', '声明一种类别').set('ai', function () {
						return ["基本牌", "锦囊牌", "装备牌"].randomGet();
					});
					'step 1'
					var type;
					switch (result.control) {
						case '基本牌': type = 'basic'; break;
						case '锦囊牌': type = 'trick'; break;
						case '装备牌': type = 'equip'; break;
					}
					event.dcshicaoType = type;
					player.chooseControl('牌堆顶', '牌堆底').set('prompt', '选择一端摸1张牌');
					'step 2'
				...
				subSkill: {
					d: {
						...
						direct: true,
						filter: function (event, player) {
							return event.cards && event.cards.length && event.getParent(1) && event.getParent(1).name == 'draw' && event.getParent(2) && event.getParent(2).name == 'dcshicao';
						},
						content: function () {
							'step 0'
							var type = get.type(trigger.cards[0]);
							if (type == trigger.getParent(2).dcshicaoType) event.finish();
							'step 1'
							if (trigger.getParent(2).dcshicaoP == 'top') {
								var cards = get.cards(2, 'bottom');
								player.chooseButton(['观看牌堆底2张牌', cards.slice()], 0, true);
								for (var i of cards) {
								...
								player.chooseButton(['观看牌堆顶2张牌', cards.slice()], 0, true);
								for (var i of cards) {
									ui.cardPile.insertBefore(i, ui.cardPile.firstChild);
								}
							}
							player.addTempSkill('dcshicao_f');
						}
					},
					f: {},
				},
			...
			dctunchu: {
				...
				forced: true,
				filter: function (event, player) {
					return (event.name != 'phase' || game.phaseNumber == 0) && player.countCards('h') < game.players.length * 4;
				},
				content: function () {
					var me = player;
					var numx = trigger.num;
				...
				subSkill: {
					1: {
						trigger: { player: 'phaseZhunbeiBegin' },
						forced: true,
						filter: function (event, player) { return player.countCards('h') > player.hp },
						content: function () { player.addTempSkill('dctunchu_2', 'phaseEnd') }
					},
					2: {
						mod: {
							cardEnabled: function (card, player) {
								if (player.getHistory('useCard').length >= 3) return false;
							},
			...
			dcshuliang: {
				...
				filter: function (event, player) {
					return game.hasPlayer(p => {
						return p != player && p.countCards('h') == 0;
					})
				},
				forced: true,
				locked: false,
				content: function () {
					...
					'step 1'
					if (game.hasPlayer(p => {
						return p != player && p.countCards('h') == 0 && !event.given.includes(p);
					})) player.chooseCardTarget({
						prompt2: '将一张牌交给一名没有手牌的其他角色',
						filterCard: true,
						selectCard: 1,
						position: 'h',
						filterTarget: function (card, player, target) {
							return target != player && target.countCards('h') == 0 && !event.given.includes(target);
						},
						ai1: function (card) {
							return 8 - get.value(card);
						},
					...
					if (result.bool) {
						...
						target.gain(card, 'giveAuto').giver = player;
						player.line(target, 'red');
						if (target.canUse(card, target, true)) target.useCard(card, target, false);
						event.given.add(target);
						event.goto(1);
					}
				},
				ai: {
			...
			dcgangu: {
				...
				filter: function (event, player) {
					if (player.getHistory('useSkill', (e) => {
						e.skill == 'dcgangu'
			...
			dckuizhen: {
				...
				filter: function (event, player) {
					return game.hasPlayer(function (c) {
						return (c.countCards('h') >= player.countCards('h') || c.hp >= player.hp) && c.canUse({ name: 'juedou' }, player);
					})
				},
				filterTarget: function (card, player, target) {
					return (target.countCards('h') >= player.countCards('h') || target.hp >= player.hp) && target.canUse({ name: 'juedou' }, player);
				},
				content: function () {
				...
				mod: {
					cardUsable: function (card, player) {
						...
						if (card.cards[0].hasGaintag('dckuizhen')) return Infinity;
					},
				},
				ai: {
					order: 8,
					...
					result: {
						player: function (player, target) {
							var eff = 0;
							if (target.countCards('h') < player.countCards('h')) eff += 2;
							if (player.hp > 2) eff += player.hp / 3;
							return eff + get.effect(player, { name: 'juedou', isCard: true }, target, player);
						},
						target: function (card, player, target) {
							if (card.name == 'juedou') return [0.75, 0.35];
						},
					}
				},
				group: ['dckuizhen_d', 'dckuizhen_u'],
				subSkill: {
					d: {
						direct: true,
						...
						filter: function (event, player) {
							...
							return source &&
								...
								event.getParent(3) &&
								event.getParent(3).name == 'dckuizhen';
						},
						content: function () {
							var source = trigger.source;
							var cards = source.getCards('h');
							player.chooseControl('ok').set('dialog', [get.translation(source) + '的手牌', cards]);
							var list = cards.filter(card => card.name == 'sha');
							if (list.length) {
								player.gain(list, 'giveAuto', 'bySelf').gaintag.add('dckuizhen');
							}
						}
					},
					...
					u: {
						...
						filter: function (event, player) {
							return event.card.name == 'juedou' && event.getParent().name == 'dckuizhen' && !player.hasHistory('damage', (e) => {
								return e.card.name == 'juedou' && e.getParent(3).name == 'dckuizhen' && e.card == event.card;
							}) && event.getParent().target != player;
						},
						content: function () {
							trigger.getParent().target.loseHp();
						}
					}
				}
			},
			dczhimin: {
				...
				filter: function (event, player) {
					return game.hasPlayer((c) => {
						return c.countCards('h') > 0;
					})
				},
				forced: true,
				content: function () {
					'step 0'
					player.chooseTarget('选择至多' + player.hp + '名角色获得其手牌', [1, player.hp], function (card, player, target) {
						return target != player && target.countCards('h') > 0;
					}).set('ai', function (target) {
						var eff = -get.attitude(_status.event.player, target);
						if (target.countCards('h')) eff += 2;
						return eff;
					});
					'step 1'
					if (result.bool) {
						event.zhiminTargets = result.targets;
					}
					else event.finish();
					'step 2'
					var current = event.zhiminTargets.shift();
					var list = [];
					current.countCards('h', function (c) {
						var num = get.number(c, player);
						if (!current.hasCard(card2 => {
							return c != card2 && get.number(card2, player) < num;
						})) list.push(c);
					})
					if (list.length) {
						player.gain(list.randomGet(), current, 'giveAuto', 'bySelf').gaintag = ['dczhimin'];
					}
					'step 3'
					if (event.zhiminTargets.length) event.goto(2);
				},
				mod: {
					aiOrder: function (player, card, num) {
						if (get.itemtype(card) == 'card' && card.hasGaintag('dczhimin') && player.maxHp - player.countCards('h') < 0) num - (player.maxHp - player.countCards('h')) * 2;
					},
					aiValue: function (player, card, num) {
						if (get.itemtype(card) == 'card' && card.hasGaintag('dczhimin')) num + 5;
					}
				},
				group: ['dczhimin_l', 'dczhimin_g'],
				subSkill: {
					l: {
						trigger: {
							player: "loseAfter",
						...
						filter: function (event, player) {
							...
							if (event.name == 'lose') {
								for (var i in event.gaintag_map) {
									if (event.gaintag_map[i].contains('dczhimin')) return true;
								}
								return false;
							}
							return player.hasHistory('lose', function (evt) {
								...
								for (var i in evt.gaintag_map) {
									if (evt.gaintag_map[i].contains('dczhimin')) return true;
								}
								return false;
							});
						},
			...
			dcjujian: {
				...
				zhuSkill: true,
				filter: function (event, player) {
					if (!player.hasZhuSkill('dcjujian')) return false;
				...
				content: function () {
					target.draw();
					target.addTempSkill('dcjujian_r', { global: 'roundFinish' });
				},
				subSkill: {
					r: {
						trigger: {
						...
						audio: "dcjujian",
						filter: function (event, player) {
							return event.card && get.type(event.card) == 'trick' && event.target && event.target.hasZhuSkill('dcjujian');
						},
						content: function () {
							if (trigger.target.hasZhuSkill('dcjujian')) trigger.getParent().excluded.add(trigger.target);
						},
					}
				},
				ai: {
			...
			dcmingshi: {
				...
				content: function () {
					"step 0"
					trigger.source.chooseToDiscard('弃置一张手牌，否则此伤害对' + get.translation(player) + '-1', 'h').set('ai', function (card) {
						var num = 6, player = _status.event.player;
						num += (player.maxHp - player.hp) / 2;
					...
					effect: {
						target: function (card, player, target) {
							if (get.tag(card, 'damage')) {
								...
								if (player.countCards('h') > target.countCards('h')) return [0.6, -1];
							}
						},
					},
				},
			...
			dcshoucheng: {
				...
				filter: function (event, player) {
					...
					}) && player.getHistory('useSkill', (c) => {
						return c.skill == 'dcshoucheng'
					}).length == 0;
				},
				content: function () {
					"step 0"
					...
					if (target.isIn() && target.countCards('h') == 0) {
						player.chooseBool(get.prompt2('dcshoucheng', target)).set('ai', function () {
			...
			dcfuli: {
				...
				usable: 1,
				filter: function (event, player) {
					return player.hasCard(card => !player.storage.dcfuli.contains(get.type(card, 'trick')), 'h')
				},
				init: function (player) {
					if (!player.storage.dcfuli) player.storage.dcfuli = []
				},
				content: function () {
					'step 0'
					...
					for (let i = 0; i < player.countCards('h'); i++) {
						if (!player.storage.dcfuli.contains(get.type(player.getCards('h')[i], 'trick')) && !list.contains(get.type(player.getCards('h')[i], 'trick'))) list.push(get.type(player.getCards('h')[i], 'trick'))
					};
					player.chooseControl(list).set('prompt', '弃置一种类别的所有手牌');
					'step 2'
					event.num = 0;
					event.num1 = 0;
					var list1 = [];
					player.storage.dcfuli.push(result.control);
					for (let i = 0; i < player.countCards('h'); i++) {
						if (get.type(player.getCards('h')[i], 'trick') == result.control) {
							list1.push(player.getCards('h')[i]);
							event.num += lib.skill.dcweidang.getLength(player.getCards('h')[i]);
							if (get.tag(player.getCards('h')[i], 'damage')) event.num1++;
						}
					};
					player.discard(list1);
					'step 3'
					var list2 = [];
					for (let i = 0; i < game.filterPlayer().length; i++) {
						list2.push(game.filterPlayer()[i].countCards('h'))
					};
					event.num2 = Math.max(...list2);
					player.draw(Math.min(event.num, event.num2));
        /*if(event.num1>0)*/ player.chooseTarget(1, '可令一名角色攻击范围-1直到你的下个回合开始时', function (card, player, target) {
						return true
					}).set('ai', function (target) {
						var player = _status.event.player;
						return -get.attitude(player, target);
					...
					'step 4'
					if (result.targets) {
						result.targets[0].addSkill('dcfulix');
						event.result_target = result.targets[0];
					}
					else event.finish();
					'step 5'
					event.result_target.markSkill('dcfulix');
					event.result_target.storage.dcfulix--;
					event.result_target.storage.dcfuliy = player;
					event.result_target.updateMarks()
					'step 6'
					if (event.num1 > 0) player.chooseTarget(1, '可令一名角色攻击范围减至零直到你的下个回合开始时', function (card, player, target) {
						return true
					}).set('ai', function (target) {
						var player = _status.event.player;
						return -get.attitude(player, target);
					...
					'step 7'
					if (result.targets) {
						result.targets[0].addSkill('dcfuliz');
						event.result_target = result.targets[0];
					}
					else event.finish();
					'step 8'
					event.result_target.markSkill('dcfuliz');
					event.result_target.storage.dcfulix--;
					event.result_target.storage.dcfuliy = player;
					event.result_target.updateMarks()
				},
				...
				subSkill: {
					"1": {
						...
						content: function () {
							for (let i = 0; i < game.filterPlayer().length; i++) {
								game.filterPlayer()[i].removeMark('dcfulix');
								game.filterPlayer()[i].removeSkill('dcfulix')
							}
							for (let i = 0; i < game.filterPlayer().length; i++) {
								game.filterPlayer()[i].removeMark('dcfuliz');
								game.filterPlayer()[i].removeSkill('dcfuliz')
							}
						},
						sub: true,
						popup: false,
			...
			dcdehua: {
				...
				intro: {
					...
					content: function (event, player) {
						return '不能使用手牌中的' + get.translation(player.storage.dcdehua) + '，且手牌上限+' + player.storage.dcdehua.length
					},
				},
				forced: true,
				trigger: {
				...
				init: function (player) {
					if (!player.storage.dcdehua) player.storage.dcdehua = [];
					player.addSkill('dcdehua_1');
				},
				content: function () {
					'step 0'
					var list = lib.inpile.filter(function (i) {
						if (player.storage.dcdehua.contains(i)) return false;
						if (game.filterPlayer(play => player.canUse(i, play, true)).length == 0) return false;
						if (get.tag({ name: i }, 'damage')) return true;
						return false;
					});
					for (var i = 0; i < list.length; i++) {
						list[i] = [get.type(list[i], 'trick'), '', list[i]];
					}
					if (list.length == 0) event.finish()
					else player.chooseButton(true, ['视为使用一张伤害牌', [list, 'vcard']]).set('ai', function (button) {
						return Math.random();
					});
					'step 1'
					...
					event.cardname = name;
					player.storage.dcdehua.push(name);
					player.popup(name);
					game.log(player, '声明了', '#y' + get.translation(name));
					var list1 = lib.inpile.filter(function (i) {
						if (player.storage.dcdehua.contains(i)) return false;
						if (get.tag({ name: i }, 'damage')) return true;
						return false;
					});
					if (list1.length == 0) {
						player.removeSkill('dcdehua');
						player.storage.dcdehua.pop();
						player.addSkill("dcdehua_hand");
					}
					'step 2'
					player.chooseUseTarget(true, '请选择' + get.translation(event.cardname) + '的目标', { name: event.cardname }, false).set('ai', function (target) {
				...
				mod: {
					cardSavable: function (card, player) {
						if (player.storage.dcdehua.contains(card.name) && (get.position(card) == 'h' || card.cards && card.cards.some(i => get.position(i) == 'h'))) return false;
					},
					maxHandcard: function (player, num) {
						if (player.storage.dcdehua && player.storage.dcdehua.length > 0) return num + player.storage.dcdehua.length
					},
				},
				subSkill: {
					"1": {
						mod: {
							...
							aiValue: function (player, card) {
								...
								if (player.storage.dcdehua.contains(get.name(card))) return 0;
							},
							aiUseful: function () {
								return lib.skill.dcdehua_1.mod.aiValue.apply(this, arguments);
							},
						},
						sub: true,
						hand: {
			...
			dcfulix: {
				...
				intro: {
					name: "抚黎",
					content: function (event, player) {
						return '直到' + get.translation(player.storage.dcfuliy) + '下回合开始前，攻击范围' + player.storage.dcfulix
					},
				},
				init: function (player) {
					if (!player.storage.dcfulix) player.storage.dcfulix = 0
				},
				mod: {
					attackRange: function (player, num) {
						return num + player.storage.dcfulix
					},
				},
				onremove: function (player) {
					player.storage.dcfulix = 0
				},
			},
			dcfuliz: {
				mark: true,
				...
				intro: {
					name: "抚黎",
					content: function (event, player) {
						return '直到' + get.translation(player.storage.dcfuliy) + '下回合开始前，攻击范围减至零'
					},
				},
				init: function (player) {
					if (!player.storage.dcfuliz) player.storage.dcfuliz = 0
				},
				mod: {
					attackRange: () => 0,
				},
				onremove: function (player) {
					player.storage.dcfuliz = 0
				},
			},
			dcyuezixi: {
				audio: 2,
				...
				direct: true,
				filter: function (event, player) {
					return player.hasCard(card => card.hasGaintag('dcyueqiqin'), 'he');
				},
				content: function () {
					'step 0'
					var list = [];
					for (var i = 0; i < lib.inpile.length; i++) {
						name = lib.inpile[i];
						if (get.type(name) == 'delay') list.push(name);
					}
					list.push('cancel2');
					player.chooseControl(list).set('prompt', '请声明一张延时锦囊').set('ai', () => {
					...
					if (result.control == 'cancel2') event.finish();
						...
						event.judgeName = result.control;
						player.chooseCardTarget({
							prompt2: '将一张“琴”置于一名角色的判定区',
							filterCard: function (card) {
								return card.hasGaintag('dcyueqiqin');
							},
							forced: true,
							position: 'he',
							filterTarget: function (card, player, target) {
								return target.getCards('j', function (c) {
									return c.judgeName == result.control;
								}).length == 0;
							},
							ai1: function (card) {
								return 8 - get.value(card);
							...
							ai2: function (target) {
								var player = _status.event.player, att = get.attitude(player, target);
								var check = 1;
								if (target.countCards('e') >= 2) check = -1;
								return att * check;
							},
						});
					}
					...
					if (result.bool) {
						var target = result.targets[0];
						player.logSkill('dcyuezixi', target);
						player.line(target, 'green');
						target.addJudge({ name: 'dcyuezixi_card' }, result.cards[0]);
						result.cards[0].judgeName = event.judgeName;
						player.popup(get.translation(event.judgeName));
					}
				},
				global: 'dcyuezixi_forbid',
				group: 'dcyuezixi_sb',
				subSkill: {
					forbid: {
						mod: {
							targetEnabled: function (card, player, target, now) {
								if (target.getCards('j', function (c) {
									return c.judgeName == card.name;
								}).length) return false;
							},
						},
					},
					sb: {
						...
						filter: function (event, player) {
							return event.targets.length == 1 && (get.type(event.card) == 'basic' || get.type(event.card) == 'trick') && event.target.countCards('j');
						},
						content: function () {
							switch (trigger.target.countCards('j')) {
								case 1: trigger.getParent().effectCount++; break;
								case 2: player.draw(2); break;
								case 3:
									trigger.target.lose(trigger.target.getCards('j'));
									trigger.target.damage(3);
									break;
							}
						}
			...
			dcyueqiqin: {
				...
				content: function () {
					var hs = player.getCards('h');
					if (hs.length) player.addGaintag(hs, 'dcyueqiqin');
					for (var i of hs) {
						if (!i.gaintagFixed) i.gaintagFixed = [];
						i.gaintagFixed.push('dcyueqiqin');
					}
				},
				group: 'dcyueqiqin_restore',
				subSkill: {
					restore: {
						audio: 'dcyueqiqin',
						trigger: { player: 'phaseZhunbeiBegin' },
						...
						content: function () {
							var list = [];
							for (let j = 0; j < ui.discardPile.childNodes.length; j++) {
								var card = ui.discardPile.childNodes[j];
								if (card.hasGaintag('dcyueqiqin')) list.push(card);
							}
							if (list.length) {
								player.logSkill('dcyueqiqin');
				...
				mod: {
					ignoredHandcard: function (card, player) {
						if (card.hasGaintag('dcyueqiqin')) {
							return true;
						}
					},
					cardDiscardable: function (card, player, name) {
						if (name == 'phaseDiscard' && card.hasGaintag('dcyueqiqin')) {
							return false;
						}
					},
				},
			...
			dcyueweiwan: {
				...
				usable: 1,
				init: function (player) {
					player.storage.dcyueweiwan = '';
				},
				position: 'he',
				filter: function (event, player) {
					return game.hasPlayer(current => current != player) && player.hasCard(card => card.hasGaintag('dcyueqiqin'), 'he');
				},
				filterCard: function (card) {
					return card.hasGaintag('dcyueqiqin');
				},
				...
				content: function () {
					...
					event.suits = [event.suit];
					event.num = 0;
					player.storage.dcyueweiwan = target;
					'step 1'
					var cardd = target.getCards('he', function (card) {
						return !event.suits.includes(get.suit(card));
					})
					if (cardd.length) {
						var gainx = cardd.randomGet();
						player.gain(gainx, target, 'gain2');
						event.suits.add(get.suit(gainx));
						event.num++;
						event.goto(1);
					}
					'step 2'
					switch (event.num) {
						...
						case 2: player.addTempSkill('dcyueweiwan_sub1', 'phaseEnd'); break;
						case 3: player.addTempSkill('dcyueweiwan_sub2', 'phaseEnd'); break;
					}
				},
				subSkill: {
					sub1: {
						mod: {
							targetInRange: function (card, player, target) {
								if (target == player.storage.dcyueweiwan) return true;
							},
					...
					sub2: {
						mod: {
							playerEnabled: function (card, player, target) {
								if (target == player.storage.dcyueweiwan) return false;
							},
						}
					},
				}
			...
			dcdufeng: {
				...
				content: function (player, event) {
					'step 0'
					var list = [];
					if (player.countDisabled() < 5) list.push('废除一个装备栏');
					list.push('失去一点体力');
					if (player.countDisabled() < 5) list.push('同时选择两项');
					player.chooseControl(list, true).set('ai', function () {
						if (player.countDisabled() < 2 && (player.isDamaged() && player.hp > 3)) return '同时选择两项';
						if (player.hp > 1 || player.countCards('h') < player.hp) return '失去一点体力';
						if (player.countDisabled() < 5 && player.hp <= 1) return '废除一个装备栏';
						return '失去一点体力';
					});
					'step 1'
					if (result.control == '失去一点体力' || result.control == '同时选择两项') {
						player.loseHp();
					}
					if (result.control == '废除一个装备栏' || result.control == '同时选择两项') {
						var listx = [];
						for (var i = 1; i < 6; i++) {
							if (!player.countDisabled(i)) listx.push('equip' + i);
						}
						if (player.countDisabled() < 5) {
							player.chooseToDisable().ai = function (event, player, listx) {
								if (listx.contains('equip5')) return 'equip5';
					...
					var X = num + lostHp;
					var xnum = Math.min(X, player.maxHp);
					player.draw(xnum);
					player.addTempSkill('dcdufeng_use');
					player.addMark('dcdufeng_use', xnum, false);
				},
				subSkill: {
					use: {
						charlotte: true,
						...
						mod: {
							attackRangeBase(player, num) {
								return player.countMark('dcdufeng_use');
							},
							cardUsable(card, player, num) {
								if (card.name == 'sha') return player.countMark('dcdufeng_use');
							},
						},
					}
				},
			...
			dcliangxiu: {
				...
				enable: 'phaseUse',
				init: function (player) {
					if (!player.storage.dcliangxiu) player.storage.dcliangxiu = [];
				},
				filter: function (event, player) {
					return !player.storage.dcliangxiu || (player.storage.dcliangxiu && player.storage.dcliangxiu.length <= 3);
				},
				filterCard: function (card, player) {
					var type = get.type2(card, player);
					if (player.storage.dcliangxiu.length > 0) {
						if (!player.storage.dcliangxiu.contains('basic')) {
							if (get.type2(ui.selected.cards[0]) == 'trick') return type == 'equip' && get.type2(ui.selected.cards[0]) != type;
							if (get.type2(ui.selected.cards[0]) == 'equip') return type == 'trick' && get.type2(ui.selected.cards[0]) != type;
						}
						if (!player.storage.dcliangxiu.contains('trick')) {
							if (get.type2(ui.selected.cards[0]) == 'basic') return type == 'equip' && get.type2(ui.selected.cards[0]) != type;
							if (get.type2(ui.selected.cards[0]) == 'equip') return type == 'basic' && get.type2(ui.selected.cards[0]) != type;
						}
						if (!player.storage.dcliangxiu.contains('equip')) {
							if (get.type2(ui.selected.cards[0]) == 'trick') return type == 'basic' && get.type2(ui.selected.cards[0]) != type;
							if (get.type2(ui.selected.cards[0]) == 'basic') return type == 'trick' && get.type2(ui.selected.cards[0]) != type;
						}
						if (player.storage.dcliangxiu.contains('basic') && player.storage.dcliangxiu.contains('trick') && player.storage.dcliangxiu.contains('equip')) return false;
					}
					return !ui.selected.cards.length || get.type2(ui.selected.cards[0]) != type;
				},
				selectCard: 2,
				complexCard: true,
				prompt: "弃置两张类型不同的牌并获得一张类型均不同的牌",
				position: 'he',
				mark: true,
				intro: {
					content: function (storage, player) {
						if (!storage) return '尚无记录';
						var str = '本回合已获得：';
						for (var i = 0; i < storage.length; i++) {
							if (i != 0) str += '，';
							str += get.translation(storage[i]) + '牌';
						}
						return str;
					}
				},
				content: function () {
					...
					while (list.length < 2) {
						var card = get.cardPile2(function (i) {
							if (list.length == 1) return get.type2(i) != get.type2(cards[0]) && get.type2(i) != get.type2(cards[1]) && i != list[0];
							return get.type2(i) != get.type2(cards[0]) && get.type2(i) != get.type2(cards[1]);
						});
						if (!card) break;
						else list.push(card);
					}
					if (list.length) {
						player.storage.dcliangxiu.add(get.type2(list[0]));

						event.cards = list.slice();
						if (event.cards.length > 1) {
							player.chooseCardButton('将两张牌分配给任意角色', true, event.cards, event.cards.length)
								.set('ai', () => ui.selected.buttons.length ? 0 : 1);
					...
					'step 1'
					if (result && result.bool) {  // 如果选择卡牌成功
						event.togive = result.links.slice(0);  // 保存要分配的卡牌
						player.chooseTarget('将' + get.translation(result.links) + '交给一名角色', true)
							.set('ai', target => {
								var att = get.attitude(_status.event.player, target);
								if (_status.event.enemy) return -att;  // 如果敌对，返回负的态度值
								else if (att > 0) return att / (1 + target.countCards('h'));  // 如果态度积极，考虑目标手牌数
								else return att / 100;  // 否则，按态度值除以100
							})
							.set('enemy', get.value(event.togive[0], player, 'raw') < 0);  // 如果分配的卡牌值为负，则认为敌对
					}

					'step 2'
					if (result && result.targets.length) {  // 如果选择了目标
						result.targets[0].gain(event.togive, 'draw').giver = player;  // 将卡牌授予目标角色
						player.line(result.targets[0], 'green');  // 绘制连接线
						game.log(result.targets[0], '获得了' + get.cnNumber(event.togive.length) + '张', '#g“牌”');  // 记录日志

					}
				},
				group: 'dcliangxiu_sub',
				subSkill: {
					sub: {
						...
						charlotte: true,
						priority: Infinity,
						filter: function (event, player) { return player.storage.dcliangxiu.length > 0 },
						content: function () { player.storage.dcliangxiu.length = 0 },
					}
				}
			},
			dcxunjie: {
				...
				direct: true,
				init: function (player) {
					player.storage.dcxunjie = [];
				},
				content: function () {
					'step 0'
					var list = [];
					if (!player.storage.dcxunjie.includes('1')) list.add('手牌调整至体力');
					if (!player.storage.dcxunjie.includes('2')) list.add('体力调整至手牌');
					if (list.length == 0) event.finish();
					player.chooseControl(list, 'cancel2').set('prompt', '殉节：令一名角色将手牌调整至等于其体力值或将体力值调整至等于其手牌数');
					'step 1'
					if (result.control == 'cancel2') event.finish();
					else {
						event.choose = result.control;
						if (result.control == '手牌调整至体力') player.storage.dcxunjie.add('1');
						else player.storage.dcxunjie.add('2');
						player.chooseTarget('殉节：令一名角色将手牌调整至等于其体力值或将体力值调整至等于其手牌数', 1, true);
					}
					'step 2'
					if (result.bool) {
						var target = result.targets[0];
						...
						if (event.choose == '手牌调整至体力') {
							if (mi > 0) target.draw(mi);
							if (mi < 0) target.chooseToDiscard(-mi, true, 'h');
						}
						else {
							if (mi > 0) target.loseHp(mi);
							if (mi < 0) target.recover(-mi);
						}
					}
				},
				group: 'dcxunjie_sub',
				subSkill: {
					sub: {
						...
						charlotte: true,
						priority: -Infinity,
						filter: function (event, player) { return player.storage.dcxunjie && player.storage.dcxunjie.length > 0 },
						content: function () { player.storage.dcxunjie.length = 0 },
					}
				}
			},
			dclingkong: {
				...
				content: function () {
					var cards = player.getCards('h');
					player.addGaintag(cards, 'dclingkongx');
				},
				mod: {
					ignoredHandcard: function (card, player) {
						if (card.hasGaintag('dclingkongx')) {
							return true;
						}
					},
					cardDiscardable: function (card, player, name) {
						if (name == 'phaseDiscard' && card.hasGaintag('dclingkongx')) {
							return false;
						}
					},
				},
				...
				subSkill: {
					marker: {
						...
						content: function () {
							...
							var card = cards.filter(card => hs.includes(card));
							player.addGaintag(card, 'dclingkongx');
							game.delayx();
						},
					},
				},
			...
			dcxianshu: {
				...
				enable: 'phaseUse',
				filter: (event, player) => {
					return game.hasPlayer(current => current != player) && player.hasCard(card => card.hasGaintag('dclingkongx'), 'h');
				},
				filterCard: (card) => card.hasGaintag('dclingkongx'),
				check: function (card) {
					if (ui.selected.cards.length && ui.selected.cards[0].color == 'black') return 6 - get.value(card);
					if (ui.selected.cards.length && ui.selected.cards[0].color == 'red') return 8 - get.value(card);
				},
				filterTarget: lib.filter.notMe,
				discard: false,
				lose: false,
				...
				content: function () {
					...
					'step 1'
					if (target.isIn()) {
						var num = Math.min(Math.abs(target.hp - player.hp), 5);
						if (num > 0) player.draw(num);
					}
					'step 2'
					if (event.color == 'red') {
						if (target.hp <= player.hp && target.isDamaged()) target.recover();
					}
					else if (event.color == 'black') {
						if (target.hp >= player.hp) target.loseHp();
					}
				},
				ai: {
					order: 5,
					result: {
						target: function (player, target) {
							if (ui.selected.cards.length && ui.selected.cards[0].color == 'black') {
								if (target.hp >= player.hp) return -1;
								if (target.hp < player.hp) return 0.5;
							}
							if (ui.selected.cards.length && ui.selected.cards[0].color == 'red') {
								if (target.hp <= player.hp && target.getDamagedHp()) return 1.5;
								if (target.hp > player.hp) return 1;
							}
						},
					},
			...
			dczuowei: {
				...
				content: function () {
					...
					else if (!player.hasSkill('dczuowei_ban')) player.chooseBool(get.prompt('dczuowei'), '摸两张牌，然后此选项于本回合失效').set('ai', () => 1);
					'step 1'
					...
					else if (!player.hasSkill('dczuowei_ban')) {
						player.logSkill('dczuowei');
						player.draw(2);
			...
			dcmoyu: {
				...
				content: function () {
					...
					player.gainPlayerCard(target, 'hej', true, 1 + player.hasSkill("dcmoyu_add"));
					player.removeSkill("dcmoyu_add");
					'step 1'
					target.chooseToUse(function (card, player, event) {
						if (get.name(card) != 'sha') return false;
						return lib.filter.filterCard.apply(this, arguments);
					}, '是否对' + get.translation(player) + '使用一张【杀】').set('targetRequired', true).set('complexSelect', true).set('filterTarget', function (card, player, target) {
						if (target != _status.event.sourcex && !ui.selected.targets.contains(_status.event.sourcex)) return false;
			...
			dcjizhong: {
				...
				content: function () {
					...
					if (marked) {
						...
						else player.gainPlayerCard(target, 3, true);
					}
					else {
						var list = [];
						var cards = target.getCards('h');
						var choiceList = ['令其获得你的三张手牌', '成为其的信徒'];
						if (cards.length < 3) choiceList[0] = '<span style="opacity:0.5; ">' + choiceList[0] + '</span>';
						else list.push('选项一');
						list.push('选项二');
						target.chooseControl(list).set('choiceList', choiceList).set('prompt', get.translation(player) + '对你发动了【集众】，请选择一项');
					}
					"step 2"
					if (result.control == '选项一') {
						player.gainPlayerCard(target, 3, true);
					} else {
			...
			dcmoshou: {
				...
				init: function (player, skill) {
					if (typeof player.storage[skill] != 'number') player.storage[skill] = player.maxHp;
				},
				filter: function (event, player) {
					return get.color(event.card) == 'black';
				},
				group: "dcmoshou_restore",
				frequent: true,
				prompt2: function (event, player) {
					var num = player.storage.dcmoshou;
					return '你可以摸' + get.cnNumber(num) + '张牌';
				},
				content: function () {
					var num = player.storage.dcmoshou;
					player.draw(num);
					if (num > 1) player.storage.dcmoshou--;
					else player.storage.dcmoshou = player.maxHp;
				...
				intro: {
					markcount: function (storage, player) {
						if (typeof storage != 'number') return player.maxHp;
						return storage;
					},
					content: '下次发动此技能摸$张牌',
				},
				subSkill: {
					restore: {
						...
						filter: function (event, player) {
							return player.storage.dcmoshou != player.maxHp && (event.name != 'phase' || game.phaseNumber == 0);
						},
						content: function () {
							player.storage.dcmoshou = player.maxHp;
						},
					},
				},
			},
			dcyunjiu: {
				...
				content: function () {
					...
					if (!evt) event.finish();
						...
						if (num) {
							player.chooseButton(['是否发动【运柩】', '请选择一张牌交给一名其他角色', cards]).set('ai', function (button) {
								return get.value(button.link, _status.event.player) * game.hasPlayer(p => {
									return get.attitude(p, _status.event.player) > 0;
								});
							});
						}
						else event.finish();
					...
					if (result.bool) {
						var card = result.links[0];
						event.card = card;
						player.chooseTarget('请选择【运柩】的目标', '令一名其他角色获得' + get.translation(card), lib.filter.notMe).set('ai', function (target) {
							var player = _status.event.player;
							return get.attitude(player, target) * get.value(_status.event.card, target) * (target.hasSkillTag('nogain') ? 0.1 : 1);
						}).set('card', card);
					}
					else event.finish();
					'step 2'
					if (result.bool) {
						...
						target.gain(event.card, 'gain2').giver = player;
					}
					else event.finish();
					'step 3'
					player.gainMaxHp();
			...
			dcsaowei: {
				...
				subSkill: {
					damage: {
						...
						popup: false,
						filter: function (event, player) {
							return event.skill == 'dcsaowei';
						},
						content: function () {
							if (player.hasHistory('sourceDamage', function (evt) {
								return evt.card == trigger.card;
							})) {
								player.gain(player.storage.dcsaowei, 'gain2');
								player.storage.dcsaowei = null;
							}
						},
						sub: true,
					},
			...
			dcjuying: {
				...
				filter: function (event, player) {
					var shaCount = player.getHistory('useCard', evt => {
						return evt.getParent('phaseUse') == event && evt.card.name == 'sha' && evt.addCount !== false;
					}).length;

					var jiuCount = player.getHistory('useCard', evt => {
						return evt.getParent('phaseUse') == event && evt.card.name == 'jiu' && evt.addCount !== false;
					}).length;

					var shaUsable = player.getCardUsable('sha', true);
					var jiuUsable = player.getCardUsable('jiu', true);

					return shaCount < shaUsable || jiuCount < jiuUsable;
				},
				direct: true,
				content: function () {
					'step 0'
			...
			dcsuchou: {
				...
				content: function () {
					"step 0"
					player.chooseControl('dcsuchou_hp', 'dcsuchou_maxHp', '失去夙仇', function (event, player) {
						if (player.hp == player.maxHp) return 'dcsuchou_hp';
						if (player.hp < player.maxHp - 1 || player.hp <= 2) return 'dcsuchou_maxHp';
						return '失去夙仇';
					}).set('prompt', '夙仇：失去1点体力或减1点体力上限,本阶段使用牌不可被响应，或失去技能夙仇');
					"step 1"
					if (result.control == 'dcsuchou_hp') {
						player.loseHp();
						player.addTempSkill("dcsuchou_effect", "phaseUseAfter");
					} else if (result.control == 'dcsuchou_maxHp') {
						player.loseMaxHp(true);
						player.addTempSkill("dcsuchou_effect", "phaseUseAfter");
					} else if (result.control == '失去夙仇') {
						player.removeSkill('dcsuchou'); // 移除技能benghuai
					}
				},
				subSkill: {
					effect: {
			...
			dccuijin: {
				...
				content: function () {
					...
					event.target = target;
					player.chooseToDiscard('he', get.prompt('dccuijin', target), '弃置一张牌并令' + get.translation(trigger.player) + '使用的【杀】或【决斗】伤害+1，但若其未造成伤害，则你摸两张牌并对其造成1点伤害。').set('ai', function (card) {
						if (_status.event.goon) return 7 - get.value(card);
						return 0;
					}).set('goon', function () {
						var d1 = true;
			...
			anyong: {
				...
				filter: function (event, player) {
					return event.source && event.source == _status.currentPhase && event.num == 1 &&
						event.player.isIn() && player.countCards('he') > 0 &&
			...
			dcxunji: {
				...
				subSkill: {
					mark: {
						marktext: '嫉',
						intro: { content: '若回合内使用过黑色牌，则蔡阳视为对你使用一张【决斗】' },
					},
					effect: {
						audio: 'dcxunji',
						charlotte: true,
						...
						content: function () {
							...
							var target = trigger.player;
							event.target = target;
							if (target.getHistory('useCard', (e) => {
								return get.color(e.card) == 'black';
							}).length > 0 && player.canUse('juedou', target)) {
			...
			dcbeini: {
				...
				content: function () {
					...
					var num = Math.abs(h - player.maxHp);
					if (h > player.maxHp) {
					...
					targets[1].addTempSkill('fengyin');
					targets[0].useCard({ name: 'sha', isCard: true }, targets[1], 'noai').animate = false;
					game.delay(0.5);
				},
				ai: {
					order: 0.1,
			...
			dcshizong: {
				...
				hiddenCard: function (player, name) {
					...
					return player.countCards('he') >= (player.getStat().skill.dcshizong || 0) + 1;
				},
				filter: function (event, player) {
					if (event.type == 'wuxie' || event.dcshizong) return false;
					if (player.countCards('he') < (player.getStat().skill.dcshizong || 0) + 1) return false;
				...
				chooseButton: {
					dialog: function (event, player) {
						...
						return ui.create.dialog('恃纵', [list, 'vcard'], 'hidden')
					},
					check: function (button) {
					...
					backup: function (links, player) {
						return {
							...
							selectTarget: 1,
							selectCard: function () {
								return (get.player().getStat().skill.dcshizong || 0) + 1;
							},
							viewAs: {
								name: links[0][2],
								nature: links[0][3],
							...
							ai2: function (target) {
								...
								if (value > 0 || player.hp <= 1) return att;
								return -att;
							},
							precontent: function () {
								'step 0'
								event.target = event.result.targets[0];
								player.logSkill('dcshizong', event.target);
								player.give(event.result.cards.slice(0), event.target);
								if (!player.getStat().skill.dcshizong) player.getStat().skill.dcshizong = 0;
								player.getStat().skill.dcshizong++;
								'step 1'
								event.viewAs = ({ name: event.result.card.name, nature: event.result.card.nature, isCard: true });
								event.target.chooseCard('恃纵：是否将一张牌置于牌堆底？', `若如此做，${get.translation(player)}视为使用一张${get.translation(event.viewAs.nature)}【${get.translation(event.viewAs.name)}】`, 'he').set('ai', card => {
									if (_status.event.goon) return 7 - get.value(card);
									return 0;
								}).set('goon', get.attitude(target, player) * (player.getUseValue(event.viewAs) || 1) >= 1);
								'step 2'
								...
								if (result.bool) {
									...
									game.delayex();
									if (get.position(card) == 'e') {
										event.target.lose(card, ui.cardPile, 'visible');
										event.target.$throw(1);
										game.log(event.target, '将', card, '置于了牌堆底');
									}
									else {
										event.target.lose(card, ui.cardPile);
										game.log(event.target, '将一张牌置于了牌堆底');
									}
									game.broadcastAll(viewAs => {
										lib.skill.dcshizong_backup2.viewAs = event.viewAs;
									}, lib.skill.dcshizong_backup.viewAs);
									var evt = event.getParent();
									evt.set('_backupevent', 'dcshizong_backup2');
									evt.set('openskilldialog', `请选择${get.translation(event.viewAs.nature)}${get.translation(event.viewAs.name)}的目标`);
									evt.backup('dcshizong_backup2');
									evt.set('norestore', true);
									evt.goto(0);
								}
								else {
									event.target.chat('不放！');
									game.log(event.target, '选择不将牌置于牌堆底');
									var evt = event.getParent();
					...
					prompt: function (links, player) {
						return `恃纵：选择要交出的牌和目标角色###将${get.cnNumber((player.getStat().skill.dcshizong || 0) + 1)}张牌交给一名其他角色，其可以选择将一张牌置于牌堆底，视为你使用一张${get.translation(links[0][3] || '')}${get.translation(links[0][2])}。`;
					}
				},
				ai: {
					order: function () {
