// Extracted from character/xianding.js; legacy startup and engine/UI patches are not executed.
export default function(lib, game, ui, get, ai, _status) {
return {
"character": {
			dc_wenqin: ['male', 'wei', 4, ['olguangao', 'dchuiqi'], []],
			dc_moqiongshu: ['female', 'wei', 3, ['dcwanchan', 'dcrunzhi']],
			anyanggongzhu: ["female", "wei", 3, ["ersi", "zhenshu"]],
			caoying: ["female", "wei", 4, ["xinfu_lingren", "xinfu_fujian"], []],
			dc_liubian: ['male', 'qun', 3, ['shiyuan', 'dcdushi', 'yuwei'], ['zhu', 'character:liubian']],
			luyi: ['female', 'qun', 3, ['dcyaoyi', 'dcfuxue']],
			huaman: ['female', 'shu', 3, ['hmmanyi', 'mansi', 'souying', 'zhanyuan']],
			zhugeruoxue: ['female', 'wei', 3, ['qiongying', 'nuanhui']],
			zhangqiying: ["female", "qun", 3, ["xinfu_falu", "xinfu_dianhua", "xinfu_zhenyi"], []],
		},
"characterSort": {
			xianding: {
				sp2_qifu: ["zhangqiying", 'caoying'],
				sp2_yinyu: [ 'luyi'],
				sp2_wangzhekejian: [],
				sp2_huben: [ 'dc_wenqin'],
				sp2_shengun: [],
				sp2_jichu: [],
				sp2_bizhe: [],
				sp2_doukou: [ 'huaman', 'dc_moqiongshu', 'anyanggongzhu'],
				sp2_huangjia: [ 'dc_liubian'],
				sp2_zhangtai: [],
				sp2_jinse: [
					'zhugeruoxue'],
				sp2_gaoshan: [],
...
"characterTitle": {
			guansuo: 'DC·限定',
			xin_baosanniang: 'DC·限定',
			caochun: 'DC·限定',
		},
"characterIntro": {
			lvju: '吕据，字世议，汝南细阳人，三国时期吴国将领，大司马吕范次子。太平元年(256年)，吕据率军攻打魏国，途中孙峻已死，孙綝掌权。大怒之下率军返回，意图废除孙綝。孙綝得知后，命文钦、孙宪率兵迎击吕据。吕据自杀，夷三族。孙休即位，得到平反。',
			moqiongshu: '莫琼树，魏文帝曹不宫人，魏宫四美之一。<br>相传莫琼树会梳理一种与众不同的“蝉鬓”发型，即将面颊两旁近耳头的头发梳成薄而翘起的形状。“望之缥缈如蝉翼”，如丝如缎，若天女下凡，令人遐想，宫中的其他女性争相仿效她的发型。',
			anyanggongzhu: "安阳公主，曹氏，生卒年不详，魏武帝曹操之女，母不详。嫁荀彧之子荀恽为妻。曹丕即位后曹氏改称安阳公主。安阳公主生荀甝，荀霬，二子因为是曹丕外甥的原因特受礼遇。",
			liutan: '柳婒，姜维之妻，出身天水书香世家，大家闺秀，自幼熟读诗书，还擅长吹笛子。<br>柳婒与姜维青梅竹马，姜维在魏国时，柳婒便嫁与其为妻。后姜维投蜀，柳婒随姜维来到益州。<br>姜维出征时，柳婒总是吹奏笛子为他送行，曲声婉转，蕴含真情，姜维和而歌，令闻者流泪，以此传为蜀地一桩美谈。',
			bianyue: '卞玥，魏高贵乡公皇后，曹髦之妻。卞玥出身琅琊卞氏，是魏武帝曹操武宣卞皇后的曾孙女，魏元帝卞皇后的侄女。卞氏一门三后，卞玥是其中最小辈，于正元二年被立为皇后。五年后，高贵乡公遇害，陈留王曹奂即位，卞玥被废，司马昭以其无害而得以保全性命。',
			dc_zhenji: '相传甄姬自幼喜爱读书，博闻强识，只要看过的篇目就能够立刻领悟，还多次用她哥哥的笔砚写字，家人常称其为女博士。<br>汉未天下大乱，灾荒连年，当时甄家有大量的谷物储备。甄氏当时才十几岁，看到这种情形便劝说家人将家里的谷物开仓赈济四方乡邻，惠及众人。全家人都认为她说得有道理，于是将家中的粮食全部无偿分发给邻里乡亲。<br>建安年间，袁绍为他的次子袁熙聘娶了甄姬为妻。建安四年，袁熙上任幽州，甄姬则留在邺城侍奉婆婆刘氏，直到建安九年，邺城被曹操攻破，曹操次子曹丕入袁府。',
			caofang: '曹芳，三国时期曹魏第三位皇帝，魏武帝曹操曾孙，任城威王曹彰之孙。<br>魏明帝曹叡病死后曹芳即位，由大将军曹爽和太尉司马懿共同辅政。正始十年，经历高平陵之变，曹爽倒台，政权落入司马氏手中。嘉平六年，中书令李丰和光禄大夫张缉图谋废掉司马师，改立夏侯玄为大将军。司马师平定叛乱后，将曹芳废为齐王',
			zhugemengxue: '诸葛梦雪，诸葛珪长女，诸葛亮的大姐，嫁与荆州蒯氏子蒯祺为妻。另一说其名不详，字为梦雪。诸葛梦雪祖籍徐州，琅邪阳都人氏，诸葛珪死后，全家跟随其叔父诸葛玄来到荆州。诸葛梦雪清丽高冷、外冷内热，自幼饱读诗书，还善奏笛、箫等乐器。后其夫蒯祺迁至方陵太守，为蜀将孟达所害，诸葛梦雪自此归隐山林，不闻其踪。',
			bailingyun: '柏夫人，三国曹魏大臣司马懿的宠姬，是八王之乱时代称帝的赵王司马伦的母亲。',
			caoxian: '曹宪，沛国谯县人。东汉末年历史人物，汉献帝刘协嫔妃，魏武帝曹操女儿。<br>建安十八年（213年），由曹操送入后宫为夫人。次年受封为贵人。黄初元年（220年），兄弟曹丕称帝后，汉献帝成为山阳公，携曹节、曹宪和曹华低调生活。',
			dc_xujing: '许靖，字文休，汝南郡平舆县人，东汉末年至三国时期蜀汉时期重臣、名士、评论家。<br>许靖因与从弟许邵俱以品评人物而闻名于世。后被刘翊推举为孝廉，任尚书郎。曾先后投奔孔仙、陈稀、许贡、王朗等人。于孙策攻王朗前与家属俱避难交州，受到交趾太守士燮礼待。<br>其后受益州牧刘璋邀请，相继为巴郡、广汉、蜀郡太守。于刘各包围成都时欲越墙叛逃，为刘璋所获。刘备定蜀后欲将其弃用，在法正的建议下方以其为左将军长史<br>建安二十三年，刘备称汉中王，任命许靖为汉中王傅。章武元年，刘备称帝，任命许靖为司徒，位列三公。',
			dc_wuluxun: '陆逊，本名陆议，字伯言，吴郡吴县人。三国时期吴国政治家、军事家。<br>建安八年，入孙权集团。建安二十四年。与吕蒙共同击败关羽、夺取荆州。章武二年孙权以陆逊为大都督，在夷陵之战中火烧连营击败刘备，一战成名。黄武七年，陆逊取得石亭之战的胜利。黄龙元年，孙权称帝后，以陆逊为上大将军，辅佐太子孙登并掌管陪都武昌事宜。赤乌七年拜为永相、荆州牧、右都护、总领三公事务，领武昌事。<br>陆逊终年六十三岁，追谥昭侯，后世以其功大拜入武庙。',
			sunlingluan: '孙翎鸾，孙坚与妾室丁氏的女儿，孙策的妹妹，孙权、孙尚香的姐姐。<br>丁氏怀孕时，曾梦见一只五彩孔雀站于枝头，故而取名翎鸾。<br>孙翎年幼时曾得杜夔点化，窥得音律玄妙，丝竹八音，擅长琵琶，每次弹奏琵琶时，经常引来百鸟，称为奇观。<br>早年孙翎鸾出游，山林巧遇葛玄，葛玄观其面相为吉，特传授修行辟谷之法，可令其身心洗涤，容颜久存。<br>孙翎鸾有恋人名张奋，两人情投意合，可惜造化弄人，张奋病死外域，孙翎鸾倚楼盼归，日复一日、年复一年。后有五彩孔雀自东南而来，绕楼而鸣，其声如慕，孙翎鸾泪染笑靥，与孔雀耳语几句后乘翎而去。',
			...
			zhugeruoxue: '诸葛若雪，名不详，字若雪，诸葛珪次女，诸葛亮的二姐，庞山民之妻。（但是对于诸葛若雪这个称呼却还有待考证，史书上并未有明确记载）',
		},
"characterReplace": {
...
"dynamicTranslate": {
			...
			caiyi: function (player) {
				...
				var list1 = ['⒈回复X点体力。', '⒉摸X张牌。', '⒊复原武将牌。', '⒋随机执行一个已经移除过的阴选项；'], list2 = ['⒈受到X点伤害。', '⒉弃置X张牌。', '⒊翻面并横置。', '⒋随机执行一个已经移除过的阳选项。'], str1 = '阳：', str2 = '阴：';
				for (var i = 0; i < 4; i++) {
			...
			dcshoutan: function (player) {
				if (player.storage.dcshoutan) return '转换技，出牌阶段限一次，阳：你可以弃置一张非黑色的手牌。<span class="bluetext">阴：你可以弃置一张黑色手牌。</span>';
			...
			dcshouzhi: function (player) {
				return (player.storage.dcshouzhix ? '' : '锁定技，') + '一名角色的回合结束时，若你的手牌数大于/小于你本回合开始时的手牌数，你' + (player.storage.dcshouzhix ? '可以' : '') + '弃置一张手牌/摸两张牌。'
			}
		},
"translate": {
			puyuan: '蒲元',
			...
			dcyishu: '易数',
			dcyishu_info: '锁定技，当你于出牌阶段外失去牌后，【慧淑】中最小的一个数字+2，最大的一个数字-1。',
			dcligong: '离宫',
			...
			dcshoutan: '手谈',
			dcshoutan_info: '转换技，出牌阶段限一次，阳：你可以弃置一张非黑色手牌。阴：你可以弃置一张黑色手牌。',
			dc_liuye: '刘晔',
			dcpoyuan: '破垣',
			...
			duanqiaoxiao: '段巧笑',
			dccaizhuang: '彩妆',
			dccaizhuang_info: '出牌阶段限一次，你可以弃置任意张牌，然后你连续摸牌摸直到手牌中至少拥有与弃牌花色数相同的花色数。',
			dchuayi: '华衣',
			dchuayi_info: '结束阶段，你可以判定，然后你获得如下效果直到你下回合开始时：红色，每个回合结束时，你摸一张牌；黑色，当你受到伤害后，你摸两张牌。',
			wu_zhugeliang: '武诸葛亮',
			dcjincui: '尽瘁',
			...
			dc_wangjun: '王濬',
			dcchangqu: '长驱',
			dcchangqu_info: '出牌阶段限一次，你可以开一艘战舰(从你的上家或下家起选择任意名连续的其他角色，第一个目标角色获得战舰标记)获得战舰标记的角色需要选择一项：1.交给你X张手牌，然后将战舰标记移动到下个目标；2.下次受到的属性伤害+X，然后横置自身(X为选项一被选择的次数且至少为1)。',
			dctongye: '统业',
			dctongye_info: '锁定技，游戏开始时或一名角色死亡后，若场上势力数：不大于4，你的手牌上限+3；不大于3，你的攻击范围+3；不大于2，你使用【杀】的次数上限+3；不大于1，你回复三点体力。每满足超过一项，你摸牌阶段摸牌额外加+1。',
			dc_tianshangyi: '田尚衣',
			dcposuo: '婆娑',
			...
			dc_wuluxun: '武陆逊',
			dcxiongmu: '雄幕',
			dcxiongmu_info: '每轮开始时，你可以将手牌摸至体力上限，然后将任意张牌随机置入牌堆，从牌堆或弃牌堆中获得等量的点数为8的牌，这些牌不计入你的手牌上限。你每回合受到第一次伤害时，若你的手牌数小于等于体力值，此伤害-1。',
			dcxiongmux: '雄幕',
			dczhangcai: '彰才',
			dczhangcai_info: '你使用或打出点数为8的牌时，可以摸X张牌（X为手牌中剩余点数为8的牌数量且至少为1）。',
			dcruxian: '儒贤',
			dcruxian_info: '限定技，出牌阶段，你可令“彰才”改为所有点数均可触发摸牌直到你的下回合开始。',
			dc_xujing: '许靖',
			dcshangyu: '赏誉',
			dcshangyux: '赏誉',
			...
			dc_malingli: '马伶俐',
			dclima: '骊马',
			dclima_info: '锁定技，场上每有一张坐骑牌，你计算与其他角色的距离-1（至少为1）。',
			dcxiaoyin: '硝引',
			dcxiaoyin_info: '准备阶段，你可以亮出牌堆顶X张牌（X为场上你距离其1以内的角色数），获得其中红色牌，将任意张黑色牌放置在等量名连续其他角色的武将牌上。<br/>有硝引牌的角色受到伤害时，若为火焰伤害：伤害来源可以弃置硝引牌并弃置一张与硝引牌同类型的牌令此伤害+ 1; 若为非火焰伤害：伤害来源可以获得硝引牌并将此伤害改为火焰伤害。',
			dchuahuo: '花火',
			dchuahuo_info: '出牌阶段限一次，你可以将一张红色手牌当做不计次数的火【杀】使用。若目标有硝引牌，此【杀】可改为指定所有有硝引牌的角色为目标。',
			dc_caoyi: '曹轶',
			dcmiyi: '蜜饴',
			dcmiyi_info: '准备阶段，你可以选择一项：1.回复一点体力，2.受到一点你造成的伤害，然后令任意名角色依次执行该项。若如此做，结束阶段这些角色执行另一项。',
			dcyinjun: '寅君',
			dcyinjun_info: '当你对其他角色使用手牌中唯一目标的【杀】或锦囊牌结算后，可以视为对其使用一张【杀】（此杀造成的伤害无来源）。若你此技能本回合发动次数大于你当前体力值，此技能本回合失效。',
			dc_caoxian: '曹宪',
			dclingxi: '灵犀',
			dclingxi_info: '出牌阶段开始或结束时，你可以将至多体力上限张牌置于武将牌上，称为“翼”。当移去一次“翼”后，你将手牌调整至等于“翼”花色数的两倍。',
			dczhifou: '知否',
			dczhifou_info: '每名角色的回合每项限一次，当你使用牌结算后，你可以移去至少X张“翼”（X为你本回合发动此技能的次数），令一名角色执行一项：1.将一张牌置入“翼”；2.弃置两张牌；3.失去1点体力。',
			dc_bailingyun: '柏灵筠',
			dclinghui: '灵慧',
			dclinghui_info: '一名角色的结束阶段，若该角色为你或本回合有角色进入过濒死状态，你可以观看牌堆顶的三张牌，然后你可以使用其中一张并随机获得其余牌的其中一张。',
			dcxiace: '黠策',
			dcxiace_info: '每回合每项限一次，当你受到伤害后，你可令一名其他角色所有非锁定技失效直到回合结束；当你造成伤害后，你可以弃置一张牌并回复1点体力。',
			dcyuxin: '御心',
			dcyuxin_info: '限定技，当一名角色进入濒死状态时，你可以令其将体力值回复至与你相同（若其为你则改为回复至1点）。',
			zhugeruoxue: '诸葛若雪',
			qiongying: '琼英',
			qiongying_info: '出牌阶段限一次，你可以移动场上的一张牌，然后你弃置一张与此牌花色相同的手牌（若没有则展示所有手牌）。',
			nuanhui: '暖惠',
			nuanhui_info: '结束阶段，你可以选择一名角色，该角色可以视为使用X张基本牌（X为其装备区里的牌数且至少为1）。若使用了同名牌，其弃置装备区里的所有牌。',
			dc_zhugemengxue: '诸葛梦雪',
			dcjichun: "寄春",
			dcjichun_info: "出牌阶段各限一次，你可以展示一张牌并选择一项：1、将此牌交给一名手牌数小于你的角色，然后你摸X张牌；2、弃置此牌，并弃置一名手牌数大于你的角色区域内至多X张牌（X为此牌名字数）。",
			dchanying: "寒英",
			dchanying_info: "准备阶段，你可以展示牌堆第一张装备牌，然后令一名手牌数等于你的角色使用之。",
			dc_chendong: '陈武董袭',
			dcduanxie: '断绁',
			dcduanxie_info: '出牌阶段限一次，你可以横置一名其他角色的武将牌，然后横置你的武将牌。',
			dc_liubian: '刘辩',
			dcdushi: '毒逝',
			dcdushi_info: '锁定技，当你处于濒死状态时，其他角色不能对你使用【桃】。当你濒死结算结束后失去〖毒逝〗并令一名其他角色获得〖毒逝〗。',
			dc_zhenji: 'SP甄姬',
			dcjijie: '己诫',
			dcjijie_info: '锁定技，每回合各限一次，当其他角色于其回合外获得牌/回复体力后，你摸等量张牌/回复等量的体力。',
			dchuiji: '惠济',
			dchuiji_info: '出牌阶段限一次，你可以令一名角色摸两张牌或使用牌堆中的一张装备牌。若其手牌数不小于存活角色数，视为你使用一张【五谷丰登】（展示牌堆顶的牌改为展示其手牌，且此牌结算后，其获得其余的牌）。',
			wu_guanyu: '武关羽',
			dcjuewu: '绝武',
			dcjuewu_info: '①当你获得其他角色的牌后，这些牌点数视为2；②每回合每种牌名限一次，你可以将一张点数为2的牌当任意一种伤害牌使用。',
			dcwuyou: '武佑',
			dcwuyou_info: '每名角色的出牌阶段限一次，其可以交给你一张手牌，然后你从五个随机的非装备牌的牌名中选择一个牌名并交给其一张手牌（此牌视为你选择的牌名且使用时无距离与次数限制）。',
			dcyixian: '义贤',
			dcyixian_info: '限定技，出牌阶段，你可以选择一项：1.获得场上的所有装备牌；2.获得弃牌堆中的所有装备牌。然后你可以令被你获得牌的角色摸X张牌（X为其因此被你获得的牌数）并回复1点体力。',
			dc_guanyue: '关樾',
			dcxingmen: '兴门',
			dcxingmen_info: '①当你因“守执”弃置牌时，你可以回复1点体力；②当你摸牌时，若摸的牌数多于一张，你使用这些牌中的红色牌不能被响应。',
			dcfenhui: '奋恚',
			dcfenhuix: '奋恚',
			dcfenhui_info: '限定技，出牌阶段，你可以令一名角色获得X个“恨”标记，然后你摸等量张牌（X为你对其使用过牌的次数且至多为5）。“恨”标记效果：1.当其受到伤害时，你移去1个“恨”标记，令此伤害+1；2.当其死亡时，若其有“恨”标记，你减1点体力上限，将“守执”改为非锁定技，获得技能“兴门”。',
			dcshouzhi: '守执',
			dcshouzhi_info: '锁定技，一名角色的回合结束时，若你的手牌数大于/小于你本回合开始时的手牌数，你弃置一张手牌/摸两张牌。',
			dc_zhupeilan: '朱佩兰',
			dccilv: '辞虑',
			dccilv_info: '当你成为普通锦囊牌的目标后，你可以摸此技能剩余选项数张牌，然后若你的手牌数大于体力上限，你选择一项并移除之：1.令此牌对你无效；2防止此牌造成的伤害；3.于此牌结算结束后获得之。',
			dctongdao: '痛悼',
			dctongdao_info: '限定技，当你处于濒死状态时，你可以将一名角色的技能还原为游戏开始时的状态。若该角色不为你，你将体力值回复至与其相同。',
			dc_liutan: '柳婒',
			dcjingyin: '经音',
			dcjingyin_info: '每回合限一次，当一名角色于其回合外使用【杀】结算结束置入弃牌堆后，你可以令另一名角色获得之（此牌使用时无次数限制）。',
			dcchixing: '迟行',
			dcchixing_info: '一名角色的出牌阶段结束时，你可以摸X张牌（X为本阶段置入弃牌堆的【杀】数），然后你可以使用一张此次摸到的【杀】。',
			dc_bianyue: '卞玥',
			dcbizu: '庇族',
			dcbizu_info: '出牌阶段，你可以令所有手牌数与你相同的角色各摸一张牌，然后若此次的目标角色与你本回合任意一次发动此技能的目标角色均相同，本回合此技能失效。',
			dcwuxie: '无胁',
			dcwuxie_info: '出牌阶段结束时，你可以选择一名其他角色，令你与其将手牌中的所有伤害牌均置于牌堆底，然后你可以令你与其之中置于牌堆底的牌较多的角色回复1点体力。',
			dc_tianfeng: '田丰',
			dcsuishi: '随势',
			dcsuishi_info: '锁定技，①当其他角色受到伤害或进入濒死状态时，若伤害来源与你势力相同，你摸一张牌;②当其他角色死亡时，若其与你势力相同，你弃置至少一张手牌。',
			dc_jiangqin: '蒋钦',
			dcshangyi: '尚义',
			dcshangyi_info: '出牌阶段限一次，你可以令一名其他角色观看你的手牌，然后你观看其手牌并可以弃置其中任意张花色不同的黑色牌。',
			dcniaoxiang: '鸟翔',
			dcniaoxiang_info: '锁定技，当你使用【杀】指定其他角色为目标后，若你在其攻击范围内，其需使用两张【闪】才能抵消。',
			dc_zhangren: '张任',
			dcchuanxin: '穿心',
			dcchuanxin_info: '当你于出牌阶段内使用【杀】或【决斗】对目标角色造成伤害时，你可以防止此伤害并令其选择一项：1.弃置装备区里的所有牌并失去1点体力；2.弃置两张手牌且本回合所有非锁定技失效。',
			dcfengshi: '锋矢',
			dcfengshi_info: '当你使用【杀】指定其他角色为目标后，若你不在其攻击范围内，你可以弃置该角色装备区里的一张防具牌或防御坐骑牌。',
			wu_huangfusong: "武皇甫嵩",
			wu_huangfusong_prefix: '武',
			dcchaozhen: "朝镇",
			dcchaozhen_info: "准备阶段或当你进入濒死状态时，你可以从牌堆或者场上获得一张点数最小的牌。若此牌点数为1，你回复1点体力且本回合【朝镇】失效。",
			dclianjie: "连捷",
			dclianjie_info: "当你使用牌指定目标时，若此牌点数小于或等于你的所有手牌，则你可以将一名角色手牌中点数最小的牌置于牌堆底，然后你将手牌摸至体力上限，以此法获得的牌本回合无距离和次数限制。（每回合每个点数限一次）",
			dcjiangxian: "将贤",
			dcjiangxian_info: "限定技，出牌阶段，你可以令本回合使用因【连捷】获得的牌造成伤害时，伤害+X (X为你本回合造成伤害的次数且至多为5)，若如此做，此回合结束后失去【连捷】或【朝镇】。",
			dc_zhugejing: '诸葛京',
			dcyanzuo: '研作',
			dcyanzuo_info: '出牌阶段限一次，你可以将一张牌置于你的武将牌上，然后你视为使用一张“研作”牌（只能为其中的基本牌或普通锦囊牌，且使用时无次数限制）。',
			dczuyin: '祖荫',
			dczuyin_info: '锁定技，当你成为其他角色使用【杀】或普通锦囊牌的目标后，若你的武将牌上有与之牌名相同的“研作”牌，则你令此牌无效并移去所有此牌名的“研作”牌，否则你令你每个出牌阶段内发动“研作”的次数上限+1（至多加至3）并将牌堆或弃牌堆中一张此牌名的牌置入“研作”牌。',
			dcpijian: '辟剑',
			dcpijian_info: '锁定技，结束阶段，若你武将牌上的“研作”牌数不小于存活角色数，你移去所有“研作”牌，对一名角色造成2点伤害。',
			dc_wenyuan: '文鸳',
			dckengqiang: '铿锵',
			dckengqiang_info: '每回合限一次，当你造成伤害时，你可以选择一项：1.摸X张牌（X为你的体力上限)；2.此伤害+1，收回你造成伤害的牌。',
			dcrekengqiang: '铿锵',
			dcrekengqiang_info: '每回合每项各限一次，当你造成伤害时，你可以选择一项：1.摸X张牌（X为你的体力上限)；2.此伤害+1，收回你造成伤害的牌。',
			dckuichi: '匮饬',
			dckuichi_info: '锁定技，回合结束时，若你本回合摸牌数和造成的伤害值均大于等于你的体力上限，你失去1点体力。',
			dcshangjue: '殇决',
			dcshangjue_info: '觉醒技，你进入濒死状态时，将体力值回复至1点,加1点体力上限并获得“困励”，然后将“铿锵”改为每回合每项各限一次。',
			dckunli: '困励',
			dckunli_info: '觉醒技，你进入濒死状态时，将体力回复至2点，加1点体力上限并失去“匮饬”。',
			pangfengyi: "庞凤衣",
			dc_pangfengyi: "庞凤衣",
			dcyitong: "异瞳",
			dcyitong_info: "锁定技，游戏开始时，你选择一种花色。当此种花色的牌每回合第一次因使用而置入弃牌堆后，你随机获得其他每种花色的牌各一张。",
			dcpeiniang: "醅酿",
			dcpeiniang_info: "你可以将“异瞳”所选花色的牌当【酒】使用（不计次数）。有角色进入濒死状态时，你可以对其使用【酒】令其回复1点体力。",
			anyanggongzhu: "安阳公主",
			ersi: "二嗣",
			ersi_info: "每轮开始时或每当你受到1点伤害后，你可以展示牌堆顶的两张牌，然后你选择一项：1.获得这两张牌；2.交给一名其他角色。",
			zhenshu: "贞淑",
			zhenshu_info: "锁定技。一名其他角色于摸牌阶段外获得牌/于弃牌阶段外弃置牌时，你摸/弃置一张牌。",
			dc_qinghegongzhu: '清河公主',
			dczhangji: '长姬',
			dczhangji_info: '锁定技，有牌指定包括你在内的角色为目标时，先结算对你的效果，然后你摸此牌目标数张牌。',
			dczengou: '谮构',
			dczengou_info: '出牌阶段限一次，你可交给一名其他角色至多你体力上限张牌并摸等量张牌；若如此做，其下次体力值增加或使用牌后展示所有手牌，每有一张“谮构”牌失去一点体力。',
			dc_moqiongshu: "莫琼树",
			dcwanchan: "宛蝉",
			dcwanchan_info: "出牌阶段限一次，你可以令一名角色摸X张牌(X为你与其距离且最多为3) ，且其可以使用一张基本牌或普通锦囊牌(无距离和次数限制且此牌目标的相邻角色也成为此牌目标）。",
			dcrunzhi: "绛脂",
			dcrunzhi_info: "当你成为基本牌或普通锦囊牌的目标后，若你不为此牌的唯一目标，你可以进行一次判定，若结果为：红色，你摸三张牌；黑色，你弃置一名其他角色的至多两张牌。",
			dc_lvju: '吕据',
			dczhengyue: '征越',
			dczhengyue_info: '①回合开始时，若你的武将牌上没有牌，你可以将牌堆顶的至多五张牌以任意顺序置于你的武将牌上，称为“征”（“征”的数量至多为5）；②当你使用牌结算结束后，若此牌与你的第一张“征”花色、点数或牌名相同，则移去此“征”并摸两张牌，否则将此牌置入“征”并可以调整“征”的顺序（当你本回合将第二张牌置入“征”后，你本回合不能再使用牌）。',
			dc_wenqin: '文钦',
			dchuiqi: "彗企",
			dchuiqi_info: "觉醒技。一名角色回合结束后，此若回合内共有三名包含你在内的角色成为过牌的目标，你获得【偕举】并执行一个额外的回合。",
			dcxieju: "偕举",
			dcxieju_info: "出牌阶段限一次。你可以令任意名本回合成为过牌的目标的角色依次视为使用一张【杀】。",
...
"skill": {
			dchuiqi: {
				...
				content: function () {
					"step 0";
					player.awakenSkill("dchuiqi");
					player.addSkill("dcxieju");
					player.insertPhase();
				},
			},
			dcxieju: {
				...
				usable: 1,
				filter: function (event, player) {
					return event.dcxieju && event.dcxieju.length;
				},
				onChooseToUse: function (event) {
					if (!event.dcxieju && !game.online) {
						var targets = [];
						game.getGlobalHistory("useCard", evt => {
							if (evt.targets && evt.targets.length) {
								targets.addArray(evt.targets);
						...
						event.set("dcxieju", targets);
					}
				},
				filterTarget: function (card, player, target) {
					var event = _status.event;
					if (event.dcxieju.includes(target)) return true;
					return false;
				},
			...
			dczhengyue: {
				...
				filter: function (event, player) {
					return player.getExpansions('dczhengyue').length == 0;
				},
				marktext: '征',
				intro: {
					content: 'expansion',
				...
				content: function () {
					...
					var next = player.chooseToMove('征越：将至多五张牌置于你的武将牌上', true);
					next.set('list', [
						['牌堆顶', cards],
						['武将牌上'],
					]);
					next.set('processAI', function (list) {
						...
						return [[], cards.splice(5)];
					});
					'step 1'
					if (result.bool) {
						player.logSkill('dczhengyue');
						...
						player.addToExpansion(cards, player, 'giveAuto').gaintag.add('dczhengyue');
						game.updateRoundNumber();
						game.delayx();
					}

				},
				group: ['dczhengyue_sub', 'dczhengyue_clear'],
				subSkill: {
					sub: {
						direct: true,
						trigger: { player: 'useCardEnd' },
						init: function (player) {
							player.storage.dczhengyue_sub = 0;
						},
						filter: function (event, player) {
							return event.card && event.card.isCard && event.cards && player.getExpansions('dczhengyue') && player.getExpansions('dczhengyue').length > 0;
						},
						content: function () {
							'step 0'
							var suit = get.suit(trigger.card), num = get.number(trigger.card), name = get.name(trigger.card); fcard = player.getExpansions('dczhengyue')[0];
							if (suit == get.suit(fcard) || num == get.number(fcard) || name == get.name(fcard)) {
								player.loseToDiscardpile(fcard);
								player.draw(2);
								event.finish();
							}
							else if (get.position(trigger.cards[0], true) == 'o') {
								player.storage.dczhengyue_sub += trigger.cards.length;
								if (player.storage.dczhengyue_sub >= 2) player.addTempSkill('dczhengyue_forbid');
								var list = player.getExpansions('dczhengyue');
								list.addArray(trigger.cards);
								var next = player.chooseToMove('征越：调整“征”的位置', true);
								next.set('list', [
									['至多保留前5张', list],
								]);
							...
							'step 1'
							var cards = result.moved[0], list = [];
							for (var i = 0; i < cards.length; i++) {
								if (i < 5) list.push(cards[i]);
								else player.loseToDiscardpile(cards[i]);
							}
							player.addToExpansion(list, player, 'giveAuto').gaintag.add('dczhengyue')
							game.updateRoundNumber();
						}
					},
					forbid: {
			...
			dcwanchan: {
				...
				targetprompt: function (target) {
					...
					if (get.distance(player, target) > 0) return "摸牌用牌";
					return "用牌";
				},
				prompt: "你可以令一名角色摸牌并使用牌",
				content: function () {
					'step 0'
					var num = Math.min(3, get.distance(player, target));
					if (num) target.draw(num);
					target.addTempSkill("dcwanchan_1");
					'step 1'
					target.chooseToUse(function (card, player, event) {
						if (!["basic", "trick"].includes(get.type(card))) return false;
						return lib.filter.filterCard.apply(this, arguments);
					}, "宛蝉：是否使用一张基本牌或普通锦囊牌？").set("targetRequired", true).set("complexSelect", true).set("filterTarget", function (card, player, target) {
				...
				ai: {
					...
					result: {
						target: function (player, target) {
							var num = Math.min(get.distance(player, target), 3);
							return num;
						},
					},
				},
				subSkill: {
					1: {
						...
						filter: function (event, player) {
							return event.getParent(2).name == "dcwanchan" &&
								game.hasPlayer(current => {
									if (event.targets.includes(current) || !lib.filter.targetEnabled2(event.card, event.player, current)) return false;
									return event.targets.some(target => [target.getPrevious(), target.getNext()].includes(current));
								});
						},
						content: function () {
							...
							player.removeSkill('dcwanchan_1');
						},
					},
				},
			},
			dcrunzhi: {
				...
				content: function () {
					"step 0"
					player.chooseBool(get.prompt2("dcrunzhi"), "你可以进行一次判定并执行对应效果。");
					"step 1"
					if (result.bool) {
						player.logSkill('dcrunzhi');
						player.judge(function (card) {
							if (!game.hasPlayer(function (target) {
								return !trigger.targets.contains(target) && target.countCards('he') > 0;
							})) {
					...
					if (result.color) {
						if (result.color == 'red') {
							...
							if (game.hasPlayer(function (target) {
								...
								player.chooseTarget(get.prompt('dcrunzhi'), '弃置一名其他角色至多两张牌', true, function (card, player, target) {
									return target != player && target.countCards('he') > 0;
					...
					if (result.bool && result.targets && result.targets.length) {
						player.discardPlayerCard(result.targets[0], true, 'he', [1, 2]);
					}
				},
			},
			dczhangji: {
				...
				filter: function (event, player) {
					...
					return event.targets.contains(player) && (!event.card.storage || !event.card.storage.dczhangji);
				},
				forced: true,
				content: function () {
					'step 0'
					if (!trigger.card.storage) trigger.card.storage = {};
					trigger.card.storage.dczhangji = true;
					var newtargets = [];
					for (var i = 0; i < trigger.targets.length; i++) {
						if (trigger.targets[i] == player) newtargets.unshift(trigger.targets[i]);
						else newtargets.push(trigger.targets[i]);
					}
					trigger.targets = newtargets;
					trigger.getParent().targets = newtargets;
					for (var i of game.filterPlayer()) if (player.canUse(trigger.card, i)) game.log('1')
					'step 1'
			...
			dczengou: {
				...
				content: function () {
					player.give(cards, target).gaintag.add("dczengou");
					player.draw(cards.length);
					target.addSkill("dczengou_loseHp");
				},
				ai: {
					order: 10,
					expose: 0.2,
				...
				subSkill: {
					loseHp: {
						...
						popup: false,
						content: function () {
							var cards = player.getCards("h", card => card.hasGaintag("dczengou"));
							player.removeSkill("dczengou_loseHp");
			...
			ersi: {
				...
				content: function () {
					"step 0"
					event.num = trigger.name != 'damage' ? 0 : trigger.num;
					"step 1"
					event.num--;
					event.cards = get.cards(2);
					player.showCards(event.cards, get.translation(player) + '发动了【二嗣】');
					var list = ["留给自己", "交出牌"];
					...
					"step 3"
					if (result.index == 1) {
						player.chooseTarget(true, '请选择一名其他角色获得' + get.translation(event.cards), lib.filter.notMe).set('ai', function (target) {
			...
			zhenshu: {
				...
				forced: true,
				filter: function (event, player) {
					if ((event.getParent().name == 'draw' && event.getParent(2).name == 'phaseDraw') || event.player == player) return false;
					return event.getg(event.player).length;
				},
				content: function () {
					player.draw();
				},
				group: "zhenshu_discard",
				subSkill: {
					discard: {
						audio: "zhenshu",
						trigger: {
						...
						forced: true,
						filter: function (event, player) {
							if (event.type != "discard" || event.getParent("phaseDiscard").player == event.player || event.player == player || event.getlx === false) return false;
							return event.getl(event.player).cards2.length;
						},
						content: function () {
							player.chooseToDiscard('贞淑：请弃置一张牌', 1, 'he', true).set('ai', card => {
			...
			dcyitong: {
				...
				content: function () {
					'step 0'
					player.chooseControl(lib.suit, true).set("prompt", "异瞳：请记录一个花色");
					'step 1'
					if (result.control) {
						game.log(player, '选择了', '#g' + get.translation(result.control), '花色')
						player.markAuto('dcyitong', [result.control]);
					}
				},
				intro: {
					content: "已记录$花色"
				...
				subSkill: {
					gain: {
						...
						filter: function (event, player) {
							...
							return evt && evt.name == 'useCard' && event.cards.filterInD('d').length && player.getStorage('dcyitong').contains(get.suit(event.cards[0], player));
						},
						direct: true,
						forced: true,
						usable: 1,
						content: function () {
							...
							var suits = lib.suit.filter(suit => {
								return suit != get.suit(trigger.cards[0]);
							})
							for (var i of suits) {
			...
			dcpeiniang: {
				mod: {
					cardUsable: function (card) {
						if (card.storage && card.storage.dcpeiniang) return Infinity;
					},
				},
				enable: "chooseToUse",
			...
			dckuichi: {
				...
				filter(event, player) {
					...
					return num >= player.maxHp && player.countMark('dckuichi') >= player.maxHp;
				},
				intro: {
					content: '已摸#张'
				},
				...
				group: ['dckuichi_draw', 'dckuichi_clear'],
				subSkill: {
					draw: {
						trigger: {
							player: 'gainAfter',
						...
						content: function () {
							var num = trigger.getg(player).length;
							player.addMark('dckuichi', num, false);
						}
					},
					clear: {
						trigger: {
						...
						popup: false,
						filter: function (event, player) {
							return player.hasMark('dckuichi');
						},
						content: function () {
							player.removeMark('dckuichi', player.countMark('dckuichi'));
						}
					},
				},
			},
			dcshangjue: {
				...
				content: function () {
					...
					player.gainMaxHp();
					player.addSkill('dckunli');
					player.removeSkill('dckengqiang');
					player.addSkill('dcrekengqiang');
					player.awakenSkill('dcshangjue');
				},
			},
			dcrekengqiang: {
				audio: 'dckengqiang',
				...
				usable: 2,
				filter: function (event, player) {
					return !player.hasSkill('dcrekengqiang_1') || !player.hasSkill('dcrekengqiang_2');
				},
				content: function () {
					'step 0'
					var list = [],
					...
					event.target = target;
					if (!player.hasSkill('dcrekengqiang_1')) list.push('选项一');
					else choiceList[0] = '<span style="opacity:0.5">' + choiceList[0] + '</span>';
					if (!player.hasSkill('dcrekengqiang_2')) list.push('选项二');
					else choiceList[1] = '<span style="opacity:0.5">' + choiceList[1] + '</span>';
					player.chooseControl(list, 'cancel2').set('prompt', get.prompt('dcrekengqiang')).set('choiceList', choiceList);
					'step 1'
					if (result.control != 'cancel2') {
						if (result.control == '选项一') {
							player.draw(player.maxHp);
							player.addTempSkill('dcrekengqiang_1');
						} else {
							trigger.num++;
							player.addTempSkill('dcrekengqiang_2')
							var cards = trigger.cards.filterInD();
							if (cards.length > 0) {
								player.gain(cards, 'gain2');
							}
			...
			dckunli: {
				...
				content: function () {
					...
					player.gainMaxHp();
					player.removeSkill('dckuichi');
					player.awakenSkill('dckunli');
				},
			},
			//京✌v我50
			dcyanzuo: {
				...
				filter: function (event, player) {
					...
					if (count && count > player.countMark('dczuyin')) return false;
				...
				discard: false,
				check: function (card) {
					return _status.event.player.getUseValue(card) + 3;
				},
				prompt: '你可将一张牌置于武将牌上，然后你视为使用一张“研作”',
				content: function () {
					'step 0'
					var next = player.addToExpansion(event.cards, player, 'give');
					next.gaintag.add('dcyanzuo');
					'step 1'
					var cards = player.getExpansions('dcyanzuo').filter(i => ['trick', 'basic'].includes(get.type(i)));
					if (!cards.length) return;
					player.chooseButton(['是否视为使用一张“研作”牌？', cards])
				...
				intro: {
					...
					mark: function (dialog, storage, player) {
						var cards = player.getExpansions('dcyanzuo');
						if (cards.length) dialog.addSmall(cards);
						var marks = player.countMark('dczuyin');
			...
			dczuyin: {
				...
				content: function () {
					...
					if (cards.some(card => card.name == trigger.card.name)) {
						...
						var discards = cards.filter(card => card.name == trigger.card.name);
						if (discards.length) player.loseToDiscardpile(discards);
					} else {
						var card = get.cardPile(card => card.name == trigger.card.name);
						if (card) {
							var next = player.addToExpansion(card, 'gain2');
							next.gaintag.add('dcyanzuo');
						}
						if (player.countMark('dczuyin') < 2 && player.hasSkill('dcyanzuo', null, null, false)) player.addMark('dczuyin', 1, false);
					}
				},
			},
			dcpijian: {
				...
				content: function () {
					'step 0'
					player.chooseTarget(get.prompt2('dcpijian'))
						.set('ai', target => {
							var player = _status.event.player;
					...
					if (result.bool) {
						...
						player.loseToDiscardpile(player.getExpansions('dcyanzuo'));
						target.damage(2);
					}
				},
			},
			...
			dcchaozhen: {
				...
				filter: function (event, player) {
					return !player.hasSkill('dcchaozhen_used');
				},
				prompt2: function (event, player) {
					return "你可以从牌堆或者场上获得一张点数最小的牌。若此牌点数为1，你回复1点体力且本回合【朝镇】失效";
				},
				content: function (event, trigger, player) {
					...
					if (control == '场上') {
						...
						for (const current of game.players) {
							cards.addArray(current.getCards('ej'));
						}
						for (const cardx of cards) {
							let numc = get.number(cardx, false);
							if (!num || numc < num) {
								num = numc;
								card = cardx;
								if (num == 1) break;
						...
						for (const cardx of ui.cardPile.childNodes) {
							let numc = get.number(cardx, false);
							if (!num || numc < num) {
								num = numc;
								card = cardx;
					...
					if (card) {
						...
						if (num == 1) {
							player.recover();
							player.addTempSkill('dcchaozhen_used');
						}
					}
					else player.chat("真倒霉");
				},
				subSkill: {
					used: {
						charlotte: true,
			...
			dclianjie: {
				...
				filter: function (event, player) {
					...
					return !player.getStorage("dclianjie_count").includes(num);
				},
				prompt2: function (event, player) {
				...
				content: function (event, trigger, player) {
					"step 0"
					player.addTempSkill('dclianjie_count');
					player.markAuto("dclianjie_count", [get.number(trigger.card) || 0]);
					...
					if (result.bool) {
						...
						const toLose = cards.filter(card => {
						...
						game.delayx();
						if (player.countCards("h") < player.maxHp) player.draw(player.maxHp - player.countCards('h')).set('gaintag', ['dclianjie']);
					}
				},
				mod: {
					aiOrder: function (player, card, num) {
						...
						else if (!player.storage.dclianjie_count || !player.storage.dclianjie_count.includes(number)) {
							return num - 0.5;
						}
					},
				},
				subSkill: {
					count: {
						...
						onremove: function (player) {
							delete player.storage.dclianjie_count;
							player.removeGaintag("dclianjie");
						},
						intro: {
							content: (storage, player) => `已记录点数：${get.translation(storage)}`,
						},
						mod: {
			...
			dcjiangxian: {
				...
				content: function (event, trigger, player) {
					...
					player.addTempSkill("dcjiangxian_dclianjie");
					player.addTempSkill("dcjiangxian_1");
				},
				subSkill: {
					1: {
						trigger: {
						...
						popup: false,
						filter: function (event, player) {
							return ["dcchaozhen", "dclianjie"].some(skill => player.hasSkill(skill, null, null, false));
						},
						content: function () {
							"step 0"
							player.chooseButton(['请选择失去一个技能', [
								...
								if (button.link == 'dclianjie' && !player.hasSkill('dclianjie')) return false;
								return true;
							}).set('ai', function (button) {
								var player = _status.event.player;
								if (button.link == 'dclianjie' && player.hp > 2) return 2;
							...
							if (result.bool) {
								...
								if (choices.contains('dclianjie')) {
									player.removeSkill('dclianjie');
								}
							}
						},
					},
			...
			dcsuishi: {
				audio: 'suishi',
				trigger: { global: ['dying', 'damageEnd'] },
				forced: true,
				check: function () {
					return false;
				},
				filter: function (event, player) {
					return event.player != player && event.source && event.source.isIn() && event.source.group == player.group;
				},
				content: function () {
					player.draw();
				},
			...
			dcshangyi: {
				...
				content: function () {
					...
					if (!target.countCards('h')) {
						...
						player.chooseCardButton(target, target.getCards('h'), [0, 2]).set('filterButton', function (button) {
							var selectedCards = ui.selected.buttons.map(function (btn) {
								return btn.link;
							});
							var suit = get.suit(button.link);
							var color = get.color(button.link);
							if (selectedCards.length) {
								return color === 'black' && suit !== get.suit(selectedCards[0]);
							}
							return color === 'black';
						});
					}
			...
			dcniaoxiang: {
				...
				filter: function (event, player) {
					return event.card.name == 'sha' && player.inRange(event.target);
				},
				forced: true,
				logTarget: "target",
				content: function () {
			...
			dcchuanxin: {
				...
				filter: function (event, player) {
					...
					if (event.card && (event.card.name == 'sha' || event.card.name == 'juedou') && event.getParent().name == event.card.name) return true;
				},
				logTarget: "player",
				content: function () {
					'step 0'
					...
					if (trigger.player.countCards('e')) {
						trigger.player.chooseControl(function (event, player) {
							...
							return 0;
						}).set('choiceList', ['弃置装备区内的所有牌并失去一点体力', '弃置两张手牌且本回合所有非锁定技失效']);
					}
					else {
					...
					'step 1'
					if (result.index == 1) {
						trigger.player.chooseToDiscard('h', 2, true, '弃置两张手牌且本回合所有非锁定技失效');
			...
			dcfengshi: {
				...
				filter: function (event, player) {
					return event.card && event.card.name == 'sha' && !event.target.inRange(player) && event.notLink() && event.target.getCards('e', {
						subtype: ['equip3', 'equip2']
					}).length > 0
				},
				logTarget: "target",
				...
				content: function () {
					...
					next.set('att', att);
					next.set('createDialog', ['弃置' + get.translation(trigger.target) + '的一张防具牌或防御坐骑牌', trigger.target.getCards('e', {
						subtype: ['equip3', 'equip2']
					})]);
					...
					"step 1"
					if (result.bool) {
						player.logSkill('qilin_skill', trigger.target);
			...
			dcbizu: {
				...
				enable: 'phaseUse',
				filter: function (event, player) {
					return !player.hasSkill('dcbizu_blocker', null, null, false);
				},
				filterTarget: function (card, player, target) {
					return target.countCards('h') == player.countCards('h');
				},
				prompt: function () {
					var player = _status.event.player, targets = game.filterPlayer(current => current.countCards('h') == player.countCards('h'));
				...
				content: function () {
					...
					if (player.getHistory('useSkill', evt => {
						return evt.skill == 'dcbizu' && evt.targets.length == event.targets.length && evt.targets.every(i => event.targets.includes(i));
					}).length > 1) player.addTempSkill('dcbizu_blocker');
				},
				ai: {
					order: 8,
					result: {
						player: function (player, target) {
							return game.filterPlayer(p => {
								p.countCards('h') == player.countCards('h') && get.attitude(p, player) > 0
							}).length - game.filterPlayer(p => {
								return p.countCards('h') == player.countCards('h') && get.attitude(p, player) < 0
							}).length;
						},
					},
				},
			...
			dcwuxie: {
				...
				content: function () {
					'step 0'
					player.chooseTarget(get.prompt2('dcwuxie'), function (card, player, target) {
					...
					'step 1'
					if (result.bool) {
						var target = result.targets[0], cards1 = player.getCards('h', card => get.tag(card, 'damage')), cards2 = target.getCards('h', card => get.tag(card, 'damage'));
						event.target = target, event.recover = cards1.length < cards2.length ? target : player;
						if (cards1.length) {
							player.$throw(cards1.length, 1000);
							player.lose(cards1, ui.cardPile);
						...
						if (cards2.length) {
							...
							target.lose(cards2, ui.cardPile);
					...
					'step 2'
					if (event.recover) {
						if (!event.recover.isDamaged()) return;
						player.chooseBool('是否令' + get.translation(event.recover) + '回复1点体力？').set('choice', get.recoverEffect(event.recover, player, player) > 0);
					}
					'step 3'
					if (result.bool) event.recover.recover();
				},
			},
			dcjingyin: {
				audio: 2,
				...
				filter: function (event, player) {
					...
					return event.card.name == 'sha' && event.cards && (() => {
				...
				content: function () {
					'step 0'
					player.chooseTarget(get.prompt('dcjingyin'), '令一名角色获得' + get.translation(trigger.cards.filterInD()), (card, player, target) => {
						return target != _status.event.getTrigger().player;
					})
						.set('ai', target => {
							var player = _status.event.player, cards = _status.event.getTrigger().cards.filterInD();
			...
			dcchixing: {
				...
				content: function () {
					'step 0'
					player.draw(lib.skill.dcchixing.getNum(trigger).length);
					game.delayx();
					'step 1'
					if (Array.isArray(result) && result.some(card => get.name(card, false) == 'sha')) {
						player.chooseToUse('是否使用一张【杀】？', function (card, player, event) {
			...
			dccilv: {
				...
				content: function () {
					'step 0'
					player.draw(3 - player.getStorage("dccilv").length);
					if (player.countCards("h") > player.maxHp) {
						var list = ['对你无效', '防止伤害', '获得此牌'];
						if (player.getStorage("dccilv").includes('对你无效')) list.remove('对你无效');
						if (player.getStorage("dccilv").includes('防止伤害')) list.remove('防止伤害');
						if (player.getStorage("dccilv").includes('获得此牌')) list.remove('获得此牌');
						player.chooseControl(list).set('prompt', '你发动了辞虑，对选择对' + get.translation(trigger.card) + '执行并移去一项');
					} else {
						event.finish();
					};
					'step 1'
					if (result.control) {
						if (!player.storage.dccilv) player.storage.dccilv = [];
						if (!player.getStorage("dccilv").includes(result.control)) player.markAuto("dccilv", [result.control]);
						player.popup(result.control);
						game.log(player, "选择了", "#y" + result.control);
						if (result.control == '对你无效') {
							trigger.getParent().excluded.add(player);
							game.log(trigger.card, "对", player, "无效");
						} else if (result.control == '防止伤害') {
							player.addTempSkill("dccilv_effect");
							player.markAuto("dccilv_effect", [trigger.card]);
						} else if (result.control == '获得此牌') {
							player.addTempSkill("dccilv_gain");
							player.markAuto("dccilv_gain", [trigger.card]);
						}
					}
				},
				mark: true,
				intro: {
					markcount: function (storage) {
						return 3 - (storage || []).length
					},
					content: function (storage) {
						return ((storage || []).length ? ("已移除选项：" + storage) : "无移除选项")
					},
				},
				subSkill: {
					gain: {
						...
						onremove: true,
						filter: function (event, player) {
							return (player.getStorage("dccilv_gain").includes(event.card) && event.cards.filterInD().length > 0);
						},
						content: function () {
							player.gain(trigger.cards.filterInD(), 'gain2');
							player.removeSkill("dccilv_gain");
						}
					},
					effect: {
						...
						content: function () {
							trigger.cancel();
							player.removeSkill("dccilv_effect");
						},
					},
				},
			},
			dctongdao: {
				...
				content: function () {
					'step 0'
					player.chooseTarget('你可发动痛悼，选择一名角色重置其技能，若该角色不为你则你将体力值回复至与其相同', false).set('ai', function (target) { return -target.hp });
					'step 1'
					if (result.bool) {
						var target = result.targets[0];
						...
						if (target !== player) {
							var newHp = target.hp;
							player.recover(newHp - player.hp);
						}
					}
					else event.finish();
					'step 2'
					event.rollback = lib.skill.dctongdao.deepCopy(player.storage.dctongdao_init);
					var target = event.target;
					for (var i of target.getSkills(true, false, false)) {
						var cards = player.getExpansions(i);
						if (cards.length) player.loseToDiscardpile(cards);
					}
					target.clearSkills(true, true);
					for (var i in target.storage) {
						delete target.storage[i];
					}
					'step 3'
					ui.updatem(event.target);
					var id = event.target.playerid, target = event.target;
					if (event.rollback.player && event.rollback.player[id]) {
						var st = event.rollback.player[id];
						target.addSkill(st.skills);
						target.tempSkills = st.tempSkills;
						target.hiddenSkills = st.hiddenSkills;
						target.forbiddenSkills = st.forbiddenSkills;
						target.additionalSkills = st.additionalSkills;
						target.storage = st.storage;
						for (let key in event.rollback.hook) {
							if (event.rollback.hook.hasOwnProperty(key) && !lib.hookmap.hasOwnProperty(key)) {
								lib.hookmap[key] = event.rollback.hook[key];
							}
						}
						game.delay();
					}
				...
				deepCopy(obj, hash = new WeakMap()) {
					...
					for (let key in obj) {
						if (obj.hasOwnProperty(key)) {
							copy[key] = lib.skill.dctongdao.deepCopy(obj[key], hash);
						}
					}

					return copy;
				},
				group: 'dctongdao_init',
				subSkill: {
					init: {
						direct: true,
						charlotte: true,
						...
						content: function () {
							'step 0'
							if (!player.storage.dctongdao_init) player.storage.dctongdao_init = {
								player: {},
								hook: Object.assign({}, lib.hookmap),
							}
							game.players.forEach((p) => {
								var skills, additionalSkills = {}, tempSkills, hiddenSkills, forbiddenSkills;
								if (p.skills) skills = p.skills.slice(0);
								if (p.additionalSkills) additionalSkills = lib.skill.dctongdao.deepCopy(p.additionalSkills);
								if (p.tempSkills) tempSkills = lib.skill.dctongdao.deepCopy(p.tempSkills);
								if (p.forbiddenSkills) forbiddenSkills = lib.skill.dctongdao.deepCopy(p.forbiddenSkills);
								if (p.hiddenSkills) hiddenSkills = lib.skill.dctongdao.deepCopy(p.hiddenSkills);
								player.storage.dctongdao_init.player[p.playerid] = {
									skills: skills,
									additionalSkills: additionalSkills,
									tempSkills: tempSkills,
									hiddenSkills: hiddenSkills,
									forbiddenSkills: forbiddenSkills,
									storage: lib.skill.dctongdao.deepCopy(p.storage),
								};
							});
			...
			dcshouzhi: {
				audio: 2,
				init: function (player) {
					player.storage.dcshouzhi = 0;
				},
				locked: function (player) {
					return !player.storage || !player.storage.dcshouzhix;
				},
				direct: true,
				trigger: { global: 'phaseEnd' },
				filter: function (event, player) {
					return player.countCards('h') != player.storage.dcshouzhi
				},
				content: function () {
					'step 0'
					if (player.storage.dcshouzhix) {
						player.chooseBool('是否发动【' + get.translation('dcshouzhi') + '】？').set('prompt2', '你' + (player.countCards('h') > player.storage.dcshouzhi ? '弃置1张牌' : '摸2张牌') + '。');
					}
					'step 1'
					if (result.bool || !player.storage.dcshouzhix) {
						player.logSkill('dcshouzhi');
						if (player.countCards('h') > player.storage.dcshouzhi) player.chooseToDiscard('弃置1张牌', 1, 'h', true);
						else if (player.countCards('h') < player.storage.dcshouzhi) player.draw(2);
					}
				},
				group: 'dcshouzhi_1',
				subSkill: {
					1: {
						...
						content: function () {
							player.storage.dcshouzhi = player.countCards('h')
						}
					}
				}
			},
			dcfenhui: {
				...
				enable: 'phaseUse',
				init: function (player) {
					player.storage.dcfenhui2 = new Map();
					game.players.forEach(p => {
						player.storage.dcfenhui2.set(p, 0)
					})
				},
				filterTarget: lib.filter.notMe,
				content: function () {
					player.awakenSkill('dcfenhui');
					var x = Math.min(player.storage.dcfenhui2.get(target), 5);
					target.addMark('dcfenhuix', x);
					player.draw(x);
					player.addSkill('dcfenhuix');
				},
				group: 'dcfenhui_1',
				subSkill: {
					1: {
						...
						content: function () {
							var x = player.storage.dcfenhui2.get(trigger.target) + 1;
							player.storage.dcfenhui2.set(trigger.target, x);
						}
					}
				}
			},
			dcfenhuix: {
				...
				check: () => true,
				filter: function (event, player) {
					return event.player.isIn() && event.player.hasMark('dcfenhuix');
				},
				content: function () {
					'step 0'
					trigger.player.removeMark('dcfenhuix');
					trigger.num++;
					'step 1'
					if (trigger.player.countMark('dcfenhuix') == 0) trigger.player.unmarkSkill('dcfenhuix');
				},
				group: 'dcfenhuix_1',
				subSkill: {
					1: {
						...
						trigger: { global: 'die' },
						filter: function (event, player) {
							return event.player.hasMark('dcfenhuix');
						},
						content: function () {
							player.loseMaxHp();
							player.storage.dcshouzhix = true;
							player.addSkill('dcxingmen')
						}
					}
				}
			},
			dcxingmen: {
				...
				forced: true,
				content: function () {
					trigger.cards.forEach(c => {
						if (get.color(c) == 'red') {
							c.addGaintag('dcxingmen');
							if (!c.gaintagFixed) c.gaintagFixed = [];
							c.gaintagFixed.add('dcxingmen')
						}
					})
				},
				group: ['dcxingmen_1', 'dcxingmen_2'],
				subSkill: {
					1: {
						audio: 'dcxingmen',
						trigger: { player: 'loseEnd' },
						filter: function (event, player) {
							return event.getParent(3).name == 'dcshouzhi'
						},
						check: () => true,
						content: function () {
							player.recover();
					...
					2: {
						...
						filter: function (event, player) {
							return event.cards && event.cards[0].hasGaintag('dcxingmen')
						},
						content: function () {
							trigger.directHit = game.players;
							trigger.cards[0].removeGaintag('dcxingmen')
						}
					},
				}
			},
			dcjuewu: {
				...
				enable: "chooseToUse",
				filter: function (event, player) {
					return player.getCards('h', function (c) {
						return get.number(c) == 2;
					}).length > 0 && event.type != 'wuxie' && event.type != 'respondShan';
				},
				init: function (player) {
					player.storage.dcjuewu = [];
				},
				hiddenCard: function (player, name) {
					return get.tag({ name: name }, 'damage') && !player.storage.dcjuewu.contains(name);
				},
				chooseButton: {
					dialog: function (event, player) {
						var list = [];
						for (var i = 0; i < lib.inpile.length; i++) {
							if (get.tag({ name: lib.inpile[i] }, 'damage') && !player.storage.dcjuewu.contains(lib.inpile[i])) list.push([get.translation(get.type(lib.inpile[i])), '', lib.inpile[i]]);
						}
						if (!list.includes(['锦囊', '', 'shuiyanqijunx']) && !player.storage.dcjuewu.contains('shuiyanqijunx')) list.add(['锦囊', '', 'shuiyanqijunx']);
						if (list.length == 0) return ui.create.dialog('无法绝武');
					...
					backup: function (links, player) {
						return {
							...
							onuse: function (links, player) {
								player.storage.dcjuewu.add(links.card.name);
							}
						}
					},
					prompt: function (links, player) {
						return '将一张点数为2的手牌当作' + get.translation(links[0][2]) + '使用';
					},
				},
				ai: {
					order: 8,
				...
				mod: {
					cardnumber: function (card) {
						if (card.hasGaintag('dcjuewu')) return 2;
					},
				},
				group: ['dcjuewu_u', 'dcjuewu_d'],
				subSkill: {
					u: {
						audio: 'dcjuewu',
						trigger: {
					...
					d: {
						...
						content: function () { player.storage.dcjuewu = [] }
					}
				}
			},
			dcwuyou: {
				...
				subSkill: {
					g: {
						...
						prompt: '交出一张手牌',
						check: function (card) {
							if (game.countPlayer(function (p) {
								if (p.hasSkill('dcwuyou') && get.attitude(p, _status.currentPhase) < 0) return 0;
							}))
								return 6 - get.value(card);
						},
						filter: function (event, player) {
							return game.hasPlayer(p => {
								return p.hasSkill('dcwuyou');
							})
						},
						content: function () {
							'step 0'
							...
							if (targets.length == 1) {
								...
								player.chooseTarget(true, '选择【武佑】的目标', function (card, player, target) {
							...
							'step 2'
							if (event.target) {
								player.logSkill('dcwuyou', event.target);
								if (event.target != player) player.give(cards, event.target);
							}
							else event.finish();
							'step 3'
							var list = [];
							for (var i = 0; i < lib.inpile.length; i++) {
								if (get.type(lib.inpile[i]) != 'equip' && !list.contains(lib.inpile[i])) list.add([get.translation(get.type(lib.inpile[i])), '', lib.inpile[i]]);
							}
							event.target.chooseButton(['选择一个牌名', [list.randomGets(5), 'vcard']], 1, true).set('ai', button => {
								return get.buttonValue({ link: button.link[2] });
							});
							'step 4'
							if (result.bool) {
								event.seen = result.links[0][2];
								event.target.chooseCard('h', 1, '选择一张手牌视为【' + get.translation(event.seen) + '】并将此牌交给' + get.translation(player)).set('ai', card => {
							...
							if (result.bool) {
								...
								if (event.target != player) event.target.give(card, player).set("gaintag", ["dcwuyou"]);
								card.addGaintag('dcwuyou');
								if (!player.storage.dcwuyou) player.storage.dcwuyou = new Map();
								player.storage.dcwuyou.set(card, event.seen);
							}
						},
						mod: {
							cardname: function (card, player) {
								if (get.itemtype(card) == 'card' && card.hasGaintag('dcwuyou') && player.storage.dcwuyou && player.storage.dcwuyou.has(card)) return player.storage.dcwuyou.get(card);
							},
							cardnature: function (card, player) {
								if (get.itemtype(card) == 'card' && card.hasGaintag('dcwuyou') && player.storage.dcwuyou && player.storage.dcwuyou.has(card)) return undefined;
							},
							cardUsable: function (card) {
								if (card.cards && card.cards[0] && card.cards[0].hasGaintag('dcwuyou')) return Infinity;
							},
							targetInRange: function (card) {
								if (card.cards && card.cards[0] && card.cards[0].hasGaintag('dcwuyou')) return true;
							},
						},
						ai: {
							order: 8,
			...
			dcyixian: {
				...
				check: function (event, player) {
					...
					if (num >= 4 || ui.discardPile.childNodes.length > 35) return true;
					return false;
				},
				content: function () {
					'step 0'
					player.awakenSkill('dcyixian');
					player.chooseControl('场上', '弃牌堆', function () {
						var num = 0;
						game.player.forEach(c => {
							num += c.countCards('e');
						})
					...
					}).set('prompt', '选择获得场上或弃牌堆中的所有装备牌');
					'step 1'
					if (result && result.control == '弃牌堆') {
						var list = [];
						...
						game.players.forEach(c => {
							var eq = c.getCards('e');
							if (eq.length > 0) {
								eq.forEach(e => { list.push(e) });
								beg.set(c, eq.length);
							}
						})
						if (list.length) {
							player.gain(list, 'giveAuto');
							event.beg = beg;
						}
					}
					'step 2'
					if (event.beg.size <= 0) event.finish();
					else {
						var playef = event.beg.keys().next().value;
						console.log(_status.event);
						player.chooseBool('是否令' + get.translation(playef) + '回复1点体力并摸' + event.beg.get(playef) + '张牌').set('ai', () => {
							return get.attitude(_status.event.player, _status.event.playef) > 0;
						});
						event.playef = playef;
					}
					'step 3'
					if (result.bool) {
						event.playef.draw(event.beg.get(event.playef));
						event.playef.recover();
					}
					'step 4'
					event.beg.delete(event.playef);
					event.goto(2);
				}
			},
			dcjijie: {
				...
				filter: function (event, player) {
					...
					if (player.getHistory('custom', function (evt) {
						return evt.dczijie_name == event.name;
					}).length > 0) return false;
					return true;
				},
				content: function () {
					trigger.name == 'recover' ? player.recover(trigger.num) : player.draw(trigger.cards.length);
					player.getHistory('custom').push({
						dczijie_name: trigger.name
					});
				},
			},
			dchuiji: {
				...
				wugu: function () {
					...
					player.lose(cards, 'visible', ui.ordering).noOrdering = true;
				...
				content: function () {
					'step 0'
					player.chooseControl('摸牌', '装备', function () {
						if (get.attitude(player, target) > 0) {
							if (target.countCards('h') + 2 < game.countPlayer() || target.countCards('h') > target.hp || ((target.hasSkillTag('noe') ? 2 : 1) * (3 - target.countCards('e') - target.countDisabled()) > 0)) return '装备';
							return '摸牌';
						}
						if (target.countCards('h') >= game.countPlayer() || ((target.hasSkillTag('noe') ? 2 : 1) * (3 - target.countCards('e') - target.countDisabled()) <= 0)) return '装备';
						return '摸牌';
					}).set('prompt', get.prompt2('dchuiji'));
					'step 1'
					if (result.control == '摸牌') target.draw(2);
					...
					if (target.countCards('h') >= game.countPlayer()) {
						target.chooseUseTarget('wugu', true, false);
					}
				},
				ai: {
					order: 10,
					...
					result: {
						target: function (player, target) {
							...
							if (att <= 0) {
								if (target.countCards('h') + 2 >= game.countPlayer()) return -5;
								if ((target.hasSkillTag('noe') ? 2 : 1) * (target.countCards('e') + target.countDisabled() - 3) > 0) return -1;
								return 0;
							}
							else if (target.countCards('h') < game.countPlayer() && ((target.hasSkillTag('noe') ? 2 : 1) * (3 - target.countCards('e') - target.countDisabled()) > 0)) return 2;
							return 0;
						},
					},
				},
				...
				subSkill: {
					wugu: {
						...
						filter: function (event, player) {
							return event.getParent(3).name == 'dchuiji';
						},
						forced: true,
						silent: true,
						popup: false,
						content: function () {
							...
							var next = game.createEvent('wuguContentAfter', false);
							next.player = trigger.player;
							next.gain = cards.slice(0);
							next.setContent(function () {
								var cards = [];
								if (get.itemtype(event.gain) == 'cards') cards.addArray(event.gain.filter(item => get.position(item, true) == 'o'));
								player.gain(cards, 'gain2');
							});
							event.next.remove(next);
							trigger.parent.after.unshift(next);
							trigger.setContent(lib.skill.dchuiji.wugu);
						},
					},
				},
			},
			dcdushi: {
				...
				content: function () {
					...
					if (result.bool) {
						var target = result.targets[0];
						player.logSkill('dcdushi', target);
						target.markSkill('dcdushi');
						target.addSkillLog('dcdushi');
						player.removeSkill('dcdushi');
					}
				},
			...
			dcjichun: {
				...
				enable: 'phaseUse',
				filter: function (event, player) {
					return player.countCards('he') > 0 && game.hasPlayer(p => p.countCards('h') != player.countCards('h')) && !player.hasSkill('dcjichun_0') || !player.hasSkill('dcjichun_1');
				},
				chooseButton: {
					dialog: function (event, player) {
						var dialog = ui.create.dialog('寄春：请选择一项', 'hidden');
						dialog.add([[
							['discard', '弃置一张牌，并弃置一名手牌数大于你的角色区域内至多X张牌（X为此牌名字数）'],
							['draw', '将一张牌交给一名手牌数小于你的角色，然后你摸X张牌（X为此牌名字数）']
						], 'textbutton']);
						return dialog;
					},
					filter: function (button, player) {
						if (button.link == 'discard' && player.hasSkill('dcjichun_0')) return false;
						if (button.link == 'draw' && player.hasSkill('dcjichun_1')) return false;
						return true;
					},
					backup: function (links) {
						return get.copy(lib.skill['dcjichun_' + links[0]]);
					},
					prompt: function (links) {
						if (links[0] == 'discard') return '弃置一张牌，并弃置一名手牌数大于你的角色区域内至多X张牌（X为此牌名字数）';
						return '将一张牌交给一名手牌数小于你的角色，然后你摸X张牌（X为此牌名字数）';
					},
				},
				ai: {
					order: 12,
				...
				subSkill: {
					...
					discard: {
						...
						content: function () {
							'step 0'
							player.addTempSkill('dcjichun_0', 'phaseUseAfter');
							player.showCards(cards);
							player.discard(cards);
							if (game.hasPlayer(p => p.countCards('h') > player.countCards('h'))) {
								player.chooseTarget('弃置一名手牌数大于你的角色区域内至多' + lib.skill.dcweidang.getLength(cards[0]) + '张牌', 1, true, function (card, player, target) {
									return target.countCards('h') > player.countCards('h');
								}).set('ai', function (target) {
									return -get.attitude(player, target);
								});
							...
							'step 1'
							if (result.targets[0].countCards('h') > 0) player.discardPlayerCard(result.targets[0], 'he', [1, lib.skill.dcweidang.getLength(cards[0])]);
						},
					},
					draw: {
						audio: 'dcjichun',
						...
						content: function () {
							'step 0'
							player.addTempSkill('dcjichun_1', 'phaseUseAfter');
							player.showCards(cards);
							player.chooseTarget('将' + get.translation(cards[0]) + '交给一名手牌数小于你的角色', 1, true, function (card, player, target) {
								return target.countCards('h') < player.countCards('h');
							}).set('ai', function (target) {
								return get.attitude(player, target);
							});
							'step 1'
							player.give(cards, result.targets[0], 'giveAuto');
							player.draw(lib.skill.dcweidang.getLength(cards[0]));
						},
					},
				},
			},
			dchanying: {
				...
				content: function () {
					...
					'step 1'
					player.chooseTarget('令一名手牌数等于你的角色使用' + get.translation(event.card), 1, true, function (card, player, target) {
						return target.countCards('h') == player.countCards('h') && !target.isDisabled(2);
					}).set('ai', function (target) {
						return get.attitude(_status.event.player, target);
					});
					'step 2'
			...
			// 出牌阶段限一次，你可以移动场上的一张牌，然后你弃置一张与此牌花色相同的手牌（若没有则展示所有手牌）。
			qiongying: {
				audio: 2,
				enable: "phaseUse",
				usable: 1,
				...
				prompt: '出牌阶段限一次，你可以移动场上的一张牌，然后你弃置一张与此牌花色相同的手牌（若没有则展示所有手牌）',
				content: function () {
					'step 0'
					...
					if (result.bool) {
						...
						var cards = player.getCards('h', o => get.color(o) == color);
						if (cards.length) {
							player.chooseToDiscard('h', "请弃置一张与此牌花色相同的手牌", 1, true)
								.set('filterCard', card => cards.includes(card))
								.set('ai', card => -ai.get.value(card));
						} else {
							player.showHandcards();
						}
					}
			...
			// 结束阶段，你可以选择一名角色，该角色可以视为使用X张基本牌（X为其装备区里的牌数）。若其以此法使用的牌数大于1，其弃置装备区里的所有牌。
			nuanhui: {
				trigger: {
					player: 'phaseJieshuBegin',
				},
				check: function (event, player) {
					for (var target of game.players) {
						...
						if (att > 0) {
							...
							if (Math.max.apply(Math, es.map(o => get.value(o))) < 7) {
								return true;
							}
						}
					}
				...
				content: function () {
					'step 0'
					player.chooseTarget("选择一名角色，令其视为使用X张基本牌（X为其装备区的牌数且至少为1）", 1)
						.set('ai', target => {
							var att = get.attitude(player, target), es = target.countCards('e'), bonus = 1;
							if (target.hp <= target.maxHp / 2) bonus += 2;
							if (es > 0) bonus += Math.round(es / 1.25);
							return att * bonus;
						});
					'step 1'
					if (!result.bool) {
					...
					event.target = result.targets[0]
					event.numx = Math.max(1, event.target.countCards('e'));
					event.useNum = 0;
					event.useList = [];
					event.nuanhuiDiscard = false;
					event.nuanhuiEnd = false;
					'step 2'
					var list = [];
					...
					event.target.chooseButton(['暖惠：选择一张视为使用的牌', [list, 'vcard']], false)
						.set('filterButton', button => {
							var name = button.link[2];
							return event.target.hasUseTarget({ name: name }, true)
						})
						.set('ai', button => {
							var player = _status.event.getParent().target, index = 1, res = button.link[2];
							if (player.hp <= 2 && res == 'tao') index = 2.5;
							else if (player.getHistory('useCard', e => {
								return e.card && e.card.name == res;
							}).length == 0) index = 2;
							else if (player.countCards('e') <= 1 && res == 'sha') index = 2.5;
							else if (res == 'sha') index = 1.5;
							if (player.getHistory('useCard', e => {
								return e.card && e.card.name == 'sha';
							}).length > 2 && player.getHistory('useCard', e => {
								return e.card && e.card.name == 'tao';
							}).length > 1 && player.getHistory('useCard', e => {
								return e.card && e.card.name == 'jiu';
							}).length > 1 && player.hp > 2 && !game.hasPlayer(p => {
								return get.attitude(player, p) < 0 && p.hp <= 2;
							})) index = 0;
							return get.buttonValue({ link: res }) * index;
						});
					'step 3'
					if (result.bool) {
						event.useNum++;
						event.target.chooseUseTarget(true, false, { name: result.links[0][2], nature: result.links[0][3] });
						if (!event.useList.includes(result.links[0][2])) event.useList.push(result.links[0][2]);
						else event.nuanhuiDiscard = true;
					}
					else event.nuanhuiEnd = true;
					'step 4'
					if (event.useNum >= event.numx || event.nuanhuiEnd) {
						if (event.nuanhuiDiscard === true) {
							event.target.lose(event.target.getCards('e'));
						}
						event.finish();
					} else if (!event.target.isDead() && !event.nuanhuiEnd) {
						event.goto(2);
					} else {
						event.finish();
					}
			...
			dclinghui: {
				...
				filter: function (event, player) {
					...
					return player.hasMark('dclinghui');
				},
				direct: true,
				content: function () {
					'step 0'
					event.cards = get.cards(3);
					player.chooseButton(['选择要使用的牌', event.cards]).set('filterButton', button => {
					...
					'step 1'
					if (result.bool) {
						player.logSkill('dclinghui');
						player.$throw(result.links, 1000);
						player.chooseUseTarget(true, result.links[0], false);
						event.cards.splice(event.cards.indexOf(result.links[0]), 1);
					} else {
						for (var i = 0; i < event.cards.length; i++) {
					...
					'step 2'
					var cardx = event.cards.randomRemove();
					player.gain(cardx, "gain2");
				},
				group: ['dclinghui_add', 'dclinghui_remove'],
				subSkill: {
					add: {
						audio: 2,
					...
					remove: {
						...
						content: function () {
							for (const i of game.filterPlayer().sortBySeat()) {
								if (i.hasMark('dclinghui')) {
									i.removeMark('dclinghui');
								}
							}
						}
					},
			...
			dcxiace: {
				audio: 2,
				init: function (player) {
					player.storage.dcxiace = [];
				},
				trigger: {
					player: 'damageEnd'
				},
				filter: function (event, player) {
					return !player.storage.dcxiace.includes('1');
				},
				direct: true,
				content: function () {
					'step 0'
					player.chooseTarget('选择一名其他角色令其所有非锁定技失效', (card, player, target) => {
					...
					if (result.bool) {
						...
						player.logSkill('dcxiace', result.targets[0]);
						player.storage.dcxiace.add('1');
					}
				},
				group: ['dcxiace_1', 'dcxiace_2'],
				subSkill: {
					1: {
						audio: 'dcxiace',
						trigger: {
						...
						direct: true,
						filter: function (event, player) {
							return player.countCards('he') && player.hp < player.maxHp && !player.storage.dcxiace.includes('2');
						},
						content: function () {
							'step 0'
							player.chooseToDiscard('弃置一张牌并回复1点体力', 'he').set('ai', function (card) {
								return 6 - get.value(card);
							});
							'step 1'
							if (result.bool) {
								player.logSkill('dcxiace');
								player.recover();
								player.storage.dcxiace.add('2');
							}
						},
						sub: true,
					},
					2: {
						...
						charlotte: true,
						content: function () {
							player.storage.dcxiace.length = 0;
						},
						sub: true,
					},
				},
			...
			dclingxi: {
				...
				content: function () {
					'step 0'
					player.chooseCard('是否将至多' + player.maxHp + '张手牌置于武将牌上，称为“翼”', [1, Math.min(player.countCards('he'), player.maxHp)], 'he').set('ai', function (card) {
						return 4 - get.value(card);
					});
					'step 1'
					if (result.cards && result.cards.length) {
						player.addToExpansion(result.cards, player, 'giveAuto').gaintag.add('dclingxi');
				...
				subSkill: {
					liangyin: {
						...
						prompt2: function (event, player) {
							var cardS = player.getExpansions('dclingxi');
							var suit = [];
							for (var i = 0; i < player.getExpansions('dclingxi').length; i++) {
								if (!suit.includes(cardS[i].suit)) suit.add(cardS[i].suit);
							}
							return '将手牌调整至' + (suit.length * 2) + '张';
						},
						check: function (event, player) {
							var cardS = player.getExpansions('dclingxi');
							var suit = [];
							...
							if (player.countCards('h') > suit.length * 2) return (player.countCards('h') - suit.length * 2);
							else return 0;
						},
						filter: function (event, player) {
							return game.hasPlayer(function (current) {
							...
							}) && event.getParent(2).name == 'dczhifou';
						},
						content: function () {
							var cardS = player.getExpansions('dclingxi');
							var suit = [];
							...
							if (player.countCards('h') > suit.length * 2) player.chooseToDiscard(player.countCards('h') - suit.length * 2, true);
							else player.draw(suit.length * 2 - player.countCards('h'));
						}
					}
				}
			},
			dczhifou: {
				...
				init: function (player) {
					player.storage.dczhifou = [];
				},
				filter: function (event, player) {
					return player.storage.dczhifou.length < 3 && player.getExpansions('dclingxi').length >= player.storage.dczhifou.length + 1;
				},
				content: function () {
					'step 0'
					player.chooseTarget(get.prompt('dczhifou'), '选择一名角色', (card, player, target) => {
						var player = _status.event.player;
						if (player.storage.dczhifou.includes('3')) return target.countCards('he') > 0;
						else return true;
					}).set('ai', function (target) {
					...
					if (result.bool) {
						var target = result.targets[0];
						event.target = target;
						if (player.storage.dczhifou.length + 1 > 0) {
							var cards = player.getExpansions('dclingxi');
							player.chooseButton([
								'选择' + (player.storage.dczhifou.length + 1) + '张“翼”',
								cards], player.storage.dczhifou.length + 1);
						}
					} else event.finish();
					'step 2'
					if (result.bool) {
					...
					'step 3'
					var choice = [];
					if (!player.storage.dczhifou.includes('1')) choice.push('将一张牌置于“翼”');
					if (!player.storage.dczhifou.includes('2')) choice.push('弃置2张牌');
					if (!player.storage.dczhifou.includes('3')) choice.push('失去1点体力');
					player.chooseButton([get.prompt('dczhifou'), '请选择一项', [choice, 'textbutton']]).set('selectButton', 1);
					'step 4'
					if (result.bool) {
						switch (result.links[0]) {
							case '弃置2张牌':
								event.target.chooseToDiscard('he', Math.min(target.countCards('he'), 2), true);
								if (!player.storage.dczhifou.includes('2')) player.storage.dczhifou.push('2');
								break;
							case '失去1点体力':
								event.target.loseHp();
								if (!player.storage.dczhifou.includes('3')) player.storage.dczhifou.push('3');
								break;
							case '将一张牌置于“翼”':
								event.target.chooseCard('将1张牌置于' + get.translation(player) + '武将牌上', true, 'he');
								if (!player.storage.dczhifou.includes('1')) player.storage.dczhifou.push('1');
								break;
						}
						if (result.links[0] != '将一张牌置于“翼”') event.finish();
					}
					'step 5'
					if (result.bool && result.cards && result.cards.length) {
						player.addToExpansion(result.cards, event.target, 'giveAuto').gaintag.add('dclingxi');
					}
				},
				group: 'dczhifou_init',
				subSkill: {
					init: {
						...
						trigger: { global: 'phaseEnd' },
						filter: function (event, player) {
							return player.storage.dczhifou.length > 0;
						},
						content: function () {
							player.storage.dczhifou.length = 0;
						}
					}
				}
			},
			dcmiyi: {
				...
				trigger: { player: 'phaseZhunbeiBegin' },
				init: function (player) {
					player.storage.dcmiyi = [];
				},
				locked: false,
				forced: true,
				content: function () {
					'step 0'
					player.chooseControl('回血', '受伤', 'cancel2').set('prompt', '蜜饴：选择一项').set('ai', () => {
						var player = _status.event.player;
						if (player.hp > 2 && game.hasPlayer(p => {
							return get.damageEffect(p, player, player) >= 0;
						})) return '受伤';
						else if (player.hp <= 2 && game.hasPlayer(p => {
							return get.recoverEffect(p, player) > 0 && get.attitude(p, player) > 0;
						})) return '回血';
						else return 'cancel2';
					});
					'step 1'
					if (result.control == 'cancel2') event.finish();
						...
						player.storage.dcmiyi = [];
						player.storage.dcmiyi.add(result.control);
						if (result.control == '回血') player.recover();
						else if (result.control == '受伤') player.damage();
					}
					'step 2'
					var prompt2 = '蜜饴:令任意名角色';
					if (player.storage.dcmiyi[0] == '回血') prompt2 += '回复1点体力';
					else prompt2 += '受到你造成的1点伤害';
					player.chooseTarget(prompt2, [1, Infinity], function (card, player, target) {
						return target != player;
					}).set('ai', (target) => {
						var player = _status.event.player;
						if (player.storage.dcmiyi[0] == '回血') return get.attitude(player, target);
						else return get.damageEffect(target, player, player);
					});
					'step 3'
					if (result.bool) {
						var targets = result.targets.sortBySeat()
						player.storage.dcmiyi.add(targets);
						player.line(targets, 'blue');
						for (var i of targets) {
							if (player.storage.dcmiyi[0] == '回血') i.recover();
							else i.damage();
						};
					}
				},
				...
				subSkill: {
					sub: {
						...
						filter: function (event, player) {
							return player.storage.dcmiyi && player.storage.dcmiyi[1] && player.storage.dcmiyi[1].length > 0
						},
						forced: true,
						content: function () {
							var check = true, targets = player.storage.dcmiyi[1];
							for (var i of targets) {
								if (i.isDead()) check = false;
							}
							if (!check) { }
							else {
								player.line(targets, 'blue');
								for (var i of targets) {
									if (player.storage.dcmiyi[0] == '回血') i.damage();
									else i.recover();
								};
							}
							player.storage.dcmiyi = [];
			...
			dcyinjun: {
				...
				filter: function (event, player) {
					if (!event.cards || !event.cards[0]) return false;
					var numx = player.getHistory('useSkill', evt => {
						return evt.skill == 'dcyinjun';
					}).length;
					if (numx >= player.hp) return false;
					return player.getHistory('lose', function (evt) {
						return evt.getParent() == event
					}) && event.targets.length == 1 && (get.type2(event.card) == 'trick' || event.card.name == 'sha') && event.targets[0] != player && player.canUse('sha', event.targets[0], false, false) && event.targets[0].isIn();
				},
				check: function (event, target, player) {
					return get.effect(event.targets[0], {
						name: 'sha'
					}, player) > 0;
				},
				content: function () {
				...
				subSkill: {
					sub: {
						...
						filter: function (event, player) {
							return event.card && event.card.name == 'sha' && event.getParent(3).name == 'dcyinjun';
						},
						direct: true,
						content: function () {
			...
			dcxiongmu: {
				...
				content: function () {
					...
					'step 1'
					player.chooseCard('he', false, [1, player.countCards('he')], '将任意张牌随机置入牌堆');
					'step 2'
					if (result.bool) {
						event.statC = result.cards.length;
						player.$throw(event.statC, 2000);
						player.lose(result.cards, ui.cardPile).insert_index = function () {
							return ui.cardPile.childNodes[get.rand(0, ui.cardPile.childNodes.length)];
						}
						if (player == game.me) game.log(player, '将', result.cards, '随机置入牌堆');
						else game.log(player, '将', event.statC, '张牌随机置入牌堆');
					}
					else event.finish();
					'step 3'
					...
					for (var i = 0; i < event.statC; i++) {
						var cardP = get.cardPile2(function (card) {
							return !event.cards.contains(card) && get.number(card) == 8;
						});
						if (cardP) {
					...
					'step 6'
					event.cards.forEach(card => card.addGaintag('dcxiongmux'));
				},
				mod: {
					ignoredHandcard: function (card, player) {
						if (card.hasGaintag('dcxiongmux')) return true;
					},
					cardDiscardable: function (card, player, name) {
						if (name == 'phaseDiscard' && card.hasGaintag('dcxiongmux')) return false;
					},
				},
				group: 'dcxiongmu_damage',
				subSkill: {
					damage: {
						forced: true,
						trigger: {
						...
						filter: function (event, player) {
							return player.countCards('h') <= player.hp && !player.hasSkill('dcxiongmu_record');
						},
						content: function () {
							trigger.num--;
							player.addSkill('dcxiongmu_record');
						}
					},
					record: {
						charlotte: true,
					...
					remove: {
						trigger: { global: 'phaseEnd' },
						filter: function (event, player) {
							return player.hasSkill('dcxiongmu_record');
						},
						forced: true,
						popup: false,
						content: function () {
							player.removeSkill('dcxiongmu_record');
						}
					},
				},
			},
			dczhangcai: {
				...
				filter: function (event, player) {
					if (player.hasSkill('dcruxian_sub')) return true;
					return get.number(event.card) == 8;
				},
				content: function () {
					var num = player.getCards('h', function (card) {
						if (player.hasSkill('dcruxian_sub')) return get.number(card) == get.number(trigger.card);
						return get.number(card) == 8;
					});
					player.draw(Math.max(1, num.length));
				}
			},
			dcruxian: {
				audio: 2,
				...
				content: function () {
					...
					player.addTempSkill('dcruxian_sub', { player: 'phaseBegin' });
					game.log(player, '执笔乾坤，挥斥方遒！');
				},
				ai: {
					order: 10,
					result: {
								...
								player: function (card, player, target, current) {
									...
									if (!get.tag(card, 'damage')) {
										if (player.getEquip('zhuge')) {
											if (get.subtype(card) == 'equip1') return [0, 0];
										}
			...
			dcxiaoren: {
				...
				direct: true,
				filter: function (event, player) {
					return !player.hasSkill('dcxiaoren_off_2');
				},
				content: function () {
					'step 0'
					if (!player.hasSkill('dcxiaoren_off_1')) {
						player.chooseBool(get.prompt('dcxiaoren'));
					} else {
						player.chooseBool('绡刃：是否再次进行判定？');
					}
					'step 1'
					if (result.bool) {
						player.judge();
						player.addTempSkill('dcxiaoren_off_1');
					} else {
						event.finish();
						if (player.hasSkill('dcxiaoren_off_1')) {
							player.addTempSkill('dcxiaoren_off_2');
						}
					}
					'step 2'
				...
				content_red: function () {
					'step 0'
					player.chooseTarget('绡刃：是否令一名角色回复1点体力（未受伤则改为摸一张牌）？').set('ai', target => get.recoverEffect(target, _status.event.player, _status.event.player) || get.attitude(_status.event.player, target));
					'step 1'
					if (result.bool) {
						var target = result.targets[0];
						player.logSkill('dcxiaoren');
						player.line(target);
				...
				content_black: function () {
					'step 0'
					player.chooseControl('上家', '下家').set('prompt', '绡刃：请选择一名角色').set('prompt2', '对' + get.translation(target) + '上家或下家造成1点伤害，然后你可以再次判定并执行对应效果直到有角色进入濒死状态').set('ai', () => {
						var player = _status.event.player;
						var num1 = get.damageEffect(player.next, player, player);
						var num2 = get.damageEffect(player.previous, player, player);
						return num1 > num2 ? '上家' : '下家';
					}).set('target', target);
					'step 1'
					if (result.control) {
						event.num = 1;
			...
			dccaizhuang: {
				...
				content: function () {
					...
					if (suits.length >= event.suits) event.finish();
					'step 2'
					player.draw();
					event.goto(1);
				},
			...
			dcshexue: {
				...
				content: function () {
					...
					next.set(
						"openskilldialog",
						`###${get.prompt("dcshexue")}###将一张牌当做${get.translation(card.nature) || ""
					...
					study: {
						...
						content: function () {
							...
							if (trigger.player.hasUseTarget(card, false)) {
								...
								next.set(
									"openskilldialog",
									`###${get.prompt("dcshexue_study")}###将一张牌当做${get.translation(card.nature) || ""
									}【${get.translation(card.name)}】使用`
								);
								next.set("norestore", true);
								next.set("addCount", false);
			...
			dcanzhi: {
				...
				content: function () {
					'step 0'
					player.judge(result => {
						if (get.color(result) == 'red') return player.countMark('dcxialei_clear') / 2;
						return 2;
					}).judge2 = result => result.bool;
					'step 1'
					if (result.color == 'red') {
					...
					result: {
						target: function (player, target) {
							if (ui.selected.cards.length) {
								...
								if (target.getEquip(card) || target.countCards('h', {
			...
			dclima: {
				mod: {
					globalFrom: function (from, to, distance) {
						var num = Math.max(1, game.hasPlayer(function (current) {
			...
			dcxiaoyin: {
				...
				content: function () {
					...
					if (event.list.length > 0)
						player.chooseButton(['硝引：选择准备当火药的牌', event.list], [1, Math.min(event.list.length, event.num)]);
					else
						event.finish();
					'step 3'
					if (result.bool) {
						event.results = result.links;
						player.chooseTarget('硝引：选择一名倒霉蛋开始埋炸药', function (card, player, target) {
							return player != target;
						}).set('ai', function (target) {
							return get.attitude(_status.event.player, target) <= 0;
						});
					...
					if (result.bool) {
						...
						for (var i = 0; i < event.results.length; i++) {
							target.addToExpansion(event.results[i], player, 'give').gaintag.add('dcxiaoyin');
							target.addSkill('dcxiaoyin_fire');
				...
				subSkill: {
					fire: {
						...
						intro: {
							...
							name: "硝引",
							mark: function (dialog, content, player) {
								var content = player.getExpansions('dcxiaoyin');
								if (content && content.length) {
									dialog.addAuto(content);
									return '带有' + get.cnNumber(content.length) + '份硝引<br/>';
								}
							},
							content: function (content, player) {
								var content = player.getExpansions('dcxiaoyin');
								if (content && content.length) {
									return '带有' + get.cnNumber(content.length) + '份硝引<br/>' + get.translation(content);
								}
							},
						},
						...
						forced: true,
						onremove: function (player, skill) {
							var cards = player.getExpansions('dcxiaoyin');
							if (cards.length) player.loseToDiscardpile(cards);
						},
						filter: function (event, player) {
							return event.source && player.getExpansions('dcxiaoyin').length > 0;
						},
						content: function () {
							'step 0'
							if (trigger.nature == 'fire') {
								trigger.source.chooseBool('弃置所有“硝引”牌并弃置一张与“硝引”牌类型相同的牌令本次伤害+1').set('ai', function () {
									if (get.attitude(_status.event.player, _status.event.getParent().player) <= 0 && _status.event.getParent().player.hasSkillTag('nofire')) return true;
									return false;
								});
							} else {
								trigger.source.chooseBool('将此伤害改为火焰伤害且获得所有的“硝引”牌').set('ai', function () {
									var att = get.attitude(_status.event.player, _status.event.getParent().player);
									if (_status.event.getParent().player.hasSkillTag('nofire')) {
							...
							if (result.bool) {
								...
								if (trigger.nature == 'fire') {
									...
									trigger.source.chooseToDiscard('弃置一张与“硝引”牌类型相同的牌令本次伤害+1', { type: types });
								} else {
									trigger.source.gain(cards, 'gain2');
									trigger.nature = 'fire';
									player.removeSkill('dcxiaoyin_fire');
									event.finish();
								}
							}
							'step 2'
			...
			dchuahuo: {
				mod: {
					cardUsable: function (card) {
						if (card.storage && card.storage.dchuahuo) return Infinity;
					},
				},
				audio: 2,
				enable: 'phaseUse',
				...
				check: function (card) {
					...
					var att = get.attitude(player, next);
					if (att < 0 && next.hasSkill('dcxiaoyin_fire')) {
						return 9 - get.value(card);
					}
					return 6 - get.value(card);
				},
				group: ['dchuahuo_sha', 'dchuahuo_shaCount'],
				subSkill: {
					sha: {
						trigger: { player: 'useCardToPlayered' },
						usable: 1,
						popup: false,
						filter: function (event, player) {
							return event.getParent().skill == 'dchuahuo' && event.target.getExpansions('dcxiaoyin').length > 0 && game.filterPlayer(function (current) {
								return current.getExpansions('dcxiaoyin').length > 0;
							}).length > 1;
						},
						logTarget: 'target',
						content: function () {
							var targets = game.filterPlayer(function (current) {
								return !trigger.targets.contains(current) && current.getExpansions('dcxiaoyin').length > 0 && lib.filter.targetEnabled(trigger.card, player, current);
							});
							if (targets.length) {
								trigger.targets.addArray(targets);
							}
					...
					shaCount: {
						...
						forced: true,
						filter: function (event, player) {
							return event.getParent().skill == 'dchuahuo' && _status.currentPhase == player;
						},
						content: function () {
