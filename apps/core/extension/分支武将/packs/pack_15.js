// Extracted from character/refresh.js; legacy startup and engine/UI patches are not executed.
export default function(lib, game, ui, get, ai, _status) {
return {
"character": {
			ol_re_caozhi: ['male', 'wei', 3, ['luoying', 'olrejiushi']],
			re_ol_liubiao: ['male', 'qun', 3, ['reolzishou', 'reolzongshi']],
			ol_re_fazheng: ['male', 'shu', 3, ['reolxuanhuo', 'reolenyuan']],
			reol_yufan: ['male', 'wu', 3, ['reolzongxuan', 'reolzhiyan'], ['character:re_yufan']],
			reol_chengpu: ['male', 'wu', 4, ['reollihuo', 'reolchunlao'], ['character:xin_chengpu']],
			redc_caorui: ['male', 'wei', 3, ['redchuituo', 'redcmingjian', 'redcxingshuai'], ['zhu']],
			ol_re_wangyi: ['female', 'wei', 3, ['olrezhenlie', 'olremiji']],
			re_ol_jianyong: ['male', 'shu', 3, ['reolqiaoshui', 'reoljyzongshi'], ['character:xin_jianyong']],
			re_ol_caozhang: ['male', 'wei', 4, ['reoljiangchi'], ['character:xin_caozhang']],
			re_ol_lingtong: ['male', 'wu', 4, ['reolxuanfeng']],
			...
			re_dczhongyao: ['male', 'wei', 3, ['redchuomo', 'zuoding']],
		},
"characterSort": {
			refresh: {
				refresh_standard: [ "re_zhenji"],
				refresh_feng: [],
				refresh_huo: [ "ol_dianwei"],
				refresh_lin: ['re_menghuo', 'ol_sunjian'],
				refresh_shan: [],
				refresh_yijiang1_ol: ['re_ol_lingtong', 'ol_re_fazheng', 'ol_re_caozhi'],
				refresh_yijiang1: [ 're_zhangchunhua'],
				refresh_yijiang2_ol: ['re_ol_caozhang', 'ol_re_wangyi', 'reol_chengpu', 're_ol_liubiao'],
				refresh_yijiang2: [],
				refresh_yijiang3_ol: ['re_ol_jianyong', 'reol_yufan'],
				refresh_yijiang3: [],
				refresh_yijiang4: [],
				refresh_yijiang5: [ 're_dczhongyao', 'redc_caorui'],
				refresh_yijiang6: [],
				refresh_xinghuo: [],
			},
		},
...
"characterTitle": {
			re_ol_caozhang: 'OL·界一将',
			re_ol_lingtong: 'OL·界一将',
			re_caozhang: 'DC·界一将',
			xin_lingtong: 'DC·界一将',
			re_ol_jianyong: 'OL·界一将',
			reol_yufan: 'OL·界一将',
			reol_chengpu: 'OL·界一将',
			re_chengpu: 'DC·界一将',
			re_caochong: 'DC·界一将',
			ol_re_caochong: 'OL·界一将',
		},
"characterIntro": {
...
"translate": {
			...
			re_dcwenpin: '界文聘',
			rezhenwei: '镇卫',
			rezhenwei_info: '当一名其他角色成为【杀】或黑色锦囊牌的目标时（使用者不是你），若该角色的体力值不大于你且此牌的目标角色数为1，你可以弃置一张牌并选择一项：1、摸一张牌，然后将此【杀】或黑色锦囊牌转移给你；2、令此【杀】或黑色锦囊牌无效且将此【杀】或黑色锦囊牌置于使用者的武将牌上，然后当前回合结束后，使用者获得使用者武将牌旁的这些牌。',
			ol_huangzhong: '界黄忠',
			remoshi: '没矢',
			...
			re_dczhongyao: '界钟繇',
			redchuomo: '活墨',
			redchuomo_info: '当你需要使用基本牌时（每种牌名每回合限一次），你可以将一张黑色的非基本牌置于牌堆顶，视为使用此基本牌（视为使用【杀】有距离限制且计入出牌阶段使用限制）。',
			re_ol_lingtong: '界凌统',
			reolxuanfeng: '旋风',
			reolxuanfeng_info: '你一次性失去至少两张牌后，或当你失去一次装备区内的牌后，你可以弃置至多两名其他角色的共计至多两张牌。',
			re_ol_caozhang: '界曹彰',
			reoljiangchi: '将驰',
			reoljiangchi_info: '摸牌阶段结束时，你可以选择一项：1.摸一张牌，本回合使用【杀】的次数-1且【杀】不计入手牌上限；2.重铸一张牌，本回合使用【杀】的次数+1且【杀】无距离限制。',
			re_ol_jianyong: '界简雍',
			reolqiaoshui: '巧说',
			reoljyzongshi: '纵适',
			reolqiaoshui_info: '出牌阶段，你可以拼点：若你赢，你本回合使用的下一张牌可以使目标+1或-1；若你没赢，此技能失效且你不能使用锦囊牌直到此回合结束。',
			reoljyzongshi_info: '当你拼点赢后，你可以获得点数较小的拼点牌；当你拼点没赢后，你可以获得你的拼点牌。',
			ol_re_wangyi: '界王异',
			olrezhenlie: '贞烈',
			olrezhenlie_info: '当你成为其他角色【杀】或普通锦囊牌的目标后，你可以失去1点体力令此牌对你无效，然后你可以选择一项: 1. 获得使用者一张牌: 2:发动一次〖秘计〗。',
			olremiji: '秘计',
			olremiji_info: '结束阶段，你可以摸x张牌(X为你已损失的体力值)，然后你可以交给其他角色至多X张牌。',
			olremiji_tag: '秘计已选择',
			redc_caorui: '界曹叡',
			redchuituo: '恢拓',
			redchuituo_info: '当你受到伤害后，你可以令一名角色进行一次判定，若结果为红色，该角色回复1点体力；若结果为黑色，该角色摸X张牌（X为此次伤害的伤害点数）',
			redcmingjian: '明鉴',
			redcmingjian_info: '出牌阶段限一次。你可以将所有手牌交给一名其他角色，然后该角色于其下个回合获得如下效果：1.手牌上限与使用【杀】的次数上限+1；2.当该角色首次造成伤害后，其可以令你发动一次〖恢拓〗。',
			redcxingshuai: '兴衰',
			redcxingshuai_info: '主公技，限定技。当你进入濒死状态时，你可令其他魏势力角色依次选择是否令你回复1点体力。然后这些角色依次受到1点伤害。',
			reol_yufan: '界虞翻',
			reolzongxuan: '纵玄',
			reolzongxuan_info: '当你或你上家的牌因弃置而置入弃牌堆后，你可以将其中任意张牌置于牌堆顶。',
			reolzhiyan: '直言',
			reolzhiyan_info: '你上家或你的结束阶段，你可以令一名角色摸一张牌并展示之，若为装备牌，其使用之并回复1点体力；若为非装备牌且其体力值不等于你，其失去1点体力。',
			reol_chengpu: '界程普',
			reollihuo: '疠火',
			reollihuo_info: '你可以将非火【杀】当火【杀】使用，结算后若造成伤害，你弃置一张牌或失去1点体力。你使用火【杀】可以使目标+1。',
			reolchunlao: '醇醪',
			reolchunlao_info: '当你的【杀】因弃置而置入弃牌堆后，将之置于武将牌上，称为“醇”。当一名角色处于濒死状态时，你可以移去一张“醇”，视为其使用一张【酒】。',
			ol_re_fazheng: '界法正',
			reolxuanhuo: '眩惑',
			reolxuanhuo_info: '摸牌阶段结束时，你可以交给一名其他角色两张牌，令其选择一项：1.对你指定的另一名角色使用一张【杀】；2.你观看其手牌并获得其两张牌。',
			reolenyuan: '恩怨',
			reolenyuan_info: '当你获得一名其他角色至少两张牌后，你可以令其摸一张牌。当你受到1点伤害后，你可以令伤害来源选择一项：1.交给你一张红色手牌；2.失去1点体力。',
			ol_re_liru: '界李儒',
			olmieji: "灭计",
			olmieji_info: "出牌阶段限一次，你可以将一张锦囊牌置于牌堆顶，然后令一名其他角色弃置一张锦囊牌或两张非锦囊牌。",
			oljuece: "绝策",
			oljuece_info: "结束阶段，你可以对一名手牌数不大于你的其他角色造成1点伤害。",
			re_ol_liubiao: '界刘表',
			reolzishou: '自守',
			reolzishou_info: '摸牌阶段，你可以多摸X张牌（X为全场势力数），然后本回合的结束阶段，若你于本回合对其他角色造成过伤害，你弃置X张牌。',
			reolzongshi: '宗室',
			reolzongshi_info: '锁定技，①你的手牌上限+X（X为全场势力数）；②每个势力限一次，当其他角色对你造成伤害时，防止之，然后伤害来源摸一张牌。',
			ol_re_caochong: '界曹冲',
			olchengxiang: '称象',
			olchengxiang_info: '当你受到1点伤害后，你可以亮出牌堆顶的四张牌。然后获得其中任意数量点数之和不大于13的牌。若获得的牌点数和恰好为13，你下次发动“称象”多亮出一张牌。',
			olrenxin: '仁心',
			olrenxin_info: '当一名其他角色进入濒死阶段时，你可以将武将牌翻面并弃置一张装备牌，然后令其将体力值回复至1点。',
			ol_re_zhangchunhua: '界张春华',
			oljianmie: '翦灭',
			...
			ol_re_caozhi: '界曹植',
			olrejiushi: '酒诗',
			olrejiushi_info: '你可以将武将牌翻至背面，视为使用一张【酒】，当你的武将牌背面朝上时，你使用的“落英”牌无距离限制且不可被响应。当你受到伤害或者回合外累计获取至少X张“落英”牌后（X为你体力值上限），若你的武将牌背面朝上，你可以翻至正面。',
			...
			refresh_lin: '界限突破·林',
			refresh_shan: '界限突破·山',
			refresh_yijiang1_ol: '将1·OL',
			refresh_yijiang2_ol: '将2·OL',
			refresh_yijiang3_ol: '将3·OL',
			refresh_yijiang1: '将1·DC',
			refresh_yijiang2: '将2·DC',
			refresh_yijiang3: '将3·DC',
			refresh_yijiang4: '将4·DC',
			refresh_yijiang5: '将5·DC',
			refresh_yijiang6: '原6·DC',
			refresh_xinghuo: '界限突破·星火燎原',
		},
"skill": {
			olrejiushi: {
				audio: 2,
				...
				mod: {
					targetInRange: function (card, player, target) {
						if (player.isTurnedOver() && card.cards && card.cards[0].hasGaintag('luoying')) return true;
					},
				},
				ai: {
					order: 5,
				...
				group: ['olrejiushi_1', 'olrejiushi_2', 'olrejiushi_4', 'olrejiushi_5'],
				subSkill: {
					1: {
						trigger: {
							player: "gainAfter",
						...
						filter: function (event, player) {
							...
							return cards && cards.length && event.getParent().name == "luoying_discard";
						},
						direct: true,
						charlotte: true,
						content: function () {
							player.addGaintag(trigger.cards, 'luoying');
							if (_status.currentPhase != player) {
								player.storage.olrejiushi += trigger.cards.length;
								player.markSkill('olrejiushi');
								if (player.isTurnedOver() && player.storage.olrejiushi > player.maxHp) {
									var next = game.createEvent('olrejiushi_turn');
									next.player = player;
									next.setContent('olrejiushi_2');
								}
							}
					...
					2: {
						...
						content: function () {
							'step 0'
							player.chooseBool('是否将武将牌翻回正面').set('ai', () => { return true });
							'step 1'
							if (result.bool) {
								player.logSkill('olrejiushi');
								player.turnOver(false);
								player.storage.olrejiushi = 0;
								player.unmarkSkill('olrejiushi');
							}
						}
					},
					4: {
						...
						filter: function (event, player) {
							return event.card && event.card.gaintag && event.card.gaintag.contains('luoying') && player.isTurnedOver();
						},
						charlotte: true,
						direct: true,
						silent: true,
						content: function () {
							...
							else trigger.directHit = game.players;
			...
			olganlu: {
				...
				content: function () {
					...
					if (player.getDamagedHp() < num) player.chooseToDiscard('h', num, true);
				},
				ai: {
					order: 10,
					expose: 0.2,
			...
			olbuyi: {
				...
				content: function () {
					'step 0'
					if (player == trigger.player) player.chooseCard('hej', true).set('ai', function (card) {
						if (get.type(card) != 'basic') return 100 - get.value(card);
						return 0;
					});
					else player.choosePlayerCard('hej', trigger.player, true);
					'step 1'
			...
			oljianmie: {
				...
				content: function () {
					...
					if (list.length == 1) event._result = { control: list[0] };
						...
						list.sort();
						target.chooseControl(list).set('prompt', '选择弃置一种颜色的所有手牌').set('ai', function () {
					...
					if (list.length == 1) event._result = { control: list[0] };
						...
						list.sort();
						player.chooseControl(list).set('prompt', '选择弃置一种颜色的所有手牌').set('ai', function () {
							var player = _status.event.player;
							if (get.value(player.getCards('h', { color: 'red' })) >= get.value(player.getCards('h', { color: 'black' }))) return 'black';
							return 'red';
						});
					...
					'step 1'
					var discardedPlayerCards = player.getCards('h', { color: result.control });
					var discardedTargetCards = event.target.getCards('h', { color: result.control });
					player.discard(discardedPlayerCards);
					event.target.discard(discardedTargetCards);
					if (discardedPlayerCards.length != discardedTargetCards.length) {
						const user = discardedPlayerCards.length > discardedTargetCards.length ? player : target;
						const aim = user == player ? target : player;
						var card = { name: 'juedou', isCard: true };
						if (user.canUse(card, aim, false)) user.useCard(card, aim, false);
					}
				},
			},
			olchengxiang: {
				...
				content: function () {
					...
					"step 1"
					var num = 4;
					if (player.storage.olchengxiang_1) {
						num += player.storage.olchengxiang_1;
						player.storage.olchengxiang_1 = 0;
						player.unmarkSkill('olchengxiang_1');
					}
					...
					event.count--;
					'step 5'
					if (event.count > 0 && player.hasSkill('olchengxiang')) {
						player.chooseBool(get.prompt2('olchengxiang'));
					}
					else event.finish();
					'step 6'
					if (result.bool) {
						player.logSkill('olchengxiang');
						event.goto(1);
					}
				},
				group: 'olchengxiang_1',
				subSkill: {
					1: {
						audio: 2,
						trigger: {
						...
						content: function () {
							if (!player.storage.olchengxiang_1) player.storage.olchengxiang_1 = 0;
							player.storage.olchengxiang_1 += 1;
							player.markSkill('olchengxiang_1');
						},
					}
				},
				ai: {
			...
			olrenxin: {
				...
				content: function () {
					"step 0"
					var next = player.chooseToDiscard(get.prompt('olrenxin', trigger.player), '弃置一张装备牌并将武将牌翻面，然后令' + get.translation(trigger.player) + '将体力值回复至1点', { type: 'equip' }, 'he');
					next.logSkill = ['olrenxin', trigger.player];
			...
			reolzishou: {
				...
				check: function (event, player) {
					return player.countCards('h') <= player.getHandcardLimit() || player.skipList.contains('phaseUse') || !player.countCards('h', function (card) {
				...
				content: function () {
					...
					player.addTempSkill('reolzishou_1', 'phaseJieshuEnd');
				},
				ai: {
					threaten: 0.6,
				},
				subSkill: {
					1: {
						...
						charlotte: true,
						filter: function (event, player) {
							return player.getHistory('sourceDamage').length && player.countCards('he');
						},
						content: function () {
							player.chooseToDiscard(true, '弃置' + game.countGroup() + '张牌', Math.min(game.countGroup(), player.countCards('he')), 'he');
						}
					}
				}
			},
			reolzongshi: {
				...
				filter: function (event, player) {
					return event.source && !player.storage.reolzongshi.contains(event.source.group)
				},
				content: function () {
					'step 0'
					trigger.cancel();
					'step 1'
					trigger.source.draw();
					player.storage.reolzongshi.add(trigger.source.group)
					'step 2'
					player.markSkill('reolzongshi')
				}
			},
			reolenyuan: {
				audio: 2,
				...
				content: function () {
					...
					"step 1"
					trigger.source.chooseCard('交给' + get.translation(player) + '一张红色手牌，或点“取消”失去1点体力', 'h', function (card, player) {
					...
					if (event.num > 1 && player.hasSkill('reolenyuan') && trigger.source && trigger.source.isIn()) {
						player.logSkill('reolenyuan', trigger.source)
						event.num--;
						event.goto(1);
					}
				},
			...
			olmieji: {
				...
				content: function () {
					...
					if (!target.countCards('he', function (card) {
						...
						return lib.filter.cardDiscardable(card, target, 'olmieji');
					})) event.finish();
					else target.chooseCard('he', true, function (card, player) {
						if (get.type2(card) == 'trick') return true;
						return lib.filter.cardDiscardable(card, player, 'olmieji');
					}).set('prompt', '选择弃置' + get.translation(player) + '一张锦囊牌，或依次弃置两张非锦囊牌。');
					'step 2'
			...
			oljuece: {
				...
				content: function () {
					'step 0'
					player.chooseTarget(get.prompt('oljuece'), '对一名没有手牌的角色造成1点伤害', function (card, player, target) {
						return player.countCards('h') >= target.countCards('h') && target != player;
					...
					'step 1'
					if (result.bool) {
						player.logSkill('oljuece', result.targets);
			...
			reolxuanhuo: {
				...
				content: function () {
					...
					var ai2 = function (target) {
						...
						var list = [null].concat(lib.inpile_nature);
					...
					player.chooseCardTarget({
						prompt: get.prompt2('reolxuanhuo'),
						filterCard: true,
						selectCard: 2,
						position: 'h',
						filterTarget: lib.filter.notMe,
					...
					if (result.bool) {
						...
						event.target = target;
						player.logSkill('reolxuanhuo', target);
					...
					}, '选择' + get.translation(target) + '使用【杀】的目标', true).set('target', event.target).set('ai', function (target) {
						return get.effect(target, { name: 'sha' }, _status.event.target, _status.event.player);
					});
					else {
						event.reolxuanhuo_shad = false;
						event.goto(4);
					};
					'step 3'
					...
					event.target.chooseToUse('对' + get.translation(target2) + '使用一张杀，或令' + get.translation(player) + '获得你的两张牌', { name: 'sha' }, target2, -1);
					'step 4'
					if (result.bool == false || event.reolxuanhuo_shad == false) {
						player.gainPlayerCard('he', event.target, Math.min(2, event.target.countCards('he')), true, 'visible');
					}
				},
				ai: {
					expose: 0.2,
			...
			reolzongxuan: {
				...
				filter: function (event, player) {
					if (event.player != player && event.player != player.previous) return false;
				...
				check: function (trigger, player) {
					if (trigger.getParent(3).name != 'phaseDiscard' || !game.hasPlayer(function (current) {
						return current.hp >= player && get.attitude(current, player) <= 0
					})) return false;
					var evt = trigger.getl(trigger.player);
					for (var i = 0; i < evt.cards2.length; i++) {
						if (get.position(evt.cards2[i], true) == 'd' && get.type(evt.cards2[i], false) != 'equip' && get.value(evt.cards2[i]) < 6) {
							return true;
						}
					}
					return false;
			...
			reolzhiyan: {
				...
				content: function () {
					"step 0"
					player.chooseTarget(get.prompt('reolzhiyan'), '令一名角色摸一张牌并展示之').set('ai', function (target) {
						var player = _status.event.player;
						if (target.hp >= player) return -get.attitude(player, target);
						else return get.attitude(player, target);
					});
					"step 1"
					if (result.bool) {
						event.target = result.targets[0];
						player.logSkill('reolzhiyan', result.targets);
						event.bool = false;
					...
					else if (event.target.hp != player.hp) event.target.loseHp();
					"step 3"
			...
			reollihuo: {
				...
				group: ['lihuo2', 'reollihuo_dam', 'reollihuo_f'],
				subSkill: {
					dam: {
						charlotte: true,
						direct: true,
						...
						filter: function (event, player) {
							return event.getParent(2).reollihuo == 1 && event.card && event.card.name == 'sha' && event.card.nature == 'fire'
						},
						content: function () {
							trigger.getParent(2).reollihuo = 2;
						}
					},
					f: {
						charlotte: true,
						...
						filter: function (event, player) {
							return event.reollihuo == 2 && event.card && event.card.name == 'sha' && event.card.nature == 'fire'
						},
						content: function () {
							'step 0'
							player.chooseToDiscard('弃置1张牌，否则失去1点体力', 1, 'he', false).set('ai', function (card) {
								var player = _status.event.player;
								if (player.hp == 1) return 10 - get.value(card);
								return 4 - get.value(card) + (player.maxHp - player.hp) * 2;
							});
							'step 1'
							if (result.bool) { }
							else player.loseHp();
			...
			reolchunlao: {
				...
				filter: function (event, player) {
					...
					for (var i = 0; i < evt.cards2.length; i++) {
						if (get.position(evt.cards2[i]) == 'd' && evt.cards2[i].name == 'sha') {
							return true;
						}
					}
					return false;
				...
				content: function () {
					...
					for (var i = 0; i < cards2.length; i++) {
						if (get.position(cards2[i], true) == 'd' && cards2[i].name == 'sha') {
							event.cards.push(cards2[i]);
						}
					}
					'step 1'
					player.addToExpansion(event.cards, player, 'giveAuto').gaintag.add('reolchunlao');
				},
				group: 'reolchunlao_jiu',
				subSkill: {
					jiu: {
						enable: 'chooseToUse',
						filter: function (event, player) {
							return event.type == 'dying' && event.dying && event.dying.hp <= 0 && player.getExpansions('reolchunlao').length > 0;
						},
						filterTarget: function (card, player, target) {
						...
						content: function () {
							"step 0"
							player.chooseCardButton(get.translation('reolchunlao'), player.getExpansions('reolchunlao'), true);
							"step 1"
							if (result.bool) {
								player.logSkill('reolchunlao', target);
						...
						ai: {
							order: 6,
							skillTagFilter: function (player) {
								return player.getExpansions('reolchunlao').length > 0;
							},
							save: true,
							result: {
								target: 1.5
			...
			redchuituo: {
				...
				content: function () {
					'step 0'
					player.chooseTarget(get.prompt2('redchuituo')).set('ai', function (target) {
						var player = _status.event.player;
					...
					'step 1'
					if (result.bool) {
						player.logSkill('redchuituo', result.targets);
						var target = result.targets[0];
						event.target = target;
			...
			redcmingjian: {
				...
				content: function () {
					...
					target.addTempSkill('redcmingjian_buff', { player: 'phaseAfter' });
					if (!target.storage.redcmingjian_buff) target.storage.redcmingjian_buff = [];
					target.storage.redcmingjian_buff.push(player);
					target.markSkill('redcmingjian_buff');
				},
				subSkill: {
					buff: {
						charlotte: true,
						...
						filter: function (event, player) {
							...
							return player.getHistory('sourceDamage').indexOf(event) == 0 && game.countPlayer(function (current, player) {
								return current.hasSkill('redchuituo') && current != _status.currentPhase && current.name == 'redc_caorui';
							});
						},
						prompt: function () {
							var str = '是否令界曹叡发动一次恢拓';
							return str;
						},
						content: function (event, map) {
							'step 0'
							game.countPlayer(function (current, player) {
								if (current.hasSkill('redchuituo') && current != _status.currentPhase && current.name == 'redc_caorui') {
									var next = game.createEvent('redchuituo');
									next.setContent(lib.skill.redchuituo.content);
									next.player = current;
									next.forced = true;
									next._trigger = event.trigger;
									/*next.setResult.bool=true;
									next.current=result.target;
									next.setStep(lib.skill.redchuituo.step1);*/
								}
							});
						},
						mod: {
							maxHandcard: function (player, num) {
								return num + player.getStorage('redcmingjian_buff').length;
							},
							cardUsable: function (card, player, num) {
								if (card.name == 'sha') return num + player.getStorage('redcmingjian_buff').length;
							}
						},
					}
				},
			...
			redcxingshuai: {
				...
				zhuSkill: true,
				filter: function (event, player) {
					if (player.storage.redcxingshuai) return false;
					if (player.hp > 0) return false;
					if (!player.hasZhuSkill('redcxingshuai')) return false;
					return game.hasPlayer(function (current) {
						return current != player && current.group == 'wei';
					});
				},
				init: function (player) {
					if (player.hasZhuSkill('redcxingshuai')) {
						player.markSkill('redcxingshuai');
						player.storage.redcxingshuai = false;
					}
				},
				intro: {
					content: 'limited'
				...
				content: function () {
					'step 0'
					player.storage.redcxingshuai = true;
					player.awakenSkill('redcxingshuai');
					...
					if (event.damages.length) {
						var next = game.createEvent('redcxingshuai_next');
			...
			olrezhenlie: {
				...
				content: function () {
					...
					player.chooseControl(list,).set('ai', function () {
						if (player.maxHp - player.hp > 1) return '发动一次秘计';
						return '获得其一张牌';
					});
					'step 3'
					if (result.control == '获得其一张牌') {
						player.gainPlayerCard(trigger.player, 'he', true);
					}
					if (result.control == '发动一次秘计') {
						const next = game.createEvent('olremiji');
						next.setContent(lib.skill.olremiji.content);
						next.player = player;
						next.forced = true;
						//next._trigger=player;
					}
				},
				ai: {
					expose: 0.3,
			...
			olremiji: {
				...
				content: function () {
					...
					event.given_map = {};
					"step 1"
					var check = player.countCards('he') - event.num;
					player.chooseCardTarget({
						...
						filterCard: function (card, player, target) {
							return get.itemtype(card) == 'card' && !card.hasGaintag('olremiji_tag');
						},
						ai1: function (card) {
							var player = _status.event.player;
					...
					if (result.bool) {
						...
						player.addGaintag(res, 'olremiji_tag');
			...
			reolqiaoshui: {
				...
				enable: "phaseUse",
				init: function (player) {
					player.storage.reolqiaoshui = 0;
				},
				filterTarget: function (card, player, target) {
					return player.canCompare(target);
				},
				filter: function (event, player) {
					return player.countCards('h') > 0 && !player.hasSkill('qiaoshui2');
				},
				content: function () {
					'step 0'
					...
					'step 1'
					if (result.bool) {
						player.storage.reolqiaoshui++;
						player.addTempSkill('reolqiaoshui_mult', 'phaseUseEnd');
					}
					else {
						player.addTempSkill('qiaoshui2', 'phaseEnd');
					}
				},
				ai: {
				...
				subSkill: {
					mult: {
						...
						content: function () {
							'step 0'
							player.removeSkill('reolqiaoshui_mult');
							var goon = false;
							...
							if (goon) {
								player.chooseTarget('巧说：是否额外指定' + player.storage.reolqiaoshui + '名' + get.translation(trigger.card) + '的目标？', [1, player.storage.reolqiaoshui], function (card, player, target) {
							...
							'step 2'
							if (event.target) {
								player.logSkill('reolqiaoshui', event.target);
								trigger.targets.add(event.target);
							}
							event.finish();
							'step 3'
							player.chooseTarget('巧说：是否减少' + player.storage.reolqiaoshui + '名' + get.translation(trigger.card) + '的目标？', [1, player.storage.reolqiaoshui], function (card, player, target) {
							...
							if (result.bool) {
								...
								if (event.isMine()) {
									player.logSkill('reolqiaoshui', event.targets);
									event.finish();
								}
						...
						filter: function (event, player) {
							return player.storage.reolqiaoshui > 0;
						},
						direct: true,
						charlotte: true,
						content: function () {
				...
				content: function () {
					if (player == trigger.player) {
						if (trigger.num1 > trigger.num2) {
							if (get.number(trigger.card1) > get.number(trigger.card2)) player.gain(trigger.card2, 'gain2', 'log');
							else player.gain(trigger.card1, 'gain2', 'log');
						}
						else {
			...
			reolxuanfeng: {
				...
				filter: function (event, player) {
					...
					return cards && ((cards.cards2 && cards.cards2.length >= 2) || (cards.player == player && cards.es && cards.es.length > 0));
				},
				content: function () {
					"step 0"
					event.count = 2;
					event.logged = false;
					"step 1"
					player.chooseTarget(get.prompt('reolxuanfeng'), '弃置一名其他角色的一张牌', function (card, player, target) {
					...
					if (result.bool) {
						if (!event.logged) {
							player.logSkill('reolxuanfeng', result.targets);
							event.logged = true;
						}
			...
			reoljiangchi: {
				...
				content: function () {
					"step 0"
					var list = ['摸牌', '重铸', '取消'];
					if (!player.countCards('he')) list.remove('重铸');
					player.chooseControl(list, function () {
						...
						return 'cancel2';
					}).set('prompt', get.prompt2('reoljiangchi'));
					"step 1"
					if (result.control == '重铸') {
						player.chooseToChongzhu(true, 'he');
						player.addTempSkill('reoljiangchi_reforge', 'phaseEnd');
						player.logSkill('reoljiangchi');
					}
					else if (result.control == '摸牌') {
						player.draw();
						player.addTempSkill('reoljiangchi_draw', 'phaseEnd');
						player.logSkill('reoljiangchi');
					}
				},
				subSkill: {
			...
			redchuomo: {
				...
				hiddenCard: function (player, name) {
					...
					const list = [];
					var his = player.getHistory('custom', function (evt) { return evt.redchuomo });
					for (var i = 0; i < his.length; i++) list.add(his[i].redchuomo);
				...
				chooseButton: {
					...
					backup: function (links, player) {
						return {
							...
							ignoreMod: true,
							precontent: function () {
								player.logSkill('redchuomo');
								var card = event.result.cards[0];
								player.getHistory('custom').push({ redchuomo: event.result.card.name });
								...
								event.result.cards = [];
								player.markAuto('redchuomo', event.result.card.name);
							},
						}
					},
