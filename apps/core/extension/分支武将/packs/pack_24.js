// Extracted from character/tw.js; legacy startup and engine/UI patches are not executed.
export default function(lib, game, ui, get, ai, _status) {
return {
"character": {
			huan_zhugeguo: ['female', 'shu', 3, ['twxianyuan', 'twlingyin']],
			huan_zhugeliang: ["male", "shu", '3/4', ['beiding', 'jielv', 'hunyou'], ['transform:[huan_zhugeliang,huan_zhugeliang2]']],
			huan_zhugeliang2: ["male", "shu", '3/4', ['huan_beiding', 'huan_jielv', 'huanji', 'changgui'], ['unseen', 'transform:[huan_zhugeliang,huan_zhugeliang2]']],
...
"characterSort": {
			tw: {
				tw_sp: [ 'tw_caocao',
					'tw_caozhao'],
				tw_yunchouzhi: [ 'tw_dongzhao'],
				tw_yunchouxin: [],
				tw_yunchouren: [],
				tw_yunchouyong: [],
				tw_yunchouyan: [],
				tw_swordsman: [ 'xia_xiahouyuan'],
				tw_if: ['huan_zhugeliang', 'huan_zhugeliang2', 'huan_zhugeguo', 'huan_simaiyi'],
				tw_mobile: [],
				tw_mobile2: [],
				tw_yijiang: [],
				tw_english: [],
...
"characterIntro": {
			...
			shia: '三国人物，善剑术。桓、灵间，有虎贲王越以剑术称于京师，阿得其法。魏帝曹丕曾从阿学剑术。',
			yuzhenzi: '三国时期，舆左慈、南华老仙同是得道之人，奉天之意，帮助天下有志者得到能力，以此终结乱世，但不能过於插手。於是玉真子选择将极致的武学流传舆世間，收下王越、李彦、童渊三名徒弟。',
...
"translate": {
			...
			twfeifu: '非服',
			twfeifu_info: '锁定技，转换技，阳：当你成为【杀】的唯一目标后；阴：当你使用【杀】指定唯一目标后；目标角色须交给使用者一张牌。若此牌为装备牌，则使用者可使用此牌。',
			tw_wangchang: 'TW王昶',
			twkaiji: '开济',
			...
			twzhenliang: '贞良',
			twzhenliang_info: '转换技，阳：出牌阶段限一次。你可以弃置一张牌并对攻击范围内的一名角色造成1点伤害。阴：当你或你攻击范围内的一名角色于你的回合外受到伤害时，你可以弃置一张牌令此伤害-1。然后若你以此法弃置的牌颜色与“任”的颜色相同，你摸一张牌。',
			tw_zhangnan: '张南',
			twfenwu: '奋武',
			...
			twkujian: '苦谏',
			twkujianx: '谏',
			twkujian_info: '出牌阶段限一次，你可以将至多两张手牌标记为“谏”并交给一名其他角色。当其他角色使用或打出“谏”牌时，你与其各摸两张牌。当其他角色非因使用或打出从手牌区失去“谏”牌时，你与其各弃置一张牌。',
			twruilian: '睿敛',
			twruilian2: '睿敛',
			twruilian_info: '每轮开始时，你可以选择一名角色，该角色接下来的一个回合结束时，若其此回合弃置的牌数不小于1，你可以选择一种类型（其本回合须弃置过此类型的牌），然后你与该角色依次从弃牌堆中随机获得一张此类型的牌。',
			tw_xiahouen: '夏侯恩',
			twfujian: '负剑',
			...
			twkuanji: '宽济',
			twkuanji_info: '每回合限一次。当你的牌不因使用而进入弃牌堆后，你可以令一名其他角色获得其中的任意张牌。',
			xia_wangyue: '王越',
			twyulong: '驭龙',
			...
			tw_yuzhenzi: '玉真子',
			twhuajing: '化境',
			twhuajing_info: '游戏开始时，你获得6枚效果不同的“武”标记，有“武”的角色攻击距离+X（X为其“武”数）。出牌阶段限一次，你可以展示至多四张手牌，并随机获得其中花色数个“武”的效果直到本回合结束。当一名角色拥有“武”的效果时，其装备区内的的武器牌效果失效。',
			twtianshou: '天授',
			twtianshou_info: '锁定技，回合结束时，若你本回合使用【杀】造成过伤害，你选择1枚本回合已获得效果的“武”交给一名其他角色并令其获得对应效果，然后你摸一张牌，其下回合结束后移除此标记。',
			twtianshou_1: '剑',
			twtianshou_1_info: '你使用【杀】指定目标后，随机弃置其两张手牌。',
			twtianshou_2: '刀',
			twtianshou_2_info: '你使用【杀】造成伤害时，若目标角色没有手牌，伤害＋1。',
			twtianshou_3: '斧',
			twtianshou_3_info: '你使用【杀】被【闪】抵消时，对目标角色造成1点伤害。',
			twtianshou_4: '枪',
			twtianshou_4_info: '你使用的黑色【杀】结算后，从牌堆或弃牌堆获得一张【杀】。',
			twtianshou_5: '戟',
			twtianshou_5_info: '你使用【杀】造成伤害时，你摸一张牌。',
			twtianshou_6: '弓',
			twtianshou_6_info: '你使用【杀】造成伤害后，随机弃置其装备区里的一张牌。',
			tw_shia: '史阿',
			twdengjian: '登剑',
			twdengjian_info: '其他角色的弃牌阶段结束时，你可以弃置一张牌并从弃牌堆随机获得一张其本回合造成过伤害的【杀】（每轮每种颜色限一次），且此【杀】不计次数。',
			twxinshou: '心授',
			twxinshou_info: '当你于出牌阶段使用一张与本回合你使用过的【杀】颜色均不同的【杀】时，你可以选择一项本回合未执行过的效果：1.摸一张牌；2.交给一名其他角色一张牌。当你使用【杀】时，若你本回合执行过此技能所有效果，你可以令“登剑”失效并令一名角色直到你下回合开始时获得“登剑”，若其有“登剑”时使用【杀】造成过伤害，你下回合开始时“登剑”重新生效。',
			tw_shitao: '石韬',
			twjieqiu: '劫囚',
			twjieqiu_info: '出牌阶段限一次，你可以选择一名所有装备栏均未被废除的其他角色，废除其所有装备栏，然后其摸X张牌（X为其废除前装备区内的牌数）。其弃牌阶段结束时，其恢复等同于此阶段弃置手牌数的装备栏。每轮限一次，其回合结束时，若仍有废除的装备栏，你可以获得一个额外的回合。',
			twenchou: '恩仇',
			twenchou_info: '出牌阶段限一次，你可以观看一名有废除装备栏的其他角色的手牌并获得其中一张牌，然后你恢复其一个装备栏。',
			xia_guanyu: '侠关羽',
			twzhongyi: '忠义',
			twzhongyi_info: '锁定技，你使用【杀】无距离限制。当你使用【杀】结算后，你选择一项：1.摸等同于此【杀】伤害和的牌；2.回复等同于此【杀】伤害和的体力；3.背水：你失去X点体力（X为此技能选择背水的次数）。',
			twchue: '除恶',
			twchue_info: '当你使用【杀】指定唯一目标时，你可以失去1点体力，多指定至多X个目标。当你扣减体力后，你摸一张牌并获得1枚“勇”标记。每名角色的回合结束时，若你本回合获得过“勇”，你可以移去X枚“勇”，然后视为使用一张【杀】，此【杀】造成的伤害+1且可以多选择X个目标（X为你的体力值）。',
			xia_xiahoudun: '侠夏侯惇',
			twdanlie: '胆烈',
			...
			twchongzhen: '冲阵',
			twchongzhen_info: '当你因发动〖龙胆〗而使用或打出【杀】或【闪】时，你可以获得对方的一张手牌。',
			huan_zhanghe: '幻张郃',
			twkuiduan: '溃端',
			...
			huan_zhugeliang2: '幻诸葛亮',
			beiding: '北定',
			beiding_info: '每名角色的准备阶段，你可以声明并记录至多X个未记录的基本牌或普通锦囊牌牌名（X为你的体力值）。当前回合角色弃牌阶段结束时，你视为依次使用本回合声明的牌（无距离限制），若此牌的目标不包含其，其摸一张牌。',
			jielv: '竭虑',
			jielv_info: '锁定技。①每名角色回合结束时，若你未对其使用牌，你失去1点体力。②当你失去1点体力或受到1点伤害后，若你的体力上限小于7，你增加1点体力上限。',
			hunyou: '魂游',
			hunyou_info: '限定技，当你处于濒死状态时，你可以将体力值回复至1点，若如此做，本回合当你受到伤害时或失去体力时，取消之；当前回合结束后，你入幻：进行一个额外的回合。',
			huan_beiding: '北定',
			huan_beiding_info: '锁定技。你使用〖北定〗记录的牌无距离限制且不计入次数；当你使用〖北定〗记录的牌结算结束后，你摸一张牌，然后从〖北定〗记录中移除此牌名。',
			huan_jielv: '竭虑',
			huan_jielv_info: '锁定技，当你减少1点体力上限后，你回复1点体力。',
			huanji: '幻技',
			huanji_info: '出牌阶段限一次，你可以减少1点体力上限，在〖北定〗记录中增加X张牌名（X为你的体力值）。',
			changgui: '怅归',
			changgui_info: '锁定技，结束阶段，若你的体力值为全场最低，你须退幻：将体力上限调整为当前体力值。',
			huan_jiangwei: '幻姜维',
			twqinghan: '擎汉',
			...
			huan_zhugeguo: '幻诸葛果',
			twxianyuan: '仙援',
			twxianyuan_info: '①每轮开始时，你获得两个“仙援”标记（每名角色至多拥有三个“仙援”）。②出牌阶段，你可将任意个“仙援”标记分配给其他角色。③拥有“仙援”标记的角色出牌阶段开始时，你选择一项：1.观看其手牌，并将其中至多X张牌以任意顺序置于牌堆顶；2.其摸x张牌（x为其拥有的“仙授”标记数）。执行完毕后，若此时为其他玩家的回合，你移除该角色的所有“仙援”标记。',
			twlingyin: '灵隐',
			...
			huan_liushan: "幻刘禅",
			twguihan: "归汉",
			twguihan_info: "出牌阶段限一次，你可以选择至多三名有手牌的其他角色。你展示牌堆顶的一张牌，然后这些角色依次选择一项：①将一张与此牌类别相同的牌置于牌堆顶；②失去1点体力。然后你选择一项，摸X张牌，获得牌堆顶第X张牌下的三张牌（X为本次选择选项①的角色数）。",
			twrenxian: "任贤",
			twrenxian_info: "出牌阶段限一次，你可以将手牌中除【闪】外的所有基本牌交给一名其他角色，然后令其于本回合结束后执行一个额外的出牌阶段（只能使用你交给其的牌，且使用【杀】无次数限制）。",
			twyanzuo: "延祚",
			...
			huan_liufeng: "幻刘封",
			twchenxun: "沉勋",
			twchenxun_info: "每轮开始时，你可视为对一名其他角色使用一张【决斗】。此牌结算结束后，若此牌:<br>对其造过伤害，你摸两张牌，然后可以对本轮未成为过此技能的目标的其他角色再次发动此技能；<br>未对其造成过伤害，你失去X点体力(X为你本轮以此法使用的【决斗】的次数)。",
...
"skill": {
			twchenxun: {
				...
				filter: function (event, player) {
					return game.hasPlayer(function (current) {
						return player.canUse('juedou', current, false) && !player.getStorage("twchenxun_effect").includes(current);
					});
				},
				direct: true,
				content: function () {
					...
					if (game.hasPlayer(function (current) {
						...
						player.chooseTarget(get.prompt2('twchenxun'), "你可以与一名本轮未成为过此技能的其他角色决斗", function (card, player, target) {
							return target != player && !player.getStorage("twchenxun_effect").includes(target);
					...
					"step 1"
					if (result.bool) {
						player.logSkill('twchenxun', result.targets[0]);
						player.addTempSkill("twchenxun_effect", 'roundStart');
						player.markAuto("twchenxun_effect", result.targets[0]);
						player.useCard({ name: 'juedou', isCard: true, storage: { twchenxun: true } }, result.targets[0], false);
					}
				},
				subSkill: {
					effect: {
						...
						filter: function (event, player) {
							return event.card.storage && event.card.storage.twchenxun;
						},
						charlotte: true,
						direct: true,
						onremove: true,
						content: function () {
							...
							for (var target of targets) {
								if (target != player) {
									var num = player.getStorage("twchenxun_effect").length;
									if (num > 0) player.loseHp(num);
								}
								else {
									player.draw(2);
									const next = game.createEvent('twchenxun');
									next.setContent(lib.skill.twchenxun.content);
									next.player = player;
									next.forced = true;
								}
							}
			...
			twguihan: {
				...
				content: function () {
					'step 0'
					event.card = get.cards(1, true)[0], event.list = event.targets.slice().sortBySeat();
					player.showCards([event.card], get.translation(player) + '发动了【归汉】');
					event.num = 0;
					console.log(event.card);
					'step 1'
					event.current = event.list.shift();
					event.current.chooseCard(`归汉：将一张${get.translation(get.type2(event.card))}牌置于牌堆顶，或失去1点体力`, (card, player) => {
					...
					if (result.bool) {
						...
						event.current.lose(result.cards[0], ui.cardPile, 'insert');
						game.log(event.current, '将一张牌置于了牌堆顶');
					...
					if (event.list.length) event.goto(1);
						...
						player.chooseControl()
							.set('choiceList', [`摸${get.cnNumber(event.num)}张牌`, `获得牌堆顶第${get.cnNumber(event.num)}张牌下的三张牌`])
							.set('prompt', '归汉：请选择一项')
							.set('ai', () => {
								var player = _status.event.player, index = event.num >= 3 - event.num ? 0 : 1;
								return player.hasSkillTag('nogain') ? 1 - index : index;
							});
					}
					'step 4'
					if (result.index == 0 && event.num > 0) player.draw(event.num);
					else if (ui.cardPile.childElementCount > event.num) {
						var gains = Array.from(ui.cardPile.childNodes).slice(event.num).slice(0, 3);
						if (gains.length > 0) player.gain(gains, 'gain2');
					}
				},
				ai: {
					order: 1,
			...
			twrenxian: {
				...
				content: function () {
					...
					event.target.addTempSkill('twrenxian_phase', { player: 'twrenxian_phaseAfter' });
					event.target.markAuto('twrenxian_phase', event.cards);
				},
				subSkill: {
					phase: {
						charlotte: true,
						...
						popup: false,
						content: function () {
							player.addTempSkill('twrenxian_mark', { player: 'phaseUseAfter' });
							player.markAuto('twrenxian_mark', player.getStorage('twrenxian_phase'));
							var next = player.phaseUse();
							trigger.next.push(next); //操作很操蛋，但海外服大概率也这么干的，按无名杀和规则集传统应该是新建一个只有出牌阶段的回合
						},
					},
					mark: {
						mark: true,
			...
			twyanzuo: {
				...
				filter: function (event, player) {
					...
					return event.source && event.source != player && event.source.group == 'shu';
				},
				usable: 3,
				zhuSkill: true,
				forced: true,
			...
			twlifeng: {
				...
				enable: 'phaseUse',
				filter: function (event, player) {
					if (!player.countCards('he') || player.hasSkill('twlifeng_block')) return false;
					// 这个判断真的奇
				...
				filterTarget: function (card, player, target) {
					...
					let cards = ui.selected.cards, num = Math.abs(get.number(cards[0], player) - get.number(cards[1], player));
				...
				subSkill: {
					effect: {
						...
						content: function () {
							'step 0'
							event.target = trigger.player, event.cards = trigger.getParent().cards;
							var num = [get.number(event.cards[0]), get.number(event.cards[1])];
							if (num[0] > num[1]) num.reverse();
							if (event.target.countCards('h')) {
								event.target.chooseCard('是否重铸一张手牌？', `若此牌点数位于${num[0]}和${num[1]}之间，防止此伤害`)
									.set('ai', card => {
										if (get.damageEffect(_status.event.player, _status.event.getTrigger().source, _status.event.player) > 0) return 0;
										if (get.number(card) >= num[0] && get.number(card) <= num[1]) return 15 - get.value(card);
										return 8 - get.value(card);
									});
							} else event.target.chooseBool('是否摸一张牌？', `若此牌点数位于${num[0]}和${num[1]}之间，防止此伤害`);
							'step 1'
							if (result.bool) {
							...
							var num = [get.number(event.cards[0]), get.number(event.cards[1])];
							if (get.number(event.card) >= num[0] && get.number(event.card) <= num[1]) {
								trigger.cancel();
								player.addTempSkill('twlifeng_block');
							}
						},
					},
					block: {
			...
			twniwo: {
				...
				content: function () {
					'step 0'
					player.chooseTarget(get.prompt2('twniwo'), lib.filter.notMe)
						.set('ai', target => {
					...
					if (result.bool) {
						...
						event.target = target;
						var dialog = ['选择你与' + get.translation(target) + '的等量张手牌'];
						...
						player.chooseButton(dialog, true, [2, Infinity])
							.set('filterOk', () => {
								var buttons = ui.selected.buttons;
								return buttons.filter(i => get.owner(i.link) == _status.event.player).length * 2 == buttons.length;
							})
							.set('cards', (function () {
					...
					'step 2'
					for (var owner of [player, event.target]) {
			...
			twqiji: {
				...
				content: function () {
					'step 0'
					var hs = player.getCards('h'), list = [];
					for (var i of hs) {
						list.add(get.type2(i, player));
						if (list.length >= 3) break;
					}
					event.num = list.length;
					player.chooseTarget(get.prompt('twqiji'), `选择一名角色其他角色视为对其使用${get.cnNumber(event.num)}张无距离限制且不计入次数的【杀】`, (card, player, target) => {
						return player.canUse({ name: 'sha', isCard: true }, target, false);
					}).set('ai', target => {
						var player = _status.event.player;
						var eff = get.effect(target, { name: 'sha', isCard: true }, player, player);
						if (target.hasSkill('bazhen') && target.hasSkill('dcjiezhen_blocker')) return 0;
						return eff;
					});
					'step 1'
					if (result.bool) {
						...
						while (target.isIn() && event.num--) {
							player.useCard(get.autoViewAs({ name: 'sha', isCard: true, storage: { twqiji: true } }), target, false);
						}
					}
				},
				subSkill: {
					buff: {
						...
						content: function () {
							'step 0'
							var chosen = player.storage.twqiji_buff || [];
							player.chooseTarget('令一名本回合未以此法选择的角色摸一张牌，然后其可以将此杀转移给自己', (card, player, target) => {
							...
							if (result.bool) {
								...
								if (!player.storage.twqiji_buff) {
									player.storage.twqiji_buff = [];
									player.addTempSkill('twqixi_remove');
								}
								player.storage.twqiji_buff.push(event.player);
								event.target.draw();
								event.target.chooseBool(`是否将${get.translation(trigger.card)}转移给自己`).set('ai', () => _status.event.bool).set('bool', () => {
									if (event.target.countCards('h', 'shan') || event.target.getEquip(2) || player.hp == 1 || event.target.hp > player.hp + 1) {
										if (!player.countCards('h', 'shan') || event.target.countCards('h') < player.countCards('h')) {
											return true;
										}
									}
									return false;
			...
			twpiankuang: {
				...
				content: function () {
					if (trigger.name == 'useCard') {
						player.addTempSkill('twpiankuang_effect');
						player.addMark('twpiankuang_effect', 1, false);
					} else trigger.num++;
				},
				subSkill: {
					effect: {
			...
			twzongquan: {
				...
				content: function () {
					'step 0'
					if (!player.storage.twzongquan) player.storage.twzongquan = [['', '']];
					player.chooseTarget(get.prompt('twzongquan'), `选择一名角色，然后你进行判定，并令其执行相应效果` + (player.storage.twzongquan[0][0] != '' ? `（上次选择的目标：${get.translation(player.storage.twzongquan[0][0])}` : ``) + (player.storage.twzongquan[0][1] != '' ? `；上次判定的结果：${get.translation(player.storage.twzongquan[0][1])}）` : ``)).set('ai', target => {
						var player = _status.event.player, att = get.attitude(player, target);
						if (player.storage.twzongquan[0]) {
							var history = player.storage.twzongquan[0];
							if (history && history[0] == target) {
								var color = history[1];
								if (color == 'black' && att > 0) return Infinity;
								if (color == 'red' && att < 0) return Infinity;
							}
						}
						return Math.abs(att);
					});
					...
					'step 2'
					let num = (result.color != player.storage.twzongquan[0][1] && event.target == player.storage.twzongquan[0][0]) ? 3 : 1;
					player.storage.twzongquan[0][0] = event.target, player.storage.twzongquan[0][1] = result.color;
					event.card = result.card;
					if (result.color == 'red') event.target.draw(num);
					else if (result.color == 'black' && event.target.countCards('he')) event.target.chooseToDiscard('he', num, true);
					'step 3'
					if (get.position(event.card) != 'd') event.finish();
					player.chooseTarget(`令一名角色获得${get.translation(event.card)}`).set('ai', target => {
						var player = _status.event.player;
					...
					'step 4'
					if (result.bool) {
						if (!result.targets || !result.targets.length) event.finish();
			...
			twguimou: {
				...
				content: function () {
					'step 0'
					event.cards = get.bottomCards(4, true);
					player.chooseButton([get.translation(trigger.player) + '的' + (trigger.judgestr || '') + '判定为' + get.translation(trigger.player.judging) + '，' + get.prompt('twguimou'), event.cards], true).set('filterButton', button => {
						...
						var card = button.link, trigger = _status.event.getTrigger(), player = _status.event.player, judging = _status.event.judging;
						var result = trigger.judge(card) - trigger.judge(judging) + 0.00001;
						var attitude = get.attitude(player, trigger.player);
						var name = trigger.getParent().name;
						if (name == 'twzongquan') {
							var target = trigger.getParent().targets[0];
							var history = player.storage.twzongquan[0];
							if (history && history[0] == target) {
								if (get.color(card) != history[1]) return Infinity * result * attitude;
							}
						}
					...
					'step 3'
					var next = player.chooseToMove('鬼谋：将卡牌以任意顺序置于牌堆顶');
			...
			twqiaosi: {
				...
				check: function (event, player) {
					var cards = get.info('twqiaosi').getCards(player);
					if (cards.reduce((sum, card) => sum + get.value(card), 0)) return false;
					if (cards.length >= player.hp || cards.some(card => get.name(card, player) == 'tao' || get.name(card, player) == 'jiu')) return true;
					return player.hp > 2 && cards.length > 1;
				},
				prompt2: function (event, player) {
					var cards = get.info('twqiaosi').getCards(player);
					let str = "获得" + get.translation(cards);
					if (cards.length < player.hp) str += '，然后你失去1点体力';
					return str;
				},
				content: function () {
					var cards = get.info('twqiaosi').getCards(player);
					player.gain(cards, 'gain2');
					if (cards.length < player.hp) player.loseHp();
				},
			...
			twbaizu: {
				...
				filter: function (event, player) {
					return player.isDamaged() && player.countCards('h') && game.hasPlayer(target => {
						return target != player && target.countCards("h");
					}) && player.hp + player.countMark('twbaizu_lizhan');
				},
				locked: true,
				content: function () {
					'step 0'
					var sum = player.hp + player.countMark('twbaizu_lizhan'), filterTarget = (_, player, target) => {
						return target != player && target.countCards('h');
					};
					let targets = game.filterPlayer(target => filterTarget(null, player, target));
					event.targets = targets;
					if (targets.length > sum) {
						player.chooseTarget('请选择【败族】的目标', '令你和这些角色同时弃置一张手牌，然后你对与你弃置牌类别相同的其他角色各造成1点伤害', filterTarget, sum, true).set('ai', target => {
							var player = _status.event.player;
							return get.effect(target, { name: 'guohe_copy2' }, target, player) + get.damageEffect(target, player, player);
						});
					}
					'step 1'
					if (result.bool) event.targets = result.targets;
					event.targets = event.targets.slice().sortBySeat();
					player.line(event.targets);
					player.addTempSkill('twbaizu_lizhanx');
					event.list = [player].concat(event.targets).filter(target => target.countDiscardableCards(target, 'h'));
					if (event.list.length) player.chooseCardOL(event.list, '败族：请弃置一张手牌', (card, player) => {
						return lib.filter.cardDiscardable(card, player);
					}, true).set('ai', get.unuseful);
					'step 2'
					let discards = [];
					for (let i = 0; i < result.length; i++) {
						discards.push([event.list[i], result[i].cards]);
					}
					game.loseAsync({ lose_list: discards }).setContent('discardMultiple');
					event.list = event.list.filter(i => get.type2(result[0].cards[0]) == get.type2(result[event.list.indexOf(i)].cards[0]));
			...
			twciyin: {
				...
				filter: function (event, player) {
					...
					return player == target || player.getStorage('tongxinWith').includes(target);
				},
				content: function () {
					'step 0'
					var num = Math.min(trigger.player.hp * 2, 10), cards = get.cards(num, true);
					player.showCards(cards);
					var gain = cards.filter(card => ['heart', 'spade'].includes(get.suit(card)));
					if (!gain.length) return;
					player.chooseButton(['慈荫：你可以将其中任意张黑桃/红桃牌置于武将牌上', gain], [1, Infinity]).set('ai', get.buttonValue);
					'step 1'
					if (!result.links || !result.links.length) return;
					player.addToExpansion(result.links).gaintag.add('twciyin');
				},
				marktext: '荫',
				intro: {
					content: 'expansion',
				...
				group: 'twciyin_heart',
				subSkill: {
					block1: { charlotte: true },
					block2: { charlotte: true },
					heart: {
						audio: 'twciyin',
						trigger: {
						...
						filter: function (event, player) {
							...
							var limit = [];
							if (player.hasSkill('twciyin_block1')) limit.push('增加体力上限并回复体力');
							if (player.hasSkill('twciyin_block2')) limit.push('将手牌摸至体力上限');
							return (cards.length % 3 == 0 || event.cards.length > 2) && (!limit.includes('增加体力上限并回复体力') || (!limit.includes('将手牌摸至体力上限') && player.countCards('h') < player.maxHp));
						},
						content: function () {
							"step 0"
							var choices = [];
							if (!player.hasSkill('twciyin_block1')) choices.push('增加体力上限并回复体力');
							if (!player.hasSkill('twciyin_block2') && player.countCards('h') < player.maxHp) choices.push('将手牌摸至体力上限');
							player.chooseControl(choices, 'cancel2').set('prompt', '慈荫：选择下列选项中的一个执行').set('ai', function () {
								if (choices.includes('增加体力上限并回复体力')) return '增加体力上限并回复体力';
								if (choices.includes('将手牌摸至体力上限') && choices.length == 1) return '将手牌摸至体力上限';
							});
							"step 1"
							if (result.control == '增加体力上限并回复体力') {
								player.gainMaxHp();
								player.recover();
								player.addSkill('twciyin_block1');
							}
							if (result.control == '将手牌摸至体力上限') {
								player.drawTo(player.maxHp);
								player.addSkill('twciyin_block2');
							}
						},
					},
				},
			...
			twchenglong: {
				...
				animationColor: 'gray',
				filter: function (event, player) {
					return player.hasSkill('twciyin_block1') && player.hasSkill('twciyin_block2');
				},
				content: function (event, trigger, player) {
					...
					var filter = skill => {
						...
						return info && !info.zhuSkill && !info.limited && !info.juexingji && !info.hiddenSkill && !info.charlotte && !info.dutySkill && ['【杀】', '【闪】'].some(str => {
							var parser = new DOMParser();
							var doc = parser.parseFromString(translation || '', 'text/html');
							return (doc.body.textContent || doc.body.innerText).includes(str);
						});
					};
					...
					for (var i of list) {
						skills.addArray((lib.character[i][3] || []).filter(function (skill) {
							var info = get.info(skill), translation = get.skillInfoTranslation(skill, player);
							return info && !info.zhuSkill && !info.limited && !info.juexingji && !info.hiddenSkill && !info.charlotte && !info.dutySkill && ['【杀】', '【闪】'].some(str => {
								var parser = new DOMParser();
								var doc = parser.parseFromString(translation || '', 'text/html');
								return (doc.body.textContent || doc.body.innerText).includes(str);
					...
					game.broadcastAll(function (list) {
						...
						for (var i of list) {
							...
							info.audioname2.tw_liquan = 'twchenglong';
						}
					}, map.skills);
				},
			},
			twshouzhu: {
				...
				filter: function (event, player) {
					return player.getStorage('tongxinWith').filter(target => {
						return target.isIn();
					});
				},
				...
				content: function () {
					'step 0'
					//萌新按照同心角色有多名来进行处理的，实际上海外正式服只能和一个人同心
					var targets = player.getStorage('tongxinWith').filter(target => {
						return target.isIn();
					});
					event.targets = targets.slice(), event.targetx = [];
					'step 1'
					event.current = event.targets.shift();
					if (event.current.isIn()) {
						event.current.chooseCard(`${get.translation(player)}对你发动了【受嘱】，作为其的同心角色，是否交给其至多四张牌？`, 'he', [1, 4])
							.set('ai', card => {
								if (!_status.event.goon) return -get.value(card);
								if (ui.selected.cards.length < 2) return 4.5 + ui.selected.cards.length - get.value(card) + _status.event.player.getUseValue(card) / 5;
								return 0;
							}).set('goon', get.attitude(event.current, player) > 0);
					}
					'step 2'
					if (result.bool) {
						...
						if (result.cards.length >= 2) {
							...
							event.targetx.push(event.current);
						}
					}
					game.delay();
					'step 3'
					if (event.targets.length > 0) event.goto(1);
					else if (event.targetx.length > 0) event.targetx.unshift(player);
					'step 4'
					if (event.targetx.length > 0) {
						event.currentx = event.targetx.shift();
						var cards = get.cards(event.count);
						game.cardsGotoOrdering(cards);
						event.currentx.chooseToMove().set('list', [['牌堆底', cards], ['弃牌堆']]).set('prompt', '受嘱：点击排列牌置于牌堆底的顺序，或置入弃牌堆').set('processAI', list => {
					...
					'step 5'
					var bottom = result.moved[0], discard = result.moved[1];
					if (bottom.length) {
						event.currentx.$throw(bottom.length);
						for (i = 0; i < bottom.length; i++) {
							bottom[i].fix();
							ui.cardPile.appendChild(bottom[i]);
						};
					}
					event.currentx.popup(get.cnNumber(bottom.length) + '下');
					game.log(event.currentx, '将' + get.cnNumber(bottom.length) + '张牌置于牌堆底');
					if (discard.length) {
						game.cardsDiscard(discard);
						game.log(event.currentx, '将', discard, '置入了弃牌堆');
					}
					game.delayx();
					'step 6'
					if (event.targetx.length > 0) event.goto(4);
					else event.finish();
				},
			},
			twdaigui: {
				...
				filter: function (event, player) {
					...
					var color = get.color(player.getCards('h')[0]);
				...
				content: function (event, player) {
					'step 0'
					var maxLimit = player.countCards('h');
					player.chooseTarget(get.prompt('twdaigui'), `选择至多${get.cnNumber(maxLimit)}名角色并亮出牌堆底等量的牌，令这些角色依次选择并获得其中一张。`, [1, maxLimit]).set('ai', target => {
						var player = _status.event.player;
						return get.attitude(player, target) * (player === target && player.needsToDiscard(1) ? 0.4 : 1);
					});
					'step 1'
					event.targets = result.targets.sortBySeat();
					var cards = get.bottomCards(event.targets.length);
					event.cards = cards, event.togain = event.cards.slice();
					game.cardsGotoOrdering(cards);
					event.videoId = lib.status.videoId++;
					game.addVideo('cardDialog', null, ['待归', get.cardsInfo(cards), event.videoId]);
					game.broadcastAll(function (cards, videoId) {
						var dialog = ui.create.dialog('待归', cards, true);
					...
					game.delay();
					'step 3'
					if (event.targets.length && event.togain.length) {
						event.current = event.targets.shift();
						var next = event.current.chooseButton(true, button => {
							return get.value(button.link, _status.event.player);
						});
						next.set('dialog', event.videoId);
						next.set('closeDialog', false);
						next.set('dialogdisplay', true);
						next.set('cardFilter', event.togain.slice());
					...
					}, card, event.videoId, function (target) {
			...
			twcairu: {
				...
				chooseButton: {
					dialog: function (event, player) {
						var list = ['huogong', 'tiesuo', 'wuzhong']
							.filter(name => {
								if (player.getStorage('twcairu_used').filter(namex => namex == name).length > 1) return false;
								return event.filterCard({ name }, player, event);
							})
						...
						return {
							...
							precontent: function () {
								...
								if (!player.storage.twcairu_used) {
									...
									player.addTempSkill('twcairu_use');
								}
			...
			tongxin: {
				...
				filter: function (event, player) {
					...
					return player.getSkills().some(skill => {
						...
						if (!info || !info.tongxin) return false;
						return true;
					});
				},
				forced: true,
				...
				content: function (event, player) {
					'step 0'
					if (player.storage.tongxinWith) {
						delete player.storage.tongxinWith;
						player.unmarkSkill('tongxin');
					}
					player.chooseTarget('请选择你的“同心”角色', lib.filter.notMe);
					'step 1'
					if (result.bool) {
						var targets = result.targets;
						player.line(targets, 'green');
						game.log(player, "选择了", targets, '作为自己的同心角色');
						player.markSkill('tongxin', '', '同心 ' + get.translation(targets[0].name));
						player.storage.tongxinWith = targets;
						game.delayx();
					}
				},
				mark: true,
				intro: {
					...
					content: function (_, player) {
						return `当前同心角色：${get.translation(player.getStorage('tongxinWith'))}`;
					},
				}
			},
			//侠刘备
			twshenyi: {
				...
				content: function () {
					...
					for (var i = 0; i < lib.inpile.length; i++) {
						...
						if (player.getStorage('twshenyi').contains(name)) continue;
						if (name == 'sha') {
							list.push(['basic', '', 'sha']);
							for (var j of lib.inpile_nature) list.push(['basic', '', 'sha', j]);
						}
						else if (get.type(name) == 'basic') list.push(['basic', '', name]);
						else if (get.type(name) == 'trick') list.push(['trick', '', name]);
						else if (get.type(name) == 'delay') list.push(['delay', '', name]);
					}
					...
					player.chooseButton(dialog).set('ai', function (button) {
						var trigger = _status.event.getTrigger(), player = _status.event.player, name = button.link[2];
						if (!get.cardPile2(card => card.name == name)) return 0;
						var value = get.value({ name: name });
						if (['tao', 'jiu', 'caochuan', 'wuxie'].includes(name) && _status.event.getRand() > 0.4) return value * 2;
						return value;
					});
					'step 1'
					if (result.bool) {
						...
						if (trigger.player != player && player.countCards('h')) {
							game.delayex();
							player.chooseCard('伸义：是否将任意张牌交给' + get.translation(trigger.player) + '?', [1, player.countCards('h')]).set('ai', card => {
								if (!_status.event.goon) return 0;
								return 7 - get.value(card);
							}).set('goon', get.attitude(player, trigger.player) > 0);
						} else event.finish();
					} else {
						player.storage.counttrigger.twshenyi--;
						event.finish();
					}
					'step 2'
					if (result.bool) {
						player.give(result.cards, trigger.player).gaintag.add('twshenyix');
						...
						filter: function (event, player) {
							return game.hasPlayer(target => {
								...
								for (let i in evt.gaintag_map) {
									if (evt.gaintag_map[i].includes('twshenyix')) return true;
								}
								return false;
							});
						},
						...
						content: function () {
							...
							var targets = game.filterPlayer(target => {
								...
								for (var i in evt.gaintag_map) {
									if (evt.gaintag_map[i].includes('twshenyix')) numx++;
								}
			...
			twxinghan: {
				...
				content: function () {
					'step 0'
					player.chooseBool()
						.set('createDialog', [get.prompt('twxinghan'), `<div class="text center">按顺序使用以下“侠义”牌。但是回合结束时你须弃置所有手牌并失去X点体力（X为你的体力值-1且X至少为1）</div>`, player.getExpansions('twshenyi').filter(card => player.hasUseTarget(card)).reverse(), 'hidden'])
						.set('choice', lib.skill.twxinghan.check(null, player));
					'step 1'
					if (!result.bool) event.finish();
					else player.addTempSkill('twxinghan_discard');
					'step 2'
					var cards = player.getExpansions('twshenyi').filter(card => player.hasUseTarget(card)).reverse();
					if (cards.length) player.chooseUseTarget(true, cards[0], false);
					event.cards = cards;
					'step 3'
			...
			twduwang: {
				...
				subSkill: {
					effect: {
						...
						content: function () {
							'step 0'
							player.chooseTarget([1, 3], (_, player, target) => {
								return target != player && target.hasCard(card => {
									if (get.position(card) == 'h') return true;
									return target.canUse(get.autoViewAs({ name: 'juedou' }, [card]), player, false);
								}, 'he');
							}).set('prompt', get.prompt('twduwang')).set('ai', target => {
								var player = _status.event.player, num = game.countPlayer(target => {
									return target != player && target.hasCard(card => {
										if (get.position(card) == 'h') return true;
										return target.canUse(get.autoViewAs({ name: 'juedou' }, [card]), player, false);
									}, 'he') && get.effect(target, { name: 'guohe_copy2' }, target, player) + get.effect(player, { name: 'juedou' }, target, player) > 0;
								});
								return get.effect(target, { name: 'guohe_copy2' }, target, player) + get.effect(player, { name: 'juedou' }, target, player);
							}).set('prompt2', '选择至多三名其他角色并摸选择角色数+1的牌，然后这些角色须将一张牌当作【决斗】对你使用');
							'step 1'
							if (result.bool) {
								var targets = result.targets.sortBySeat();
								event.targets = targets, event.numx = 0;
								player.draw(targets.length + 1);
								game.delayx();
							} else event.finish();
							'step 2'
							var target = event.targets[event.numx];
							if (target.hasCard(card => target.canUse(get.autoViewAs({ name: 'juedou' }, [card]), player, false), 'he')) {
								// 逆乱
								var next = target.chooseToUse();
								next.set('openskilldialog', '独往：将一张牌当作【决斗】对' + get.translation(player) + '使用');
								next.set('forced', true);
								next.set('norestore', true);
								next.set('_backupevent', 'twduwang_backup');
							...
							'step 3'
							if (event.numx < event.targets.length - 1) {
								event.numx++;
								event.goto(2);
							} else event.finish();
						},
					...
					backup: {
						...
						position: 'he',
						filterCard: function (card, player) {
							var cardx = get.autoViewAs({ name: 'juedou' }, [card]);
							return lib.filter.targetEnabledx(cardx, player, _status.event.sourcex);
						},
						check: function (card) {
					...
					achieve: {
						...
						filter: function (event, player, target) {
							...
							var history = player.actionHistory, targets = game.players.slice().concat(game.dead.slice());
							let num = 0;
							for (let i = history.length - 1; i >= 0; i--) {
								for (var evt of history[i].useCard) {
									if (evt.card.name == 'juedou') num++;
								};
							}
							for (var target of targets) {
								var historyx = target.actionHistory;
								for (let i = historyx.length - 1; i >= 0; i--) {
									for (var evt of historyx[i].useCard) {
										if (evt.card.name == 'juedou' && evt.targets && evt.targets.includes(player)) num++;
									}
								}
							}
						...
						content: function () {
							...
							player.chooseControl().set('choiceList', ['获得〖狭勇〗', '重置〖延势〗并为其添加历战效果']).set('ai', () => {
								var player = _status.event.player, num = game.countPlayer(current => {
									return current != player && current.hasCard(card => {
										if (get.position(card) == 'h') return true;
										return current.canUse(get.autoViewAs({ name: 'juedou' }, [card]), player, false);
									}, 'he') && get.effect(current, { name: 'guohe_copy2' }, current, player) / 2.5 + get.effect(player, { name: 'juedou' }, current, player) > 0;
								});
								return num >= 2 ? 0 : 1;
							});
							'step 1'
							if (result.control == '选项一') player.addSkill('twxiayong');
			...
			twduwang1: { audio: true },
			twduwang2: { audio: true },
			twduwang3: { audio: true },
			twylyanshi: {
				audio: 2,
				enable: ['chooseToUse', 'chooseToRespond'],
				limited: true,
				...
				chooseButton: {
					dialog: function (event, player) {
						var list = ['juedou', 'binglinchengxiax'].concat(get.zhinangs()).filter(name => {
							var info = { name: name };
							return get.info(info) && player.hasCard(card => {
								return get.name(card) == 'sha' && event.filterCard({ name: name, cards: [card] }, player, event);
							}, 'hs');
					...
					backup: function (links, player) {
						return {
							...
							precontent: function () {
								...
								if (player.storage.twduwang_ylyanshi) {
									player.addTempSkill('twylyanshi_lizhan');
								}
							},
						};
					},
			...
			twjuexing: {
				...
				filterTarget: function (_, player, target) {
					...
					return player.canUse('juedou', target) && target != player;
				},
				content: function () {
					player.addTempSkill('twjuexing_lizhanx');
					var target = event.target, card = { name: 'juedou' };
					player.addTempSkill('twjuexing_effect');
					player.addTempSkill('twjuexing_discard');
				...
				subSkill: {
					effect: {
						...
						content: function () {
							...
							player.addTempSkill('twjuexing_buff');
							target.addTempSkill('twjuexing_buff');
							let list = [];
							for (var current of [player, target]) {
								if (current.isIn() && current.countCards('h')) {
									list.push([current, current.getCards('h')]);
								}
							}
							if (list.length) {
								game.loseAsync({
								...
								}).setContent(lib.skill.twjuexing.addToExpansionMultiple);
							}
							if (player.hp > 0) player.draw(player.hp, target.hp > 0 ? 'nodelay' : '').set('gaintag', ['twjuexing']);
							if (target.hp > 0) target.draw(target.hp).set('gaintag', ['twjuexing']);
							game.delay();
						},
					},
					discard: {
						...
						charlotte: true,
						filter: function (event, player) {
							return event.getParent().name === 'twjuexing';
						},
						content: function () {
							'step 0'
							let list = [];
							...
							for (var current of targets) {
								if (current.isIn() && current.hasCard(card => card.hasGaintag('twjuexing'), 'h')) {
									list.push([current, current.getCards("h", card => card.hasGaintag('twjuexing'))]);
								}
							}
							if (list.length) {
							...
							var targets = [player].concat(trigger.targets);
							for (var current of targets) {
								if (current.isIn() && current.getExpansions('twjuexing_buff').length) {
									listx.push([current, current.getExpansions('twjuexing_buff')]);
								}
							}
							if (listx.length) {
				...
				ai: {
					...
					result: {
						target(player, target) {
							return get.sgn(get.attitude(player, target)) * get.effect(target, { name: 'juedou' }, player, player) * ((player.hp + 1) / (target.hp + 1));
						},
					},
				},
				// 搬运一个loseAsync的情况，方便同时将牌放在武将牌上
				addToExpansionMultiple: function () {
					'step 0'
			...
			twxiayong: {
				...
				content: function () {
					if (trigger.player === player) {
						...
						player.logSkill('twxiayong1');
						if (cards.length > 0) player.discard(cards.randomGet());
					} else {
						player.logSkill('twxiayong2');
						trigger.num++;
					}
				},
			},
			twxiayong1: { audio: true, audioname: ['tw_yanliang', 'tw_wenchou'] },
			twxiayong2: { audio: true, audioname: ['tw_yanliang', 'tw_wenchou'] },
			twxianyuan: {
				audio: 2,
				trigger: {
					global: ["roundStart"],
				...
				filter: function (event, player) {
					return player.countMark("twxianyuan") < 3;
				},
				direct: true,
				content: function () {
					var num = 3 - player.countMark("twxianyuan");
					player.addMark("twxianyuan", num < 2 ? num : 2);
				},
				marktext: "仙援",
				intro: {
					name: "仙援",
				...
				group: ["twxianyuan_use", "twxianyuan_xianshou"],
				subSkill: {
					use: {
						audio: "twxianyuan",
						enable: "phaseUse",
						filter: function (event, player) {
							return player.hasMark("twxianyuan") && game.hasPlayer(t => t != player);
						},
						content: function () {
							"step 0"
							player.chooseTarget(get.prompt("twxianyuan"), "移去任意枚“仙援”标记并令一名其他角色获得等量枚“仙援”标记", (card, player, target) => {
								return target.countMark("twxianyuan") < 3;
							}).set("ai", target => {
								if (player.countMark("twxianyuan") > 2) return get.attitude(player, target) * (target.countCards("h") + 1);
							});
							"step 1"
							if (result.bool) {
								var target = result.targets[0];
								...
								var map = {};
								var list = [];
								const limit = player.countMark("twxianyuan");
								for (var i = 1; i <= player.countMark("twxianyuan"); i++) {
									var cn = get.cnNumber(i, true);
									map[cn] = i;
									list.push(cn);
								}
								event.map = map;
								player.chooseControl(list, true).set("prompt", get.prompt("twxianyuan")).set('prompt2', '你可以将至多' + get.cnNumber(limit.length) + '个“仙援”标记分配给' + get.translation(target)).set('goon', list[list.length - 2]).set('ai', () => _status.event.goon);
							}
							"step 2"
							if (result.control) {
								var num1 = event.map[result.control];
								player.removeMark("twxianyuan", num1);
								event.target.addMark("twxianyuan", num1);
							}
						},
					},
					xianshou: {
						...
						filter: function (event, player) {
							return event.player.hasMark("twxianyuan");
						},
						logTarget: "player",
						direct: true,
						content: function () {
							"step 0"
							var num1 = trigger.player.countMark("twxianyuan");
							var num = Math.min(trigger.player.countCards("h"), trigger.player.countMark("twxianyuan"));
							var list = [];
							if (num > 0) list.push("将" + get.translation(trigger.player) + "的至多" + num + "张手牌置于牌堆顶");
							list.push("令" + get.translation(trigger.player) + "摸" + num1 + "张牌");
							player.chooseControl(list).set('ai', function () {
								var num = Math.min(trigger.player.countCards("h"), trigger.player.countMark("twxianyuan"));
								if (get.attitude(player, trigger.player) < 0 && num > 0) return "将" + get.translation(trigger.player) + "的至多" + num + "张手牌置于牌堆顶";
								return "令" + get.translation(trigger.player) + "摸" + num1 + "张牌";
							});
							"step 1"
							var num1 = trigger.player.countMark("twxianyuan");
							if (result.control == "令" + get.translation(trigger.player) + "摸" + num1 + "张牌") {
								trigger.player.draw(num1);
								if (_status.currentPhase !== player) trigger.player.removeMark("twxianyuan", num1);
								event.finish();
							}
							else {
								event.num = Math.min(trigger.player.countCards("h"), trigger.player.countMark("twxianyuan"));
								player.chooseToMove("仙援：将" + get.translation(trigger.player) + "的至多" + event.num + "张牌以任意顺序置于牌堆顶", true).set("list", [[get.translation(trigger.player) + "的手牌", trigger.player.getCards("h"), "dcsushou_tag"], ["牌堆顶"]]).set("filterOk", moved => {
									var num = event.num;
									return moved[1].length >= 1 && moved[1].length <= num;
								}).set("num", num).set("processAI", list => {
									var num = event.num;
									let cards = list[0][1],
										sgn = get.attitude(player, trigger.player) > 0 ? 1 : -1;
			...
			twlingyin: {
				...
				content: function () {
					'step 0'
					event.cards = get.cards(1, true), event.card = event.cards[0];
					player.showCards(event.cards, get.translation(player) + '发动了【灵隐】');
					'step 1'
					if (get.color(event.card) == get.color(trigger.card)) {
						player.gain(event.cards, 'gain2');
					}
					if (get.suit(event.card) == get.suit(trigger.card)) {
			...
			twqinghan: {
				...
				content: function () {
					'step 0'
					player.chooseToCompare(target).set('fixedResult', { [player.playerid]: event.cards[0] });
					'step 1'
					event.card1 = result.player, event.card2 = result.target;
					if (result.bool) {
						var cards = [];
						for (var i = 0; i < lib.inpile.length; i++) {
							var name = lib.inpile[i];
							if (get.type(name) == 'trick' && player.canUse({ name: name }, target, false)) cards.push(['trick', '', name]);
						}
						player.chooseButton([`请选择你要对${get.translation(target)}使用的牌`, [cards, 'vcard']])
							.set('ai', button => {
					...
					'step 2'
					if (result.bool) {
						player.useCard({ name: result.links[0][2] }, target, false);
					}
					'step 3'
					if (get.color(event.card1, player) == get.color(event.card2, target)) {
						if (get.position(event.card1) == 'd') target.gain(event.card1, 'gain2');
						if (get.position(event.card2) == 'd') player.gain(event.card2, 'gain2');
					}
				},
				ai: {
					order: 4,
			...
			twzhihuan: {
				...
				filter: function (event, player) {
					return (event.card && event.card.name == 'sha' && event.getParent().type == 'card' && (event.player.countGainableCards(player, 'e') || Array.from({ length: 5 }).map((_, i) => i + 1).some(i => !player.getEquip(i) && !player.isDisabled(i))));
				},
				logTarget: 'player',
				content: function () {
					'step 0'
					var target = trigger.player, choices = [];
					event.target = target;
					var choiceList = [`获得${get.translation(target)}装备区一张牌`, `获得并使用一张牌堆或弃牌堆中空置装备栏对应类别的装备牌`];
					if (trigger.player.countGainableCards(player, 'e')) choices.push('选项一');
					else choiceList[0] = '<span style="opacity:0.5;">' + choiceList[0] + '</span>';
					if (Array.from({ length: 5 }).map((_, i) => i + 1).some(i => !player.getEquip(i) && !player.isDisabled(i)))
						choices.push('选项二');
					else choiceList[1] = '<span style="opacity:0.5;">' + choiceList[1] + '</span>';
					player.chooseControl(choices, 'cancel2').set('prompt', get.prompt('twzhihuan')).set('choiceList', choiceList)
						.set('ai', () => {
							var choices = _status.event.controls.slice(), player = _status.event.player, evt = _status.event.getTrigger(), target = evt.player;
							var eff = get.damageEffect(target, player, player, evt.nature), att = get.attitude(player, target);
							if (att > 0) {
							...
							if ((target.hp == 1 && att < 0) || evt.num > 1 || player.hasSkill('luoyi2') || player.hasSkill('reluoyi2')) return 'cancel2';
							if (choices.includes('选项一') && target.countCards('e', card => {
					...
					'step 1'
					trigger.cancel();
					if (result.control == '选项一') player.gainPlayerCard(trigger.player, 'e', true);
					else {
						for (var i = 1; i < 7; i++) {
							if (!player.getEquip(i) && !player.isDisabled(i)) {
								var sub = 'equip' + i, equip = get.cardPile(card => get.subtype(card, false) == sub && player.hasUseTarget(card));
								if (equip) {
									player.$gain2(equip);
						...
						trigger.player.addSkill('twzhihuan_discard');
					}
				},
				subSkill: {
					discard: {
			...
			beiding: {
				...
				intro: {
					content: function (storage, player) {
						return '当前已记录' + get.translation(storage);
					}
				},
				init: function (player) {
					if (!player.storage.beiding) player.storage.beiding = []
				},
				direct: true,
				content: function () {
					'step 0'
					...
					for (var i = 0; i < lib.inpile.length; i++) {
						var name = lib.inpile[i];
						if (player.getStorage('beiding').contains(name)) continue;
						if (name == 'sha') {
							list.push(['基本', '', 'sha']);
					...
					if (list.length) {
						player.chooseButton([get.prompt('beiding', trigger.player), [list, 'vcard']], [1, num]).set('ai', button => {
					...
					if (result.bool) {
						...
						player.storage.beiding_use = list;
						player.storage.beiding = player.storage.beiding.concat(list2);
						game.log(player, '发动了', "#g【" + get.translation('beiding') + '】', '记录了', '#y' + get.translation(list2));
					}
				},
				group: ["beiding_use"],
				subSkill: {
					use: {
						...
						init: function (player) {
							player.storage.beiding_use = []
						},
						filter: function (event, player) {
							var target = _status.currentPhase;
							if (!target || !target.isIn() || event.player != target) return false;
							return player.getStorage("beiding_use").length > 0;
						},
						forced: true,
						content: function () {
							'step 0'
							event.target = _status.currentPhase;
							var storage = player.getStorage("beiding_use");
							if (storage.length) {
								var name = storage.shift();
								var card = get.autoViewAs({ name: name[2], nature: name[3], isCard: true });
								if (!player.hasUseTarget(card, false)) return;
								player.chooseUseTarget(`请选择${get.translation(card)}的目标，若此牌的目标不包含${get.translation(event.target)}，则其摸一张牌`, card, "nodistance").set("targetRequired", target).set("ai", function () {
							...
							if (result.bool && result.targets) {
								var targets = result.targets;
								if (!targets.includes(event.target) && event.target.isIn()) {
									event.target.draw();
								}
							}
							else event.target.draw();
							'step 2'
							if (player.getStorage("beiding_use").length) {
								event.goto(0);
							}
						},
					},
			...
			jielv: {
				...
				filter(event, player) {
					if (player.hasSkill('huan_jielv')) return false;
				...
				subSkill: {
					add: {
						...
						forced: true,
						content: function () {
							var num = Math.min(trigger.num, player.maxHp);
			...
			hunyou: {
				...
				skillAnimation: true,
				owner: 'huan_zhugeliang',
				content: function () {
					'step 0'
					player.awakenSkill('hunyou');
					player.addTempSkill("hunyou_ruhuan");
					player.removeSkill(['beiding', 'jielv', 'hunyou'], false, false);
					player.addSkill(["huan_beiding", "huan_jielv", "huanji", "changgui"], true, true, false, false);
					trigger.player.recover(1 - player.hp);
					player.swapBackground('hunyou');
			...
			huan_beiding: {
				mod: {
					targetInRange(card, player, target) {
						if (player.getStorage("beiding").includes(card.name)) return true;
					},
				},
				audio: 2,
				trigger: {
				...
				filter(event, player, name) {
					if (!player.getStorage("beiding").includes(event.card.name)) return false;
				...
				content: function () {
					if (event.triggername == "useCard1") {
						...
						player.draw();
						player.unmarkAuto("beiding", [trigger.card.name]);
					}
				},
			},
			huan_jielv: {
				...
				forced: true,
				content: function () {
					var num = Math.min(player.getDamagedHp(), trigger.num);
					player.recover(num);
				},
			},
			huanji: {
				...
				chooseButton: {
					dialog: function (event, player) {
						...
						for (var i = 0; i < lib.inpile.length; i++) {
							var name = lib.inpile[i];
							if (player.storage.beiding && player.storage.beiding.contains(name)) continue;
							if (name == 'sha') {
								list.push(['基本', '', 'sha']);
								for (var j of lib.inpile_nature) list.push(['基本', '', 'sha', j]);
							}
						...
						if (list.length == 0) {
							return ui.create.dialog('幻技已无可用牌');
						}
						return ui.create.dialog('幻技', [list, 'vcard']);
					},
					...
					backup: function (links, player) {
						return {
							...
							selectCard: -1,
							content: function () {
								var names = lib.skill[event.name].names;
								player.loseMaxHp();
								game.log(player, "声明了", "#g" + get.translation(names));
								player.markAuto("beiding", names);
							},
						};
					},
					prompt(links, player) {
						const names = links.map(i => i[2]);
						return `减少1点体力上限并记录${get.translation(names)}`;
					},
				},
				ai: {
					order: 10,
			...
			changgui: {
				...
				filter: function (event, player) {
					return player.isMinHp() && player.maxHp != player.hp;
				},
				owner: 'huan_zhugeliang',
				forced: true,
				content: function () {
					var num = player.maxHp - player.hp;
					if (player.maxHp > player.hp) player.loseMaxHp(player.maxHp - player.hp);
					player.removeSkill(["huan_beiding", "huan_jielv", "huanji", "changgui"]);
					player.addSkill(['beiding', 'jielv', 'hunyou'], true, true, false, false);
					player.swapBackground('changgui');
					if (player.storage.isHuan) delete player.storage.isHuan;
				},
			},
			twkuiduan: {
				audio: 2,
						...
						filter: function (event, player) {
							...
							if (!evtx ||
								...
								!event.source.hasHistory("lose", evt => {
									...
									return Object.values(evt.gaintag_map).some(tags => tags.includes("twkuiduan_card"));
								})) return false;
			...
			twchongzhen: {
				...
				filter: function (event, player) {
					...
					if (!event.skill || event.skill.indexOf('fanghun') + event.skill.indexOf('ollongdan') + event.skill.indexOf('longdan') == -3) return false;
					var target = lib.skill.twchongzhen.logTarget(event, player);
				...
				content: function () {
					var target = lib.skill.twchongzhen.logTarget(trigger, player);
			...
			twjiezhan: {
				...
				content: function () {
					...
					if (target.canUse(sha, player, false, true)) target.useCard(sha, player).set('addCount', true);
				},
			},
			twlongjin: {
				audio: 2,
				...
				content: function () {
					...
					var list = ["ollongdan", "twchongzhen"];
				...
				subSkill: {
					buff: {
						...
						content: function () {
							...
							var list = ["ollongdan", "twchongzhen"];
							if (event.triggername == "phaseAfter" && !player.countMark(event.name)) player.removeSkill(list);
						},
					},
				},
				derivation: ["ollongdan", "twchongzhen"],
			},
			twchengxi: {
				audio: 2,
				enable: 'phaseUse',
				...
				subSkill: {
					remove: {
						...
						popup: false,
						content: function () {
							delete player.storage.twchengxi_used;
						},
					},
					effect: {
						charlotte: true,
			...
			twzhongyi: {
				...
				content: function () {
					"step 0"
					event.numx = 0;
					if (trigger.num_sha) event.numx = trigger.num_sha;
					var choiceList = ['摸牌：摸等同于此【杀】伤害和的牌', '回复体力：回复等同于此【杀】伤害和的体力', '背水：依次执行以上两项。']
					player.chooseControl('摸牌', '回复体力', '背水！')
					...
					if (result.control) {
						switch (result.control) {
							case '摸牌':
								player.draw(event.numx);
								event.finish();
								break;
							case '回复体力':
								player.recover(event.numx);
								event.finish();
								break;
							case '背水！':
								event.goto(2);
					...
					'step 2'
					player.storage.twzhongyi++;
					player.markSkill('twzhongyi');
					player.loseHp(player.storage.twzhongyi);
					player.draw(event.numx);
					'step 3'
					player.recover(event.numx);
				},
				...
				subSkill: {
					rec: {
						...
						charlotte: true,
						content: function () {
							if (!trigger.getParent('useCard').num_sha) trigger.getParent('useCard').num_sha = 0;
							trigger.getParent('useCard').num_sha += trigger.num;
							console.log(trigger)
						}
					}
				}
			...
			twchue: {
				...
				check: function (event, player) {
					return player.hp > 1 && player.getEnemies().length > 0;
				},
				prompt: function (event, player) {
					return '你可以失去1点体力，多指定至多' + player.hp + '个目标。'
				},
				content: function () {
					"step 0"
					player.loseHp(1);
					"step 1"
					var select = get.select(lib.card.sha.selectTarget);
					select[1] += player.hp
				...
				group: ['twchue_loseHp', 'twchue_mark', 'twchue_unmark'],
				subSkill: {
					mark: {
						trigger: {
							global: 'phaseEnd'
						...
						silent: true,
						filter: function (event, player) {
							return player.storage.twchue_loseHp && player.countMark('twchue') >= player.hp;
						},
						content: function () {
							"step 0"
							var select = get.select(lib.card.sha.selectTarget);
							select[1] += player.hp;
							player.chooseUseTarget(select, 'sha', '你是否要失去' + player.hp + '个“勇”标记，视为使用一张伤害+1的杀').set('oncard', function () {
								this.baseDamage++;
							});
							"step 1"
							if (result.bool) {
								var yong = player.hp;
								player.removeMark('twchue', yong);
							}
						},
					},
					loseHp: {
						...
						content: function () {
							...
							player.storage.twchue_loseHp = true;
						},
					},
					unmark: {
						trigger: {
						...
						direct: true,
						content: function () {
							player.storage.twchue_loseHp = false;
						},
					},
				}
			},
			twjieqiu: {
				...
				filter: function (event, player) {
					return game.hasPlayer(function (current) {
						return current != player && current.storage.disableEquip != undefined && current.storage.disableEquip.length == 0;
					})
				},
				filterTarget: function (card, player, target) {
					return target != player && target.storage.disableEquip != undefined && target.storage.disableEquip.length == 0;
				},
				content: function () {
					var num = target.countCards('e');
					for (var i = 1; i < 6; i++) {
						if (!target.isDisabled(i)) target.disableEquip(i);
					}
					target.draw(num);
					target.addSkill('twjieqiu_enable');
				},
				ai: {
					order: 7,
					result: {
				...
				group: ['twjieqiu_phase', 'twjieqiu_check'],
				subSkill: {
					enable: {
						...
						filter: function (event, player) {
							...
							}).length > 0 && player.storage.disableEquip.length > 0;
						},
						direct: true,
						content: function () {
							'step 0'
							...
							if (!cards2.length) event.finish();
							else if (cards2.length >= player.storage.disableEquip.length) {
								for (var i of list) {
								...
								event.disabledNum = cards2.length;
							}
							'step 1'
							if (event.disabledNum > 0) {
					...
					phase: {
						...
						filter: function (event, player) {
							return event.player != player && event.player.hasSkill('twjieqiu_enable') && !player.hasSkill('twjieqiu_block');
						},
						content: function () {
							player.addSkill('twjieqiu_block');
							player.insertPhase();
						}
					},
					check: {
						...
						charlotte: true,
						filter: function (event, player) {
							return player.hasSkill('twjieqiu_block');
						},
						content: function () {
							player.removeSkill('twjieqiu_block');
						}
					},
			...
			twenchou: {
				...
				filter: function (event, player) {
					return game.hasPlayer(function (current) {
						return current != player && current.storage.disableEquip.length > 0;
					})
				},
				filterTarget: function (card, player, target) {
					return target != player && target.storage.disableEquip.length > 0 && target.countCards('h') > 0;
				},
				content: function () {
					'step 0'
					...
					player.chooseControl(list).set('prompt', '请选择恢复一个装备栏').set("ai", function () {
					...
					'step 2'
					if (result.control) {
						target.enableEquip(event.map[result.control]);
					}
				},
				ai: {
					order: 9,
			...
			twdengjian: {
				...
				init: function (player) {
					player.storage.twdengjian = [];
				},
				filter: function (event, player) {
					if (player.storage.twdengjian.length >= lib.color.length) return false;
					if (player.hasSkill('twxinshou_block1')) return false;
					return event.player != player && event.player.getHistory('sourceDamage', function (evt) {
						return evt.card && evt.card.name && evt.card.name == 'sha' && !player.storage.twdengjian.includes(evt.card.color);
					}).length > 0;
				},
				direct: true,
				content: function () {
					'step 0'
					player.chooseCard('he', '是否弃置一张牌并从弃牌堆获得' + get.translation(trigger.player) + '本回合造成过伤害的【杀】').set('ai', function (card) {
						return 6 - get.value(card);
					});
					'step 1'
					if (result.bool) {
						event.resultC = result.cards;
						var hist = trigger.player.getHistory('sourceDamage', function (evt) {
							return evt.card && evt.card.name && evt.card.name == 'sha' && !player.storage.twdengjian.includes(evt.card.color);
						})[0];
						var suitC = hist.card.suit, numberC = hist.card.number, natureC = hist.card.nature;
						var card = get.discardPile(function (card) {
							return card.name == 'sha' && card.suit == suitC && card.number == numberC && card.nature == natureC;
						});
						if (card) {
							player.logSkill('twdengjian', trigger.player);
							player.discard(event.resultC);
							player.storage.twdengjian.add(get.color(card));
							player.gain(card, 'gain2').gaintag.add('twdengjian');
						}
					}
					'step 2'
					game.updateRoundNumber();
				},
				group: ['twdengjian_1', 'twdengjian_3'],
				subSkill: {
					1: {
						...
						charlotte: true,
						filter: function (event, player) {
							return event.card && event.card.name == 'sha' && event.cards[0].hasGaintag('twdengjian');
						},
						content: function () {
							player.addSkill('twdengjian_2');
							trigger.twdengjian = true;
						}
					},
					2: {
						trigger: { player: 'useCardAfter' },
						...
						charlotte: true,
						filter: function (event, player) {
							return event.card && event.card.name == 'sha' && event.twdengjian == true;
						},
						content: function () {
							...
							player.removeSkill('twdengjian_2');
						}
					},
					3: {
						trigger: { global: 'roundFinish' },
						...
						charlotte: true,
						filter: function (event, player) {
							return player.storage.twdengjian.length > 0;
						},
						content: function () {
							player.storage.twdengjian.length = 0;
						}
					}
				}
			},
			twxinshou: {
				...
				init: function (player) {
					player.storage.twxinshou = [];
				},
				filter: function (event, player) {
					var colorC = [];
					player.getHistory('useCard').forEach(function (evt) {
						if (evt.card && evt.card.name == 'sha' && evt.card.color) colorC.add(evt.card.color);
					});
					if (!event.card.color || colorC.includes(event.card.color)) return false;
					return player.isPhaseUsing() && player.storage.twxinshou.length < 2;
				},
				content: function () {
					'step 0'
					var list = [];
					if (!player.storage.twxinshou.includes('1')) list.push('摸一张牌');
					if (!player.storage.twxinshou.includes('2')) list.push('交给一名其他角色一张牌');
					if (list.length) player.chooseControl(list).set('prompt', '请选择一项');
					else event.finish();
					'step 1'
					if (result.control == '摸一张牌') {
						player.draw();
						player.storage.twxinshou.add('1');
						event.finish();
					}
					else {
						player.storage.twxinshou.add('2');
						player.chooseCardTarget({
							prompt: get.prompt2('twxinshou'),
							filterCard: true,
							selectCard: 1,
							position: 'he',
							filterTarget: lib.filter.notMe,
				...
				group: ['twxinshou_use', 'twxinshou_reuse', 'twxinshou_start'],
				subSkill: {
					block1: { charlotte: true },
					use: {
						trigger: { player: 'useCard' },
						filter: function (event, player) {
							return player.storage.twxinshou && player.storage.twxinshou.length == 2;
						},
						content: function () {
							'step 0'
							player.addSkill('twxinshou_block1');
							player.chooseTarget('令一名其他角色获得【登剑】', lib.filter.notMe, true);
							'step 1'
							if (result.bool) {
								result.targets[0].addSkill('twdengjian');
								player.addSkill('twxinshou_get');
							}
						},
					},
					get: {
						...
						onremove: true,
						filter: function (event, player) {
							return event.source && event.card && event.card.name == 'sha' && event.source != player && event.source.hasSkill('twxinshou') && player.hasSkill('twxinshou_block1');
						},
						logTarget: "source",
						content: function () {
							player.addSkill('twxinshou_block2');
						}
					},
					block2: {
						...
						charlotte: true,
						filter: function (event, player) {
							return player.hasSkill('twxinshou_block1');
						},
						content: function () {
							player.removeSkill('twxinshou_block1');
							player.removeSkill('twxinshou_block2');
						}
					},
					reuse: {
						trigger: { global: 'phaseEnd' },
						...
						charlotte: true,
						filter: function (event, player) {
							return player.storage.twxinshou.length > 0;
						},
						content: function () {
							player.storage.twxinshou.length = 0;
						}
					},
					start: {
						...
						content: function () {
							game.players.forEach(function (current) {
								if (current != player && current.hasSkill('twdengjian')) current.removeSkill('twdengjian');
							})
						}
					}
				}
			...
			twhuajing: {
				...
				content: function () {
					player.addMark("twhuajing", 6);
				},
				marktext: '武',
				intro: {
					content: function (storage, player) {
						var text = '当前拥有' + storage + '个【武】<br>';
						if (player.storage.twhuajingwu) {
							if (player.storage.twhuajingwu.length > 0) {
								text += '当前已激活：';
								for (var i = 0; i < player.storage.twhuajingwu.length; i++) {
									text += get.translation('twtianshou_' + player.storage.twhuajingwu[i]) + ' ';
								}
							}
							else text += '当前没有【武】被激活';
						}
						return text;
					}
				},
				group: ['twhuajing_gain', 'twhuajing_clear'],
				global: 'twhuajing_mark',
				subSkill: {
					gain: {
						audio: 'twhuajing',
						enable: 'phaseUse',
						...
						content: function () {
							...
							var wuqiku = [1, 2, 3, 4, 5, 6];
							var wuqi = wuqiku.randomGets(suit.length);
							player.storage.twhuajingwu = wuqi;
							for (var k = 0; k < wuqi.length; k++) {
								player.addTempSkill('twtianshou_' + wuqi[k], 'phaseEnd');
							}
						}
					},
					mark: {
						mod: {
							globalFrom: function (from, to, current) {
								return current - from.countMark('twhuajing');
							},
						},
					},
					clear: {
						...
						charlotte: true,
						content: function () {
							if (player.storage.twhuajingwu && player.storage.twhuajingwu.length > 0) player.storage.twhuajingwu.length = 0;
						}
					},
				},
			},
			twtianshou: {
				...
				filter: function (event, player) {
					return player.getHistory('sourceDamage', function (evt) {
						return evt.card && evt.card.name && evt.card.name == 'sha';
					}).length > 0 && player.storage.twhuajingwu && player.storage.twhuajingwu.length > 0;
				},
				content: function () {
					'step 0'
					var list = [];
					for (var i = 0; i < player.storage.twhuajingwu.length; i++) {
						list.push([('twtianshou_' + player.storage.twhuajingwu[i]), get.translation('twtianshou_' + player.storage.twhuajingwu[i]) + '：' + get.translation('twtianshou_' + player.storage.twhuajingwu[i] + '_info')])
					}
					player.chooseButton([
						'选择并给出一个【武】的效果',
					...
					if (result.bool) {
						...
						player.chooseTarget(get.prompt2('twtianshou'), true, function (card, player, target) {
					...
					'step 2'
					result.targets[0].addSkill(event.giveS);
					result.targets[0].addMark('twhuajing');
					player.draw();
					player.removeMark('twhuajing');
				},
				group: 'twtianshou_clear',
				subSkill: {
					1: {
						trigger: {
						...
						content: function () {
							...
							trigger.target.discard(hs.randomGets(Math.min(2, trigger.target.countCards('he'))));
						}
					},
					2: {
						trigger: {
					...
					6: {
						...
						shaRelated: true,
						filter: function (event, player) {
							return event.card && event.card.name == 'sha' && event.player.countCards('e') > 0;
						},
						content: function () {
					...
					clear: {
						...
						charlotte: true,
						filter: function (event, player) {
							return event.player != player && (event.player.hasSkill('twtianshou_1') || event.player.hasSkill('twtianshou_2') || event.player.hasSkill('twtianshou_3') || event.player.hasSkill('twtianshou_4') || event.player.hasSkill('twtianshou_5') || event.player.hasSkill('twtianshou_6'));
						},
						content: function () {
							for (var i = 1; i < 7; i++) {
								if (trigger.player.hasSkill('twtianshou_' + i)) trigger.player.removeSkill('twtianshou_' + i)
							}
							if (trigger.player.hasMark('twhuajing')) trigger.player.removeMark('twhuajing')
						}
					},
				},
			},
			twquanqian: {
				...
				ai: {
					...
					result: {
						target: function (player, target) {
							return Math.min(player.countCards('h'), 4);
						},
					},
				},
				subSkill: {
				...
				content: function () {
					...
					player.chooseCardTarget({
						...
						ai1: function (card) {
							...
							if (ui.selected.cards.length <= targetx.hp && player.hp <= 1 && !get.subtype(card) == 'equip1') return false;
							if (get.subtype(card) == 'equip1' && !hasWeapon) return 30 - get.value(card);
							return 7 - get.value(card);
						},
						ai2: function (target) {
			...
			twkuanji: {
				...
				content: function () {
					...
					player.chooseButton(['宽济：是否将任意张牌交给一名其他角色？', cards], [1, cards.length]).set('ai', function (button) {
						var player = _status.event.player;
						if (game.hasPlayer(function (current) {
							return current != player && get.attitude(player, current) > 0;
			...
			twdanlie: {
				...
				content: function () {
					'step 0'
					player.chooseToCompare(targets).setContent(lib.skill.twchaofeng.chooseToCompareMeanwhile);
					'step 1'
					if (result.winner && result.winner == player) {
						player.line(targets);
				...
				ai: {
					...
					result: {
						target: function (player, target) {
							var att = get.attitude(player, target);
							if (att >= 0) return 0;
							if (player.hp > 2) return -get.damageEffect(target, player, player) - 10 / target.countCards('h');
							var hs = player.getCards('h').sort((a, b) => b.number - a.number);
							var ts = target.getCards('h').sort((a, b) => b.number - a.number);
							if (!hs.length || !ts.length) return 0;
			...
			twhuzhong: {
				...
				trigger: { player: 'useCardToPlayer' },
				filter: function (event, player) {
					if (event.card.name == 'sha' && (event.card.nature == 'fire' || event.card.nature == 'thunder' || event.card.nature == 'ice' || event.card.nature == 'stab')) return false;
					return event.card.name == 'sha' && event.targets.length == 1 && player.isPhaseUsing() && (game.hasPlayer(target => !event.targets.includes(target) && player.canUse(event.card, target)) || event.target.countCards('h') > 0);
				},
				direct: true,
				content: function () {
					'step 0'
					...
					if (result.control != 'cancel2') {
						...
						player.addTempSkill('twhuzhong_damage');
				...
				subSkill: {
					damage: {
						...
						onremove: true,
						filter: function (event, player) {
							return event.card && event.card == 'sha';
						},
						content: function () {
							...
							player.removeSkill('twhuzhong_damage');
						},
					},
					sha: {
						charlotte: true,
			...
			twfenwang: {
				...
				filter: function (event, player, name) {
					if (name == 'damageBegin2') {
						return !event.nature && player.countCards('h') > event.player.countCards('h');
					}
					return event.nature;
				},
				forced: true,
