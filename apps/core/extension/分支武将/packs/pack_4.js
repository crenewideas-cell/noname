// Extracted from character/diy.js; legacy startup and engine/UI patches are not executed.
...
"characterSort": {
			diy:{
				diy_fakenews:["ns_caimao","ns_chengpu",'ns_sundeng','ns_duji'],
				diy_xushi:[],
				diy_default:[],
				diy_trashbin:['junk_sunquan'],
			},
		},
"characterFilter": {},
"characterTitle": {
...
"translate": {
			...
			chihaya_youfeng:'游凤',
			chihaya_youfeng_info:'转换技，阳，每轮限一次，你可以加1点体力上限，视为使用一张普通锦囊牌；阴，每轮限一次，你可以废除你的一个装备栏，视为使用一张基本牌。',
			chihaya_huairou:'怀柔',
			...
			kamome_jieban:'结伴',
			kamome_jieban_info:'转换技，每回合限一次，当你受到或造成伤害后，阳：你可将两张牌交给一名其他角色，然后其交给你一张牌。阴：你可将一张牌交给一名其他角色，然后其交给你两张牌。',
			kamome_suitcase:'旅行箱',
			...
			junkchigang:'持纲',
			junkchigang_info:'转换技，锁定技，判定阶段开始前，你取消此阶段。然后你获得一个额外的：阳，摸牌阶段；阴，出牌阶段。',
			junk_liubei:'削弱刘备',
			junk_liubei_ab:'刘备',
			junkrende:'仁德',
...
"skill": {
			...
			junkdili:{
				audio:'dili',
				trigger:{player:['addSkillAfter','gainMaxHpEnd','loseMaxHpEnd']},
				forced:true,
				juexingji:true,
				skillAnimation:true,
				animationColor:'wood',
