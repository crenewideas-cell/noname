// Extracted from character/standard.js; legacy startup and engine/UI patches are not executed.
...
"characterReplace": {
			...
			guanyu:['re_guanyu','guanyu','ps_guanyu','sb_guanyu','sbfm_sb_guanyu','jsrg_guanyu'],
