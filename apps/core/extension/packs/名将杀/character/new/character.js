...
const characters = {
    ...
    mjs_new_yueguang: {
        ...
        hp: 4,
        group: "xijin",
        skills: ["mjsnewyueyanxili", "mjsmingjiaoyuedi", "mjsbeigongsheying"],
        trashBin: ["junk"],
        maxHandcardBase: 5,
        dieAudios: [],
    },
    ...
    mjs_new_weiyan: {
        ...
        hp: 6,
        group: "shu",
        skills: ["mjsnewziwuqimou", "mjsfangunizhan", "mjsshuiganshawo"],
        trashBin: ["junk"],
        maxHandcardBase: 3,
        dieAudios: [],
    },
    ...
    mjs_new_chenping: {
        ...
        hp: 4,
        group: "xihan",
        skills: ["mjsnewliuchuqiji", "mjsguaxiweimen"],
        trashBin: ["rare"],
        maxHandcardBase: 5,
        dieAudios: [],
    },
...
const characters2 = {
    mjs_new_huatuo: {
        ...
        hp: 4,
        group: "donghan",
        skills: ["mjsnewguaguliaodu", "mjsnewqingnangmiaoshou"],
        trashBin: ["rare"],
        maxHandcardBase: 4,
        dieAudios: [],
    },
...
for (let i in characters2) {
    const name = `mjs${i.slice("mjs_new".length)}`;
    characters2[i].trashBin.push(`ext:名将杀/image/character/${lib.config.extension_名将杀_outcrop}/${name}.jpg`);
    characters2[i].dieAudios.addArray([`ext:名将杀/audio/die/${name}.mp3`, `ext:名将杀/audio/die/${name}2.mp3`]);
    if (lib.characterReplace) {
        if (!lib.characterReplace[name]) {
            lib.characterReplace[name] = [name, i];
        } else {
...
const characters3 = {
    mjs_off_huangyueying: {
        sex: "female",
        hp: 4,
        group: "shu",
        skills: ["mjsoffqiaoshoujiangxin", "mjsqizhizuomou"],
        trashBin: ["rare"],
        maxHandcardBase: 4,
        dieAudios: [],
    },
    mjs_off_pangtong: {
        ...
        hp: 4,
        group: "shu",
        skills: ["mjstiesuolianzhou", "mjsoffyuhuochongsheng"],
        trashBin: ["legend"],
        maxHandcardBase: 5,
        dieAudios: [],
    },
    mjs_off_lvbu: {
        ...
        hp: 7,
        group: "donghan",
        skills: ["mjsoffwushuangfeijiang", "mjslangziyexin", "mjsyuanmensheji"],
        trashBin: ["epic"],
        maxHandcardBase: 2,
        dieAudios: [],
    },
    mjs_off_guanyu: {
        ...
        hp: 6,
        group: "shu",
        skills: ["mjsoffwanjunqushou", "mjswushengyijue", "mjsoffshuiyanqijun"],
        trashBin: ["legend"],
        maxHandcardBase: 3,
        dieAudios: [],
    },
    mjs_off_baoyuan: {
        ...
        hp: 9,
        group: "han",
        skills: ["mjsbaizhanwujie", "mjsoffluzhanfenghui", "mjsxuruizhuizhan"],
        trashBin: ["junk"],
        dieAudios: [],
        maxHandcardBase: 2,
    },
    mjs_off_yuanshao: {
        ...
        hp: 5,
        group: "donghan",
        skills: ["mjssishisangong", "mjsoffbaiwanxiongbing", "mjsfujinfengliu"],
        trashBin: ["rare"],
        maxHandcardBase: 4,
        dieAudios: [],
    },
    mjs_off_guowei: {
        ...
        hp: 4,
        group: "yan",
        skills: ["mjsoffqianjinshigu", "mjsqingziweishi"],
        trashBin: ["rare"],
        maxHandcardBase: 5,
        dieAudios: [],
    },
    mjs_off_xuchu: {
        ...
        hp: 6,
        group: "wei",
        skills: ["mjsoffhuchi", "mjsoffxiejiahanzhan"],
        trashBin: ["junk"],
        maxHandcardBase: 3,
        dieAudios: [],
    },
...
const characters5 = {
    mjs_10170_shangyang: {
        ...
        maxHandcardBase: 5,
        dieAudios: [],
        img: "extension/名将杀/image/character/full/mjs_shangyang.jpg",
    },
    mjs_10240_shangyang: {
        sex: "male",
        hp: 4,
    ...
    mjs_10381_mozi: {
        ...
        maxHandcardBase: 5,
        dieAudios: [],
        img: "extension/名将杀/image/character/full/mjs_mozi.jpg",
    },
    mjs_10601_mozi: {
        sex: "male",
        hp: 4,
