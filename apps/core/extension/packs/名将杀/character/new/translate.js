...
const translates = {
    ...
    mjs_new_yueguang: "新杀乐广",
    mjs_new_yueguang_prefix: "新杀",
    mjsnewyueyanxili: "约言析理",
    mjsnewyueyanxili_info: "回合结束时，若你在本回合的每个出牌阶段打出的牌数都≤2，直到你的下个回合开始，当其他角色主动打出战法牌后，你可以立即将1张牌当作同名战法牌打出。",
    ...
    mjs_new_weiyan: "新杀魏延",
    mjs_new_weiyan_prefix: "新杀",
    mjsnewziwuqimou: "子午奇谋",
    mjsnewziwuqimou_info: "每轮开始时，你可以将任意牌当作杀对一名其他角色打出，若此杀造成伤害，你摸2张牌。",
    ...
    mjs_new_chenping: "新杀陈平",
    mjs_new_chenping_prefix: "新杀",
    mjsnewliuchuqiji: "六出奇计",
    mjsnewliuchuqiji_info: `出牌阶段开始时/${get.poptip("rule_mjs_yingzhan")}，你可以将1张未选择过的${get.poptip("mjsliuchuqiji_faq")}添加到手牌，直到每张专属战法牌都选择后重置此技能。`,
...
const translates2 = {
    mjs_new_huatuo: "修华佗",
    mjs_new_huatuo_prefix: "修",
    mjsnewguaguliaodu: "刮骨疗毒",
    mjsnewguaguliaodu_info: `每个回合限1次，当一名有手牌的角色受伤后，你可以将其所有手牌移出游戏，直到其下个回合开始，然后令其${get.poptip("mjs_debuff_zhongdu_faq")}-1并回复1点体力。`,
    mjsnewqingnangmiaoshou: "青囊妙手",
    mjsnewqingnangmiaoshou_info: `当你打出♣的牌后，可以令一名角色${get.poptip("mjs_debuff_liuxue_faq")}-1并回复1点体力，若其体力值已满，则改为体力上限+1并回复1点体力。`,
};

Object.assign(translates, translates2);

const translates3 = {
    mjs_off_huangyueying: "将黄月英",
    mjs_off_huangyueying_prefix: "将",
    mjsoffqiaoshoujiangxin: "巧手匠心",
    mjsoffqiaoshoujiangxin_info: "出牌阶段限1次，你可以选择一项：1.移动场上一张装备牌；2.获得重放1。",
    mjsoffqizhizuomou: "奇智佐谋",
    mjsoffqizhizuomou_info: "每种牌名每回合限1次，你对角色打出的战法牌获得重放1。",

    mjs_off_pangtong: "将庞统",
    mjs_off_pangtong_prefix: "将",
    mjsoffyuhuochongsheng: "浴火重生",
    mjsoffyuhuochongsheng_info: `回合结束时，你可以将所有牌交给一名其他角色，然后受到1点火焰伤害。阵亡，若你的阵营未失败，你进入${get.poptip("mjsyuhuochongsheng_faq")}。`,

    mjs_off_lvbu: "将吕布",
    mjs_off_lvbu_prefix: "将",
    mjsoffwushuangfeijiang: "无双飞将",
    mjsoffwushuangfeijiang_info: `你的战法牌只能当杀打出，你每回合首次打出的首张杀具有${get.poptip("rule_mjs_qiangming")}和重放1。`,

    mjs_off_guanyu: "将关羽",
    mjs_off_guanyu_prefix: "将",
    mjsoffwanjunqushou: "万军取首",
    mjsoffwanjunqushou_info: "你的杀攻击范围无限，你的杀对目标即将造成伤害时，你观看其所有手牌并展示其中任意张杀，每展示一张此伤害便+1。",
    mjsoffshuiyanqijun: "水淹七军",
    mjsoffshuiyanqijun_info: "每个回合限1次，当你打出的杀被闪抵消后，你可以摸1张牌，或令以下效果中需要弃置牌的数量-1；每局游戏限1次，你可以弃置3张♠牌，令一名其他角色弃置所有牌并受到1点伤害。",

    mjs_off_baoyuan: "将暴鸢",
    mjs_off_baoyuan_prefix: "将",
    mjsoffluzhanfenghui: "路转锋回",
    mjsoffluzhanfenghui_info: "你的杀不计入出杀次数。当其他角色应战你的杀时，其可以弃置1张牌，令座次为此牌点数的角色（特别地，能为你）成为此杀的额外目标。",

    mjs_off_yuanshao: "将袁绍",
    mjs_off_yuanshao_prefix: "将",
    mjsoffbaiwanxiongbing: "百万雄兵",
    mjsoffbaiwanxiongbing_info: "出牌阶段开始时，若你的手牌数全场最多，你可以将一张战法牌当箭雨齐射打出且可以重复此流程。",

    mjs_off_guowei: "将郭隗",
    mjs_off_guowei_prefix: "将",
    mjsoffqianjinshigu: "千金市骨",
    mjsoffqianjinshigu_info: "出牌阶段限1次，你可以将所有手牌增强后洗入牌堆，然后从弃牌堆中选择任意张类型各不同的牌获得（不能包含你上次发动此技能时选择过的牌名），并增强其中的坐骑牌。",

    mjs_off_xuchu: "将许褚",
    mjs_off_xuchu_prefix: "将",
    mjsoffhuchi: "虎痴",
    mjsoffhuchi_info: "受伤，摸1张牌，然后你可以将此牌当阵前对决对伤害来源打出。出牌阶段限1次，你可以将1张牌当阵前对决打出。",
    mjsoffxiejiahanzhan: "卸甲酣战",
    mjsoffxiejiahanzhan_info: "限定，你弃置手牌中的任意张装备牌和装备区里的所有牌，每弃置1张装备牌，摸2张牌，出杀次数+1。",
};
...
const translates5 = {
    ...
    mjs_10381_mozi: "墨子",
    mjs1038101: "非攻",
    mjs1038101_info: `其他角色${get.poptip("rule_mjs_yingzhan")}时，若其体力值小于目标或拥有${get.poptip("mjs1038101")}，你可以交给其任意张牌，然后其可以打出其中1张。`,
    mjs1038102: "兼爱",
