...
import { composeApk } from "./apk.js";
export const type = "extension";
function originalHandkill(lib, game, ui, get, ai, _status){
    const skills = {
        // 势钟会
        dzmbsizi: {
...
export default async function (...args) {
    const pack = await composeApk(originalHandkill(...args), args);
    pack.package.author = "PXLNGU";
    return pack;
}
